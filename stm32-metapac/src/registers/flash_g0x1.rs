        ...
        Block {
            ...
            items: &[
                ...
                BlockItem {
                    name: "pcrop2asr",
                    description: Some(
                        "Flash PCROP zone A Start address register bank 2",
                    ),
                    array: None,
                    byte_offset: 0x44,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "pcrop2aer",
                    description: Some(
                        "Flash PCROP zone A End address register bank 2",
                    ),
                    array: None,
                    byte_offset: 0x48,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "pcrop2bsr",
                    description: Some(
                        "Flash PCROP zone B Start address register bank 2",
                    ),
                    array: None,
                    byte_offset: 0x54,
                    inner: BlockItemInner::Register(
                ...
                BlockItem {
                    name: "pcrop2ber",
                    description: Some(
                        "Flash PCROP zone B End address register bank 2",
                    ),
                    array: None,
                    byte_offset: 0x58,
                    inner: BlockItemInner::Register(

...
struct Cfgr1 { mem_mode : u8 , ufb : bool , boot_mode : u8 , } let proxy = Cfgr1 { mem_mode : self . mem_mode () , ufb : self . ufb () , boot_mode : self . boot_mode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CFGR2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { fwdis : bool , i2c_pb6_fmp : bool , i2c_pb7_fmp : bool , i2c_pb8_fmp : bool , i2c_pb9_fmp : bool , i2c1_fmp : bool , i2c2_fmp : bool , i2c3_fmp : bool , } let proxy = Cfgr2 { fwdis : self . fwdis () , i2c_pb6_fmp : self . i2c_pb6_fmp () , i2c_pb7_fmp : self . i2c_pb7_fmp () , i2c_pb8_fmp : self . i2c_pb8_fmp () , i2c_pb9_fmp : self . i2c_pb9_fmp () , i2c1_fmp : self . i2c1_fmp () , i2c2_fmp : self . i2c2_fmp () , i2c3_fmp : self . i2c3_fmp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CFGR3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr3 { en_vrefint : bool , sel_vref_out : u8 , enbuf_vrefint_adc : bool , enbuf_sensor_adc : bool , enbuf_vrefint_comp2 : bool , enref_hsi48 : bool , vrefint_rdyf : bool , ref_lock : bool , } let proxy = Cfgr3 { en_vrefint : self . en_vrefint () , sel_vref_out : self . sel_vref_out () , enbuf_vrefint_adc : self . enbuf_vrefint_adc () , enbuf_sensor_adc : self . enbuf_sensor_adc () , enbuf_vrefint_comp2 : self . enbuf_vrefint_comp2 () , enref_hsi48 : self . enref_hsi48 () , vrefint_rdyf : self . vrefint_rdyf () , ref_lock : self . ref_lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "external interrupt configuration register 1-4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

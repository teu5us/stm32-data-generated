...
struct Acr { latency : super :: vals :: Latency , prften : bool , icen : bool , dcen : bool , icrst : bool , dcrst : bool , } let proxy = Acr { latency : self . latency () , prften : self . prften () , icen : self . icen () , dcen : self . dcen () , icrst : self . icrst () , dcrst : self . dcrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { pg : bool , ser : bool , mer : bool , snb : u8 , psize : super :: vals :: Psize , strt : bool , eopie : bool , errie : bool , lock : bool , } let proxy = Cr { pg : self . pg () , ser : self . ser () , mer : self . mer () , snb : self . snb () , psize : self . psize () , strt : self . strt () , eopie : self . eopie () , errie : self . errie () , lock : self . lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash option control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Optcr { optlock : bool , optstrt : bool , bor_lev : u8 , wdg_sw : bool , n_rst_stop : bool , n_rst_stdby : bool , rdp : u8 , n_wrp : u16 , db1m : bool , sprmod : bool , } let proxy = Optcr { optlock : self . optlock () , optstrt : self . optstrt () , bor_lev : self . bor_lev () , wdg_sw : self . wdg_sw () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , rdp : self . rdp () , n_wrp : self . n_wrp () , db1m : self . db1m () , sprmod : self . sprmod () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { eop : bool , operr : bool , wrperr : bool , pgaerr : bool , pgperr : bool , pgserr : bool , bsy : bool , } let proxy = Sr { eop : self . eop () , operr : self . operr () , wrperr : self . wrperr () , pgaerr : self . pgaerr () , pgperr : self . pgperr () , pgserr : self . pgserr () , bsy : self . bsy () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

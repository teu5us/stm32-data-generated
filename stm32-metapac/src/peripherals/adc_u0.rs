...
struct Dr { regular_data : u16 , } let proxy = Dr { regular_data : self . regular_data () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

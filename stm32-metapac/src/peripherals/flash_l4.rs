...
struct Acr { latency : u8 , prften : bool , icen : bool , dcen : bool , icrst : bool , dcrst : bool , run_pd : bool , sleep_pd : bool , } let proxy = Acr { latency : self . latency () , prften : self . prften () , icen : self . icen () , dcen : self . dcen () , icrst : self . icrst () , dcrst : self . dcrst () , run_pd : self . run_pd () , sleep_pd : self . sleep_pd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("pg" , & self . pg ()) . field ("per" , & self . per ()) . field ("mer" , & [self . mer (0usize) , self . mer (1usize) ,]) . field ("pnb" , & self . pnb ()) . field ("bker" , & self . bker ()) . field ("start" , & self . start ()) . field ("optstrt" , & self . optstrt ()) . field ("fstpg" , & self . fstpg ()) . field ("eopie" , & self . eopie ()) . field ("errie" , & self . errie ()) . field ("rderrie" , & self . rderrie ()) . field ("obl_launch" , & self . obl_launch ()) . field ("optlock" , & self . optlock ()) . field ("lock" , & self . lock ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr { pg : bool , per : bool , mer : [bool ; 2usize]
, pnb : u8 , bker : bool , start : bool , optstrt : bool , fstpg : bool , eopie : bool , errie : bool , rderrie : bool , obl_launch : bool , optlock : bool , lock : bool , } let proxy = Cr { pg : self . pg () , per : self . per () , mer : [self . mer (0usize) , self . mer (1usize) ,]
, pnb : self . pnb () , bker : self . bker () , start : self . start () , optstrt : self . optstrt () , fstpg : self . fstpg () , eopie : self . eopie () , errie : self . errie () , rderrie : self . rderrie () , obl_launch : self . obl_launch () , optlock : self . optlock () , lock : self . lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash ECC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Eccr { addr_ecc : u32 , bk_ecc : bool , sysf_ecc : bool , eccie : bool , eccc : bool , eccd : bool , } let proxy = Eccr { addr_ecc : self . addr_ecc () , bk_ecc : self . bk_ecc () , sysf_ecc : self . sysf_ecc () , eccie : self . eccie () , eccc : self . eccc () , eccd : self . eccd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash option register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Optr { rdp : u8 , bor_lev : u8 , n_rst_stop : bool , n_rst_stdby : bool , idwg_sw : bool , iwdg_stop : bool , iwdg_stdby : bool , wwdg_sw : bool , bfb : bool , dualbank : bool , n_boot1 : bool , sram2_pe : bool , sram2_rst : bool , n_swboot0 : bool , n_boot0 : bool , } let proxy = Optr { rdp : self . rdp () , bor_lev : self . bor_lev () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , idwg_sw : self . idwg_sw () , iwdg_stop : self . iwdg_stop () , iwdg_stdby : self . iwdg_stdby () , wwdg_sw : self . wwdg_sw () , bfb : self . bfb () , dualbank : self . dualbank () , n_boot1 : self . n_boot1 () , sram2_pe : self . sram2_pe () , sram2_rst : self . sram2_rst () , n_swboot0 : self . n_swboot0 () , n_boot0 : self . n_boot0 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Bank 1 PCROP End address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop2sr { pcrop2_strt : u16 , } let proxy = Pcrop2sr { pcrop2_strt : self . pcrop2_strt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Wrp2br { wrp2b_strt : u8 , wrp2b_end : u8 , } let proxy = Wrp2br { wrp2b_strt : self . wrp2b_strt () , wrp2b_end : self . wrp2b_end () , } ; defmt :: write ! (f , "{}" , proxy) } } }
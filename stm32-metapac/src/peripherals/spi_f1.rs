...
struct Cr2 { rxdmaen : bool , txdmaen : bool , ssoe : bool , errie : bool , rxneie : bool , txeie : bool , } let proxy = Cr2 { rxdmaen : self . rxdmaen () , txdmaen : self . txdmaen () , ssoe : self . ssoe () , errie : self . errie () , rxneie : self . rxneie () , txeie : self . txeie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CRC polynomial register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { rxne : bool , txe : bool , chside : super :: vals :: Chside , udr : bool , crcerr : bool , modf : bool , ovr : bool , bsy : bool , } let proxy = Sr { rxne : self . rxne () , txe : self . txe () , chside : self . chside () , udr : self . udr () , crcerr : self . crcerr () , modf : self . modf () , ovr : self . ovr () , bsy : self . bsy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "TX CRC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
struct Ahb2enr { dcmien : bool , jpegen : bool , aesen : bool , crypen : bool , hashen : bool , rngen : bool , usb_otg_fsen : bool , } let proxy = Ahb2enr { dcmien : self . dcmien () , jpegen : self . jpegen () , aesen : self . aesen () , crypen : self . crypen () , hashen : self . hashen () , rngen : self . rngen () , usb_otg_fsen : self . usb_otg_fsen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2lpenr { dcmilpen : bool , jpeglpen : bool , aeslpen : bool , cryplpen : bool , hashlpen : bool , rnglpen : bool , usb_otg_fslpen : bool , } let proxy = Ahb2lpenr { dcmilpen : self . dcmilpen () , jpeglpen : self . jpeglpen () , aeslpen : self . aeslpen () , cryplpen : self . cryplpen () , hashlpen : self . hashlpen () , rnglpen : self . rnglpen () , usb_otg_fslpen : self . usb_otg_fslpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2rstr { dcmirst : bool , aesrst : bool , cryprst : bool , hsahrst : bool , rngrst : bool , usb_otg_fsrst : bool , } let proxy = Ahb2rstr { dcmirst : self . dcmirst () , aesrst : self . aesrst () , cryprst : self . cryprst () , hsahrst : self . hsahrst () , rngrst : self . rngrst () , usb_otg_fsrst : self . usb_otg_fsrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3enr { fmcen : bool , quadspien : bool , } let proxy = Ahb3enr { fmcen : self . fmcen () , quadspien : self . quadspien () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3lpenr { fmclpen : bool , quadspilpen : bool , } let proxy = Ahb3lpenr { fmclpen : self . fmclpen () , quadspilpen : self . quadspilpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3rstr { fmcrst : bool , quadspirst : bool , } let proxy = Ahb3rstr { fmcrst : self . fmcrst () , quadspirst : self . quadspirst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , tim12en : bool , tim13en : bool , tim14en : bool , lptim1en : bool , rtcen : bool , wwdgen : bool , can3en : bool , spi2en : bool , spi3en : bool , spdifrxen : bool , usart2en : bool , usart3en : bool , uart4en : bool , uart5en : bool , i2c1en : bool , i2c2en : bool , i2c3en : bool , i2c4en : bool , can1en : bool , can2en : bool , cecen : bool , pwren : bool , dacen : bool , uart7en : bool , uart8en : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , tim12en : self . tim12en () , tim13en : self . tim13en () , tim14en : self . tim14en () , lptim1en : self . lptim1en () , rtcen : self . rtcen () , wwdgen : self . wwdgen () , can3en : self . can3en () , spi2en : self . spi2en () , spi3en : self . spi3en () , spdifrxen : self . spdifrxen () , usart2en : self . usart2en () , usart3en : self . usart3en () , uart4en : self . uart4en () , uart5en : self . uart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , i2c3en : self . i2c3en () , i2c4en : self . i2c4en () , can1en : self . can1en () , can2en : self . can2en () , cecen : self . cecen () , pwren : self . pwren () , dacen : self . dacen () , uart7en : self . uart7en () , uart8en : self . uart8en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1lpenr { tim2lpen : bool , tim3lpen : bool , tim4lpen : bool , tim5lpen : bool , tim6lpen : bool , tim7lpen : bool , tim12lpen : bool , tim13lpen : bool , tim14lpen : bool , lptim1lpen : bool , rtclpen : bool , wwdglpen : bool , can3lpen : bool , spi2lpen : bool , spi3lpen : bool , spdifrxlpen : bool , usart2lpen : bool , usart3lpen : bool , uart4lpen : bool , uart5lpen : bool , i2c1lpen : bool , i2c2lpen : bool , i2c3lpen : bool , i2c4lpen : bool , can1lpen : bool , can2lpen : bool , ceclpen : bool , pwrlpen : bool , daclpen : bool , uart7lpen : bool , uart8lpen : bool , } let proxy = Apb1lpenr { tim2lpen : self . tim2lpen () , tim3lpen : self . tim3lpen () , tim4lpen : self . tim4lpen () , tim5lpen : self . tim5lpen () , tim6lpen : self . tim6lpen () , tim7lpen : self . tim7lpen () , tim12lpen : self . tim12lpen () , tim13lpen : self . tim13lpen () , tim14lpen : self . tim14lpen () , lptim1lpen : self . lptim1lpen () , rtclpen : self . rtclpen () , wwdglpen : self . wwdglpen () , can3lpen : self . can3lpen () , spi2lpen : self . spi2lpen () , spi3lpen : self . spi3lpen () , spdifrxlpen : self . spdifrxlpen () , usart2lpen : self . usart2lpen () , usart3lpen : self . usart3lpen () , uart4lpen : self . uart4lpen () , uart5lpen : self . uart5lpen () , i2c1lpen : self . i2c1lpen () , i2c2lpen : self . i2c2lpen () , i2c3lpen : self . i2c3lpen () , i2c4lpen : self . i2c4lpen () , can1lpen : self . can1lpen () , can2lpen : self . can2lpen () , ceclpen : self . ceclpen () , pwrlpen : self . pwrlpen () , daclpen : self . daclpen () , uart7lpen : self . uart7lpen () , uart8lpen : self . uart8lpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , tim12rst : bool , tim13rst : bool , tim14rst : bool , lptim1rst : bool , wwdgrst : bool , can3rst : bool , spi2rst : bool , spi3rst : bool , spdifrxrst : bool , usart2rst : bool , usart3rst : bool , uart4rst : bool , uart5rst : bool , i2c1rst : bool , i2c2rst : bool , i2c3rst : bool , i2c4rst : bool , can1rst : bool , can2rst : bool , cecrst : bool , pwrrst : bool , dacrst : bool , uart7rst : bool , uart8rst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , tim12rst : self . tim12rst () , tim13rst : self . tim13rst () , tim14rst : self . tim14rst () , lptim1rst : self . lptim1rst () , wwdgrst : self . wwdgrst () , can3rst : self . can3rst () , spi2rst : self . spi2rst () , spi3rst : self . spi3rst () , spdifrxrst : self . spdifrxrst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , uart4rst : self . uart4rst () , uart5rst : self . uart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , i2c3rst : self . i2c3rst () , i2c4rst : self . i2c4rst () , can1rst : self . can1rst () , can2rst : self . can2rst () , cecrst : self . cecrst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , uart7rst : self . uart7rst () , uart8rst : self . uart8rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { tim1en : bool , tim8en : bool , usart1en : bool , usart6en : bool , sdmmc2en : bool , adc1en : bool , adc2en : bool , adc3en : bool , sdmmc1en : bool , spi1en : bool , spi4en : bool , syscfgen : bool , tim9en : bool , tim10en : bool , tim11en : bool , spi5en : bool , spi6en : bool , sai1en : bool , sai2en : bool , ltdcen : bool , dsien : bool , dfsdm1en : bool , mdiosen : bool , usbphycen : bool , } let proxy = Apb2enr { tim1en : self . tim1en () , tim8en : self . tim8en () , usart1en : self . usart1en () , usart6en : self . usart6en () , sdmmc2en : self . sdmmc2en () , adc1en : self . adc1en () , adc2en : self . adc2en () , adc3en : self . adc3en () , sdmmc1en : self . sdmmc1en () , spi1en : self . spi1en () , spi4en : self . spi4en () , syscfgen : self . syscfgen () , tim9en : self . tim9en () , tim10en : self . tim10en () , tim11en : self . tim11en () , spi5en : self . spi5en () , spi6en : self . spi6en () , sai1en : self . sai1en () , sai2en : self . sai2en () , ltdcen : self . ltdcen () , dsien : self . dsien () , dfsdm1en : self . dfsdm1en () , mdiosen : self . mdiosen () , usbphycen : self . usbphycen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enabled in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2lpenr { tim1lpen : bool , tim8lpen : bool , usart1lpen : bool , usart6lpen : bool , sdmmc2lpen : bool , adc1lpen : bool , adc2lpen : bool , adc3lpen : bool , sdmmc1lpen : bool , spi1lpen : bool , spi4lpen : bool , syscfglpen : bool , tim9lpen : bool , tim10lpen : bool , tim11lpen : bool , spi5lpen : bool , spi6lpen : bool , sai1lpen : bool , sai2lpen : bool , ltdclpen : bool , dsilpen : bool , dfsdm1lpen : bool , mdioslpen : bool , } let proxy = Apb2lpenr { tim1lpen : self . tim1lpen () , tim8lpen : self . tim8lpen () , usart1lpen : self . usart1lpen () , usart6lpen : self . usart6lpen () , sdmmc2lpen : self . sdmmc2lpen () , adc1lpen : self . adc1lpen () , adc2lpen : self . adc2lpen () , adc3lpen : self . adc3lpen () , sdmmc1lpen : self . sdmmc1lpen () , spi1lpen : self . spi1lpen () , spi4lpen : self . spi4lpen () , syscfglpen : self . syscfglpen () , tim9lpen : self . tim9lpen () , tim10lpen : self . tim10lpen () , tim11lpen : self . tim11lpen () , spi5lpen : self . spi5lpen () , spi6lpen : self . spi6lpen () , sai1lpen : self . sai1lpen () , sai2lpen : self . sai2lpen () , ltdclpen : self . ltdclpen () , dsilpen : self . dsilpen () , dfsdm1lpen : self . dfsdm1lpen () , mdioslpen : self . mdioslpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { tim1rst : bool , tim8rst : bool , usart1rst : bool , usart6rst : bool , sdmmc2rst : bool , adcrst : bool , sdmmc1rst : bool , spi1rst : bool , spi4rst : bool , syscfgrst : bool , tim9rst : bool , tim10rst : bool , tim11rst : bool , spi5rst : bool , spi6rst : bool , sai1rst : bool , sai2rst : bool , ltdcrst : bool , dsirst : bool , dfsdm1rst : bool , mdiosrst : bool , usbphycrst : bool , } let proxy = Apb2rstr { tim1rst : self . tim1rst () , tim8rst : self . tim8rst () , usart1rst : self . usart1rst () , usart6rst : self . usart6rst () , sdmmc2rst : self . sdmmc2rst () , adcrst : self . adcrst () , sdmmc1rst : self . sdmmc1rst () , spi1rst : self . spi1rst () , spi4rst : self . spi4rst () , syscfgrst : self . syscfgrst () , tim9rst : self . tim9rst () , tim10rst : self . tim10rst () , tim11rst : self . tim11rst () , spi5rst : self . spi5rst () , spi6rst : self . spi6rst () , sai1rst : self . sai1rst () , sai2rst : self . sai2rst () , ltdcrst : self . ltdcrst () , dsirst : self . dsirst () , dfsdm1rst : self . dfsdm1rst () , mdiosrst : self . mdiosrst () , usbphycrst : self . usbphycrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bdcr { lseon : bool , lserdy : bool , lsebyp : bool , lsedrv : super :: vals :: Lsedrv , rtcsel : super :: vals :: Rtcsel , rtcen : bool , bdrst : bool , } let proxy = Bdcr { lseon : self . lseon () , lserdy : self . lserdy () , lsebyp : self . lsebyp () , lsedrv : self . lsedrv () , rtcsel : self . rtcsel () , rtcen : self . rtcen () , bdrst : self . bdrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr { sw : super :: vals :: Sw , sws : super :: vals :: Sw , hpre : super :: vals :: Hpre , ppre1 : super :: vals :: Ppre , ppre2 : super :: vals :: Ppre , rtcpre : u8 , mco1sel : super :: vals :: Mco1sel , i2ssrc : super :: vals :: Issrc , mco1pre : super :: vals :: Mcopre , mco2pre : super :: vals :: Mcopre , mco2sel : super :: vals :: Mco2sel , } let proxy = Cfgr { sw : self . sw () , sws : self . sws () , hpre : self . hpre () , ppre1 : self . ppre1 () , ppre2 : self . ppre2 () , rtcpre : self . rtcpre () , mco1sel : self . mco1sel () , i2ssrc : self . i2ssrc () , mco1pre : self . mco1pre () , mco2pre : self . mco2pre () , mco2sel : self . mco2sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dckcfgr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dckcfgr1 { plli2sdivq : super :: vals :: Plli2sdivq , pllsaidivq : super :: vals :: Pllsaidivq , pllsaidivr : super :: vals :: Pllsaidivr , sai1sel : super :: vals :: Saisel , sai2sel : super :: vals :: Saisel , timpre : super :: vals :: Timpre , dfsdm1sel : super :: vals :: Dfsdmsel , adfsdm1sel : super :: vals :: Adfsdmsel , } let proxy = Dckcfgr1 { plli2sdivq : self . plli2sdivq () , pllsaidivq : self . pllsaidivq () , pllsaidivr : self . pllsaidivr () , sai1sel : self . sai1sel () , sai2sel : self . sai2sel () , timpre : self . timpre () , dfsdm1sel : self . dfsdm1sel () , adfsdm1sel : self . adfsdm1sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "dedicated clocks configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dckcfgr2 { usart1sel : super :: vals :: Usart1sel , usart2sel : super :: vals :: Usart2sel , usart3sel : super :: vals :: Usart2sel , uart4sel : super :: vals :: Usart2sel , uart5sel : super :: vals :: Usart2sel , usart6sel : super :: vals :: Usart1sel , uart7sel : super :: vals :: Usart2sel , uart8sel : super :: vals :: Usart2sel , i2c1sel : super :: vals :: I2csel , i2c2sel : super :: vals :: I2csel , i2c3sel : super :: vals :: I2csel , i2c4sel : super :: vals :: I2csel , lptim1sel : super :: vals :: Lptimsel , cecsel : super :: vals :: Cecsel , clk48sel : super :: vals :: Clk48sel , sdmmc1sel : super :: vals :: Sdmmcsel , sdmmc2sel : super :: vals :: Sdmmcsel , dsisel : super :: vals :: Dsisel , } let proxy = Dckcfgr2 { usart1sel : self . usart1sel () , usart2sel : self . usart2sel () , usart3sel : self . usart3sel () , uart4sel : self . uart4sel () , uart5sel : self . uart5sel () , usart6sel : self . usart6sel () , uart7sel : self . uart7sel () , uart8sel : self . uart8sel () , i2c1sel : self . i2c1sel () , i2c2sel : self . i2c2sel () , i2c3sel : self . i2c3sel () , i2c4sel : self . i2c4sel () , lptim1sel : self . lptim1sel () , cecsel : self . cecsel () , clk48sel : self . clk48sel () , sdmmc1sel : self . sdmmc1sel () , sdmmc2sel : self . sdmmc2sel () , dsisel : self . dsisel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Plli2scfgr { plln : super :: vals :: Plln , pllp : super :: vals :: Pllp , pllq : super :: vals :: Pllq , pllr : super :: vals :: Pllr , } let proxy = Plli2scfgr { plln : self . plln () , pllp : self . pllp () , pllq : self . pllq () , pllr : self . pllr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pllsaicfgr { plln : super :: vals :: Plln , pllp : super :: vals :: Pllp , pllq : super :: vals :: Pllq , pllr : super :: vals :: Pllr , } let proxy = Pllsaicfgr { plln : self . plln () , pllp : self . pllp () , pllq : self . pllq () , pllr : self . pllr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "spread spectrum clock generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

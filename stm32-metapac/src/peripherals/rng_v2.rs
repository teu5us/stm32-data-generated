...
struct Cr { rngen : bool , ie : bool , ced : bool , rng_config3 : super :: vals :: RngConfig3 , nistc : super :: vals :: Nistc , rng_config2 : super :: vals :: RngConfig2 , clkdiv : super :: vals :: Clkdiv , rng_config1 : super :: vals :: RngConfig1 , condrst : bool , configlock : bool , } let proxy = Cr { rngen : self . rngen () , ie : self . ie () , ced : self . ced () , rng_config3 : self . rng_config3 () , nistc : self . nistc () , rng_config2 : self . rng_config2 () , clkdiv : self . clkdiv () , rng_config1 : self . rng_config1 () , condrst : self . condrst () , configlock : self . configlock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Health test control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

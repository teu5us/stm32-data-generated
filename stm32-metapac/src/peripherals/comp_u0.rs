...
struct Csr { en : bool , inmsel : u8 , inpsel : u8 , winmode : super :: vals :: WindowMode , winout : super :: vals :: WindowOut , polarity : super :: vals :: Polarity , hyst : super :: vals :: Hyst , pwrmode : super :: vals :: Pwrmode , blanksel : super :: vals :: Blanking , value : bool , lock : bool , } let proxy = Csr { en : self . en () , inmsel : self . inmsel () , inpsel : self . inpsel () , winmode : self . winmode () , winout : self . winout () , polarity : self . polarity () , hyst : self . hyst () , pwrmode : self . pwrmode () , blanksel : self . blanksel () , value : self . value () , lock : self . lock () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Cr { pg : bool , per : bool , mer : bool , pnb : u8 , strt : bool , optstrt : bool , fstpg : bool , eopie : bool , errie : bool , rderrie : bool , obl_launch : bool , sec_prot : bool , optlock : bool , lock : bool , } let proxy = Cr { pg : self . pg () , per : self . per () , mer : self . mer () , pnb : self . pnb () , strt : self . strt () , optstrt : self . optstrt () , fstpg : self . fstpg () , eopie : self . eopie () , errie : self . errie () , rderrie : self . rderrie () , obl_launch : self . obl_launch () , sec_prot : self . sec_prot () , optlock : self . optlock () , lock : self . lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash option register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Optr { rdp : super :: vals :: Rdp , boren : bool , borf_lev : super :: vals :: BorfLev , borr_lev : super :: vals :: BorrLev , n_rst_stop : bool , n_rst_stdby : bool , n_rsts_hdw : bool , idwg_sw : bool , iwdg_stop : bool , iwdg_stdby : bool , wwdg_sw : bool , ram_parity_check : bool , n_boot_sel : bool , n_boot1 : bool , n_boot0 : bool , nrst_mode : super :: vals :: NrstMode , irhen : bool , } let proxy = Optr { rdp : self . rdp () , boren : self . boren () , borf_lev : self . borf_lev () , borr_lev : self . borr_lev () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , n_rsts_hdw : self . n_rsts_hdw () , idwg_sw : self . idwg_sw () , iwdg_stop : self . iwdg_stop () , iwdg_stdby : self . iwdg_stdby () , wwdg_sw : self . wwdg_sw () , ram_parity_check : self . ram_parity_check () , n_boot_sel : self . n_boot_sel () , n_boot1 : self . n_boot1 () , n_boot0 : self . n_boot0 () , nrst_mode : self . nrst_mode () , irhen : self . irhen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash PCROP zone A End address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1aer { pcrop1a_end : u8 , pcrop_rdp : bool , } let proxy = Pcrop1aer { pcrop1a_end : self . pcrop1a_end () , pcrop_rdp : self . pcrop_rdp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash PCROP zone A Start address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1asr { pcrop1a_strt : u8 , } let proxy = Pcrop1asr { pcrop1a_strt : self . pcrop1a_strt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash PCROP zone B End address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1ber { pcrop1b_end : u8 , } let proxy = Pcrop1ber { pcrop1b_end : self . pcrop1b_end () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash PCROP zone B Start address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1bsr { pcrop1b_strt : u8 , } let proxy = Pcrop1bsr { pcrop1b_strt : self . pcrop1b_strt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Security register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Secr { sec_size : u8 , boot_lock : bool , } let proxy = Secr { sec_size : self . sec_size () , boot_lock : self . boot_lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { eop : bool , operr : bool , progerr : bool , wrperr : bool , pgaerr : bool , sizerr : bool , pgserr : bool , miserr : bool , fasterr : bool , rderr : bool , optverr : bool , bsy : bool , cfgbsy : bool , } let proxy = Sr { eop : self . eop () , operr : self . operr () , progerr : self . progerr () , wrperr : self . wrperr () , pgaerr : self . pgaerr () , sizerr : self . sizerr () , pgserr : self . pgserr () , miserr : self . miserr () , fasterr : self . fasterr () , rderr : self . rderr () , optverr : self . optverr () , bsy : self . bsy () , cfgbsy : self . cfgbsy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash WRP area A address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Wrp1br { wrp1b_strt : u8 , wrp1b_end : u8 , } let proxy = Wrp1br { wrp1b_strt : self . wrp1b_strt () , wrp1b_end : self . wrp1b_end () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

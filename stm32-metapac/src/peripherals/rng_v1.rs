...
struct Cr { rngen : bool , ie : bool , ced : bool , } let proxy = Cr { rngen : self . rngen () , ie : self . ie () , ced : self . ced () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { drdy : bool , cecs : bool , secs : bool , ceis : bool , seis : bool , } let proxy = Sr { drdy : self . drdy () , cecs : self . cecs () , secs : self . secs () , ceis : self . ceis () , seis : self . seis () , } ; defmt :: write ! (f , "{}" , proxy) } } }
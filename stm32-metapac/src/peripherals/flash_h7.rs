...
struct Cr { lock : bool , pg : bool , ser : bool , ber : bool , psize : u8 , fw : bool , start : bool , snb : u8 , crc_en : bool , eopie : bool , wrperrie : bool , pgserrie : bool , strberrie : bool , incerrie : bool , operrie : bool , rdperrie : bool , rdserrie : bool , sneccerrie : bool , dbeccerrie : bool , crcendie : bool , crcrderrie : bool , } let proxy = Cr { lock : self . lock () , pg : self . pg () , ser : self . ser () , ber : self . ber () , psize : self . psize () , fw : self . fw () , start : self . start () , snb : self . snb () , crc_en : self . crc_en () , eopie : self . eopie () , wrperrie : self . wrperrie () , pgserrie : self . pgserrie () , strberrie : self . strberrie () , incerrie : self . incerrie () , operrie : self . operrie () , rdperrie : self . rdperrie () , rdserrie : self . rdserrie () , sneccerrie : self . sneccerrie () , dbeccerrie : self . dbeccerrie () , crcendie : self . crcendie () , crcrderrie : self . crcrderrie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH CRC control register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Optcr { optlock : bool , optstart : bool , mer : bool , optchangeerrie : bool , swap_bank : bool , } let proxy = Optcr { optlock : self . optlock () , optstart : self . optstart () , mer : self . mer () , optchangeerrie : self . optchangeerrie () , swap_bank : self . swap_bank () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH option status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

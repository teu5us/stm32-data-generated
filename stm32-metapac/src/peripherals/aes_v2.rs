...
struct Cr { en : bool , datatype : super :: vals :: Datatype , mode : super :: vals :: Mode , chmod10 : u8 , ccfc : bool , errc : bool , ccfie : bool , errie : bool , dmainen : bool , dmaouten : bool , gcmph : super :: vals :: Gcmph , chmod2 : bool , keysize : bool , npblb : u8 , } let proxy = Cr { en : self . en () , datatype : self . datatype () , mode : self . mode () , chmod10 : self . chmod10 () , ccfc : self . ccfc () , errc : self . errc () , ccfie : self . ccfie () , errie : self . errie () , dmainen : self . dmainen () , dmaouten : self . dmaouten () , gcmph : self . gcmph () , chmod2 : self . chmod2 () , keysize : self . keysize () , npblb : self . npblb () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dinr { din : u32 , } let proxy = Dinr { din : self . din () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Data output register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Doutr { dout : u32 , } let proxy = Doutr { dout : self . dout () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Initialization vector register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ivr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ivr { ivi : u32 , } let proxy = Ivr { ivi : self . ivi () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Key register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Keyr { key : u32 , } let proxy = Keyr { key : self . key () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { ccf : bool , rderr : bool , wrerr : bool , busy : bool , } let proxy = Sr { ccf : self . ccf () , rderr : self . rderr () , wrerr : self . wrerr () , busy : self . busy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Suspend register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Suspr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Suspr { susp : u32 , } let proxy = Suspr { susp : self . susp () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

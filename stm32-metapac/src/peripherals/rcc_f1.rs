...
struct Ahbenr { dma1en : bool , dma2en : bool , sramen : bool , flashen : bool , crcen : bool , fsmcen : bool , sdioen : bool , } let proxy = Ahbenr { dma1en : self . dma1en () , dma2en : self . dma2en () , sramen : self . sramen () , flashen : self . flashen () , crcen : self . crcen () , fsmcen : self . fsmcen () , sdioen : self . sdioen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register (RCC_APB1ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , tim12en : bool , tim13en : bool , tim14en : bool , wwdgen : bool , spi2en : bool , spi3en : bool , usart2en : bool , usart3en : bool , uart4en : bool , uart5en : bool , i2c1en : bool , i2c2en : bool , usben : bool , canen : bool , bkpen : bool , pwren : bool , dacen : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , tim12en : self . tim12en () , tim13en : self . tim13en () , tim14en : self . tim14en () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , spi3en : self . spi3en () , usart2en : self . usart2en () , usart3en : self . usart3en () , uart4en : self . uart4en () , uart5en : self . uart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , usben : self . usben () , canen : self . canen () , bkpen : self . bkpen () , pwren : self . pwren () , dacen : self . dacen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register (RCC_APB1RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , tim12rst : bool , tim13rst : bool , tim14rst : bool , wwdgrst : bool , spi2rst : bool , spi3rst : bool , usart2rst : bool , usart3rst : bool , uart4rst : bool , uart5rst : bool , i2c1rst : bool , i2c2rst : bool , usbrst : bool , canrst : bool , bkprst : bool , pwrrst : bool , dacrst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , tim12rst : self . tim12rst () , tim13rst : self . tim13rst () , tim14rst : self . tim14rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , spi3rst : self . spi3rst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , uart4rst : self . uart4rst () , uart5rst : self . uart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , usbrst : self . usbrst () , canrst : self . canrst () , bkprst : self . bkprst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register (RCC_APB2ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { afioen : bool , gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , gpiofen : bool , gpiogen : bool , adc1en : bool , adc2en : bool , tim1en : bool , spi1en : bool , tim8en : bool , usart1en : bool , adc3en : bool , tim9en : bool , tim10en : bool , tim11en : bool , } let proxy = Apb2enr { afioen : self . afioen () , gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , gpiofen : self . gpiofen () , gpiogen : self . gpiogen () , adc1en : self . adc1en () , adc2en : self . adc2en () , tim1en : self . tim1en () , spi1en : self . spi1en () , tim8en : self . tim8en () , usart1en : self . usart1en () , adc3en : self . adc3en () , tim9en : self . tim9en () , tim10en : self . tim10en () , tim11en : self . tim11en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register (RCC_APB2RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { afiorst : bool , gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiodrst : bool , gpioerst : bool , gpiofrst : bool , gpiogrst : bool , adc1rst : bool , adc2rst : bool , tim1rst : bool , spi1rst : bool , tim8rst : bool , usart1rst : bool , adc3rst : bool , tim9rst : bool , tim10rst : bool , tim11rst : bool , } let proxy = Apb2rstr { afiorst : self . afiorst () , gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiodrst : self . gpiodrst () , gpioerst : self . gpioerst () , gpiofrst : self . gpiofrst () , gpiogrst : self . gpiogrst () , adc1rst : self . adc1rst () , adc2rst : self . adc2rst () , tim1rst : self . tim1rst () , spi1rst : self . spi1rst () , tim8rst : self . tim8rst () , usart1rst : self . usart1rst () , adc3rst : self . adc3rst () , tim9rst : self . tim9rst () , tim10rst : self . tim10rst () , tim11rst : self . tim11rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register (RCC_BDCR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

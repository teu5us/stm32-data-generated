...
struct Acr { latency : u8 , prften : bool , icen : bool , dcen : bool , icrst : bool , dcrst : bool , pes : bool , empty : bool , } let proxy = Acr { latency : self . latency () , prften : self . prften () , icen : self . icen () , dcen : self . dcen () , icrst : self . icrst () , dcrst : self . dcrst () , pes : self . pes () , empty : self . empty () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 cortex M0 access control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for C2acr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct C2acr { prften : bool , icen : bool , icrst : bool , pes : bool , } let proxy = C2acr { prften : self . prften () , icen : self . icen () , icrst : self . icrst () , pes : self . pes () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 cortex M0 control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for C2cr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct C2cr { pg : bool , per : bool , mer : bool , pnb : u8 , strt : bool , fstpg : bool , eopie : bool , errie : bool , rderrie : bool , } let proxy = C2cr { pg : self . pg () , per : self . per () , mer : self . mer () , pnb : self . pnb () , strt : self . strt () , fstpg : self . fstpg () , eopie : self . eopie () , errie : self . errie () , rderrie : self . rderrie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 cortex M0 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for C2sr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct C2sr { eop : bool , operr : bool , progerr : bool , wrperr : bool , pgaerr : bool , sizerr : bool , pgserr : bool , misserr : bool , fasterr : bool , rderr : bool , bsy : bool , cfgbsy : bool , pesd : bool , } let proxy = C2sr { eop : self . eop () , operr : self . operr () , progerr : self . progerr () , wrperr : self . wrperr () , pgaerr : self . pgaerr () , sizerr : self . sizerr () , pgserr : self . pgserr () , misserr : self . misserr () , fasterr : self . fasterr () , rderr : self . rderr () , bsy : self . bsy () , cfgbsy : self . cfgbsy () , pesd : self . pesd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { pg : bool , per : bool , mer : bool , pnb : u8 , strt : bool , optstrt : bool , fstpg : bool , eopie : bool , errie : bool , rderrie : bool , obl_launch : bool , optlock : bool , lock : bool , } let proxy = Cr { pg : self . pg () , per : self . per () , mer : self . mer () , pnb : self . pnb () , strt : self . strt () , optstrt : self . optstrt () , fstpg : self . fstpg () , eopie : self . eopie () , errie : self . errie () , rderrie : self . rderrie () , obl_launch : self . obl_launch () , optlock : self . optlock () , lock : self . lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash ECC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Eccr { addr_ecc : u32 , sysf_ecc : bool , ecccie : bool , cpuid : u8 , eccc : bool , eccd : bool , } let proxy = Eccr { addr_ecc : self . addr_ecc () , sysf_ecc : self . sysf_ecc () , ecccie : self . ecccie () , cpuid : self . cpuid () , eccc : self . eccc () , eccd : self . eccd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "IPCC mailbox data buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ipccbr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ipccbr { ipccdba : u16 , } let proxy = Ipccbr { ipccdba : self . ipccdba () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash option register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Optr { rdp : u8 , ese : bool , bor_lev : u8 , n_rst_stop : bool , n_rst_stdby : bool , n_rst_shdw : bool , idwg_sw : bool , iwdg_stop : bool , iwdg_stdby : bool , wwdg_sw : bool , n_boot1 : bool , sram2_pe : bool , sram2_rst : bool , n_swboot0 : bool , n_boot0 : bool , agc_trim : u8 , } let proxy = Optr { rdp : self . rdp () , ese : self . ese () , bor_lev : self . bor_lev () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , n_rst_shdw : self . n_rst_shdw () , idwg_sw : self . idwg_sw () , iwdg_stop : self . iwdg_stop () , iwdg_stdby : self . iwdg_stdby () , wwdg_sw : self . wwdg_sw () , n_boot1 : self . n_boot1 () , sram2_pe : self . sram2_pe () , sram2_rst : self . sram2_rst () , n_swboot0 : self . n_swboot0 () , n_boot0 : self . n_boot0 () , agc_trim : self . agc_trim () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Bank 1 PCROP End address zone A register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1aer { pcrop1a_end : u16 , pcrop_rdp : bool , } let proxy = Pcrop1aer { pcrop1a_end : self . pcrop1a_end () , pcrop_rdp : self . pcrop_rdp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Bank 1 PCROP Start address zone A register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1asr { pcrop1a_strt : u16 , } let proxy = Pcrop1asr { pcrop1a_strt : self . pcrop1a_strt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Bank 1 PCROP End address area B register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1ber { pcrop1b_end : u16 , } let proxy = Pcrop1ber { pcrop1b_end : self . pcrop1b_end () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Bank 1 PCROP Start address area B register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pcrop1bsr { pcrop1b_strt : u16 , } let proxy = Pcrop1bsr { pcrop1b_strt : self . pcrop1b_strt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Secure flash start address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Sfr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sfr { sfsa : u8 , fsd : bool , dds : bool , } let proxy = Sfr { sfsa : self . sfsa () , fsd : self . fsd () , dds : self . dds () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { eop : bool , operr : bool , progerr : bool , wrperr : bool , pgaerr : bool , sizerr : bool , pgserr : bool , miserr : bool , fasterr : bool , optnv : bool , rderr : bool , optverr : bool , bsy : bool , cfgbsy : bool , pesd : bool , } let proxy = Sr { eop : self . eop () , operr : self . operr () , progerr : self . progerr () , wrperr : self . wrperr () , pgaerr : self . pgaerr () , sizerr : self . sizerr () , pgserr : self . pgserr () , miserr : self . miserr () , fasterr : self . fasterr () , optnv : self . optnv () , rderr : self . rderr () , optverr : self . optverr () , bsy : self . bsy () , cfgbsy : self . cfgbsy () , pesd : self . pesd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Secure SRAM2 start address and cortex M0 reset vector register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Srrvr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Srrvr { sbrv : u32 , sbrsa : u8 , brsd : bool , snbrsa : u8 , nbrsd : bool , c2opt : bool , } let proxy = Srrvr { sbrv : self . sbrv () , sbrsa : self . sbrsa () , brsd : self . brsd () , snbrsa : self . snbrsa () , nbrsd : self . nbrsd () , c2opt : self . c2opt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Bank 1 WRP area A address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Wrp1ar { wrp1a_strt : u8 , wrp1a_end : u8 , } let proxy = Wrp1ar { wrp1a_strt : self . wrp1a_strt () , wrp1a_end : self . wrp1a_end () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash Bank 1 WRP area B address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Wrp1br { wrp1b_end : u8 , wrp1b_strt : u8 , } let proxy = Wrp1br { wrp1b_end : self . wrp1b_end () , wrp1b_strt : self . wrp1b_strt () , } ; defmt :: write ! (f , "{}" , proxy) } } }
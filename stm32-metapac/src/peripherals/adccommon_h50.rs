...
struct Ccr { ckmode : super :: vals :: Ckmode , presc : super :: vals :: Presc , vrefen : bool , tsen : bool , vbaten : bool , } let proxy = Ccr { ckmode : self . ckmode () , presc : self . presc () , vrefen : self . vrefen () , tsen : self . tsen () , vbaten : self . vbaten () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "hardware configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
fn default () -> Af11chCmp { Af11chCmp (0) } } impl core :: fmt :: Debug for Af11chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af11chCmp") . field ("bkine" , & self . bkine ()) . field ("bkcmpe" , & [self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkcmpe (2usize) , self . bkcmpe (3usize) , self . bkcmpe (4usize) , self . bkcmpe (5usize) , self . bkcmpe (6usize) , self . bkcmpe (7usize) ,]) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp" , & [self . bkcmpp (0usize) , self . bkcmpp (1usize) , self . bkcmpp (2usize) , self . bkcmpp (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af11chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af11chCmp { bkine : bool , bkcmpe : [bool ; 8usize]
, bkinp : super :: vals :: Bkinp , bkcmpp : [super :: vals :: Bkinp ; 4usize]
, } let proxy = Af11chCmp { bkine : self . bkine () , bkcmpe : [self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkcmpe (2usize) , self . bkcmpe (3usize) , self . bkcmpe (4usize) , self . bkcmpe (5usize) , self . bkcmpe (6usize) , self . bkcmpe (7usize) ,]
, bkinp : self . bkinp () , bkcmpp : [self . bkcmpp (0usize) , self . bkcmpp (1usize) , self . bkcmpp (2usize) , self . bkcmpp (3usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "alternate function register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af1Adv { Af1Adv (0) } } impl core :: fmt :: Debug for Af1Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af1Adv") . field ("bkine" , & self . bkine ()) . field ("bkcmpe" , & [self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkcmpe (2usize) , self . bkcmpe (3usize) , self . bkcmpe (4usize) , self . bkcmpe (5usize) , self . bkcmpe (6usize) , self . bkcmpe (7usize) ,]) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp" , & [self . bkcmpp (0usize) , self . bkcmpp (1usize) , self . bkcmpp (2usize) , self . bkcmpp (3usize) ,]) . field ("etrsel" , & self . etrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af1Adv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af1Adv { bkine : bool , bkcmpe : [bool ; 8usize]
, bkinp : super :: vals :: Bkinp , bkcmpp : [super :: vals :: Bkinp ; 4usize]
, etrsel : u8 , } let proxy = Af1Adv { bkine : self . bkine () , bkcmpe : [self . bkcmpe (0usize) , self . bkcmpe (1usize) , self . bkcmpe (2usize) , self . bkcmpe (3usize) , self . bkcmpe (4usize) , self . bkcmpe (5usize) , self . bkcmpe (6usize) , self . bkcmpe (7usize) ,]
, bkinp : self . bkinp () , bkcmpp : [self . bkcmpp (0usize) , self . bkcmpp (1usize) , self . bkcmpp (2usize) , self . bkcmpp (3usize) ,]
, etrsel : self . etrsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "alternate function register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Af1Gp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af1Gp16 { etrsel : u8 , } let proxy = Af1Gp16 { etrsel : self . etrsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "alternate function register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Af21chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af21chCmp { ocrsel : u8 , } let proxy = Af21chCmp { ocrsel : self . ocrsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "alternate function register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Af2Adv { Af2Adv (0) } } impl core :: fmt :: Debug for Af2Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af2Adv") . field ("bk2ine" , & self . bk2ine ()) . field ("bk2cmpe" , & [self . bk2cmpe (0usize) , self . bk2cmpe (1usize) , self . bk2cmpe (2usize) , self . bk2cmpe (3usize) , self . bk2cmpe (4usize) , self . bk2cmpe (5usize) , self . bk2cmpe (6usize) , self . bk2cmpe (7usize) ,]) . field ("bk2inp" , & self . bk2inp ()) . field ("bk2cmpp" , & [self . bk2cmpp (0usize) , self . bk2cmpp (1usize) , self . bk2cmpp (2usize) , self . bk2cmpp (3usize) ,]) . field ("ocrsel" , & self . ocrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af2Adv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af2Adv { bk2ine : bool , bk2cmpe : [bool ; 8usize]
, bk2inp : super :: vals :: Bkinp , bk2cmpp : [super :: vals :: Bkinp ; 4usize]
, ocrsel : u8 , } let proxy = Af2Adv { bk2ine : self . bk2ine () , bk2cmpe : [self . bk2cmpe (0usize) , self . bk2cmpe (1usize) , self . bk2cmpe (2usize) , self . bk2cmpe (3usize) , self . bk2cmpe (4usize) , self . bk2cmpe (5usize) , self . bk2cmpe (6usize) , self . bk2cmpe (7usize) ,]
, bk2inp : self . bk2inp () , bk2cmpp : [self . bk2cmpp (0usize) , self . bk2cmpp (1usize) , self . bk2cmpp (2usize) , self . bk2cmpp (3usize) ,]
, ocrsel : self . ocrsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "auto-reload register (Dither mode disabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for ArrCore { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct ArrCore { arr : u16 , } let proxy = ArrCore { arr : self . arr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "auto-reload register (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for ArrDitherCore { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct ArrDitherCore { dither : u8 , arr : u16 , } let proxy = ArrDitherCore { dither : self . dither () , arr : self . arr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "auto-reload register (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for ArrDitherGp32 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct ArrDitherGp32 { dither : u8 , arr : u32 , } let proxy = ArrDitherGp32 { dither : self . dither () , arr : self . arr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "break and dead-time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Bdtr1chCmp { Bdtr1chCmp (0) } } impl core :: fmt :: Debug for Bdtr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Bdtr1chCmp") . field ("dtg" , & self . dtg ()) . field ("lock" , & self . lock ()) . field ("ossi" , & self . ossi ()) . field ("ossr" , & self . ossr ()) . field ("bke" , & [self . bke (0usize) ,]) . field ("bkp" , & [self . bkp (0usize) ,]) . field ("aoe" , & self . aoe ()) . field ("moe" , & self . moe ()) . field ("bkf" , & [self . bkf (0usize) ,]) . field ("bkdsrm" , & [self . bkdsrm (0usize) ,]) . field ("bkbid" , & [self . bkbid (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Bdtr1chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Bdtr1chCmp { dtg : u8 , lock : super :: vals :: Lock , ossi : super :: vals :: Ossi , ossr : super :: vals :: Ossr , bke : [bool ; 1usize]
, bkp : [super :: vals :: Bkp ; 1usize]
, aoe : bool , moe : bool , bkf : [super :: vals :: FilterValue ; 1usize]
, bkdsrm : [super :: vals :: Bkdsrm ; 1usize]
, bkbid : [super :: vals :: Bkbid ; 1usize]
, } let proxy = Bdtr1chCmp { dtg : self . dtg () , lock : self . lock () , ossi : self . ossi () , ossr : self . ossr () , bke : [self . bke (0usize) ,]
, bkp : [self . bkp (0usize) ,]
, aoe : self . aoe () , moe : self . moe () , bkf : [self . bkf (0usize) ,]
, bkdsrm : [self . bkdsrm (0usize) ,]
, bkbid : [self . bkbid (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "break and dead-time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> BdtrAdv { BdtrAdv (0) } } impl core :: fmt :: Debug for BdtrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("BdtrAdv") . field ("dtg" , & self . dtg ()) . field ("lock" , & self . lock ()) . field ("ossi" , & self . ossi ()) . field ("ossr" , & self . ossr ()) . field ("bke" , & [self . bke (0usize) , self . bke (1usize) ,]) . field ("bkp" , & [self . bkp (0usize) , self . bkp (1usize) ,]) . field ("aoe" , & self . aoe ()) . field ("moe" , & self . moe ()) . field ("bkf" , & [self . bkf (0usize) , self . bkf (1usize) ,]) . field ("bkdsrm" , & [self . bkdsrm (0usize) , self . bkdsrm (1usize) ,]) . field ("bkbid" , & [self . bkbid (0usize) , self . bkbid (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for BdtrAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct BdtrAdv { dtg : u8 , lock : super :: vals :: Lock , ossi : super :: vals :: Ossi , ossr : super :: vals :: Ossr , bke : [bool ; 2usize]
, bkp : [super :: vals :: Bkp ; 2usize]
, aoe : bool , moe : bool , bkf : [super :: vals :: FilterValue ; 2usize]
, bkdsrm : [super :: vals :: Bkdsrm ; 2usize]
, bkbid : [super :: vals :: Bkbid ; 2usize]
, } let proxy = BdtrAdv { dtg : self . dtg () , lock : self . lock () , ossi : self . ossi () , ossr : self . ossr () , bke : [self . bke (0usize) , self . bke (1usize) ,]
, bkp : [self . bkp (0usize) , self . bkp (1usize) ,]
, aoe : self . aoe () , moe : self . moe () , bkf : [self . bkf (0usize) , self . bkf (1usize) ,]
, bkdsrm : [self . bkdsrm (0usize) , self . bkdsrm (1usize) ,]
, bkbid : [self . bkbid (0usize) , self . bkbid (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccer1ch { Ccer1ch (0) } } impl core :: fmt :: Debug for Ccer1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer1ch") . field ("cce" , & [self . cce (0usize) ,]) . field ("ccp" , & [self . ccp (0usize) ,]) . field ("ccnp" , & [self . ccnp (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccer1ch { cce : [bool ; 1usize]
, ccp : [bool ; 1usize]
, ccnp : [bool ; 1usize]
, } let proxy = Ccer1ch { cce : [self . cce (0usize) ,]
, ccp : [self . ccp (0usize) ,]
...
fn default () -> Ccer1chCmp { Ccer1chCmp (0) } } impl core :: fmt :: Debug for Ccer1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer1chCmp") . field ("cce" , & [self . cce (0usize) ,]) . field ("ccp" , & [self . ccp (0usize) ,]) . field ("ccne" , & [self . ccne (0usize) ,]) . field ("ccnp" , & [self . ccnp (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer1chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccer1chCmp { cce : [bool ; 1usize]
, ccp : [bool ; 1usize]
, ccne : [bool ; 1usize]
, ccnp : [bool ; 1usize]
, } let proxy = Ccer1chCmp { cce : [self . cce (0usize) ,]
, ccp : [self . ccp (0usize) ,]
...
fn default () -> Ccer2ch { Ccer2ch (0) } } impl core :: fmt :: Debug for Ccer2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer2ch") . field ("cce" , & [self . cce (0usize) , self . cce (1usize) ,]) . field ("ccp" , & [self . ccp (0usize) , self . ccp (1usize) ,]) . field ("ccnp" , & [self . ccnp (0usize) , self . ccnp (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccer2ch { cce : [bool ; 2usize]
, ccp : [bool ; 2usize]
, ccnp : [bool ; 2usize]
, } let proxy = Ccer2ch { cce : [self . cce (0usize) , self . cce (1usize) ,]
...
fn default () -> Ccer2chCmp { Ccer2chCmp (0) } } impl core :: fmt :: Debug for Ccer2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccer2chCmp") . field ("cce" , & [self . cce (0usize) , self . cce (1usize) ,]) . field ("ccp" , & [self . ccp (0usize) , self . ccp (1usize) ,]) . field ("ccne" , & [self . ccne (0usize) ,]) . field ("ccnp" , & [self . ccnp (0usize) , self . ccnp (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccer2chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccer2chCmp { cce : [bool ; 2usize]
, ccp : [bool ; 2usize]
, ccne : [bool ; 1usize]
, ccnp : [bool ; 2usize]
, } let proxy = Ccer2chCmp { cce : [self . cce (0usize) , self . cce (1usize) ,]
, ccp : [self . ccp (0usize) , self . ccp (1usize) ,]
, ccne : [self . ccne (0usize) ,]
, ccnp : [self . ccnp (0usize) , self . ccnp (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare enable register"]
...
fn default () -> CcerAdv { CcerAdv (0) } } impl core :: fmt :: Debug for CcerAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcerAdv") . field ("cce" , & [self . cce (0usize) , self . cce (1usize) , self . cce (2usize) , self . cce (3usize) , self . cce (4usize) , self . cce (5usize) ,]) . field ("ccp" , & [self . ccp (0usize) , self . ccp (1usize) , self . ccp (2usize) , self . ccp (3usize) , self . ccp (4usize) , self . ccp (5usize) ,]) . field ("ccne" , & [self . ccne (0usize) , self . ccne (1usize) , self . ccne (2usize) , self . ccne (3usize) ,]) . field ("ccnp" , & [self . ccnp (0usize) , self . ccnp (1usize) , self . ccnp (2usize) , self . ccnp (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcerAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcerAdv { cce : [bool ; 6usize]
, ccp : [bool ; 6usize]
, ccne : [bool ; 4usize]
, ccnp : [bool ; 4usize]
, } let proxy = CcerAdv { cce : [self . cce (0usize) , self . cce (1usize) , self . cce (2usize) , self . cce (3usize) , self . cce (4usize) , self . cce (5usize) ,]
, ccp : [self . ccp (0usize) , self . ccp (1usize) , self . ccp (2usize) , self . ccp (3usize) , self . ccp (4usize) , self . ccp (5usize) ,]
, ccne : [self . ccne (0usize) , self . ccne (1usize) , self . ccne (2usize) , self . ccne (3usize) ,]
, ccnp : [self . ccnp (0usize) , self . ccnp (1usize) , self . ccnp (2usize) , self . ccnp (3usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcerGp16 { CcerGp16 (0) } } impl core :: fmt :: Debug for CcerGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcerGp16") . field ("cce" , & [self . cce (0usize) , self . cce (1usize) , self . cce (2usize) , self . cce (3usize) ,]) . field ("ccp" , & [self . ccp (0usize) , self . ccp (1usize) , self . ccp (2usize) , self . ccp (3usize) ,]) . field ("ccnp" , & [self . ccnp (0usize) , self . ccnp (1usize) , self . ccnp (2usize) , self . ccnp (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcerGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcerGp16 { cce : [bool ; 4usize]
, ccp : [bool ; 4usize]
, ccnp : [bool ; 4usize]
, } let proxy = CcerGp16 { cce : [self . cce (0usize) , self . cce (1usize) , self . cce (2usize) , self . cce (3usize) ,]
, ccp : [self . ccp (0usize) , self . ccp (1usize) , self . ccp (2usize) , self . ccp (3usize) ,]
, ccnp : [self . ccnp (0usize) , self . ccnp (1usize) , self . ccnp (2usize) , self . ccnp (3usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare mode register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccmr3Adv { Ccmr3Adv (0) } } impl core :: fmt :: Debug for Ccmr3Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccmr3Adv") . field ("ocfe" , & [self . ocfe (0usize) , self . ocfe (1usize) ,]) . field ("ocpe" , & [self . ocpe (0usize) , self . ocpe (1usize) ,]) . field ("ocm" , & [self . ocm (0usize) , self . ocm (1usize) ,]) . field ("occe" , & [self . occe (0usize) , self . occe (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccmr3Adv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccmr3Adv { ocfe : [bool ; 2usize]
, ocpe : [bool ; 2usize]
, ocm : [super :: vals :: Ocm ; 2usize]
, occe : [bool ; 2usize]
, } let proxy = Ccmr3Adv { ocfe : [self . ocfe (0usize) , self . ocfe (1usize) ,]
, ocpe : [self . ocpe (0usize) , self . ocpe (1usize) ,]
, ocm : [self . ocm (0usize) , self . ocm (1usize) ,]
, occe : [self . occe (0usize) , self . occe (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare mode register x (x=1) (input mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrInput1ch { CcmrInput1ch (0) } } impl core :: fmt :: Debug for CcmrInput1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrInput1ch") . field ("ccs" , & [self . ccs (0usize) ,]) . field ("icpsc" , & [self . icpsc (0usize) ,]) . field ("icf" , & [self . icf (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrInput1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcmrInput1ch { ccs : [super :: vals :: CcmrInputCcs ; 1usize]
, icpsc : [u8 ; 1usize]
, icf : [super :: vals :: FilterValue ; 1usize]
, } let proxy = CcmrInput1ch { ccs : [self . ccs (0usize) ,]
...
fn default () -> CcmrInput2ch { CcmrInput2ch (0) } } impl core :: fmt :: Debug for CcmrInput2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrInput2ch") . field ("ccs" , & [self . ccs (0usize) , self . ccs (1usize) ,]) . field ("icpsc" , & [self . icpsc (0usize) , self . icpsc (1usize) ,]) . field ("icf" , & [self . icf (0usize) , self . icf (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrInput2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcmrInput2ch { ccs : [super :: vals :: CcmrInputCcs ; 2usize]
, icpsc : [u8 ; 2usize]
, icf : [super :: vals :: FilterValue ; 2usize]
, } let proxy = CcmrInput2ch { ccs : [self . ccs (0usize) , self . ccs (1usize) ,]
, icpsc : [self . icpsc (0usize) , self . icpsc (1usize) ,]
, icf : [self . icf (0usize) , self . icf (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare mode register x (x=1) (output mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrOutput1ch { CcmrOutput1ch (0) } } impl core :: fmt :: Debug for CcmrOutput1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrOutput1ch") . field ("ccs" , & [self . ccs (0usize) ,]) . field ("ocfe" , & [self . ocfe (0usize) ,]) . field ("ocpe" , & [self . ocpe (0usize) ,]) . field ("ocm" , & [self . ocm (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrOutput1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcmrOutput1ch { ccs : [super :: vals :: CcmrOutputCcs ; 1usize]
, ocfe : [bool ; 1usize]
, ocpe : [bool ; 1usize]
, ocm : [super :: vals :: Ocm ; 1usize]
, } let proxy = CcmrOutput1ch { ccs : [self . ccs (0usize) ,]
...
fn default () -> CcmrOutput2ch { CcmrOutput2ch (0) } } impl core :: fmt :: Debug for CcmrOutput2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrOutput2ch") . field ("ccs" , & [self . ccs (0usize) , self . ccs (1usize) ,]) . field ("ocfe" , & [self . ocfe (0usize) , self . ocfe (1usize) ,]) . field ("ocpe" , & [self . ocpe (0usize) , self . ocpe (1usize) ,]) . field ("ocm" , & [self . ocm (0usize) , self . ocm (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrOutput2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcmrOutput2ch { ccs : [super :: vals :: CcmrOutputCcs ; 2usize]
, ocfe : [bool ; 2usize]
, ocpe : [bool ; 2usize]
, ocm : [super :: vals :: Ocm ; 2usize]
, } let proxy = CcmrOutput2ch { ccs : [self . ccs (0usize) , self . ccs (1usize) ,]
, ocfe : [self . ocfe (0usize) , self . ocfe (1usize) ,]
, ocpe : [self . ocpe (0usize) , self . ocpe (1usize) ,]
, ocm : [self . ocm (0usize) , self . ocm (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare mode register x (x=1-2) (output mode)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcmrOutputGp16 { CcmrOutputGp16 (0) } } impl core :: fmt :: Debug for CcmrOutputGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcmrOutputGp16") . field ("ccs" , & [self . ccs (0usize) , self . ccs (1usize) ,]) . field ("ocfe" , & [self . ocfe (0usize) , self . ocfe (1usize) ,]) . field ("ocpe" , & [self . ocpe (0usize) , self . ocpe (1usize) ,]) . field ("ocm" , & [self . ocm (0usize) , self . ocm (1usize) ,]) . field ("occe" , & [self . occe (0usize) , self . occe (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for CcmrOutputGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcmrOutputGp16 { ccs : [super :: vals :: CcmrOutputCcs ; 2usize]
, ocfe : [bool ; 2usize]
, ocpe : [bool ; 2usize]
, ocm : [super :: vals :: Ocm ; 2usize]
, occe : [bool ; 2usize]
, } let proxy = CcmrOutputGp16 { ccs : [self . ccs (0usize) , self . ccs (1usize) ,]
, ocfe : [self . ocfe (0usize) , self . ocfe (1usize) ,]
, ocpe : [self . ocpe (0usize) , self . ocpe (1usize) ,]
, ocm : [self . ocm (0usize) , self . ocm (1usize) ,]
, occe : [self . occe (0usize) , self . occe (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare register x (x=1-4,6) (Dither mode disabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ccr1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccr1ch { ccr : u16 , } let proxy = Ccr1ch { ccr : self . ccr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare register 5 (Dither mode disabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr5Adv { Ccr5Adv (0) } } impl core :: fmt :: Debug for Ccr5Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr5Adv") . field ("ccr" , & self . ccr ()) . field ("gc5c" , & [self . gc5c (0usize) , self . gc5c (1usize) , self . gc5c (2usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr5Adv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccr5Adv { ccr : u16 , gc5c : [super :: vals :: Gc5c ; 3usize]
, } let proxy = Ccr5Adv { ccr : self . ccr () , gc5c : [self . gc5c (0usize) , self . gc5c (1usize) , self . gc5c (2usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare register 5 (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ccr5DitherAdv { Ccr5DitherAdv (0) } } impl core :: fmt :: Debug for Ccr5DitherAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ccr5DitherAdv") . field ("dither" , & self . dither ()) . field ("ccr" , & self . ccr ()) . field ("gc5c" , & [self . gc5c (0usize) , self . gc5c (1usize) , self . gc5c (2usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ccr5DitherAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccr5DitherAdv { dither : u8 , ccr : u16 , gc5c : [super :: vals :: Gc5c ; 3usize]
, } let proxy = Ccr5DitherAdv { dither : self . dither () , ccr : self . ccr () , gc5c : [self . gc5c (0usize) , self . gc5c (1usize) , self . gc5c (2usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare register x (x=1-4,6) (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for CcrDither1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcrDither1ch { dither : u8 , ccr : u16 , } let proxy = CcrDither1ch { dither : self . dither () , ccr : self . ccr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare register x (x=1-4,6) (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for CcrDitherGp32 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CcrDitherGp32 { dither : u8 , ccr : u32 , } let proxy = CcrDitherGp32 { dither : self . dither () , ccr : self . ccr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for CntCore { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CntCore { cnt : u16 , uifcpy : bool , } let proxy = CntCore { cnt : self . cnt () , uifcpy : self . uifcpy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "counter (Dither mode enabled)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for CntDitherGp32 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct CntDitherGp32 { cnt : u32 , uifcpy : bool , } let proxy = CntDitherGp32 { cnt : self . cnt () , uifcpy : self . uifcpy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr11ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr11ch { cen : bool , udis : bool , urs : super :: vals :: Urs , opm : bool , arpe : bool , ckd : super :: vals :: Ckd , uifremap : bool , dithen : bool , } let proxy = Cr11ch { cen : self . cen () , udis : self . udis () , urs : self . urs () , opm : self . opm () , arpe : self . arpe () , ckd : self . ckd () , uifremap : self . uifremap () , dithen : self . dithen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr1Core { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr1Core { cen : bool , udis : bool , urs : super :: vals :: Urs , opm : bool , arpe : bool , uifremap : bool , dithen : bool , } let proxy = Cr1Core { cen : self . cen () , udis : self . udis () , urs : self . urs () , opm : self . opm () , arpe : self . arpe () , uifremap : self . uifremap () , dithen : self . dithen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr1Gp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr1Gp16 { cen : bool , udis : bool , urs : super :: vals :: Urs , opm : bool , dir : super :: vals :: Dir , cms : super :: vals :: Cms , arpe : bool , ckd : super :: vals :: Ckd , uifremap : bool , dithen : bool , } let proxy = Cr1Gp16 { cen : self . cen () , udis : self . udis () , urs : self . urs () , opm : self . opm () , dir : self . dir () , cms : self . cms () , arpe : self . arpe () , ckd : self . ckd () , uifremap : self . uifremap () , dithen : self . dithen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr21chCmp { Cr21chCmp (0) } } impl core :: fmt :: Debug for Cr21chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr21chCmp") . field ("ccpc" , & self . ccpc ()) . field ("ccus" , & self . ccus ()) . field ("ccds" , & self . ccds ()) . field ("ois" , & [self . ois (0usize) ,]) . field ("oisn" , & [self . oisn (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr21chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr21chCmp { ccpc : bool , ccus : bool , ccds : super :: vals :: Ccds , ois : [bool ; 1usize]
, oisn : [bool ; 1usize]
, } let proxy = Cr21chCmp { ccpc : self . ccpc () , ccus : self . ccus () , ccds : self . ccds () , ois : [self . ois (0usize) ,]
, oisn : [self . oisn (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr22ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr22ch { mms : super :: vals :: Mms , ti1s : super :: vals :: Ti1s , } let proxy = Cr22ch { mms : self . mms () , ti1s : self . ti1s () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr22chCmp { Cr22chCmp (0) } } impl core :: fmt :: Debug for Cr22chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr22chCmp") . field ("ccpc" , & self . ccpc ()) . field ("ccus" , & self . ccus ()) . field ("ccds" , & self . ccds ()) . field ("mms" , & self . mms ()) . field ("ti1s" , & self . ti1s ()) . field ("ois" , & [self . ois (0usize) , self . ois (1usize) ,]) . field ("oisn" , & [self . oisn (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr22chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr22chCmp { ccpc : bool , ccus : bool , ccds : super :: vals :: Ccds , mms : super :: vals :: Mms , ti1s : super :: vals :: Ti1s , ois : [bool ; 2usize]
, oisn : [bool ; 1usize]
, } let proxy = Cr22chCmp { ccpc : self . ccpc () , ccus : self . ccus () , ccds : self . ccds () , mms : self . mms () , ti1s : self . ti1s () , ois : [self . ois (0usize) , self . ois (1usize) ,]
, oisn : [self . oisn (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr2Adv { Cr2Adv (0) } } impl core :: fmt :: Debug for Cr2Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr2Adv") . field ("ccpc" , & self . ccpc ()) . field ("ccus" , & self . ccus ()) . field ("ccds" , & self . ccds ()) . field ("mms" , & self . mms ()) . field ("ti1s" , & self . ti1s ()) . field ("ois" , & [self . ois (0usize) , self . ois (1usize) , self . ois (2usize) , self . ois (3usize) , self . ois (4usize) , self . ois (5usize) ,]) . field ("oisn" , & [self . oisn (0usize) , self . oisn (1usize) , self . oisn (2usize) , self . oisn (3usize) ,]) . field ("mms2" , & self . mms2 ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr2Adv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr2Adv { ccpc : bool , ccus : bool , ccds : super :: vals :: Ccds , mms : super :: vals :: Mms , ti1s : super :: vals :: Ti1s , ois : [bool ; 6usize]
, oisn : [bool ; 4usize]
, mms2 : super :: vals :: Mms2 , } let proxy = Cr2Adv { ccpc : self . ccpc () , ccus : self . ccus () , ccds : self . ccds () , mms : self . mms () , ti1s : self . ti1s () , ois : [self . ois (0usize) , self . ois (1usize) , self . ois (2usize) , self . ois (3usize) , self . ois (4usize) , self . ois (5usize) ,]
, oisn : [self . oisn (0usize) , self . oisn (1usize) , self . oisn (2usize) , self . oisn (3usize) ,]
, mms2 : self . mms2 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr2Basic { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr2Basic { mms : super :: vals :: Mms , } let proxy = Cr2Basic { mms : self . mms () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cr2Gp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr2Gp16 { ccds : super :: vals :: Ccds , mms : super :: vals :: Mms , ti1s : super :: vals :: Ti1s , } let proxy = Cr2Gp16 { ccds : self . ccds () , mms : self . mms () , ti1s : self . ti1s () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dcr1chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dcr1chCmp { dba : u8 , dbl : u8 , dbss : super :: vals :: Dbss , } let proxy = Dcr1chCmp { dba : self . dba () , dbl : self . dbl () , dbss : self . dbss () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier1ch { Dier1ch (0) } } impl core :: fmt :: Debug for Dier1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier1ch") . field ("uie" , & self . uie ()) . field ("ccie" , & [self . ccie (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dier1ch { uie : bool , ccie : [bool ; 1usize]
, } let proxy = Dier1ch { uie : self . uie () , ccie : [self . ccie (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier1chCmp { Dier1chCmp (0) } } impl core :: fmt :: Debug for Dier1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier1chCmp") . field ("uie" , & self . uie ()) . field ("ccie" , & [self . ccie (0usize) ,]) . field ("comie" , & self . comie ()) . field ("bie" , & self . bie ()) . field ("ude" , & self . ude ()) . field ("ccde" , & [self . ccde (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier1chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dier1chCmp { uie : bool , ccie : [bool ; 1usize]
, comie : bool , bie : bool , ude : bool , ccde : [bool ; 1usize]
, } let proxy = Dier1chCmp { uie : self . uie () , ccie : [self . ccie (0usize) ,]
, comie : self . comie () , bie : self . bie () , ude : self . ude () , ccde : [self . ccde (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier2ch { Dier2ch (0) } } impl core :: fmt :: Debug for Dier2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier2ch") . field ("uie" , & self . uie ()) . field ("ccie" , & [self . ccie (0usize) , self . ccie (1usize) ,]) . field ("tie" , & self . tie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dier2ch { uie : bool , ccie : [bool ; 2usize]
, tie : bool , } let proxy = Dier2ch { uie : self . uie () , ccie : [self . ccie (0usize) , self . ccie (1usize) ,]
, tie : self . tie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Dier2chCmp { Dier2chCmp (0) } } impl core :: fmt :: Debug for Dier2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Dier2chCmp") . field ("uie" , & self . uie ()) . field ("ccie" , & [self . ccie (0usize) ,]) . field ("comie" , & self . comie ()) . field ("tie" , & self . tie ()) . field ("bie" , & self . bie ()) . field ("ude" , & self . ude ()) . field ("ccde" , & [self . ccde (0usize) ,]) . field ("comde" , & self . comde ()) . field ("tde" , & self . tde ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Dier2chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dier2chCmp { uie : bool , ccie : [bool ; 1usize]
, comie : bool , tie : bool , bie : bool , ude : bool , ccde : [bool ; 1usize]
, comde : bool , tde : bool , } let proxy = Dier2chCmp { uie : self . uie () , ccie : [self . ccie (0usize) ,]
, comie : self . comie () , tie : self . tie () , bie : self . bie () , ude : self . ude () , ccde : [self . ccde (0usize) ,]
, comde : self . comde () , tde : self . tde () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DierAdv { DierAdv (0) } } impl core :: fmt :: Debug for DierAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DierAdv") . field ("uie" , & self . uie ()) . field ("ccie" , & [self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) ,]) . field ("comie" , & self . comie ()) . field ("tie" , & self . tie ()) . field ("bie" , & self . bie ()) . field ("ude" , & self . ude ()) . field ("ccde" , & [self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) ,]) . field ("comde" , & self . comde ()) . field ("tde" , & self . tde ()) . field ("idxie" , & self . idxie ()) . field ("dirie" , & self . dirie ()) . field ("ierrie" , & self . ierrie ()) . field ("terrie" , & self . terrie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DierAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct DierAdv { uie : bool , ccie : [bool ; 4usize]
, comie : bool , tie : bool , bie : bool , ude : bool , ccde : [bool ; 4usize]
, comde : bool , tde : bool , idxie : bool , dirie : bool , ierrie : bool , terrie : bool , } let proxy = DierAdv { uie : self . uie () , ccie : [self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) ,]
, comie : self . comie () , tie : self . tie () , bie : self . bie () , ude : self . ude () , ccde : [self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) ,]
, comde : self . comde () , tde : self . tde () , idxie : self . idxie () , dirie : self . dirie () , ierrie : self . ierrie () , terrie : self . terrie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for DierBasicNoCr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct DierBasicNoCr2 { uie : bool , ude : bool , } let proxy = DierBasicNoCr2 { uie : self . uie () , ude : self . ude () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for DierCore { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct DierCore { uie : bool , } let proxy = DierCore { uie : self . uie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DierGp16 { DierGp16 (0) } } impl core :: fmt :: Debug for DierGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DierGp16") . field ("uie" , & self . uie ()) . field ("ccie" , & [self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) ,]) . field ("tie" , & self . tie ()) . field ("ude" , & self . ude ()) . field ("ccde" , & [self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) ,]) . field ("tde" , & self . tde ()) . field ("idxie" , & self . idxie ()) . field ("dirie" , & self . dirie ()) . field ("ierrie" , & self . ierrie ()) . field ("terrie" , & self . terrie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for DierGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct DierGp16 { uie : bool , ccie : [bool ; 4usize]
, tie : bool , ude : bool , ccde : [bool ; 4usize]
, tde : bool , idxie : bool , dirie : bool , ierrie : bool , terrie : bool , } let proxy = DierGp16 { uie : self . uie () , ccie : [self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) ,]
, tie : self . tie () , ude : self . ude () , ccde : [self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) ,]
, tde : self . tde () , idxie : self . idxie () , dirie : self . dirie () , ierrie : self . ierrie () , terrie : self . terrie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "deadtime register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dtr21chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dtr21chCmp { dtgf : u8 , dtae : super :: vals :: Dtae , dtpe : bool , } let proxy = Dtr21chCmp { dtgf : self . dtgf () , dtae : self . dtae () , dtpe : self . dtpe () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "encoder control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for EcrGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct EcrGp16 { ie : bool , idir : super :: vals :: Idir , iblk : super :: vals :: Iblk , fidx : super :: vals :: Fidx , ipos : u8 , pw : u8 , pwprsc : u8 , } let proxy = EcrGp16 { ie : self . ie () , idir : self . idir () , iblk : self . iblk () , fidx : self . fidx () , ipos : self . ipos () , pw : self . pw () , pwprsc : self . pwprsc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr1ch { Egr1ch (0) } } impl core :: fmt :: Debug for Egr1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr1ch") . field ("ug" , & self . ug ()) . field ("ccg" , & [self . ccg (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Egr1ch { ug : bool , ccg : [bool ; 1usize]
, } let proxy = Egr1ch { ug : self . ug () , ccg : [self . ccg (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr1chCmp { Egr1chCmp (0) } } impl core :: fmt :: Debug for Egr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr1chCmp") . field ("ug" , & self . ug ()) . field ("ccg" , & [self . ccg (0usize) ,]) . field ("comg" , & self . comg ()) . field ("bg" , & [self . bg (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr1chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Egr1chCmp { ug : bool , ccg : [bool ; 1usize]
, comg : bool , bg : [bool ; 1usize]
, } let proxy = Egr1chCmp { ug : self . ug () , ccg : [self . ccg (0usize) ,]
, comg : self . comg () , bg : [self . bg (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr2ch { Egr2ch (0) } } impl core :: fmt :: Debug for Egr2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr2ch") . field ("ug" , & self . ug ()) . field ("ccg" , & [self . ccg (0usize) , self . ccg (1usize) ,]) . field ("tg" , & self . tg ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Egr2ch { ug : bool , ccg : [bool ; 2usize]
, tg : bool , } let proxy = Egr2ch { ug : self . ug () , ccg : [self . ccg (0usize) , self . ccg (1usize) ,]
, tg : self . tg () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Egr2chCmp { Egr2chCmp (0) } } impl core :: fmt :: Debug for Egr2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Egr2chCmp") . field ("ug" , & self . ug ()) . field ("ccg" , & [self . ccg (0usize) , self . ccg (1usize) ,]) . field ("comg" , & self . comg ()) . field ("tg" , & self . tg ()) . field ("bg" , & [self . bg (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Egr2chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Egr2chCmp { ug : bool , ccg : [bool ; 2usize]
, comg : bool , tg : bool , bg : [bool ; 1usize]
, } let proxy = Egr2chCmp { ug : self . ug () , ccg : [self . ccg (0usize) , self . ccg (1usize) ,]
, comg : self . comg () , tg : self . tg () , bg : [self . bg (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> EgrAdv { EgrAdv (0) } } impl core :: fmt :: Debug for EgrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("EgrAdv") . field ("ug" , & self . ug ()) . field ("ccg" , & [self . ccg (0usize) , self . ccg (1usize) , self . ccg (2usize) , self . ccg (3usize) ,]) . field ("comg" , & self . comg ()) . field ("tg" , & self . tg ()) . field ("bg" , & [self . bg (0usize) , self . bg (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for EgrAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct EgrAdv { ug : bool , ccg : [bool ; 4usize]
, comg : bool , tg : bool , bg : [bool ; 2usize]
, } let proxy = EgrAdv { ug : self . ug () , ccg : [self . ccg (0usize) , self . ccg (1usize) , self . ccg (2usize) , self . ccg (3usize) ,]
, comg : self . comg () , tg : self . tg () , bg : [self . bg (0usize) , self . bg (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for EgrCore { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct EgrCore { ug : bool , } let proxy = EgrCore { ug : self . ug () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> EgrGp16 { EgrGp16 (0) } } impl core :: fmt :: Debug for EgrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("EgrGp16") . field ("ug" , & self . ug ()) . field ("ccg" , & [self . ccg (0usize) , self . ccg (1usize) , self . ccg (2usize) , self . ccg (3usize) ,]) . field ("tg" , & self . tg ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for EgrGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct EgrGp16 { ug : bool , ccg : [bool ; 4usize]
, tg : bool , } let proxy = EgrGp16 { ug : self . ug () , ccg : [self . ccg (0usize) , self . ccg (1usize) , self . ccg (2usize) , self . ccg (3usize) ,]
, tg : self . tg () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "repetition counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Rcr1chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Rcr1chCmp { rep : u8 , } let proxy = Rcr1chCmp { rep : self . rep () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "repetition counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for RcrAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct RcrAdv { rep : u16 , } let proxy = RcrAdv { rep : self . rep () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Smcr2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smcr2ch { sms : super :: vals :: Sms , ts : super :: vals :: Ts , msm : super :: vals :: Msm , } let proxy = Smcr2ch { sms : self . sms () , ts : self . ts () , msm : self . msm () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Smcr2chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smcr2chCmp { sms : super :: vals :: Sms , ts : super :: vals :: Ts , msm : super :: vals :: Msm , smspe : bool , } let proxy = Smcr2chCmp { sms : self . sms () , ts : self . ts () , msm : self . msm () , smspe : self . smspe () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for SmcrAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct SmcrAdv { sms : super :: vals :: Sms , occs : super :: vals :: Occs , ts : super :: vals :: Ts , msm : super :: vals :: Msm , etf : super :: vals :: FilterValue , etps : super :: vals :: Etps , ece : bool , etp : super :: vals :: Etp , smspe : bool , smsps : super :: vals :: Smsps , } let proxy = SmcrAdv { sms : self . sms () , occs : self . occs () , ts : self . ts () , msm : self . msm () , etf : self . etf () , etps : self . etps () , ece : self . ece () , etp : self . etp () , smspe : self . smspe () , smsps : self . smsps () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for SmcrGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct SmcrGp16 { sms : super :: vals :: Sms , ts : super :: vals :: Ts , msm : super :: vals :: Msm , etf : super :: vals :: FilterValue , etps : super :: vals :: Etps , ece : bool , etp : super :: vals :: Etp , smspe : bool , smsps : super :: vals :: Smsps , } let proxy = SmcrGp16 { sms : self . sms () , ts : self . ts () , msm : self . msm () , etf : self . etf () , etps : self . etps () , ece : self . ece () , etp : self . etp () , smspe : self . smspe () , smsps : self . smsps () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr1ch { Sr1ch (0) } } impl core :: fmt :: Debug for Sr1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr1ch") . field ("uif" , & self . uif ()) . field ("ccif" , & [self . ccif (0usize) ,]) . field ("ccof" , & [self . ccof (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr1ch { uif : bool , ccif : [bool ; 1usize]
, ccof : [bool ; 1usize]
, } let proxy = Sr1ch { uif : self . uif () , ccif : [self . ccif (0usize) ,]
, ccof : [self . ccof (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr1chCmp { Sr1chCmp (0) } } impl core :: fmt :: Debug for Sr1chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr1chCmp") . field ("uif" , & self . uif ()) . field ("ccif" , & [self . ccif (0usize) ,]) . field ("comif" , & self . comif ()) . field ("bif" , & [self . bif (0usize) ,]) . field ("ccof" , & [self . ccof (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr1chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr1chCmp { uif : bool , ccif : [bool ; 1usize]
, comif : bool , bif : [bool ; 1usize]
, ccof : [bool ; 1usize]
, } let proxy = Sr1chCmp { uif : self . uif () , ccif : [self . ccif (0usize) ,]
, comif : self . comif () , bif : [self . bif (0usize) ,]
, ccof : [self . ccof (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr2ch { Sr2ch (0) } } impl core :: fmt :: Debug for Sr2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr2ch") . field ("uif" , & self . uif ()) . field ("ccif" , & [self . ccif (0usize) , self . ccif (1usize) ,]) . field ("tif" , & self . tif ()) . field ("ccof" , & [self . ccof (0usize) , self . ccof (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr2ch { uif : bool , ccif : [bool ; 2usize]
, tif : bool , ccof : [bool ; 2usize]
, } let proxy = Sr2ch { uif : self . uif () , ccif : [self . ccif (0usize) , self . ccif (1usize) ,]
, tif : self . tif () , ccof : [self . ccof (0usize) , self . ccof (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr2chCmp { Sr2chCmp (0) } } impl core :: fmt :: Debug for Sr2chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr2chCmp") . field ("uif" , & self . uif ()) . field ("ccif" , & [self . ccif (0usize) , self . ccif (1usize) ,]) . field ("comif" , & self . comif ()) . field ("tif" , & self . tif ()) . field ("bif" , & [self . bif (0usize) ,]) . field ("ccof" , & [self . ccof (0usize) , self . ccof (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr2chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr2chCmp { uif : bool , ccif : [bool ; 2usize]
, comif : bool , tif : bool , bif : [bool ; 1usize]
, ccof : [bool ; 2usize]
, } let proxy = Sr2chCmp { uif : self . uif () , ccif : [self . ccif (0usize) , self . ccif (1usize) ,]
, comif : self . comif () , tif : self . tif () , bif : [self . bif (0usize) ,]
...
fn default () -> SrAdv { SrAdv (0) } } impl core :: fmt :: Debug for SrAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SrAdv") . field ("uif" , & self . uif ()) . field ("ccif" , & [self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) ,]) . field ("comif" , & self . comif ()) . field ("tif" , & self . tif ()) . field ("bif" , & [self . bif (0usize) , self . bif (1usize) ,]) . field ("ccof" , & [self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize) ,]) . field ("sbif" , & self . sbif ()) . field ("ccif5" , & self . ccif5 ()) . field ("ccif6" , & self . ccif6 ()) . field ("idxif" , & self . idxif ()) . field ("dirif" , & self . dirif ()) . field ("ierrif" , & self . ierrif ()) . field ("terrif" , & self . terrif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SrAdv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct SrAdv { uif : bool , ccif : [bool ; 4usize]
, comif : bool , tif : bool , bif : [bool ; 2usize]
, ccof : [bool ; 4usize]
, sbif : bool , ccif5 : bool , ccif6 : bool , idxif : bool , dirif : bool , ierrif : bool , terrif : bool , } let proxy = SrAdv { uif : self . uif () , ccif : [self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) ,]
, comif : self . comif () , tif : self . tif () , bif : [self . bif (0usize) , self . bif (1usize) ,]
, ccof : [self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize) ,]
, sbif : self . sbif () , ccif5 : self . ccif5 () , ccif6 : self . ccif6 () , idxif : self . idxif () , dirif : self . dirif () , ierrif : self . ierrif () , terrif : self . terrif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for SrCore { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct SrCore { uif : bool , } let proxy = SrCore { uif : self . uif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SrGp16 { SrGp16 (0) } } impl core :: fmt :: Debug for SrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SrGp16") . field ("uif" , & self . uif ()) . field ("ccif" , & [self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) ,]) . field ("tif" , & self . tif ()) . field ("ccof" , & [self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize) ,]) . field ("idxif" , & self . idxif ()) . field ("dirif" , & self . dirif ()) . field ("ierrif" , & self . ierrif ()) . field ("terrif" , & self . terrif ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for SrGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct SrGp16 { uif : bool , ccif : [bool ; 4usize]
, tif : bool , ccof : [bool ; 4usize]
, idxif : bool , dirif : bool , ierrif : bool , terrif : bool , } let proxy = SrGp16 { uif : self . uif () , ccif : [self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) ,]
, tif : self . tif () , ccof : [self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize) ,]
, idxif : self . idxif () , dirif : self . dirif () , ierrif : self . ierrif () , terrif : self . terrif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "input selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tisel1ch { Tisel1ch (0) } } impl core :: fmt :: Debug for Tisel1ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tisel1ch") . field ("tisel" , & [self . tisel (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tisel1ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tisel1ch { tisel : [u8 ; 1usize]
, } let proxy = Tisel1ch { tisel : [self . tisel (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "input selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Tisel2ch { Tisel2ch (0) } } impl core :: fmt :: Debug for Tisel2ch { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Tisel2ch") . field ("tisel" , & [self . tisel (0usize) , self . tisel (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Tisel2ch { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tisel2ch { tisel : [u8 ; 2usize]
, } let proxy = Tisel2ch { tisel : [self . tisel (0usize) , self . tisel (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "input selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> TiselGp16 { TiselGp16 (0) } } impl core :: fmt :: Debug for TiselGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("TiselGp16") . field ("tisel" , & [self . tisel (0usize) , self . tisel (1usize) , self . tisel (2usize) , self . tisel (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for TiselGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct TiselGp16 { tisel : [u8 ; 4usize]
, } let proxy = TiselGp16 { tisel : [self . tisel (0usize) , self . tisel (1usize) , self . tisel (2usize) , self . tisel (3usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

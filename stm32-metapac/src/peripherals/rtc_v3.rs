...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("wucksel" , & self . wucksel ()) . field ("tsedge" , & self . tsedge ()) . field ("refckon" , & self . refckon ()) . field ("bypshad" , & self . bypshad ()) . field ("fmt" , & self . fmt ()) . field ("ssruie" , & self . ssruie ()) . field ("alre" , & [self . alre (0usize) , self . alre (1usize) ,]) . field ("wute" , & self . wute ()) . field ("tse" , & self . tse ()) . field ("alraie" , & [self . alraie (0usize) , self . alraie (1usize) ,]) . field ("wutie" , & self . wutie ()) . field ("tsie" , & self . tsie ()) . field ("add1h" , & self . add1h ()) . field ("sub1h" , & self . sub1h ()) . field ("bkp" , & self . bkp ()) . field ("cosel" , & self . cosel ()) . field ("pol" , & self . pol ()) . field ("osel" , & self . osel ()) . field ("coe" , & self . coe ()) . field ("itse" , & self . itse ()) . field ("tampts" , & self . tampts ()) . field ("tampoe" , & self . tampoe ()) . field ("tampalrm_pu" , & self . tampalrm_pu ()) . field ("tampalrm_type" , & self . tampalrm_type ()) . field ("out2en" , & self . out2en ()) . finish () } } # [cfg (feature = "defmt")]
...
, wute : bool , tse : bool , alraie : [bool ; 2usize]
, wutie : bool , tsie : bool , add1h : bool , sub1h : bool , bkp : bool , cosel : super :: vals :: Cosel , pol : super :: vals :: Pol , osel : super :: vals :: Osel , coe : bool , itse : bool , tampts : bool , tampoe : bool , tampalrm_pu : bool , tampalrm_type : super :: vals :: TampalrmType , out2en : bool , } let proxy = Cr { wucksel : self . wucksel () , tsedge : self . tsedge () , refckon : self . refckon () , bypshad : self . bypshad () , fmt : self . fmt () , ssruie : self . ssruie () , alre : [self . alre (0usize) , self . alre (1usize) ,]
, wute : self . wute () , tse : self . tse () , alraie : [self . alraie (0usize) , self . alraie (1usize) ,]
...
struct Prer { prediv_s : u16 , prediv_a : u8 , } let proxy = Prer { prediv_s : self . prediv_s () , prediv_a : self . prediv_a () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, cwutf : self . cwutf () , ctsf : self . ctsf () , ctsovf : self . ctsovf () , citsf : self . citsf () , cssruf : self . cssruf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Shift control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Shiftr { subfs : u16 , add1s : bool , } let proxy = Shiftr { subfs : self . subfs () , add1s : self . add1s () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

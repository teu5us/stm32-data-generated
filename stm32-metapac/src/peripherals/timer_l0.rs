...
struct ArrCore { arr : u16 , } let proxy = ArrCore { arr : self . arr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccr1ch { ccr : u16 , } let proxy = Ccr1ch { ccr : self . ccr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for DcrGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct DcrGp16 { dba : u8 , dbl : u8 , } let proxy = DcrGp16 { dba : self . dba () , dbl : self . dbl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, tg : self . tg () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "slave mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

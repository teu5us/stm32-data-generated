...
struct Cr { tpe : bool , tpal : super :: vals :: Tpal , } let proxy = Cr { tpe : self . tpe () , tpal : self . tpal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { cte : bool , cti : bool , tpie : bool , tef : bool , tif : bool , } let proxy = Csr { cte : self . cte () , cti : self . cti () , tpie : self . tpie () , tef : self . tef () , tif : self . tif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { d : u16 , } let proxy = Dr { d : self . d () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RTC clock calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Rtccr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Rtccr { cal : u8 , cco : bool , asoe : bool , asos : super :: vals :: Asos , } let proxy = Rtccr { cal : self . cal () , cco : self . cco () , asoe : self . asoe () , asos : self . asos () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

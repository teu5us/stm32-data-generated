...
struct Cfgr1 { mem_mode : super :: vals :: MemMode , pa11_pa12_rmp : bool , ir_mod : super :: vals :: IrMod , adc_dma_rmp : bool , usart1_tx_dma_rmp : bool , usart1_rx_dma_rmp : bool , tim16_dma_rmp : bool , tim17_dma_rmp : bool , tim16_dma_rmp2 : bool , tim17_dma_rmp2 : bool , i2c_pb6_fmp : super :: vals :: Fmp , i2c_pb7_fmp : super :: vals :: Fmp , i2c_pb8_fmp : super :: vals :: Fmp , i2c_pb9_fmp : super :: vals :: Fmp , i2c1_fmp : super :: vals :: Fmp , i2c2_fmp : super :: vals :: Fmp , i2c_pa9_fmp : super :: vals :: Fmp , i2c_pa10_fmp : super :: vals :: Fmp , spi2_dma_rmp : bool , usart2_dma_rmp : bool , usart3_dma_rmp : bool , i2c1_dma_rmp : bool , tim1_dma_rmp : bool , tim2_dma_rmp : bool , tim3_dma_rmp : bool , } let proxy = Cfgr1 { mem_mode : self . mem_mode () , pa11_pa12_rmp : self . pa11_pa12_rmp () , ir_mod : self . ir_mod () , adc_dma_rmp : self . adc_dma_rmp () , usart1_tx_dma_rmp : self . usart1_tx_dma_rmp () , usart1_rx_dma_rmp : self . usart1_rx_dma_rmp () , tim16_dma_rmp : self . tim16_dma_rmp () , tim17_dma_rmp : self . tim17_dma_rmp () , tim16_dma_rmp2 : self . tim16_dma_rmp2 () , tim17_dma_rmp2 : self . tim17_dma_rmp2 () , i2c_pb6_fmp : self . i2c_pb6_fmp () , i2c_pb7_fmp : self . i2c_pb7_fmp () , i2c_pb8_fmp : self . i2c_pb8_fmp () , i2c_pb9_fmp : self . i2c_pb9_fmp () , i2c1_fmp : self . i2c1_fmp () , i2c2_fmp : self . i2c2_fmp () , i2c_pa9_fmp : self . i2c_pa9_fmp () , i2c_pa10_fmp : self . i2c_pa10_fmp () , spi2_dma_rmp : self . spi2_dma_rmp () , usart2_dma_rmp : self . usart2_dma_rmp () , usart3_dma_rmp : self . usart3_dma_rmp () , i2c1_dma_rmp : self . i2c1_dma_rmp () , tim1_dma_rmp : self . tim1_dma_rmp () , tim2_dma_rmp : self . tim2_dma_rmp () , tim3_dma_rmp : self . tim3_dma_rmp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { lockup_lock : bool , sram_parity_lock : bool , pvd_lock : bool , sram_pef : bool , } let proxy = Cfgr2 { lockup_lock : self . lockup_lock () , sram_parity_lock : self . sram_parity_lock () , pvd_lock : self . pvd_lock () , sram_pef : self . sram_pef () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "external interrupt configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

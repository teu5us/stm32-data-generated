...
struct Dmabmr { sr : bool , da : super :: vals :: Da , dsl : u8 , pbl : super :: vals :: Pbl , pm : super :: vals :: PriorityRxOverTx , fb : super :: vals :: Fb , rdp : super :: vals :: Rdp , usp : super :: vals :: Usp , fpm : super :: vals :: Fpm , aab : bool , } let proxy = Dmabmr { sr : self . sr () , da : self . da () , dsl : self . dsl () , pbl : self . pbl () , pm : self . pm () , fb : self . fb () , rdp : self . rdp () , usp : self . usp () , fpm : self . fpm () , aab : self . aab () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA current host receive buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dmarpdr { rpd : super :: vals :: Rpd , } let proxy = Dmarpdr { rpd : self . rpd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Mmccr { cr : super :: vals :: CounterReset , csr : super :: vals :: Csr , ror : bool , mcf : bool , } let proxy = Mmccr { cr : self . cr () , csr : self . csr () , ror : self . ror () , mcf : self . mcf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC received frames with alignment error counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
impl defmt :: Format for Dmabmr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmabmr { sr : bool , da : super :: vals :: Da , dsl : u8 , edfe : bool , pbl : super :: vals :: Pbl , pm : super :: vals :: PriorityRxOverTx , fb : super :: vals :: Fb , rdp : super :: vals :: Rdp , usp : super :: vals :: Usp , fpm : super :: vals :: Fpm , aab : bool , mb : super :: vals :: Mb , } let proxy = Dmabmr { sr : self . sr () , da : self . da () , dsl : self . dsl () , edfe : self . edfe () , pbl : self . pbl () , pm : self . pm () , fb : self . fb () , rdp : self . rdp () , usp : self . usp () , fpm : self . fpm () , aab : self . aab () , mb : self . mb () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA current host receive buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmachrbar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmachrbar { hrbap : u32 , } let proxy = Dmachrbar { hrbap : self . hrbap () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA current host receive descriptor register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmachrdr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmachrdr { hrdap : u32 , } let proxy = Dmachrdr { hrdap : self . hrdap () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA current host transmit buffer address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmachtbar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmachtbar { htbap : u32 , } let proxy = Dmachtbar { htbap : self . htbap () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA current host transmit descriptor register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmachtdr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmachtdr { htdap : u32 , } let proxy = Dmachtdr { htdap : self . htdap () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmaier { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmaier { tie : bool , tpsie : bool , tbuie : bool , tjtie : bool , roie : bool , tuie : bool , rie : bool , rbuie : bool , rpsie : bool , rwtie : bool , etie : bool , fbeie : bool , erie : bool , aise : bool , nise : bool , } let proxy = Dmaier { tie : self . tie () , tpsie : self . tpsie () , tbuie : self . tbuie () , tjtie : self . tjtie () , roie : self . roie () , tuie : self . tuie () , rie : self . rie () , rbuie : self . rbuie () , rpsie : self . rpsie () , rwtie : self . rwtie () , etie : self . etie () , fbeie : self . fbeie () , erie : self . erie () , aise : self . aise () , nise : self . nise () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA missed frame and buffer overflow counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmamfbocr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmamfbocr { mfc : u16 , omfc : bool , mfa : u16 , ofoc : bool , } let proxy = Dmamfbocr { mfc : self . mfc () , omfc : self . omfc () , mfa : self . mfa () , ofoc : self . ofoc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA operation mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmaomr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmaomr { sr : super :: vals :: DmaomrSr , osf : bool , rtc : super :: vals :: Rtc , fugf : super :: vals :: Fugf , fef : super :: vals :: Fef , st : super :: vals :: St , ttc : super :: vals :: Ttc , ftf : super :: vals :: Ftf , tsf : super :: vals :: Tsf , dfrf : bool , rsf : super :: vals :: Rsf , dtcefd : super :: vals :: Dtcefd , } let proxy = Dmaomr { sr : self . sr () , osf : self . osf () , rtc : self . rtc () , fugf : self . fugf () , fef : self . fef () , st : self . st () , ttc : self . ttc () , ftf : self . ftf () , tsf : self . tsf () , dfrf : self . dfrf () , rsf : self . rsf () , dtcefd : self . dtcefd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA receive descriptor list address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmardlar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmardlar { srl : u32 , } let proxy = Dmardlar { srl : self . srl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "EHERNET DMA receive poll demand register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmarpdr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmarpdr { rpd : super :: vals :: Rpd , } let proxy = Dmarpdr { rpd : self . rpd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA receive status watchdog timer register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmarswtr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmarswtr { rswtc : u8 , } let proxy = Dmarswtr { rswtc : self . rswtc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmasr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmasr { ts : bool , tpss : bool , tbus : bool , tjts : bool , ros : bool , tus : bool , rs : bool , rbus : bool , rpss : bool , pwts : bool , ets : bool , fbes : bool , ers : bool , ais : bool , nis : bool , rps : super :: vals :: Rps , tps : super :: vals :: Tps , ebs : u8 , mmcs : bool , pmts : bool , tsts : bool , } let proxy = Dmasr { ts : self . ts () , tpss : self . tpss () , tbus : self . tbus () , tjts : self . tjts () , ros : self . ros () , tus : self . tus () , rs : self . rs () , rbus : self . rbus () , rpss : self . rpss () , pwts : self . pwts () , ets : self . ets () , fbes : self . fbes () , ers : self . ers () , ais : self . ais () , nis : self . nis () , rps : self . rps () , tps : self . tps () , ebs : self . ebs () , mmcs : self . mmcs () , pmts : self . pmts () , tsts : self . tsts () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA transmit descriptor list address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmatdlar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmatdlar { stl : u32 , } let proxy = Dmatdlar { stl : self . stl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet DMA transmit poll demand register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dmatpdr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dmatpdr { tpd : super :: vals :: Tpd , } let proxy = Dmatpdr { tpd : self . tpd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC address 0 high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Maca0hr { maca0h : u16 , mo : bool , } let proxy = Maca0hr { maca0h : self . maca0h () , mo : self . mo () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC address 0 low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Maca0lr { maca0l : u32 , } let proxy = Maca0lr { maca0l : self . maca0l () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC address 1/2/3 high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Macahr { macah : u16 , mbc : u8 , sa : super :: vals :: MacahrSa , ae : bool , } let proxy = Macahr { macah : self . macah () , mbc : self . mbc () , sa : self . sa () , ae : self . ae () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC address 1/2/3 low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Macalr { macal : u32 , } let proxy = Macalr { macal : self . macal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Maccr { re : bool , te : bool , dc : bool , bl : super :: vals :: Bl , apcs : super :: vals :: Apcs , rd : super :: vals :: Rd , ipco : super :: vals :: Ipco , dm : super :: vals :: Dm , lm : super :: vals :: Lm , rod : super :: vals :: Rod , fes : super :: vals :: Fes , csd : super :: vals :: Csd , ifg : super :: vals :: Ifg , jd : super :: vals :: Jd , wd : super :: vals :: Wd , cstf : bool , } let proxy = Maccr { re : self . re () , te : self . te () , dc : self . dc () , bl : self . bl () , apcs : self . apcs () , rd : self . rd () , ipco : self . ipco () , dm : self . dm () , lm : self . lm () , rod : self . rod () , fes : self . fes () , csd : self . csd () , ifg : self . ifg () , jd : self . jd () , wd : self . wd () , cstf : self . cstf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC debug register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macdbgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macdbgr { mmrpea : bool , msfrwcs : u8 , rfwra : bool , rfrcs : u8 , rffl : u8 , mmtea : bool , mtfcs : u8 , mtp : bool , tfrs : u8 , tfwa : bool , tfne : bool , tff : bool , } let proxy = Macdbgr { mmrpea : self . mmrpea () , msfrwcs : self . msfrwcs () , rfwra : self . rfwra () , rfrcs : self . rfrcs () , rffl : self . rffl () , mmtea : self . mmtea () , mtfcs : self . mtfcs () , mtp : self . mtp () , tfrs : self . tfrs () , tfwa : self . tfwa () , tfne : self . tfne () , tff : self . tff () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC flow control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macfcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macfcr { fcb : super :: vals :: Fcb , tfce : bool , rfce : bool , upfd : bool , plt : super :: vals :: Plt , zqpd : super :: vals :: Zqpd , pt : u16 , } let proxy = Macfcr { fcb : self . fcb () , tfce : self . tfce () , rfce : self . rfce () , upfd : self . upfd () , plt : self . plt () , zqpd : self . zqpd () , pt : self . pt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC frame filter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macffr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macffr { pm : bool , hu : super :: vals :: Hu , hm : super :: vals :: Hm , daif : super :: vals :: Daif , pam : bool , bfd : super :: vals :: Bfd , pcf : super :: vals :: Pcf , saif : super :: vals :: Saif , saf : bool , hpf : super :: vals :: Hpf , ra : bool , } let proxy = Macffr { pm : self . pm () , hu : self . hu () , hm : self . hm () , daif : self . daif () , pam : self . pam () , bfd : self . bfd () , pcf : self . pcf () , saif : self . saif () , saf : self . saf () , hpf : self . hpf () , ra : self . ra () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC hash table high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Machthr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Machthr { hth : u32 , } let proxy = Machthr { hth : self . hth () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC hash table low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Machtlr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Machtlr { htl : u32 , } let proxy = Machtlr { htl : self . htl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC interrupt mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macimr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macimr { pmtim : super :: vals :: Pmtim , tstim : super :: vals :: Tstim , } let proxy = Macimr { pmtim : self . pmtim () , tstim : self . tstim () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC MII address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macmiiar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macmiiar { mb : super :: vals :: MbProgress , mw : super :: vals :: Mw , cr : super :: vals :: Cr , mr : u8 , pa : u8 , } let proxy = Macmiiar { mb : self . mb () , mw : self . mw () , cr : self . cr () , mr : self . mr () , pa : self . pa () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC MII data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macmiidr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macmiidr { md : u16 , } let proxy = Macmiidr { md : self . md () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC PMT control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macpmtcsr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macpmtcsr { pd : super :: vals :: Pd , mpe : bool , wfe : bool , mpr : bool , wfr : bool , gu : bool , wffrpr : super :: vals :: Wffrpr , } let proxy = Macpmtcsr { pd : self . pd () , mpe : self . mpe () , wfe : self . wfe () , mpr : self . mpr () , wfr : self . wfr () , gu : self . gu () , wffrpr : self . wffrpr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macsr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macsr { pmts : bool , mmcs : bool , mmcrs : bool , mmcts : bool , tsts : bool , } let proxy = Macsr { pmts : self . pmts () , mmcs : self . mmcs () , mmcrs : self . mmcrs () , mmcts : self . mmcts () , tsts : self . tsts () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MAC VLAN tag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Macvlantr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Macvlantr { vlanti : u16 , vlantc : super :: vals :: Vlantc , } let proxy = Macvlantr { vlanti : self . vlanti () , vlantc : self . vlantc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmccr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmccr { cr : super :: vals :: CounterReset , csr : super :: vals :: Csr , ror : bool , mcf : bool , mcp : super :: vals :: Mcp , mcfhp : super :: vals :: Mcfhp , } let proxy = Mmccr { cr : self . cr () , csr : self . csr () , ror : self . ror () , mcf : self . mcf () , mcp : self . mcp () , mcfhp : self . mcfhp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC received frames with alignment error counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmcrfaecr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmcrfaecr { rfaec : u32 , } let proxy = Mmcrfaecr { rfaec : self . rfaec () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC received frames with CRC error counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmcrfcecr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmcrfcecr { rfcfc : u32 , } let proxy = Mmcrfcecr { rfcfc : self . rfcfc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "MMC received good unicast frames counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmcrgufcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmcrgufcr { rgufc : u32 , } let proxy = Mmcrgufcr { rgufc : self . rgufc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC receive interrupt mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmcrimr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmcrimr { rfcem : super :: vals :: Rfcem , rfaem : super :: vals :: Rfaem , rgufm : super :: vals :: Rgufm , } let proxy = Mmcrimr { rfcem : self . rfcem () , rfaem : self . rfaem () , rgufm : self . rgufm () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC receive interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmcrir { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmcrir { rfces : bool , rfaes : bool , rgufs : bool , } let proxy = Mmcrir { rfces : self . rfces () , rfaes : self . rfaes () , rgufs : self . rgufs () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC transmitted good frames counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmctgfcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmctgfcr { tgfc : u32 , } let proxy = Mmctgfcr { tgfc : self . tgfc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC transmitted good frames after more than a single collision"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmctgfmsccr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmctgfmsccr { tgfmscc : u32 , } let proxy = Mmctgfmsccr { tgfmscc : self . tgfmscc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC transmitted good frames after a single collision counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmctgfsccr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmctgfsccr { tgfscc : u32 , } let proxy = Mmctgfsccr { tgfscc : self . tgfscc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC transmit interrupt mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmctimr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmctimr { tgfscm : super :: vals :: Tgfscm , tgfmscm : super :: vals :: Tgfmscm , tgfm : super :: vals :: Tgfm , } let proxy = Mmctimr { tgfscm : self . tgfscm () , tgfmscm : self . tgfmscm () , tgfm : self . tgfm () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet MMC transmit interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmctir { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmctir { tgfscs : bool , tgfmscs : bool , tgfs : bool , } let proxy = Mmctir { tgfscs : self . tgfscs () , tgfmscs : self . tgfmscs () , tgfs : self . tgfs () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP PPS control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptpppscr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptpppscr { tsso : bool , tsttr : bool , } let proxy = Ptpppscr { tsso : self . tsso () , tsttr : self . tsttr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP subsecond increment register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptpssir { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptpssir { stssi : u8 , } let proxy = Ptpssir { stssi : self . stssi () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP time stamp addend register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptsar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptsar { tsa : u32 , } let proxy = Ptptsar { tsa : self . tsa () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP time stamp control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptscr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptscr { tse : bool , tsfcu : bool , tssti : bool , tsstu : bool , tsite : bool , ttsaru : bool , tssarfe : bool , tsssr : bool , tsptppsv2e : bool , tssptpoefe : bool , tssipv6fe : bool , tssipv4fe : bool , tsseme : bool , tssmrme : bool , tscnt : u8 , tspffmae : bool , } let proxy = Ptptscr { tse : self . tse () , tsfcu : self . tsfcu () , tssti : self . tssti () , tsstu : self . tsstu () , tsite : self . tsite () , ttsaru : self . ttsaru () , tssarfe : self . tssarfe () , tsssr : self . tsssr () , tsptppsv2e : self . tsptppsv2e () , tssptpoefe : self . tssptpoefe () , tssipv6fe : self . tssipv6fe () , tssipv4fe : self . tssipv4fe () , tsseme : self . tsseme () , tssmrme : self . tssmrme () , tscnt : self . tscnt () , tspffmae : self . tspffmae () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP time stamp high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptshr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptshr { sts : u32 , } let proxy = Ptptshr { sts : self . sts () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP time stamp high update register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptshur { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptshur { tsus : u32 , } let proxy = Ptptshur { tsus : self . tsus () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP time stamp low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptslr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptslr { stss : u32 , stpns : bool , } let proxy = Ptptslr { stss : self . stss () , stpns : self . stpns () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP time stamp low update register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptslur { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptslur { tsuss : u32 , tsupns : bool , } let proxy = Ptptslur { tsuss : self . tsuss () , tsupns : self . tsupns () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP time stamp status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptssr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptssr { tsso : bool , tsttr : bool , } let proxy = Ptptssr { tsso : self . tsso () , tsttr : self . tsttr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP target time high register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptptthr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptptthr { ttsh : u32 , } let proxy = Ptptthr { ttsh : self . ttsh () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Ethernet PTP target time low register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ptpttlr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ptpttlr { ttsl : u32 , } let proxy = Ptpttlr { ttsl : self . ttsl () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

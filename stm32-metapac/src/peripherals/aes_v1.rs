...
struct Cr { en : bool , datatype : super :: vals :: Datatype , mode : super :: vals :: Mode , chmod10 : u8 , ccfc : bool , errc : bool , ccfie : bool , errie : bool , dmainen : bool , dmaouten : bool , } let proxy = Cr { en : self . en () , datatype : self . datatype () , mode : self . mode () , chmod10 : self . chmod10 () , ccfc : self . ccfc () , errc : self . errc () , ccfie : self . ccfie () , errie : self . errie () , dmainen : self . dmainen () , dmaouten : self . dmaouten () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { ccf : bool , rderr : bool , wrerr : bool , } let proxy = Sr { ccf : self . ccf () , rderr : self . rderr () , wrerr : self . wrerr () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

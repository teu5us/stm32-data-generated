...
struct Ahb1enr { gpdma1en : bool , cordicen : bool , fmacen : bool , mdf1en : bool , flashen : bool , crcen : bool , jpegen : bool , tscen : bool , ramcfgen : bool , dma2den : bool , gfxmmuen : bool , gpu2den : bool , dcache2en : bool , gtzc1en : bool , bkpsramen : bool , dcache1en : bool , sram1en : bool , } let proxy = Ahb1enr { gpdma1en : self . gpdma1en () , cordicen : self . cordicen () , fmacen : self . fmacen () , mdf1en : self . mdf1en () , flashen : self . flashen () , crcen : self . crcen () , jpegen : self . jpegen () , tscen : self . tscen () , ramcfgen : self . ramcfgen () , dma2den : self . dma2den () , gfxmmuen : self . gfxmmuen () , gpu2den : self . gpu2den () , dcache2en : self . dcache2en () , gtzc1en : self . gtzc1en () , bkpsramen : self . bkpsramen () , dcache1en : self . dcache1en () , sram1en : self . sram1en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb1rstr { gpdma1rst : bool , cordicrst : bool , fmacrst : bool , mdf1rst : bool , crcrst : bool , jpegrst : bool , tscrst : bool , ramcfgrst : bool , dma2drst : bool , gfxmmurst : bool , gpu2drst : bool , } let proxy = Ahb1rstr { gpdma1rst : self . gpdma1rst () , cordicrst : self . cordicrst () , fmacrst : self . fmacrst () , mdf1rst : self . mdf1rst () , crcrst : self . crcrst () , jpegrst : self . jpegrst () , tscrst : self . tscrst () , ramcfgrst : self . ramcfgrst () , dma2drst : self . dma2drst () , gfxmmurst : self . gfxmmurst () , gpu2drst : self . gpu2drst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB1 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb1smenr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb1smenr { gpdma1smen : bool , cordicsmen : bool , fmacsmen : bool , mdf1smen : bool , flashsmen : bool , crcsmen : bool , jpegsmen : bool , tscsmen : bool , ramcfgsmen : bool , dma2dsmen : bool , gfxmmusmen : bool , gpu2dsmen : bool , dcache2smen : bool , gtzc1smen : bool , bkpsramsmen : bool , icachesmen : bool , dcache1smen : bool , sram1smen : bool , } let proxy = Ahb1smenr { gpdma1smen : self . gpdma1smen () , cordicsmen : self . cordicsmen () , fmacsmen : self . fmacsmen () , mdf1smen : self . mdf1smen () , flashsmen : self . flashsmen () , crcsmen : self . crcsmen () , jpegsmen : self . jpegsmen () , tscsmen : self . tscsmen () , ramcfgsmen : self . ramcfgsmen () , dma2dsmen : self . dma2dsmen () , gfxmmusmen : self . gfxmmusmen () , gpu2dsmen : self . gpu2dsmen () , dcache2smen : self . dcache2smen () , gtzc1smen : self . gtzc1smen () , bkpsramsmen : self . bkpsramsmen () , icachesmen : self . icachesmen () , dcache1smen : self . dcache1smen () , sram1smen : self . sram1smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 peripheral clock enable register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb2enr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb2enr1 { gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , gpiofen : bool , gpiogen : bool , gpiohen : bool , gpioien : bool , gpiojen : bool , adc12en : bool , dcmien : bool , usb_otg_fsen : bool , usb_otg_hsen : bool , usb_otg_hs_phyen : bool , aesen : bool , hashen : bool , rngen : bool , pkaen : bool , saesen : bool , octospimen : bool , otfdec1en : bool , otfdec2en : bool , sdmmc1en : bool , sdmmc2en : bool , sram2en : bool , sram3en : bool , } let proxy = Ahb2enr1 { gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , gpiofen : self . gpiofen () , gpiogen : self . gpiogen () , gpiohen : self . gpiohen () , gpioien : self . gpioien () , gpiojen : self . gpiojen () , adc12en : self . adc12en () , dcmien : self . dcmien () , usb_otg_fsen : self . usb_otg_fsen () , usb_otg_hsen : self . usb_otg_hsen () , usb_otg_hs_phyen : self . usb_otg_hs_phyen () , aesen : self . aesen () , hashen : self . hashen () , rngen : self . rngen () , pkaen : self . pkaen () , saesen : self . saesen () , octospimen : self . octospimen () , otfdec1en : self . otfdec1en () , otfdec2en : self . otfdec2en () , sdmmc1en : self . sdmmc1en () , sdmmc2en : self . sdmmc2en () , sram2en : self . sram2en () , sram3en : self . sram3en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb2enr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb2enr2 { fsmcen : bool , octospi1en : bool , octospi2en : bool , hspi1en : bool , sram6en : bool , sram5en : bool , } let proxy = Ahb2enr2 { fsmcen : self . fsmcen () , octospi1en : self . octospi1en () , octospi2en : self . octospi2en () , hspi1en : self . hspi1en () , sram6en : self . sram6en () , sram5en : self . sram5en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb2rstr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb2rstr1 { gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiodrst : bool , gpioerst : bool , gpiofrst : bool , gpiogrst : bool , gpiohrst : bool , gpioirst : bool , gpiojrst : bool , adc12rst : bool , dcmirst : bool , usb_otg_fsrst : bool , usb_otg_hsrst : bool , aesrst : bool , hashrst : bool , rngrst : bool , pkarst : bool , saesrst : bool , octospimrst : bool , otfdec1rst : bool , otfdec2rst : bool , sdmmc1rst : bool , sdmmc2rst : bool , } let proxy = Ahb2rstr1 { gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiodrst : self . gpiodrst () , gpioerst : self . gpioerst () , gpiofrst : self . gpiofrst () , gpiogrst : self . gpiogrst () , gpiohrst : self . gpiohrst () , gpioirst : self . gpioirst () , gpiojrst : self . gpiojrst () , adc12rst : self . adc12rst () , dcmirst : self . dcmirst () , usb_otg_fsrst : self . usb_otg_fsrst () , usb_otg_hsrst : self . usb_otg_hsrst () , aesrst : self . aesrst () , hashrst : self . hashrst () , rngrst : self . rngrst () , pkarst : self . pkarst () , saesrst : self . saesrst () , octospimrst : self . octospimrst () , otfdec1rst : self . otfdec1rst () , otfdec2rst : self . otfdec2rst () , sdmmc1rst : self . sdmmc1rst () , sdmmc2rst : self . sdmmc2rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb2rstr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb2rstr2 { fsmcrst : bool , octospi1rst : bool , octospi2rst : bool , hspi1rst : bool , } let proxy = Ahb2rstr2 { fsmcrst : self . fsmcrst () , octospi1rst : self . octospi1rst () , octospi2rst : self . octospi2rst () , hspi1rst : self . hspi1rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 peripheral clocks enable in Sleep and Stop modes register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb2smenr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb2smenr1 { gpioasmen : bool , gpiobsmen : bool , gpiocsmen : bool , gpiodsmen : bool , gpioesmen : bool , gpiofsmen : bool , gpiogsmen : bool , gpiohsmen : bool , gpioismen : bool , gpiojsmen : bool , adc12smen : bool , dcmismen : bool , usb_otg_fssmen : bool , usb_otg_hssmen : bool , usb_otg_hs_physmen : bool , aessmen : bool , hashsmen : bool , rngsmen : bool , pkasmen : bool , saessmen : bool , octospimsmen : bool , otfdec1smen : bool , otfdec2smen : bool , sdmmc1smen : bool , sdmmc2smen : bool , sram2smen : bool , sram3smen : bool , } let proxy = Ahb2smenr1 { gpioasmen : self . gpioasmen () , gpiobsmen : self . gpiobsmen () , gpiocsmen : self . gpiocsmen () , gpiodsmen : self . gpiodsmen () , gpioesmen : self . gpioesmen () , gpiofsmen : self . gpiofsmen () , gpiogsmen : self . gpiogsmen () , gpiohsmen : self . gpiohsmen () , gpioismen : self . gpioismen () , gpiojsmen : self . gpiojsmen () , adc12smen : self . adc12smen () , dcmismen : self . dcmismen () , usb_otg_fssmen : self . usb_otg_fssmen () , usb_otg_hssmen : self . usb_otg_hssmen () , usb_otg_hs_physmen : self . usb_otg_hs_physmen () , aessmen : self . aessmen () , hashsmen : self . hashsmen () , rngsmen : self . rngsmen () , pkasmen : self . pkasmen () , saessmen : self . saessmen () , octospimsmen : self . octospimsmen () , otfdec1smen : self . otfdec1smen () , otfdec2smen : self . otfdec2smen () , sdmmc1smen : self . sdmmc1smen () , sdmmc2smen : self . sdmmc2smen () , sram2smen : self . sram2smen () , sram3smen : self . sram3smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 peripheral clocks enable in Sleep and Stop modes register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb2smenr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb2smenr2 { fsmcsmen : bool , octospi1smen : bool , octospi2smen : bool , hspi1smen : bool , sram6smen : bool , sram5smen : bool , } let proxy = Ahb2smenr2 { fsmcsmen : self . fsmcsmen () , octospi1smen : self . octospi1smen () , octospi2smen : self . octospi2smen () , hspi1smen : self . hspi1smen () , sram6smen : self . sram6smen () , sram5smen : self . sram5smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3enr { lpgpio1en : bool , pwren : bool , adc4en : bool , dac1en : bool , lpdma1en : bool , adf1en : bool , gtzc2en : bool , sram4en : bool , } let proxy = Ahb3enr { lpgpio1en : self . lpgpio1en () , pwren : self . pwren () , adc4en : self . adc4en () , dac1en : self . dac1en () , lpdma1en : self . lpdma1en () , adf1en : self . adf1en () , gtzc2en : self . gtzc2en () , sram4en : self . sram4en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3rstr { lpgpio1rst : bool , adc4rst : bool , dac1rst : bool , lpdma1rst : bool , adf1rst : bool , } let proxy = Ahb3rstr { lpgpio1rst : self . lpgpio1rst () , adc4rst : self . adc4rst () , dac1rst : self . dac1rst () , lpdma1rst : self . lpdma1rst () , adf1rst : self . adf1rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ahb3smenr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ahb3smenr { lpgpio1smen : bool , pwrsmen : bool , adc4smen : bool , dac1smen : bool , lpdma1smen : bool , adf1smen : bool , gtzc2smen : bool , sram4smen : bool , } let proxy = Ahb3smenr { lpgpio1smen : self . lpgpio1smen () , pwrsmen : self . pwrsmen () , adc4smen : self . adc4smen () , dac1smen : self . dac1smen () , lpdma1smen : self . lpdma1smen () , adf1smen : self . adf1smen () , gtzc2smen : self . gtzc2smen () , sram4smen : self . sram4smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 peripheral clock enable register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1enr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1enr1 { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , wwdgen : bool , spi2en : bool , usart2en : bool , usart3en : bool , uart4en : bool , uart5en : bool , i2c1en : bool , i2c2en : bool , crsen : bool , usart6en : bool , } let proxy = Apb1enr1 { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , usart2en : self . usart2en () , usart3en : self . usart3en () , uart4en : self . uart4en () , uart5en : self . uart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , crsen : self . crsen () , usart6en : self . usart6en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1enr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1enr2 { i2c4en : bool , lptim2en : bool , i2c5en : bool , i2c6en : bool , fdcan1en : bool , ucpd1en : bool , } let proxy = Apb1enr2 { i2c4en : self . i2c4en () , lptim2en : self . lptim2en () , i2c5en : self . i2c5en () , i2c6en : self . i2c6en () , fdcan1en : self . fdcan1en () , ucpd1en : self . ucpd1en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1rstr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1rstr1 { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , spi2rst : bool , usart2rst : bool , usart3rst : bool , uart4rst : bool , uart5rst : bool , i2c1rst : bool , i2c2rst : bool , crsrst : bool , usart6rst : bool , } let proxy = Apb1rstr1 { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , spi2rst : self . spi2rst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , uart4rst : self . uart4rst () , uart5rst : self . uart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , crsrst : self . crsrst () , usart6rst : self . usart6rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1rstr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1rstr2 { i2c4rst : bool , lptim2rst : bool , i2c5rst : bool , i2c6rst : bool , fdcan1rst : bool , ucpd1rst : bool , } let proxy = Apb1rstr2 { i2c4rst : self . i2c4rst () , lptim2rst : self . lptim2rst () , i2c5rst : self . i2c5rst () , i2c6rst : self . i2c6rst () , fdcan1rst : self . fdcan1rst () , ucpd1rst : self . ucpd1rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 peripheral clocks enable in Sleep and Stop modes register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1smenr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1smenr1 { tim2smen : bool , tim3smen : bool , tim4smen : bool , tim5smen : bool , tim6smen : bool , tim7smen : bool , wwdgsmen : bool , spi2smen : bool , usart2smen : bool , usart3smen : bool , uart4smen : bool , uart5smen : bool , i2c1smen : bool , i2c2smen : bool , crssmen : bool , usart6smen : bool , } let proxy = Apb1smenr1 { tim2smen : self . tim2smen () , tim3smen : self . tim3smen () , tim4smen : self . tim4smen () , tim5smen : self . tim5smen () , tim6smen : self . tim6smen () , tim7smen : self . tim7smen () , wwdgsmen : self . wwdgsmen () , spi2smen : self . spi2smen () , usart2smen : self . usart2smen () , usart3smen : self . usart3smen () , uart4smen : self . uart4smen () , uart5smen : self . uart5smen () , i2c1smen : self . i2c1smen () , i2c2smen : self . i2c2smen () , crssmen : self . crssmen () , usart6smen : self . usart6smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 peripheral clocks enable in Sleep and Stop modes register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1smenr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1smenr2 { i2c4smen : bool , lptim2smen : bool , i2c5smen : bool , i2c6smen : bool , fdcan1smen : bool , ucpd1smen : bool , } let proxy = Apb1smenr2 { i2c4smen : self . i2c4smen () , lptim2smen : self . lptim2smen () , i2c5smen : self . i2c5smen () , i2c6smen : self . i2c6smen () , fdcan1smen : self . fdcan1smen () , ucpd1smen : self . ucpd1smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { tim1en : bool , spi1en : bool , tim8en : bool , usart1en : bool , tim15en : bool , tim16en : bool , tim17en : bool , sai1en : bool , sai2en : bool , usben : bool , gfxtimen : bool , ltdcen : bool , dsien : bool , } let proxy = Apb2enr { tim1en : self . tim1en () , spi1en : self . spi1en () , tim8en : self . tim8en () , usart1en : self . usart1en () , tim15en : self . tim15en () , tim16en : self . tim16en () , tim17en : self . tim17en () , sai1en : self . sai1en () , sai2en : self . sai2en () , usben : self . usben () , gfxtimen : self . gfxtimen () , ltdcen : self . ltdcen () , dsien : self . dsien () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { tim1rst : bool , spi1rst : bool , tim8rst : bool , usart1rst : bool , tim15rst : bool , tim16rst : bool , tim17rst : bool , sai1rst : bool , sai2rst : bool , usbrst : bool , gfxtimrst : bool , ltdcrst : bool , dsirst : bool , } let proxy = Apb2rstr { tim1rst : self . tim1rst () , spi1rst : self . spi1rst () , tim8rst : self . tim8rst () , usart1rst : self . usart1rst () , tim15rst : self . tim15rst () , tim16rst : self . tim16rst () , tim17rst : self . tim17rst () , sai1rst : self . sai1rst () , sai2rst : self . sai2rst () , usbrst : self . usbrst () , gfxtimrst : self . gfxtimrst () , ltdcrst : self . ltdcrst () , dsirst : self . dsirst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB2 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb2smenr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb2smenr { tim1smen : bool , spi1smen : bool , tim8smen : bool , usart1smen : bool , tim15smen : bool , tim16smen : bool , tim17smen : bool , sai1smen : bool , sai2smen : bool , usbsmen : bool , gfxtimsmen : bool , ltdcsmen : bool , dsismen : bool , } let proxy = Apb2smenr { tim1smen : self . tim1smen () , spi1smen : self . spi1smen () , tim8smen : self . tim8smen () , usart1smen : self . usart1smen () , tim15smen : self . tim15smen () , tim16smen : self . tim16smen () , tim17smen : self . tim17smen () , sai1smen : self . sai1smen () , sai2smen : self . sai2smen () , usbsmen : self . usbsmen () , gfxtimsmen : self . gfxtimsmen () , ltdcsmen : self . ltdcsmen () , dsismen : self . dsismen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb3enr { syscfgen : bool , spi3en : bool , lpuart1en : bool , i2c3en : bool , lptim1en : bool , lptim3en : bool , lptim4en : bool , opampen : bool , compen : bool , vrefen : bool , rtcapben : bool , } let proxy = Apb3enr { syscfgen : self . syscfgen () , spi3en : self . spi3en () , lpuart1en : self . lpuart1en () , i2c3en : self . i2c3en () , lptim1en : self . lptim1en () , lptim3en : self . lptim3en () , lptim4en : self . lptim4en () , opampen : self . opampen () , compen : self . compen () , vrefen : self . vrefen () , rtcapben : self . rtcapben () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb3rstr { syscfgrst : bool , spi3rst : bool , lpuart1rst : bool , i2c3rst : bool , lptim1rst : bool , lptim3rst : bool , lptim4rst : bool , opamprst : bool , comprst : bool , vrefrst : bool , } let proxy = Apb3rstr { syscfgrst : self . syscfgrst () , spi3rst : self . spi3rst () , lpuart1rst : self . lpuart1rst () , i2c3rst : self . i2c3rst () , lptim1rst : self . lptim1rst () , lptim3rst : self . lptim3rst () , lptim4rst : self . lptim4rst () , opamprst : self . opamprst () , comprst : self . comprst () , vrefrst : self . vrefrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB3 peripheral clock enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb3smenr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb3smenr { syscfgsmen : bool , spi3smen : bool , lpuart1smen : bool , i2c3smen : bool , lptim1smen : bool , lptim3smen : bool , lptim4smen : bool , opampsmen : bool , compsmen : bool , vrefsmen : bool , rtcapbsmen : bool , } let proxy = Apb3smenr { syscfgsmen : self . syscfgsmen () , spi3smen : self . spi3smen () , lpuart1smen : self . lpuart1smen () , i2c3smen : self . i2c3smen () , lptim1smen : self . lptim1smen () , lptim3smen : self . lptim3smen () , lptim4smen : self . lptim4smen () , opampsmen : self . opampsmen () , compsmen : self . compsmen () , vrefsmen : self . vrefsmen () , rtcapbsmen : self . rtcapbsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bdcr { lseon : bool , lserdy : bool , lsebyp : bool , lsedrv : super :: vals :: Lsedrv , lsecsson : bool , lsecssd : bool , lsesysen : bool , rtcsel : super :: vals :: Rtcsel , lsesysrdy : bool , lsegfon : bool , rtcen : bool , bdrst : bool , lscoen : bool , lscosel : super :: vals :: Lscosel , lsion : bool , lsirdy : bool , lsiprediv : super :: vals :: Lsiprediv , } let proxy = Bdcr { lseon : self . lseon () , lserdy : self . lserdy () , lsebyp : self . lsebyp () , lsedrv : self . lsedrv () , lsecsson : self . lsecsson () , lsecssd : self . lsecssd () , lsesysen : self . lsesysen () , rtcsel : self . rtcsel () , lsesysrdy : self . lsesysrdy () , lsegfon : self . lsegfon () , rtcen : self . rtcen () , bdrst : self . bdrst () , lscoen : self . lscoen () , lscosel : self . lscosel () , lsion : self . lsion () , lsirdy : self . lsirdy () , lsiprediv : self . lsiprediv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC peripherals independent clock configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ccipr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccipr1 { usart1sel : super :: vals :: Usart1sel , usart2sel : super :: vals :: Usartsel , usart3sel : super :: vals :: Usartsel , uart4sel : super :: vals :: Usartsel , uart5sel : super :: vals :: Usartsel , i2c1sel : super :: vals :: I2csel , i2c2sel : super :: vals :: I2csel , i2c4sel : super :: vals :: I2csel , spi2sel : super :: vals :: Spi2sel , lptim2sel : super :: vals :: Lptim2sel , spi1sel : super :: vals :: Spi1sel , systicksel : super :: vals :: Systicksel , fdcan1sel : super :: vals :: Fdcansel , iclksel : super :: vals :: Iclksel , timicsel : super :: vals :: Timicsel , } let proxy = Ccipr1 { usart1sel : self . usart1sel () , usart2sel : self . usart2sel () , usart3sel : self . usart3sel () , uart4sel : self . uart4sel () , uart5sel : self . uart5sel () , i2c1sel : self . i2c1sel () , i2c2sel : self . i2c2sel () , i2c4sel : self . i2c4sel () , spi2sel : self . spi2sel () , lptim2sel : self . lptim2sel () , spi1sel : self . spi1sel () , systicksel : self . systicksel () , fdcan1sel : self . fdcan1sel () , iclksel : self . iclksel () , timicsel : self . timicsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC peripherals independent clock configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ccipr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccipr2 { mdf1sel : super :: vals :: Mdfsel , sai1sel : super :: vals :: Saisel , sai2sel : super :: vals :: Saisel , saessel : super :: vals :: Saessel , rngsel : super :: vals :: Rngsel , sdmmcsel : super :: vals :: Sdmmcsel , dsisel : super :: vals :: Dsisel , usart6sel : super :: vals :: Usartsel , ltdcsel : super :: vals :: Ltdcsel , octospisel : super :: vals :: Octospisel , hspi1sel : super :: vals :: Hspisel , i2c5sel : super :: vals :: I2csel , i2c6sel : super :: vals :: I2csel , otghssel : super :: vals :: Otghssel , } let proxy = Ccipr2 { mdf1sel : self . mdf1sel () , sai1sel : self . sai1sel () , sai2sel : self . sai2sel () , saessel : self . saessel () , rngsel : self . rngsel () , sdmmcsel : self . sdmmcsel () , dsisel : self . dsisel () , usart6sel : self . usart6sel () , ltdcsel : self . ltdcsel () , octospisel : self . octospisel () , hspi1sel : self . hspi1sel () , i2c5sel : self . i2c5sel () , i2c6sel : self . i2c6sel () , otghssel : self . otghssel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC peripherals independent clock configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ccipr3 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ccipr3 { lpuart1sel : super :: vals :: Lpusartsel , spi3sel : super :: vals :: Spi3sel , i2c3sel : super :: vals :: I2c3sel , lptim34sel : super :: vals :: Lptimsel , lptim1sel : super :: vals :: Lptimsel , adcdacsel : super :: vals :: Adcdacsel , dac1sel : super :: vals :: Dacsel , adf1sel : super :: vals :: Adfsel , } let proxy = Ccipr3 { lpuart1sel : self . lpuart1sel () , spi3sel : self . spi3sel () , i2c3sel : self . i2c3sel () , lptim34sel : self . lptim34sel () , lptim1sel : self . lptim1sel () , adcdacsel : self . adcdacsel () , dac1sel : self . dac1sel () , adf1sel : self . adf1sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC clock configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfgr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfgr1 { sw : super :: vals :: Sw , sws : super :: vals :: Sw , stopwuck : super :: vals :: Stopwuck , stopkerwuck : super :: vals :: Stopkerwuck , mcosel : super :: vals :: Mcosel , mcopre : super :: vals :: Mcopre , } let proxy = Cfgr1 { sw : self . sw () , sws : self . sws () , stopwuck : self . stopwuck () , stopkerwuck : self . stopkerwuck () , mcosel : self . mcosel () , mcopre : self . mcopre () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC clock configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfgr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfgr2 { hpre : super :: vals :: Hpre , ppre1 : super :: vals :: Ppre , ppre2 : super :: vals :: Ppre , dpre : super :: vals :: Dpre , ahb1dis : bool , ahb2dis1 : bool , ahb2dis2 : bool , apb1dis : bool , apb2dis : bool , } let proxy = Cfgr2 { hpre : self . hpre () , ppre1 : self . ppre1 () , ppre2 : self . ppre2 () , dpre : self . dpre () , ahb1dis : self . ahb1dis () , ahb2dis1 : self . ahb2dis1 () , ahb2dis2 : self . ahb2dis2 () , apb1dis : self . apb1dis () , apb2dis : self . apb2dis () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC clock configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfgr3 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfgr3 { ppre3 : super :: vals :: Ppre , ahb3dis : bool , apb3dis : bool , } let proxy = Cfgr3 { ppre3 : self . ppre3 () , ahb3dis : self . ahb3dis () , apb3dis : self . apb3dis () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC clock interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cicr { Cicr (0) } } impl core :: fmt :: Debug for Cicr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cicr") . field ("lsirdyc" , & self . lsirdyc ()) . field ("lserdyc" , & self . lserdyc ()) . field ("msisrdyc" , & self . msisrdyc ()) . field ("hsirdyc" , & self . hsirdyc ()) . field ("hserdyc" , & self . hserdyc ()) . field ("hsi48rdyc" , & self . hsi48rdyc ()) . field ("pllrdyc" , & [self . pllrdyc (0usize) , self . pllrdyc (1usize) , self . pllrdyc (2usize) ,]) . field ("cssc" , & self . cssc ()) . field ("msikrdyc" , & self . msikrdyc ()) . field ("shsirdyc" , & self . shsirdyc ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cicr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cicr { lsirdyc : bool , lserdyc : bool , msisrdyc : bool , hsirdyc : bool , hserdyc : bool , hsi48rdyc : bool , pllrdyc : [bool ; 3usize]
, cssc : bool , msikrdyc : bool , shsirdyc : bool , } let proxy = Cicr { lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , msisrdyc : self . msisrdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , hsi48rdyc : self . hsi48rdyc () , pllrdyc : [self . pllrdyc (0usize) , self . pllrdyc (1usize) , self . pllrdyc (2usize) ,]
, cssc : self . cssc () , msikrdyc : self . msikrdyc () , shsirdyc : self . shsirdyc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cier { Cier (0) } } impl core :: fmt :: Debug for Cier { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cier") . field ("lsirdyie" , & self . lsirdyie ()) . field ("lserdyie" , & self . lserdyie ()) . field ("msisrdyie" , & self . msisrdyie ()) . field ("hsirdyie" , & self . hsirdyie ()) . field ("hserdyie" , & self . hserdyie ()) . field ("hsi48rdyie" , & self . hsi48rdyie ()) . field ("pllrdyie" , & [self . pllrdyie (0usize) , self . pllrdyie (1usize) , self . pllrdyie (2usize) ,]) . field ("msikrdyie" , & self . msikrdyie ()) . field ("shsirdyie" , & self . shsirdyie ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cier { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cier { lsirdyie : bool , lserdyie : bool , msisrdyie : bool , hsirdyie : bool , hserdyie : bool , hsi48rdyie : bool , pllrdyie : [bool ; 3usize]
, msikrdyie : bool , shsirdyie : bool , } let proxy = Cier { lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , msisrdyie : self . msisrdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , hsi48rdyie : self . hsi48rdyie () , pllrdyie : [self . pllrdyie (0usize) , self . pllrdyie (1usize) , self . pllrdyie (2usize) ,]
, msikrdyie : self . msikrdyie () , shsirdyie : self . shsirdyie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cifr { Cifr (0) } } impl core :: fmt :: Debug for Cifr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cifr") . field ("lsirdyf" , & self . lsirdyf ()) . field ("lserdyf" , & self . lserdyf ()) . field ("msisrdyf" , & self . msisrdyf ()) . field ("hsirdyf" , & self . hsirdyf ()) . field ("hserdyf" , & self . hserdyf ()) . field ("hsi48rdyf" , & self . hsi48rdyf ()) . field ("pllrdyf" , & [self . pllrdyf (0usize) , self . pllrdyf (1usize) , self . pllrdyf (2usize) ,]) . field ("cssf" , & self . cssf ()) . field ("msikrdyf" , & self . msikrdyf ()) . field ("shsirdyf" , & self . shsirdyf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cifr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cifr { lsirdyf : bool , lserdyf : bool , msisrdyf : bool , hsirdyf : bool , hserdyf : bool , hsi48rdyf : bool , pllrdyf : [bool ; 3usize]
, cssf : bool , msikrdyf : bool , shsirdyf : bool , } let proxy = Cifr { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , msisrdyf : self . msisrdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , hsi48rdyf : self . hsi48rdyf () , pllrdyf : [self . pllrdyf (0usize) , self . pllrdyf (1usize) , self . pllrdyf (2usize) ,]
, cssf : self . cssf () , msikrdyf : self . msikrdyf () , shsirdyf : self . shsirdyf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("msison" , & self . msison ()) . field ("msikeron" , & self . msikeron ()) . field ("msisrdy" , & self . msisrdy ()) . field ("msipllen" , & self . msipllen ()) . field ("msikon" , & self . msikon ()) . field ("msikrdy" , & self . msikrdy ()) . field ("msipllsel" , & self . msipllsel ()) . field ("msipllfast" , & self . msipllfast ()) . field ("hsion" , & self . hsion ()) . field ("hsikeron" , & self . hsikeron ()) . field ("hsirdy" , & self . hsirdy ()) . field ("hsi48on" , & self . hsi48on ()) . field ("hsi48rdy" , & self . hsi48rdy ()) . field ("shsion" , & self . shsion ()) . field ("shsirdy" , & self . shsirdy ()) . field ("hseon" , & self . hseon ()) . field ("hserdy" , & self . hserdy ()) . field ("hsebyp" , & self . hsebyp ()) . field ("csson" , & self . csson ()) . field ("hseext" , & self . hseext ()) . field ("pllon" , & [self . pllon (0usize) , self . pllon (1usize) , self . pllon (2usize) ,]) . field ("pllrdy" , & [self . pllrdy (0usize) , self . pllrdy (1usize) , self . pllrdy (2usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr { msison : bool , msikeron : bool , msisrdy : bool , msipllen : bool , msikon : bool , msikrdy : bool , msipllsel : super :: vals :: Msipllsel , msipllfast : super :: vals :: Msipllfast , hsion : bool , hsikeron : bool , hsirdy : bool , hsi48on : bool , hsi48rdy : bool , shsion : bool , shsirdy : bool , hseon : bool , hserdy : bool , hsebyp : bool , csson : bool , hseext : super :: vals :: Hseext , pllon : [bool ; 3usize]
, pllrdy : [bool ; 3usize]
, } let proxy = Cr { msison : self . msison () , msikeron : self . msikeron () , msisrdy : self . msisrdy () , msipllen : self . msipllen () , msikon : self . msikon () , msikrdy : self . msikrdy () , msipllsel : self . msipllsel () , msipllfast : self . msipllfast () , hsion : self . hsion () , hsikeron : self . hsikeron () , hsirdy : self . hsirdy () , hsi48on : self . hsi48on () , hsi48rdy : self . hsi48rdy () , shsion : self . shsion () , shsirdy : self . shsirdy () , hseon : self . hseon () , hserdy : self . hserdy () , hsebyp : self . hsebyp () , csson : self . csson () , hseext : self . hseext () , pllon : [self . pllon (0usize) , self . pllon (1usize) , self . pllon (2usize) ,]
...
struct Crrcr { hsi48cal : u16 , } let proxy = Crrcr { hsi48cal : self . hsi48cal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { msiksrange : super :: vals :: Msixsrange , msissrange : super :: vals :: Msixsrange , rmvf : bool , oblrstf : bool , pinrstf : bool , borrstf : bool , sftrstf : bool , iwdgrstf : bool , wwdgrstf : bool , lpwrrstf : bool , } let proxy = Csr { msiksrange : self . msiksrange () , msissrange : self . msissrange () , rmvf : self . rmvf () , oblrstf : self . oblrstf () , pinrstf : self . pinrstf () , borrstf : self . borrstf () , sftrstf : self . sftrstf () , iwdgrstf : self . iwdgrstf () , wwdgrstf : self . wwdgrstf () , lpwrrstf : self . lpwrrstf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC internal clock sources calibration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Icscr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Icscr1 { msical3 : u8 , msical2 : u8 , msical1 : u8 , msical0 : u8 , msibias : super :: vals :: Msibias , msirgsel : super :: vals :: Msirgsel , msikrange : super :: vals :: Msirange , msisrange : super :: vals :: Msirange , } let proxy = Icscr1 { msical3 : self . msical3 () , msical2 : self . msical2 () , msical1 : self . msical1 () , msical0 : self . msical0 () , msibias : self . msibias () , msirgsel : self . msirgsel () , msikrange : self . msikrange () , msisrange : self . msisrange () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC internal clock sources calibration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Icscr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Icscr2 { msitrim3 : u8 , msitrim2 : u8 , msitrim1 : u8 , msitrim0 : u8 , } let proxy = Icscr2 { msitrim3 : self . msitrim3 () , msitrim2 : self . msitrim2 () , msitrim1 : self . msitrim1 () , msitrim0 : self . msitrim0 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC internal clock sources calibration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Icscr3 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Icscr3 { hsical : u16 , hsitrim : u8 , } let proxy = Icscr3 { hsical : self . hsical () , hsitrim : self . hsitrim () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pll1cfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Pll1cfgr { pllsrc : super :: vals :: Pllsrc , pllrge : super :: vals :: Pllrge , pllfracen : bool , pllm : super :: vals :: Pllm , pllmboost : super :: vals :: Pllmboost , pllpen : bool , pllqen : bool , pllren : bool , } let proxy = Pll1cfgr { pllsrc : self . pllsrc () , pllrge : self . pllrge () , pllfracen : self . pllfracen () , pllm : self . pllm () , pllmboost : self . pllmboost () , pllpen : self . pllpen () , pllqen : self . pllqen () , pllren : self . pllren () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pll23cfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Pll23cfgr { pllsrc : super :: vals :: Pllsrc , pllrge : super :: vals :: Pllrge , pllfracen : bool , pllm : super :: vals :: Pllm , pllpen : bool , pllqen : bool , pllren : bool , } let proxy = Pll23cfgr { pllsrc : self . pllsrc () , pllrge : self . pllrge () , pllfracen : self . pllfracen () , pllm : self . pllm () , pllpen : self . pllpen () , pllqen : self . pllqen () , pllren : self . pllren () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC PLL1 dividers register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Plldivr { plln : super :: vals :: Plln , pllp : super :: vals :: Plldiv , pllq : super :: vals :: Plldiv , pllr : super :: vals :: Plldiv , } let proxy = Plldivr { plln : self . plln () , pllp : self . pllp () , pllq : self . pllq () , pllr : self . pllr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC PLL1 fractional divider register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pllfracr { pllfracn : u16 , } let proxy = Pllfracr { pllfracn : self . pllfracn () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC privilege configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Privcfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Privcfgr { spriv : bool , nspriv : bool , } let proxy = Privcfgr { spriv : self . spriv () , nspriv : self . nspriv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC secure configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Seccfgr { Seccfgr (0) } } impl core :: fmt :: Debug for Seccfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Seccfgr") . field ("hsisec" , & self . hsisec ()) . field ("hsesec" , & self . hsesec ()) . field ("msisec" , & self . msisec ()) . field ("lsisec" , & self . lsisec ()) . field ("lsesec" , & self . lsesec ()) . field ("sysclksec" , & self . sysclksec ()) . field ("prescsec" , & self . prescsec ()) . field ("pllsec" , & [self . pllsec (0usize) , self . pllsec (1usize) , self . pllsec (2usize) ,]) . field ("iclksec" , & self . iclksec ()) . field ("hsi48sec" , & self . hsi48sec ()) . field ("rmvfsec" , & self . rmvfsec ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Seccfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Seccfgr { hsisec : super :: vals :: Security , hsesec : super :: vals :: Security , msisec : super :: vals :: Security , lsisec : super :: vals :: Security , lsesec : super :: vals :: Security , sysclksec : super :: vals :: Security , prescsec : super :: vals :: Security , pllsec : [super :: vals :: Security ; 3usize]
, iclksec : super :: vals :: Security , hsi48sec : super :: vals :: Security , rmvfsec : super :: vals :: Security , } let proxy = Seccfgr { hsisec : self . hsisec () , hsesec : self . hsesec () , msisec : self . msisec () , lsisec : self . lsisec () , lsesec : self . lsesec () , sysclksec : self . sysclksec () , prescsec : self . prescsec () , pllsec : [self . pllsec (0usize) , self . pllsec (1usize) , self . pllsec (2usize) ,]
, iclksec : self . iclksec () , hsi48sec : self . hsi48sec () , rmvfsec : self . rmvfsec () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC SmartRun domain peripheral autonomous mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Srdamr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Srdamr { spi3amen : bool , lpuart1amen : bool , i2c3amen : bool , lptim1amen : bool , lptim3amen : bool , lptim4amen : bool , opampamen : bool , compamen : bool , vrefamen : bool , rtcapbamen : bool , adc4amen : bool , lpgpio1amen : bool , dac1amen : bool , lpdma1amen : bool , adf1amen : bool , sram4amen : bool , } let proxy = Srdamr { spi3amen : self . spi3amen () , lpuart1amen : self . lpuart1amen () , i2c3amen : self . i2c3amen () , lptim1amen : self . lptim1amen () , lptim3amen : self . lptim3amen () , lptim4amen : self . lptim4amen () , opampamen : self . opampamen () , compamen : self . compamen () , vrefamen : self . vrefamen () , rtcapbamen : self . rtcapbamen () , adc4amen : self . adc4amen () , lpgpio1amen : self . lpgpio1amen () , dac1amen : self . dac1amen () , lpdma1amen : self . lpdma1amen () , adf1amen : self . adf1amen () , sram4amen : self . sram4amen () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Argr { cmdarg : u32 , } let proxy = Argr { cmdarg : self . cmdarg () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SDI clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Clkcr { clkdiv : u8 , clken : bool , pwrsav : bool , bypass : bool , widbus : u8 , negedge : bool , hwfc_en : bool , } let proxy = Clkcr { clkdiv : self . clkdiv () , clken : self . clken () , pwrsav : self . pwrsav () , bypass : self . bypass () , widbus : self . widbus () , negedge : self . negedge () , hwfc_en : self . hwfc_en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "command register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cmdr { cmdindex : u8 , waitresp : u8 , waitint : bool , waitpend : bool , cpsmen : bool , sdiosuspend : bool , } let proxy = Cmdr { cmdindex : self . cmdindex () , waitresp : self . waitresp () , waitint : self . waitint () , waitpend : self . waitpend () , cpsmen : self . cpsmen () , sdiosuspend : self . sdiosuspend () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dcntr { datacount : u32 , } let proxy = Dcntr { datacount : self . datacount () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dctrl { dten : bool , dtdir : bool , dtmode : bool , dmaen : bool , dblocksize : u8 , rwstart : bool , rwstop : bool , rwmod : bool , sdioen : bool , } let proxy = Dctrl { dten : self . dten () , dtdir : self . dtdir () , dtmode : self . dtmode () , dmaen : self . dmaen () , dblocksize : self . dblocksize () , rwstart : self . rwstart () , rwstop : self . rwstop () , rwmod : self . rwmod () , sdioen : self . sdioen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data length register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dlenr { datalength : u32 , } let proxy = Dlenr { datalength : self . datalength () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data timer register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dtimer { datatime : u32 , } let proxy = Dtimer { datatime : self . datatime () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FIFO counter register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fifocnt { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Fifocnt { fifocount : u32 , } let proxy = Fifocnt { fifocount : self . fifocount () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data FIFO register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fifor { fifodata : u32 , } let proxy = Fifor { fifodata : self . fifodata () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Icr { ccrcfailc : bool , dcrcfailc : bool , ctimeoutc : bool , dtimeoutc : bool , txunderrc : bool , rxoverrc : bool , cmdrendc : bool , cmdsentc : bool , dataendc : bool , stbiterrc : bool , dbckendc : bool , sdioitc : bool , } let proxy = Icr { ccrcfailc : self . ccrcfailc () , dcrcfailc : self . dcrcfailc () , ctimeoutc : self . ctimeoutc () , dtimeoutc : self . dtimeoutc () , txunderrc : self . txunderrc () , rxoverrc : self . rxoverrc () , cmdrendc : self . cmdrendc () , cmdsentc : self . cmdsentc () , dataendc : self . dataendc () , stbiterrc : self . stbiterrc () , dbckendc : self . dbckendc () , sdioitc : self . sdioitc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "mask register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Maskr { ccrcfailie : bool , dcrcfailie : bool , ctimeoutie : bool , dtimeoutie : bool , txunderrie : bool , rxoverrie : bool , cmdrendie : bool , cmdsentie : bool , dataendie : bool , stbiterre : bool , dbckendie : bool , cmdactie : bool , txactie : bool , rxactie : bool , txfifoheie : bool , rxfifohfie : bool , txfifofie : bool , rxfifofie : bool , txfifoeie : bool , rxfifoeie : bool , txdavlie : bool , rxdavlie : bool , sdioitie : bool , } let proxy = Maskr { ccrcfailie : self . ccrcfailie () , dcrcfailie : self . dcrcfailie () , ctimeoutie : self . ctimeoutie () , dtimeoutie : self . dtimeoutie () , txunderrie : self . txunderrie () , rxoverrie : self . rxoverrie () , cmdrendie : self . cmdrendie () , cmdsentie : self . cmdsentie () , dataendie : self . dataendie () , stbiterre : self . stbiterre () , dbckendie : self . dbckendie () , cmdactie : self . cmdactie () , txactie : self . txactie () , rxactie : self . rxactie () , txfifoheie : self . txfifoheie () , rxfifohfie : self . rxfifohfie () , txfifofie : self . txfifofie () , rxfifofie : self . rxfifofie () , txfifoeie : self . txfifoeie () , rxfifoeie : self . rxfifoeie () , txdavlie : self . txdavlie () , rxdavlie : self . rxdavlie () , sdioitie : self . sdioitie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "power control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Power { pwrctrl : u8 , } let proxy = Power { pwrctrl : self . pwrctrl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "command response register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Respcmdr { respcmd : u8 , } let proxy = Respcmdr { respcmd : self . respcmd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "response 1..4 register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct RespxR { cardstatus : u32 , } let proxy = RespxR { cardstatus : self . cardstatus () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Star { ccrcfail : bool , dcrcfail : bool , ctimeout : bool , dtimeout : bool , txunderr : bool , rxoverr : bool , cmdrend : bool , cmdsent : bool , dataend : bool , stbiterr : bool , dbckend : bool , cmdact : bool , txact : bool , rxact : bool , txfifohe : bool , rxfifohf : bool , txfifof : bool , rxfifof : bool , txfifoe : bool , rxfifoe : bool , txdavl : bool , rxdavl : bool , sdioit : bool , } let proxy = Star { ccrcfail : self . ccrcfail () , dcrcfail : self . dcrcfail () , ctimeout : self . ctimeout () , dtimeout : self . dtimeout () , txunderr : self . txunderr () , rxoverr : self . rxoverr () , cmdrend : self . cmdrend () , cmdsent : self . cmdsent () , dataend : self . dataend () , stbiterr : self . stbiterr () , dbckend : self . dbckend () , cmdact : self . cmdact () , txact : self . txact () , rxact : self . rxact () , txfifohe : self . txfifohe () , rxfifohf : self . rxfifohf () , txfifof : self . txfifof () , rxfifof : self . rxfifof () , txfifoe : self . txfifoe () , rxfifoe : self . rxfifoe () , txdavl : self . txdavl () , rxdavl : self . rxdavl () , sdioit : self . sdioit () , } ; defmt :: write ! (f , "{}" , proxy) } } }
...
struct Ahbenr { dma1en : bool , dma2en : bool , sramen : bool , flashen : bool , crcen : bool , usb_otg_fsen : bool , ethen : bool , ethtxen : bool , ethrxen : bool , } let proxy = Ahbenr { dma1en : self . dma1en () , dma2en : self . dma2en () , sramen : self . sramen () , flashen : self . flashen () , crcen : self . crcen () , usb_otg_fsen : self . usb_otg_fsen () , ethen : self . ethen () , ethtxen : self . ethtxen () , ethrxen : self . ethrxen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB peripheral clock reset register (RCC_AHBRSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahbrstr { usb_otg_fsrst : bool , ethrst : bool , } let proxy = Ahbrstr { usb_otg_fsrst : self . usb_otg_fsrst () , ethrst : self . ethrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register (RCC_APB1ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , wwdgen : bool , spi2en : bool , spi3en : bool , usart2en : bool , usart3en : bool , uart4en : bool , uart5en : bool , i2c1en : bool , i2c2en : bool , can1en : bool , can2en : bool , bkpen : bool , pwren : bool , dacen : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , spi3en : self . spi3en () , usart2en : self . usart2en () , usart3en : self . usart3en () , uart4en : self . uart4en () , uart5en : self . uart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , can1en : self . can1en () , can2en : self . can2en () , bkpen : self . bkpen () , pwren : self . pwren () , dacen : self . dacen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register (RCC_APB1RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , wwdgrst : bool , spi2rst : bool , spi3rst : bool , usart2rst : bool , usart3rst : bool , uart4rst : bool , uart5rst : bool , i2c1rst : bool , i2c2rst : bool , can1rst : bool , can2rst : bool , bkprst : bool , pwrrst : bool , dacrst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , spi3rst : self . spi3rst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , uart4rst : self . uart4rst () , uart5rst : self . uart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , can1rst : self . can1rst () , can2rst : self . can2rst () , bkprst : self . bkprst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register (RCC_APB2ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { afioen : bool , gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , adc1en : bool , adc2en : bool , tim1en : bool , spi1en : bool , usart1en : bool , } let proxy = Apb2enr { afioen : self . afioen () , gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , adc1en : self . adc1en () , adc2en : self . adc2en () , tim1en : self . tim1en () , spi1en : self . spi1en () , usart1en : self . usart1en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register (RCC_APB2RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { afiorst : bool , gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiodrst : bool , gpioerst : bool , adc1rst : bool , adc2rst : bool , tim1rst : bool , spi1rst : bool , usart1rst : bool , } let proxy = Apb2rstr { afiorst : self . afiorst () , gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiodrst : self . gpiodrst () , gpioerst : self . gpioerst () , adc1rst : self . adc1rst () , adc2rst : self . adc2rst () , tim1rst : self . tim1rst () , spi1rst : self . spi1rst () , usart1rst : self . usart1rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register (RCC_BDCR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bdcr { lseon : bool , lserdy : bool , lsebyp : bool , rtcsel : super :: vals :: Rtcsel , rtcen : bool , bdrst : bool , } let proxy = Bdcr { lseon : self . lseon () , lserdy : self . lserdy () , lsebyp : self . lsebyp () , rtcsel : self . rtcsel () , rtcen : self . rtcen () , bdrst : self . bdrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register (RCC_CFGR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr { sw : super :: vals :: Sw , sws : super :: vals :: Sw , hpre : super :: vals :: Hpre , ppre1 : super :: vals :: Ppre , ppre2 : super :: vals :: Ppre , adcpre : super :: vals :: Adcpre , pllsrc : super :: vals :: Pllsrc , pllxtpre : super :: vals :: Pllxtpre , pllmul : super :: vals :: Pllmul , usbpre : super :: vals :: Usbpre , mcosel : super :: vals :: Mcosel , } let proxy = Cfgr { sw : self . sw () , sws : self . sws () , hpre : self . hpre () , ppre1 : self . ppre1 () , ppre2 : self . ppre2 () , adcpre : self . adcpre () , pllsrc : self . pllsrc () , pllxtpre : self . pllxtpre () , pllmul : self . pllmul () , usbpre : self . usbpre () , mcosel : self . mcosel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register2 (RCC_CFGR2)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { prediv1 : super :: vals :: Prediv1 , prediv2 : super :: vals :: Prediv1 , pll2mul : super :: vals :: Pll2mul , pll3mul : super :: vals :: Pll2mul , prediv1src : super :: vals :: Prediv1src , i2s2src : super :: vals :: I2s2src , i2s3src : super :: vals :: I2s2src , } let proxy = Cfgr2 { prediv1 : self . prediv1 () , prediv2 : self . prediv2 () , pll2mul : self . pll2mul () , pll3mul : self . pll3mul () , prediv1src : self . prediv1src () , i2s2src : self . i2s2src () , i2s3src : self . i2s3src () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt register (RCC_CIR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cir { lsirdyf : bool , lserdyf : bool , hsirdyf : bool , hserdyf : bool , pllrdyf : bool , pll2rdyf : bool , pll3rdyf : bool , cssf : bool , lsirdyie : bool , lserdyie : bool , hsirdyie : bool , hserdyie : bool , pllrdyie : bool , pll2rdyie : bool , pll3rdyie : bool , lsirdyc : bool , lserdyc : bool , hsirdyc : bool , hserdyc : bool , pllrdyc : bool , pll2rdyc : bool , pll3rdyc : bool , cssc : bool , } let proxy = Cir { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , pllrdyf : self . pllrdyf () , pll2rdyf : self . pll2rdyf () , pll3rdyf : self . pll3rdyf () , cssf : self . cssf () , lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , pllrdyie : self . pllrdyie () , pll2rdyie : self . pll2rdyie () , pll3rdyie : self . pll3rdyie () , lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , pllrdyc : self . pllrdyc () , pll2rdyc : self . pll2rdyc () , pll3rdyc : self . pll3rdyc () , cssc : self . cssc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { hsion : bool , hsirdy : bool , hsitrim : u8 , hsical : u8 , hseon : bool , hserdy : bool , hsebyp : bool , csson : bool , pllon : bool , pllrdy : bool , pll2on : bool , pll2rdy : bool , pll3on : bool , pll3rdy : bool , } let proxy = Cr { hsion : self . hsion () , hsirdy : self . hsirdy () , hsitrim : self . hsitrim () , hsical : self . hsical () , hseon : self . hseon () , hserdy : self . hserdy () , hsebyp : self . hsebyp () , csson : self . csson () , pllon : self . pllon () , pllrdy : self . pllrdy () , pll2on : self . pll2on () , pll2rdy : self . pll2rdy () , pll3on : self . pll3on () , pll3rdy : self . pll3rdy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control/status register (RCC_CSR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { lsion : bool , lsirdy : bool , rmvf : bool , pinrstf : bool , porrstf : bool , sftrstf : bool , iwdgrstf : bool , wwdgrstf : bool , lpwrrstf : bool , } let proxy = Csr { lsion : self . lsion () , lsirdy : self . lsirdy () , rmvf : self . rmvf () , pinrstf : self . pinrstf () , porrstf : self . porrstf () , sftrstf : self . sftrstf () , iwdgrstf : self . iwdgrstf () , wwdgrstf : self . wwdgrstf () , lpwrrstf : self . lpwrrstf () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

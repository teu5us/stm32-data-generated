...
struct Cfgr { dmaen : bool , dmacfg : super :: vals :: Dmacfg , res : super :: vals :: Res , align : bool , extsel : u8 , exten : u8 , ovrmod : bool , cont : bool , autdly : bool , autoff : bool , discen : bool , discnum : u8 , jdiscen : bool , jqm : bool , awd1sgl : bool , awd1en : bool , jawd1en : bool , jauto : bool , awdch1ch : u8 , } let proxy = Cfgr { dmaen : self . dmaen () , dmacfg : self . dmacfg () , res : self . res () , align : self . align () , extsel : self . extsel () , exten : self . exten () , ovrmod : self . ovrmod () , cont : self . cont () , autdly : self . autdly () , autoff : self . autoff () , discen : self . discen () , discnum : self . discnum () , jdiscen : self . jdiscen () , jqm : self . jqm () , awd1sgl : self . awd1sgl () , awd1en : self . awd1en () , jawd1en : self . jawd1en () , jauto : self . jauto () , awdch1ch : self . awdch1ch () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { rovse : bool , jovse : bool , ovsr : u8 , ovss : u8 , tovs : bool , rovsm : bool , } let proxy = Cfgr2 { rovse : self . rovse () , jovse : self . jovse () , ovsr : self . ovsr () , ovss : self . ovss () , tovs : self . tovs () , rovsm : self . rovsm () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Difsel { difsel_1_15 : u16 , difsel_16_18 : u8 , } let proxy = Difsel { difsel_1_15 : self . difsel_1_15 () , difsel_16_18 : self . difsel_16_18 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { regular_data : u16 , } let proxy = Dr { regular_data : self . regular_data () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ofr { offset : u16 , offset_ch : u8 , offset_en : bool , } let proxy = Ofr { offset : self . offset () , offset_ch : self . offset_ch () , offset_en : self . offset_en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample time register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Tr { lt : u16 , ht : u16 , } let proxy = Tr { lt : self . lt () , ht : self . ht () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Cfgr1 { en : bool , brgen : bool , scalen : bool , polarity : bool , iten : bool , hyst : super :: vals :: Hyst , pwrmode : super :: vals :: Pwrmode , inmsel : super :: vals :: Inmsel , inpsel : super :: vals :: Inpsel , blanking : super :: vals :: Blanking , lock : bool , } let proxy = Cfgr1 { en : self . en () , brgen : self . brgen () , scalen : self . scalen () , polarity : self . polarity () , iten : self . iten () , hyst : self . hyst () , pwrmode : self . pwrmode () , inmsel : self . inmsel () , inpsel : self . inpsel () , blanking : self . blanking () , lock : self . lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Comparator configuration register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { en : bool , brgen : bool , scalen : bool , polarity : bool , winmode : bool , iten : bool , hyst : super :: vals :: Hyst , pwrmode : super :: vals :: Pwrmode , inmsel : super :: vals :: Inmsel , inpsel : super :: vals :: Inpsel , blanking : super :: vals :: Blanking , lock : bool , } let proxy = Cfgr2 { en : self . en () , brgen : self . brgen () , scalen : self . scalen () , polarity : self . polarity () , winmode : self . winmode () , iten : self . iten () , hyst : self . hyst () , pwrmode : self . pwrmode () , inmsel : self . inmsel () , inpsel : self . inpsel () , blanking : self . blanking () , lock : self . lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Comparator interrupt clear flag register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icfr { Icfr (0) } } impl core :: fmt :: Debug for Icfr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icfr") . field ("ccif" , & [self . ccif (0usize) , self . ccif (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icfr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Icfr { ccif : [bool ; 2usize]
, } let proxy = Icfr { ccif : [self . ccif (0usize) , self . ccif (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Comparator option register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Or { afop : u16 , } let proxy = Or { afop : self . afop () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Comparator status register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("cval" , & [self . cval (0usize) , self . cval (1usize) ,]) . field ("cif" , & [self . cif (0usize) , self . cif (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr { cval : [bool ; 2usize]
, cif : [bool ; 2usize]
, } let proxy = Sr { cval : [self . cval (0usize) , self . cval (1usize) ,]

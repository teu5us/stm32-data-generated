...
struct Optcr { optlock : bool , optstrt : bool , bor_lev : u8 , wdg_sw : bool , n_rst_stop : bool , n_rst_stdby : bool , rdp : u8 , n_wrp : u16 , } let proxy = Optcr { optlock : self . optlock () , optstrt : self . optstrt () , bor_lev : self . bor_lev () , wdg_sw : self . wdg_sw () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , rdp : self . rdp () , n_wrp : self . n_wrp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

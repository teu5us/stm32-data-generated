...
impl defmt :: Format for Awcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Awcr { aah : u16 , aaw : u16 , } let proxy = Awcr { aah : self . aah () , aaw : self . aaw () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Background Color Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bccr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Bccr { bcblue : u8 , bcgreen : u8 , bcred : u8 , } let proxy = Bccr { bcblue : self . bcblue () , bcgreen : self . bcgreen () , bcred : self . bcred () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Blending Factors Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bfcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Bfcr { bf2 : super :: vals :: Bf2 , bf1 : super :: vals :: Bf1 , } let proxy = Bfcr { bf2 : self . bf2 () , bf1 : self . bf1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Back Porch Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bpcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Bpcr { avbp : u16 , ahbp : u16 , } let proxy = Bpcr { avbp : self . avbp () , ahbp : self . ahbp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Constant Alpha Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cacr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cacr { consta : u8 , } let proxy = Cacr { consta : self . consta () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Current Display Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cdsr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cdsr { vdes : bool , hdes : bool , vsyncs : bool , hsyncs : bool , } let proxy = Cdsr { vdes : self . vdes () , hdes : self . hdes () , vsyncs : self . vsyncs () , hsyncs : self . hsyncs () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Color Frame Buffer Address Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfbar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfbar { cfbadd : u32 , } let proxy = Cfbar { cfbadd : self . cfbadd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx ColorFrame Buffer Line Number Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfblnr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfblnr { cfblnbr : u16 , } let proxy = Cfblnr { cfblnbr : self . cfblnbr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Color Frame Buffer Length Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfblr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfblr { cfbll : u16 , cfbp : u16 , } let proxy = Cfblr { cfbll : self . cfbll () , cfbp : self . cfbp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Color Keying Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ckcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ckcr { ckblue : u8 , ckgreen : u8 , ckred : u8 , } let proxy = Ckcr { ckblue : self . ckblue () , ckgreen : self . ckgreen () , ckred : self . ckred () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx CLUT Write Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Clutwr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Clutwr { blue : u8 , green : u8 , red : u8 , clutadd : u8 , } let proxy = Clutwr { blue : self . blue () , green : self . green () , red : self . red () , clutadd : self . clutadd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Current Position Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cpsr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cpsr { cypos : u16 , cxpos : u16 , } let proxy = Cpsr { cypos : self . cypos () , cxpos : self . cxpos () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Control Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { len : bool , colken : bool , cluten : bool , } let proxy = Cr { len : self . len () , colken : self . colken () , cluten : self . cluten () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Default Color Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dccr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dccr { dcblue : u8 , dcgreen : u8 , dcred : u8 , dcalpha : u8 , } let proxy = Dccr { dcblue : self . dcblue () , dcgreen : self . dcgreen () , dcred : self . dcred () , dcalpha : self . dcalpha () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Global Control Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Gcr { ltdcen : bool , dbw : u8 , dgw : u8 , drw : u8 , den : bool , pcpol : super :: vals :: Pcpol , depol : super :: vals :: Depol , vspol : super :: vals :: Vspol , hspol : super :: vals :: Hspol , } let proxy = Gcr { ltdcen : self . ltdcen () , dbw : self . dbw () , dgw : self . dgw () , drw : self . drw () , den : self . den () , pcpol : self . pcpol () , depol : self . depol () , vspol : self . vspol () , hspol : self . hspol () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt Clear Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Icr { clif : super :: vals :: Clif , cfuif : super :: vals :: Cfuif , cterrif : super :: vals :: Cterrif , crrif : super :: vals :: Crrif , } let proxy = Icr { clif : self . clif () , cfuif : self . cfuif () , cterrif : self . cterrif () , crrif : self . crrif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt Enable Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ier { lie : bool , fuie : bool , terrie : bool , rrie : bool , } let proxy = Ier { lie : self . lie () , fuie : self . fuie () , terrie : self . terrie () , rrie : self . rrie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Isr { lif : bool , fuif : bool , terrif : bool , rrif : bool , } let proxy = Isr { lif : self . lif () , fuif : self . fuif () , terrif : self . terrif () , rrif : self . rrif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Line Interrupt Position Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Lipcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Lipcr { lipos : u16 , } let proxy = Lipcr { lipos : self . lipos () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Pixel Format Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pfcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Pfcr { pf : super :: vals :: Pf , } let proxy = Pfcr { pf : self . pf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Shadow Reload Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Srcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Srcr { imr : super :: vals :: Imr , vbr : super :: vals :: Vbr , } let proxy = Srcr { imr : self . imr () , vbr : self . vbr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Synchronization Size Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Sscr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sscr { vsh : u16 , hsw : u16 , } let proxy = Sscr { vsh : self . vsh () , hsw : self . hsw () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Total Width Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Twcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Twcr { totalh : u16 , totalw : u16 , } let proxy = Twcr { totalh : self . totalh () , totalw : self . totalw () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Window Horizontal Position Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Whpcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Whpcr { whstpos : u16 , whsppos : u16 , } let proxy = Whpcr { whstpos : self . whstpos () , whsppos : self . whsppos () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Layerx Window Vertical Position Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Wvpcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Wvpcr { wvstpos : u16 , wvsppos : u16 , } let proxy = Wvpcr { wvstpos : self . wvstpos () , wvsppos : self . wvsppos () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Ccr { dual : super :: vals :: Dual , delay : u8 , dmacfg : super :: vals :: Dmacfg , mdma : super :: vals :: Mdma , ckmode : super :: vals :: Ckmode , vrefen : bool , tsen : bool , vbaten : bool , } let proxy = Ccr { dual : self . dual () , delay : self . delay () , dmacfg : self . dmacfg () , mdma : self . mdma () , ckmode : self . ckmode () , vrefen : self . vrefen () , tsen : self . tsen () , vbaten : self . vbaten () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC common regular data register for dual and triple modes"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cdr { rdata_mst : u16 , rdata_slv : u16 , } let proxy = Cdr { rdata_mst : self . rdata_mst () , rdata_slv : self . rdata_slv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("adrdy_mst" , & self . adrdy_mst ()) . field ("eosmp_mst" , & self . eosmp_mst ()) . field ("eoc_mst" , & self . eoc_mst ()) . field ("eos_mst" , & self . eos_mst ()) . field ("ovr_mst" , & self . ovr_mst ()) . field ("jeoc_mst" , & self . jeoc_mst ()) . field ("jeos" , & self . jeos ()) . field ("awd_mst" , & [self . awd_mst (0usize) , self . awd_mst (1usize) , self . awd_mst (2usize) ,]) . field ("jqovf_mst" , & self . jqovf_mst ()) . field ("adrdy_slv" , & self . adrdy_slv ()) . field ("eosmp_slv" , & self . eosmp_slv ()) . field ("eoc_slv" , & self . eoc_slv ()) . field ("eos_slv" , & self . eos_slv ()) . field ("ovr_slv" , & self . ovr_slv ()) . field ("jeoc_slv" , & self . jeoc_slv ()) . field ("jeos_slv" , & self . jeos_slv ()) . field ("awd_slv" , & [self . awd_slv (0usize) , self . awd_slv (1usize) , self . awd_slv (2usize) ,]) . field ("jqovf_slv" , & self . jqovf_slv ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Csr { adrdy_mst : bool , eosmp_mst : bool , eoc_mst : bool , eos_mst : bool , ovr_mst : bool , jeoc_mst : bool , jeos : bool , awd_mst : [bool ; 3usize]
...
, jqovf_slv : bool , } let proxy = Csr { adrdy_mst : self . adrdy_mst () , eosmp_mst : self . eosmp_mst () , eoc_mst : self . eoc_mst () , eos_mst : self . eos_mst () , ovr_mst : self . ovr_mst () , jeoc_mst : self . jeoc_mst () , jeos : self . jeos () , awd_mst : [self . awd_mst (0usize) , self . awd_mst (1usize) , self . awd_mst (2usize) ,]
...
, jqovf_slv : self . jqovf_slv () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [doc = "ADC clock mode"]
# [repr (u8)]

...
struct Ahb3rstr { mdmarst : bool , dma2drst : bool , jpgdecrst : bool , fmcrst : bool , quadspirst : bool , sdmmc1rst : bool , octospi2rst : bool , iomngrrst : bool , otfd1rst : bool , otfd2rst : bool , cpurst : bool , } let proxy = Ahb3rstr { mdmarst : self . mdmarst () , dma2drst : self . dma2drst () , jpgdecrst : self . jpgdecrst () , fmcrst : self . fmcrst () , quadspirst : self . quadspirst () , sdmmc1rst : self . sdmmc1rst () , octospi2rst : self . octospi2rst () , iomngrrst : self . iomngrrst () , otfd1rst : self . otfd1rst () , otfd2rst : self . otfd2rst () , cpurst : self . cpurst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB4 Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct D1ccipr { fmcsel : super :: vals :: Fmcsel , quadspisel : super :: vals :: Fmcsel , sdmmcsel : super :: vals :: Sdmmcsel , persel : super :: vals :: Persel , } let proxy = D1ccipr { fmcsel : self . fmcsel () , quadspisel : self . quadspisel () , sdmmcsel : self . sdmmcsel () , persel : self . persel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC Domain 1 Clock Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

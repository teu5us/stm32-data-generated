...
struct Ccr { mult : u8 , delay : u8 , dmacfg : super :: vals :: Dmacfg , mdma : u8 , ckmode : u8 , vrefen : bool , ch18sel : bool , ch17sel : bool , } let proxy = Ccr { mult : self . mult () , delay : self . delay () , dmacfg : self . dmacfg () , mdma : self . mdma () , ckmode : self . ckmode () , vrefen : self . vrefen () , ch18sel : self . ch18sel () , ch17sel : self . ch17sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC common regular data register for dual and triple modes"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cdr { rdata_mst : u16 , rdata_slv : u16 , } let proxy = Cdr { rdata_mst : self . rdata_mst () , rdata_slv : self . rdata_slv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC Common status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { addrdy_mst : bool , eosmp_mst : bool , eoc_mst : bool , eos_mst : bool , ovr_mst : bool , jeoc_mst : bool , jeos_mst : bool , awd_mst : [bool ; 3usize]
...
, jqovf_slv : bool , } let proxy = Csr { addrdy_mst : self . addrdy_mst () , eosmp_mst : self . eosmp_mst () , eoc_mst : self . eoc_mst () , eos_mst : self . eos_mst () , ovr_mst : self . ovr_mst () , jeoc_mst : self . jeoc_mst () , jeos_mst : self . jeos_mst () , awd_mst : [self . awd_mst (0usize) , self . awd_mst (1usize) , self . awd_mst (2usize) ,]

...
struct Ccr { multi : super :: vals :: Multi , delay : u8 , dds : super :: vals :: Dds , dma : super :: vals :: Dma , adcpre : super :: vals :: Adcpre , vbate : bool , tsvrefe : bool , } let proxy = Ccr { multi : self . multi () , delay : self . delay () , dds : self . dds () , dma : self . dma () , adcpre : self . adcpre () , vbate : self . vbate () , tsvrefe : self . tsvrefe () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC common regular data register for dual and triple modes"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cdr { Cdr (0) } } impl core :: fmt :: Debug for Cdr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cdr") . field ("data" , & [self . data (0usize) , self . data (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cdr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cdr { data : [u16 ; 2usize]
, } let proxy = Cdr { data : [self . data (0usize) , self . data (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC common status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Csr { Csr (0) } } impl core :: fmt :: Debug for Csr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Csr") . field ("awd" , & [self . awd (0usize) , self . awd (1usize) , self . awd (2usize) ,]) . field ("eoc" , & [self . eoc (0usize) , self . eoc (1usize) , self . eoc (2usize) ,]) . field ("jeoc" , & [self . jeoc (0usize) , self . jeoc (1usize) , self . jeoc (2usize) ,]) . field ("jstrt" , & [self . jstrt (0usize) , self . jstrt (1usize) , self . jstrt (2usize) ,]) . field ("strt" , & [self . strt (0usize) , self . strt (1usize) , self . strt (2usize) ,]) . field ("ovr" , & [self . ovr (0usize) , self . ovr (1usize) , self . ovr (2usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Csr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Csr { awd : [bool ; 3usize]
, eoc : [bool ; 3usize]
, jeoc : [bool ; 3usize]
, jstrt : [bool ; 3usize]
, strt : [bool ; 3usize]
, ovr : [bool ; 3usize]
, } let proxy = Csr { awd : [self . awd (0usize) , self . awd (1usize) , self . awd (2usize) ,]

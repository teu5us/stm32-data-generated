...
struct Cr { lpds : bool , pdds : super :: vals :: Pdds , cwuf : bool , csbf : bool , pvde : bool , pls : u8 , dbp : bool , fpds : bool , } let proxy = Cr { lpds : self . lpds () , pdds : self . pdds () , cwuf : self . cwuf () , csbf : self . csbf () , pvde : self . pvde () , pls : self . pls () , dbp : self . dbp () , fpds : self . fpds () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "power control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { wuf : bool , sbf : bool , pvdo : bool , brr : bool , ewup : bool , bre : bool , } let proxy = Csr { wuf : self . wuf () , sbf : self . sbf () , pvdo : self . pvdo () , brr : self . brr () , ewup : self . ewup () , bre : self . bre () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

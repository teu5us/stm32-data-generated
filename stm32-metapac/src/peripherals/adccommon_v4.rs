...
struct Ccr { dual : super :: vals :: Dual , delay : u8 , damdf : super :: vals :: Damdf , ckmode : super :: vals :: Ckmode , presc : super :: vals :: Presc , vrefen : bool , vsenseen : bool , vbaten : bool , } let proxy = Ccr { dual : self . dual () , delay : self . delay () , damdf : self . damdf () , ckmode : self . ckmode () , presc : self . presc () , vrefen : self . vrefen () , vsenseen : self . vsenseen () , vbaten : self . vbaten () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC common regular data register for dual and triple modes"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cdr { rdata_mst : u16 , rdata_slv : u16 , } let proxy = Cdr { rdata_mst : self . rdata_mst () , rdata_slv : self . rdata_slv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ADC x common regular data register for 32-bit dual mode"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, jqovf_slv : self . jqovf_slv () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Ccipr { usart1sel : super :: vals :: Usart1sel , usart2sel : super :: vals :: Uartsel , lpuart1sel : super :: vals :: Uartsel , i2c1sel : super :: vals :: I2csel , i2c3sel : super :: vals :: I2csel , lptim1sel : super :: vals :: Lptimsel , } let proxy = Ccipr { usart1sel : self . usart1sel () , usart2sel : self . usart2sel () , lpuart1sel : self . lpuart1sel () , i2c1sel : self . i2c1sel () , i2c3sel : self . i2c3sel () , lptim1sel : self . lptim1sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cicr { lsirdyc : bool , lserdyc : bool , hsirdyc : bool , hserdyc : bool , pllrdyc : bool , msirdyc : bool , csslsec : bool , csshsec : bool , } let proxy = Cicr { lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , pllrdyc : self . pllrdyc () , msirdyc : self . msirdyc () , csslsec : self . csslsec () , csshsec : self . csshsec () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cier { lsirdyie : bool , lserdyie : bool , hsirdyie : bool , hserdyie : bool , pllrdyie : bool , msirdyie : bool , csslse : bool , } let proxy = Cier { lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , pllrdyie : self . pllrdyie () , msirdyie : self . msirdyie () , csslse : self . csslse () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cifr { lsirdyf : bool , lserdyf : bool , hsirdyf : bool , hserdyf : bool , pllrdyf : bool , msirdyf : bool , csslsef : bool , csshsef : bool , } let proxy = Cifr { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , pllrdyf : self . pllrdyf () , msirdyf : self . msirdyf () , csslsef : self . csslsef () , csshsef : self . csshsef () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
struct Cr1 { awdch : u8 , eocie : bool , awdie : bool , jeocie : bool , scan : bool , awdsgl : bool , jauto : bool , discen : bool , jdiscen : bool , discnum : super :: vals :: Discnum , jawden : bool , awden : bool , } let proxy = Cr1 { awdch : self . awdch () , eocie : self . eocie () , awdie : self . awdie () , jeocie : self . jeocie () , scan : self . scan () , awdsgl : self . awdsgl () , jauto : self . jauto () , discen : self . discen () , jdiscen : self . jdiscen () , discnum : self . discnum () , jawden : self . jawden () , awden : self . awden () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { adon : bool , cont : bool , cal : bool , rstcal : bool , dma : bool , align : bool , jextsel : u8 , jexttrig : bool , extsel : u8 , exttrig : bool , jswstart : bool , swstart : bool , tsvrefe : bool , } let proxy = Cr2 { adon : self . adon () , cont : self . cont () , cal : self . cal () , rstcal : self . rstcal () , dma : self . dma () , align : self . align () , jextsel : self . jextsel () , jexttrig : self . jexttrig () , extsel : self . extsel () , exttrig : self . exttrig () , jswstart : self . jswstart () , swstart : self . swstart () , tsvrefe : self . tsvrefe () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { data : u16 , } let proxy = Dr { data : self . data () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog higher threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Htr { ht : u16 , } let proxy = Htr { ht : self . ht () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected data register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jdr1 { jdata1 : u16 , } let proxy = Jdr1 { jdata1 : self . jdata1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected data register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jdr2 { jdata2 : u16 , } let proxy = Jdr2 { jdata2 : self . jdata2 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected data register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jdr3 { jdata3 : u16 , } let proxy = Jdr3 { jdata3 : self . jdata3 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected data register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jdr4 { jdata4 : u16 , } let proxy = Jdr4 { jdata4 : self . jdata4 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected channel data offset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jofr1 { joffset1 : u16 , } let proxy = Jofr1 { joffset1 : self . joffset1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected channel data offset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jofr2 { joffset2 : u16 , } let proxy = Jofr2 { joffset2 : self . joffset2 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected channel data offset register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jofr3 { joffset3 : u16 , } let proxy = Jofr3 { joffset3 : self . joffset3 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected channel data offset register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ltr { lt : u16 , } let proxy = Ltr { lt : self . lt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample time register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Smpr1 { smp10 : super :: vals :: SampleTime , smp11 : super :: vals :: SampleTime , smp12 : super :: vals :: SampleTime , smp13 : super :: vals :: SampleTime , smp14 : super :: vals :: SampleTime , smp15 : super :: vals :: SampleTime , smp16 : super :: vals :: SampleTime , smp17 : super :: vals :: SampleTime , smp18 : super :: vals :: SampleTime , } let proxy = Smpr1 { smp10 : self . smp10 () , smp11 : self . smp11 () , smp12 : self . smp12 () , smp13 : self . smp13 () , smp14 : self . smp14 () , smp15 : self . smp15 () , smp16 : self . smp16 () , smp17 : self . smp17 () , smp18 : self . smp18 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample time register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Smpr2 { smp0 : super :: vals :: SampleTime , smp1 : super :: vals :: SampleTime , smp2 : super :: vals :: SampleTime , smp3 : super :: vals :: SampleTime , smp4 : super :: vals :: SampleTime , smp5 : super :: vals :: SampleTime , smp6 : super :: vals :: SampleTime , smp7 : super :: vals :: SampleTime , smp8 : super :: vals :: SampleTime , smp9 : super :: vals :: SampleTime , } let proxy = Smpr2 { smp0 : self . smp0 () , smp1 : self . smp1 () , smp2 : self . smp2 () , smp3 : self . smp3 () , smp4 : self . smp4 () , smp5 : self . smp5 () , smp6 : self . smp6 () , smp7 : self . smp7 () , smp8 : self . smp8 () , smp9 : self . smp9 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sqr1 { sq13 : u8 , sq14 : u8 , sq15 : u8 , sq16 : u8 , l : u8 , } let proxy = Sqr1 { sq13 : self . sq13 () , sq14 : self . sq14 () , sq15 : self . sq15 () , sq16 : self . sq16 () , l : self . l () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sqr2 { sq7 : u8 , sq8 : u8 , sq9 : u8 , sq10 : u8 , sq11 : u8 , sq12 : u8 , } let proxy = Sqr2 { sq7 : self . sq7 () , sq8 : self . sq8 () , sq9 : self . sq9 () , sq10 : self . sq10 () , sq11 : self . sq11 () , sq12 : self . sq12 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sqr3 { sq1 : u8 , sq2 : u8 , sq3 : u8 , sq4 : u8 , sq5 : u8 , sq6 : u8 , } let proxy = Sqr3 { sq1 : self . sq1 () , sq2 : self . sq2 () , sq3 : self . sq3 () , sq4 : self . sq4 () , sq5 : self . sq5 () , sq6 : self . sq6 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { awd : bool , eoc : bool , jeoc : bool , jstrt : bool , strt : bool , ovr : bool , } let proxy = Sr { awd : self . awd () , eoc : self . eoc () , jeoc : self . jeoc () , jstrt : self . jstrt () , strt : self . strt () , ovr : self . ovr () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

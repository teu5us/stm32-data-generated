...
struct Ahb1enr { dma1en : bool , dma2en : bool , dmamux1en : bool , crcen : bool , } let proxy = Ahb1enr { dma1en : self . dma1en () , dma2en : self . dma2en () , dmamux1en : self . dmamux1en () , crcen : self . crcen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb1rstr { dma1rst : bool , dma2rst : bool , dmamux1rst : bool , crcrst : bool , } let proxy = Ahb1rstr { dma1rst : self . dma1rst () , dma2rst : self . dma2rst () , dmamux1rst : self . dmamux1rst () , crcrst : self . crcrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB1 peripheral clocks enable in Sleep modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb1smenr { dma1smen : bool , dma2smen : bool , dmamux1smen : bool , crcsmen : bool , } let proxy = Ahb1smenr { dma1smen : self . dma1smen () , dma2smen : self . dma2smen () , dmamux1smen : self . dmamux1smen () , crcsmen : self . crcsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2enr { gpioaen : bool , gpioben : bool , gpiocen : bool , gpiohen : bool , } let proxy = Ahb2enr { gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpiohen : self . gpiohen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2rstr { gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiohrst : bool , } let proxy = Ahb2rstr { gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiohrst : self . gpiohrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral clocks enable in Sleep modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2smenr { gpioasmen : bool , gpiobsmen : bool , gpiocsmen : bool , gpiohsmen : bool , } let proxy = Ahb2smenr { gpioasmen : self . gpioasmen () , gpiobsmen : self . gpiobsmen () , gpiocsmen : self . gpiocsmen () , gpiohsmen : self . gpiohsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3enr { pkaen : bool , aesen : bool , rngen : bool , hsemen : bool , ipccen : bool , flashen : bool , } let proxy = Ahb3enr { pkaen : self . pkaen () , aesen : self . aesen () , rngen : self . rngen () , hsemen : self . hsemen () , ipccen : self . ipccen () , flashen : self . flashen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3rstr { pkarst : bool , aesrst : bool , rngrst : bool , hsemrst : bool , ipccrst : bool , flashrst : bool , } let proxy = Ahb3rstr { pkarst : self . pkarst () , aesrst : self . aesrst () , rngrst : self . rngrst () , hsemrst : self . hsemrst () , ipccrst : self . ipccrst () , flashrst : self . flashrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3smenr { pkasmen : bool , aessmen : bool , rngsmen : bool , sram1smen : bool , sram2smen : bool , flashsmen : bool , } let proxy = Ahb3smenr { pkasmen : self . pkasmen () , aessmen : self . aessmen () , rngsmen : self . rngsmen () , sram1smen : self . sram1smen () , sram2smen : self . sram2smen () , flashsmen : self . flashsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr1 { tim2en : bool , rtcapben : bool , wwdgen : bool , spi2en : bool , usart2en : bool , i2c1en : bool , i2c2en : bool , i2c3en : bool , dacen : bool , lptim1en : bool , } let proxy = Apb1enr1 { tim2en : self . tim2en () , rtcapben : self . rtcapben () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , usart2en : self . usart2en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , i2c3en : self . i2c3en () , dacen : self . dacen () , lptim1en : self . lptim1en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr2 { lpuart1en : bool , lptim2en : bool , lptim3en : bool , } let proxy = Apb1enr2 { lpuart1en : self . lpuart1en () , lptim2en : self . lptim2en () , lptim3en : self . lptim3en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr1 { tim2rst : bool , spi2rst : bool , usart2rst : bool , i2c1rst : bool , i2c2rst : bool , i2c3rst : bool , dacrst : bool , lptim1rst : bool , } let proxy = Apb1rstr1 { tim2rst : self . tim2rst () , spi2rst : self . spi2rst () , usart2rst : self . usart2rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , i2c3rst : self . i2c3rst () , dacrst : self . dacrst () , lptim1rst : self . lptim1rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr2 { lpuart1rst : bool , lptim2rst : bool , lptim3rst : bool , } let proxy = Apb1rstr2 { lpuart1rst : self . lpuart1rst () , lptim2rst : self . lptim2rst () , lptim3rst : self . lptim3rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clocks enable in Sleep mode register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1smenr1 { tim2smen : bool , rtcapbsmen : bool , wwdgsmen : bool , spi2smen : bool , usart2smen : bool , i2c1smen : bool , i2c2smen : bool , i2c3smen : bool , dacsmen : bool , lptim1smen : bool , } let proxy = Apb1smenr1 { tim2smen : self . tim2smen () , rtcapbsmen : self . rtcapbsmen () , wwdgsmen : self . wwdgsmen () , spi2smen : self . spi2smen () , usart2smen : self . usart2smen () , i2c1smen : self . i2c1smen () , i2c2smen : self . i2c2smen () , i2c3smen : self . i2c3smen () , dacsmen : self . dacsmen () , lptim1smen : self . lptim1smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clocks enable in Sleep mode register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1smenr2 { lpuart1smen : bool , lptim2smen : bool , lptim3smen : bool , } let proxy = Apb1smenr2 { lpuart1smen : self . lpuart1smen () , lptim2smen : self . lptim2smen () , lptim3smen : self . lptim3smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { adcen : bool , tim1en : bool , spi1en : bool , usart1en : bool , tim16en : bool , tim17en : bool , } let proxy = Apb2enr { adcen : self . adcen () , tim1en : self . tim1en () , spi1en : self . spi1en () , usart1en : self . usart1en () , tim16en : self . tim16en () , tim17en : self . tim17en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { adcrst : bool , tim1rst : bool , spi1rst : bool , usart1rst : bool , tim16rst : bool , tim17rst : bool , } let proxy = Apb2rstr { adcrst : self . adcrst () , tim1rst : self . tim1rst () , spi1rst : self . spi1rst () , usart1rst : self . usart1rst () , tim16rst : self . tim16rst () , tim17rst : self . tim17rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clocks enable in Sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2smenr { adcsmen : bool , tim1smen : bool , spi1smen : bool , usart1smen : bool , tim16smen : bool , tim17smen : bool , } let proxy = Apb2smenr { adcsmen : self . adcsmen () , tim1smen : self . tim1smen () , spi1smen : self . spi1smen () , usart1smen : self . usart1smen () , tim16smen : self . tim16smen () , tim17smen : self . tim17smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb3enr { subghzspien : bool , } let proxy = Apb3enr { subghzspien : self . subghzspien () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb3rstr { subghzspirst : bool , } let proxy = Apb3rstr { subghzspirst : self . subghzspirst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB3 peripheral clock enable in Sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb3smenr { subghzspismen : bool , } let proxy = Apb3smenr { subghzspismen : self . subghzspismen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2ahb1enr { dma1en : bool , dma2en : bool , dmamux1en : bool , crcen : bool , } let proxy = C2ahb1enr { dma1en : self . dma1en () , dma2en : self . dma2en () , dmamux1en : self . dmamux1en () , crcen : self . crcen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 AHB1 peripheral clocks enable in Sleep modes register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2ahb1smenr { dma1smen : bool , dma2smen : bool , dmamux1smen : bool , crcsmen : bool , } let proxy = C2ahb1smenr { dma1smen : self . dma1smen () , dma2smen : self . dma2smen () , dmamux1smen : self . dmamux1smen () , crcsmen : self . crcsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 AHB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2ahb2enr { gpioaen : bool , gpioben : bool , gpiocen : bool , gpiohen : bool , } let proxy = C2ahb2enr { gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpiohen : self . gpiohen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 AHB2 peripheral clocks enable in Sleep modes register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2ahb2smenr { gpioasmen : bool , gpiobsmen : bool , gpiocsmen : bool , gpiohsmen : bool , } let proxy = C2ahb2smenr { gpioasmen : self . gpioasmen () , gpiobsmen : self . gpiobsmen () , gpiocsmen : self . gpiocsmen () , gpiohsmen : self . gpiohsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 AHB3 peripheral clock enable register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2ahb3enr { pkaen : bool , aesen : bool , rngen : bool , hsemen : bool , ipccen : bool , flashen : bool , } let proxy = C2ahb3enr { pkaen : self . pkaen () , aesen : self . aesen () , rngen : self . rngen () , hsemen : self . hsemen () , ipccen : self . ipccen () , flashen : self . flashen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 AHB3 peripheral clocks enable in Sleep mode register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2ahb3smenr { pkasmen : bool , aessmen : bool , rngsmen : bool , sram1smen : bool , sram2smen : bool , flashsmen : bool , } let proxy = C2ahb3smenr { pkasmen : self . pkasmen () , aessmen : self . aessmen () , rngsmen : self . rngsmen () , sram1smen : self . sram1smen () , sram2smen : self . sram2smen () , flashsmen : self . flashsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB1 peripheral clock enable register 1 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb1enr1 { tim2en : bool , rtcapben : bool , spi2en : bool , usart2en : bool , i2c1en : bool , i2c2en : bool , i2c3en : bool , dacen : bool , lptim1en : bool , } let proxy = C2apb1enr1 { tim2en : self . tim2en () , rtcapben : self . rtcapben () , spi2en : self . spi2en () , usart2en : self . usart2en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , i2c3en : self . i2c3en () , dacen : self . dacen () , lptim1en : self . lptim1en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB1 peripheral clock enable register 2 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb1enr2 { lpuart1en : bool , lptim2en : bool , lptim3en : bool , } let proxy = C2apb1enr2 { lpuart1en : self . lpuart1en () , lptim2en : self . lptim2en () , lptim3en : self . lptim3en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB1 peripheral clocks enable in Sleep mode register 1 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb1smenr1 { tim2smen : bool , rtcapbsmen : bool , spi2smen : bool , usart2smen : bool , i2c1smen : bool , i2c2smen : bool , i2c3smen : bool , dacsmen : bool , lptim1smen : bool , } let proxy = C2apb1smenr1 { tim2smen : self . tim2smen () , rtcapbsmen : self . rtcapbsmen () , spi2smen : self . spi2smen () , usart2smen : self . usart2smen () , i2c1smen : self . i2c1smen () , i2c2smen : self . i2c2smen () , i2c3smen : self . i2c3smen () , dacsmen : self . dacsmen () , lptim1smen : self . lptim1smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB1 peripheral clocks enable in Sleep mode register 2 \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb1smenr2 { lpuart1smen : bool , lptim2smen : bool , lptim3smen : bool , } let proxy = C2apb1smenr2 { lpuart1smen : self . lpuart1smen () , lptim2smen : self . lptim2smen () , lptim3smen : self . lptim3smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB2 peripheral clock enable register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb2enr { adcen : bool , tim1en : bool , spi1en : bool , usart1en : bool , tim16en : bool , tim17en : bool , } let proxy = C2apb2enr { adcen : self . adcen () , tim1en : self . tim1en () , spi1en : self . spi1en () , usart1en : self . usart1en () , tim16en : self . tim16en () , tim17en : self . tim17en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB2 peripheral clocks enable in Sleep mode register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb2smenr { adcsmen : bool , tim1smen : bool , spi1smen : bool , usart1smen : bool , tim16smen : bool , tim17smen : bool , } let proxy = C2apb2smenr { adcsmen : self . adcsmen () , tim1smen : self . tim1smen () , spi1smen : self . spi1smen () , usart1smen : self . usart1smen () , tim16smen : self . tim16smen () , tim17smen : self . tim17smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB3 peripheral clock enable register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb3enr { subghzspien : bool , } let proxy = C2apb3enr { subghzspien : self . subghzspien () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU2 APB3 peripheral clock enable in Sleep mode register \\[dual core device only\\]"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2apb3smenr { subghzspismen : bool , } let proxy = C2apb3smenr { subghzspismen : self . subghzspismen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Peripherals independent clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccipr { usart1sel : u8 , usart2sel : u8 , spi2sel : u8 , lpuart1sel : u8 , i2c1sel : u8 , i2c2sel : u8 , i2c3sel : u8 , lptim1sel : u8 , lptim2sel : u8 , lptim3sel : u8 , adcsel : super :: vals :: Adcsel , rngsel : super :: vals :: Rngsel , } let proxy = Ccipr { usart1sel : self . usart1sel () , usart2sel : self . usart2sel () , spi2sel : self . spi2sel () , lpuart1sel : self . lpuart1sel () , i2c1sel : self . i2c1sel () , i2c2sel : self . i2c2sel () , i2c3sel : self . i2c3sel () , lptim1sel : self . lptim1sel () , lptim2sel : self . lptim2sel () , lptim3sel : self . lptim3sel () , adcsel : self . adcsel () , rngsel : self . rngsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cicr { lsirdyc : bool , lserdyc : bool , msirdyc : bool , hsirdyc : bool , hserdyc : bool , pllrdyc : bool , cssc : bool , lsecssc : bool , } let proxy = Cicr { lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , msirdyc : self . msirdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , pllrdyc : self . pllrdyc () , cssc : self . cssc () , lsecssc : self . lsecssc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cier { lsirdyie : bool , lserdyie : bool , msirdyie : bool , hsirdyie : bool , hserdyie : bool , pllrdyie : bool , lsecssie : bool , } let proxy = Cier { lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , msirdyie : self . msirdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , pllrdyie : self . pllrdyie () , lsecssie : self . lsecssie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cifr { lsirdyf : bool , lserdyf : bool , msirdyf : bool , hsirdyf : bool , hserdyf : bool , pllrdyf : bool , cssf : bool , lsecssf : bool , } let proxy = Cifr { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , msirdyf : self . msirdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , pllrdyf : self . pllrdyf () , cssf : self . cssf () , lsecssf : self . lsecssf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { msion : bool , msirdy : bool , msipllen : bool , msirgsel : super :: vals :: Msirgsel , msirange : super :: vals :: Msirange , hsion : bool , hsikeron : bool , hsirdy : bool , hsiasfs : bool , hsikerdy : bool , hseon : bool , hserdy : bool , csson : bool , hsepre : super :: vals :: Hsepre , hsebyppwr : bool , pllon : bool , pllrdy : bool , } let proxy = Cr { msion : self . msion () , msirdy : self . msirdy () , msipllen : self . msipllen () , msirgsel : self . msirgsel () , msirange : self . msirange () , hsion : self . hsion () , hsikeron : self . hsikeron () , hsirdy : self . hsirdy () , hsiasfs : self . hsiasfs () , hsikerdy : self . hsikerdy () , hseon : self . hseon () , hserdy : self . hserdy () , csson : self . csson () , hsepre : self . hsepre () , hsebyppwr : self . hsebyppwr () , pllon : self . pllon () , pllrdy : self . pllrdy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { lsion : bool , lsirdy : bool , lsipre : bool , msisrange : u8 , rfrstf : bool , rfrst : bool , rmvf : bool , rfilarstf : bool , oblrstf : bool , pinrstf : bool , borrstf : bool , sftrstf : bool , iwdgrstf : bool , wwdgrstf : bool , lpwrrstf : bool , } let proxy = Csr { lsion : self . lsion () , lsirdy : self . lsirdy () , lsipre : self . lsipre () , msisrange : self . msisrange () , rfrstf : self . rfrstf () , rfrst : self . rfrst () , rmvf : self . rmvf () , rfilarstf : self . rfilarstf () , oblrstf : self . oblrstf () , pinrstf : self . pinrstf () , borrstf : self . borrstf () , sftrstf : self . sftrstf () , iwdgrstf : self . iwdgrstf () , wwdgrstf : self . wwdgrstf () , lpwrrstf : self . lpwrrstf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Extended clock recovery register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Extcfgr { shdhpre : super :: vals :: Hpre , c2hpre : super :: vals :: Hpre , shdhpref : bool , c2hpref : bool , } let proxy = Extcfgr { shdhpre : self . shdhpre () , c2hpre : self . c2hpre () , shdhpref : self . shdhpref () , c2hpref : self . c2hpref () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Internal clock sources calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

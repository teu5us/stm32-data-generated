...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("en" , & [self . en (0usize) , self . en (1usize) ,]) . field ("boff" , & [self . boff (0usize) , self . boff (1usize) ,]) . field ("ten" , & [self . ten (0usize) , self . ten (1usize) ,]) . field ("tsel" , & [self . tsel (0usize) , self . tsel (1usize) ,]) . field ("wave" , & [self . wave (0usize) , self . wave (1usize) ,]) . field ("mamp" , & [self . mamp (0usize) , self . mamp (1usize) ,]) . field ("dmaen" , & [self . dmaen (0usize) , self . dmaen (1usize) ,]) . field ("dmaudrie" , & [self . dmaudrie (0usize) , self . dmaudrie (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
...
struct Dor { dor : u16 , } let proxy = Dor { dor : self . dor () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("dmaudr" , & [self . dmaudr (0usize) , self . dmaudr (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]

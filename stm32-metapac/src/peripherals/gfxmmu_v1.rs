...
struct Bcr { pbo : u32 , pbba : u16 , } let proxy = Bcr { pbo : self . pbo () , pbba : self . pbba () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU configuration register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("boie" , & [self . boie (0usize) , self . boie (1usize) , self . boie (2usize) , self . boie (3usize) ,]) . field ("ameie" , & self . ameie ()) . field ("bm" , & [self . bm (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
...
, } let proxy = Cr { boie : [self . boie (0usize) , self . boie (1usize) , self . boie (2usize) , self . boie (3usize) ,]
, ameie : self . ameie () , bm : [self . bm (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU default value register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

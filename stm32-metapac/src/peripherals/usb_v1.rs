...
struct Cntr { fres : bool , pdwn : bool , lpmode : bool , fsusp : bool , resume : bool , esofm : bool , sofm : bool , resetm : bool , suspm : bool , wkupm : bool , errm : bool , pmaovrm : bool , ctrm : bool , } let proxy = Cntr { fres : self . fres () , pdwn : self . pdwn () , lpmode : self . lpmode () , fsusp : self . fsusp () , resume : self . resume () , esofm : self . esofm () , sofm : self . sofm () , resetm : self . resetm () , suspm : self . suspm () , wkupm : self . wkupm () , errm : self . errm () , pmaovrm : self . pmaovrm () , ctrm : self . ctrm () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "device address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Istr { ep_id : u8 , dir : super :: vals :: Dir , esof : bool , sof : bool , reset : bool , susp : bool , wkup : bool , err : bool , pmaovr : bool , ctr : bool , } let proxy = Istr { ep_id : self . ep_id () , dir : self . dir () , esof : self . esof () , sof : self . sof () , reset : self . reset () , susp : self . susp () , wkup : self . wkup () , err : self . err () , pmaovr : self . pmaovr () , ctr : self . ctr () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

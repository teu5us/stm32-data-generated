...
struct Cr { rngen : bool , ie : bool , ced : bool , ardis : bool , rng_config3 : super :: vals :: RngConfig3 , nistc : super :: vals :: Nistc , rng_config2 : super :: vals :: RngConfig2 , clkdiv : super :: vals :: Clkdiv , rng_config1 : super :: vals :: RngConfig1 , condrst : bool , configlock : bool , } let proxy = Cr { rngen : self . rngen () , ie : self . ie () , ced : self . ced () , ardis : self . ardis () , rng_config3 : self . rng_config3 () , nistc : self . nistc () , rng_config2 : self . rng_config2 () , clkdiv : self . clkdiv () , rng_config1 : self . rng_config1 () , condrst : self . condrst () , configlock : self . configlock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Health test control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Htcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Htcr { htcfg : super :: vals :: Htcfg , } let proxy = Htcr { htcfg : self . htcfg () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { drdy : bool , cecs : bool , secs : bool , ceis : bool , seis : bool , } let proxy = Sr { drdy : self . drdy () , cecs : self . cecs () , secs : self . secs () , ceis : self . ceis () , seis : self . seis () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]
...
pub const CONFIG_A : Self = Self (0x0f) ; # [doc = "Recommended value for config B (not NIST certifiable)"]
pub const CONFIG_B : Self = Self (0x18) ; } impl RngConfig1 { pub const fn from_bits (val : u8) -> RngConfig1 { Self (val & 0x3f) } pub const fn to_bits (self) -> u8 { self . 0 } } impl core :: fmt :: Debug for RngConfig1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { match self . 0 { 0x0f => f . write_str ("CONFIG_A") , 0x18 => f . write_str ("CONFIG_B") , other => core :: write ! (f , "0x{:02X}" , other) , } } } # [cfg (feature = "defmt")]
impl defmt :: Format for RngConfig1 { fn format (& self , f : defmt :: Formatter) { match self . 0 { 0x0f => defmt :: write ! (f , "CONFIG_A") , 0x18 => defmt :: write ! (f , "CONFIG_B") , other => defmt :: write ! (f , "0x{:02X}" , other) , } } } impl From < u8 > for RngConfig1 { # [inline (always)]

...
struct Awd2cr { awd2ch : u32 , } let proxy = Awd2cr { awd2ch : self . awd2ch () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Analog Watchdog 3 Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Awd3cr { awd3ch : u32 , } let proxy = Awd3cr { awd3ch : self . awd3ch () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Calibration Factors"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Calfact { calfact_s : u8 , calfact_d : u8 , } let proxy = Calfact { calfact_s : self . calfact_s () , calfact_d : self . calfact_d () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cfgr { Cfgr (0) } } impl core :: fmt :: Debug for Cfgr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cfgr") . field ("dmaen" , & self . dmaen ()) . field ("dmacfg" , & self . dmacfg ()) . field ("res" , & self . res ()) . field ("extsel" , & [self . extsel (0usize) , self . extsel (1usize) , self . extsel (2usize) , self . extsel (3usize) , self . extsel (4usize) ,]) . field ("exten" , & self . exten ()) . field ("ovrmod" , & self . ovrmod ()) . field ("cont" , & self . cont ()) . field ("autdly" , & self . autdly ()) . field ("align" , & self . align ()) . field ("discen" , & self . discen ()) . field ("discnum" , & self . discnum ()) . field ("jdiscen" , & self . jdiscen ()) . field ("jqm" , & self . jqm ()) . field ("awd1sgl" , & self . awd1sgl ()) . field ("awd1en" , & self . awd1en ()) . field ("jawd1en" , & self . jawd1en ()) . field ("jauto" , & self . jauto ()) . field ("awd1ch" , & self . awd1ch ()) . field ("jqdis" , & self . jqdis ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfgr { dmaen : bool , dmacfg : super :: vals :: Dmacfg , res : super :: vals :: Res , extsel : [bool ; 5usize]
, exten : super :: vals :: Exten , ovrmod : super :: vals :: Ovrmod , cont : bool , autdly : bool , align : super :: vals :: Align , discen : bool , discnum : u8 , jdiscen : bool , jqm : super :: vals :: Jqm , awd1sgl : super :: vals :: Awd1sgl , awd1en : bool , jawd1en : bool , jauto : bool , awd1ch : u8 , jqdis : bool , } let proxy = Cfgr { dmaen : self . dmaen () , dmacfg : self . dmacfg () , res : self . res () , extsel : [self . extsel (0usize) , self . extsel (1usize) , self . extsel (2usize) , self . extsel (3usize) , self . extsel (4usize) ,]
, exten : self . exten () , ovrmod : self . ovrmod () , cont : self . cont () , autdly : self . autdly () , align : self . align () , discen : self . discen () , discnum : self . discnum () , jdiscen : self . jdiscen () , jqm : self . jqm () , awd1sgl : self . awd1sgl () , awd1en : self . awd1en () , jawd1en : self . jawd1en () , jauto : self . jauto () , awd1ch : self . awd1ch () , jqdis : self . jqdis () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { rovse : bool , jovse : bool , ovsr : super :: vals :: Ovsr , ovss : u8 , trovs : super :: vals :: Trovs , rovsm : super :: vals :: Rovsm , swtrig : super :: vals :: Swtrig , bulb : bool , smptrig : bool , } let proxy = Cfgr2 { rovse : self . rovse () , jovse : self . jovse () , ovsr : self . ovsr () , ovss : self . ovss () , trovs : self . trovs () , rovsm : self . rovsm () , swtrig : self . swtrig () , bulb : self . bulb () , smptrig : self . smptrig () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Difsel { difsel : u32 , } let proxy = Difsel { difsel : self . difsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { rdata : u16 , } let proxy = Dr { rdata : self . rdata () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, jqovfie : bool , } let proxy = Ier { adrdyie : self . adrdyie () , eosmpie : self . eosmpie () , eocie : self . eocie () , eosie : self . eosie () , ovrie : self . ovrie () , jeocie : self . jeocie () , jeosie : self . jeosie () , awdie : [self . awdie (0usize) , self . awdie (1usize) , self . awdie (2usize) ,]
, jqovfie : self . jqovfie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, jqovf : bool , } let proxy = Isr { adrdy : self . adrdy () , eosmp : self . eosmp () , eoc : self . eoc () , eos : self . eos () , ovr : self . ovr () , jeoc : self . jeoc () , jeos : self . jeos () , awd : [self . awd (0usize) , self . awd (1usize) , self . awd (2usize) ,]
, jqovf : self . jqovf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected channel 1-4 data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jdr { jdata : u16 , } let proxy = Jdr { jdata : self . jdata () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected sequence register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "offset 1-4 register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ofr { offset : u16 , offsetpos : super :: vals :: Offsetpos , saten : bool , offset_ch : u8 , offset_en : bool , } let proxy = Ofr { offset : self . offset () , offsetpos : self . offsetpos () , saten : self . saten () , offset_ch : self . offset_ch () , offset_en : self . offset_en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "option register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Or { op0 : bool , op1 : bool , } let proxy = Or { op0 : self . op0 () , op1 : self . op1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample time register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr1 { Smpr1 (0) } } impl core :: fmt :: Debug for Smpr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr1") . field ("smp" , & [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) , self . smp (9usize) ,]) . field ("smpplus" , & self . smpplus ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smpr1 { smp : [super :: vals :: SampleTime ; 10usize]
, smpplus : super :: vals :: Smpplus , } let proxy = Smpr1 { smp : [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) , self . smp (9usize) ,]
, smpplus : self . smpplus () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample time register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr2 { Smpr2 (0) } } impl core :: fmt :: Debug for Smpr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr2") . field ("smp" , & [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) , self . smp (9usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smpr2 { smp : [super :: vals :: SampleTime ; 10usize]
, } let proxy = Smpr2 { smp : [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) , self . smp (9usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog threshold register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Tr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tr1 { lt1 : u16 , awdfilt : u8 , ht1 : u16 , } let proxy = Tr1 { lt1 : self . lt1 () , awdfilt : self . awdfilt () , ht1 : self . ht1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog threshold register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Tr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tr2 { lt2 : u8 , ht2 : u8 , } let proxy = Tr2 { lt2 : self . lt2 () , ht2 : self . ht2 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog threshold register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Tr3 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tr3 { lt3 : u8 , ht3 : u8 , } let proxy = Tr3 { lt3 : self . lt3 () , ht3 : self . ht3 () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

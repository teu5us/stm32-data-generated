...
impl defmt :: Format for Clrisr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Clrisr { clreocalf : bool , clrjovrf : bool , clrrovrf : bool , } let proxy = Clrisr { clreocalf : self . clreocalf () , clrjovrf : self . clrjovrf () , clrrovrf : self . clrrovrf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "channel configuration register 1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Confchr1 { Confchr1 (0) } } impl core :: fmt :: Debug for Confchr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Confchr1") . field ("confch" , & [self . confch (0usize) , self . confch (1usize) , self . confch (2usize) , self . confch (3usize) , self . confch (4usize) , self . confch (5usize) , self . confch (6usize) , self . confch (7usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Confchr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Confchr1 { confch : [u8 ; 8usize]
, } let proxy = Confchr1 { confch : [self . confch (0usize) , self . confch (1usize) , self . confch (2usize) , self . confch (3usize) , self . confch (4usize) , self . confch (5usize) , self . confch (6usize) , self . confch (7usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "channel configuration register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Confchr2 { Confchr2 (0) } } impl core :: fmt :: Debug for Confchr2 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Confchr2") . field ("confch" , & [self . confch (0usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Confchr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Confchr2 { confch : [u8 ; 1usize]
, } let proxy = Confchr2 { confch : [self . confch (0usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration 0 register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Confr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Confr { offset : u16 , gain : u8 , se : u8 , common : u8 , } let proxy = Confr { offset : self . offset () , gain : self . gain () , se : self . se () , common : self . common () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr1 { eocalie : bool , jeocie : bool , jovrie : bool , reocie : bool , rovrie : bool , refv : u8 , slowck : bool , sbi : bool , pdi : bool , jsync : bool , rsync : bool , jdmaen : bool , rdmaen : bool , init : bool , } let proxy = Cr1 { eocalie : self . eocalie () , jeocie : self . jeocie () , jovrie : self . jovrie () , reocie : self . reocie () , rovrie : self . rovrie () , refv : self . refv () , slowck : self . slowck () , sbi : self . sbi () , pdi : self . pdi () , jsync : self . jsync () , rsync : self . rsync () , jdmaen : self . jdmaen () , rdmaen : self . rdmaen () , init : self . init () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { adon : bool , calibcnt : u8 , startcalib : bool , jcont : bool , jds : bool , jextsel : u8 , jexten : u8 , jswstart : bool , rch : u8 , rcont : bool , rswstart : bool , fast : bool , } let proxy = Cr2 { adon : self . adon () , calibcnt : self . calibcnt () , startcalib : self . startcalib () , jcont : self . jcont () , jds : self . jds () , jextsel : self . jextsel () , jexten : self . jexten () , jswstart : self . jswstart () , rch : self . rch () , rcont : self . rcont () , rswstart : self . rswstart () , fast : self . fast () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt and status register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Isr { eocalf : bool , jeocf : bool , jovrf : bool , reocf : bool , rovrf : bool , calibip : bool , jcip : bool , rcip : bool , stabip : bool , initrdy : bool , } let proxy = Isr { eocalf : self . eocalf () , jeocf : self . jeocf () , jovrf : self . jovrf () , reocf : self . reocf () , rovrf : self . rovrf () , calibip : self . calibip () , jcip : self . jcip () , rcip : self . rcip () , stabip : self . stabip () , initrdy : self . initrdy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected channel group selection register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Jchgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Jchgr { jchg : u16 , } let proxy = Jchgr { jchg : self . jchg () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data register for injected group."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Jdatar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Jdatar { jdata : u16 , jdatach : u8 , } let proxy = Jdatar { jdata : self . jdata () , jdatach : self . jdatach () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data register for the regular channel."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Rdatar { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Rdatar { rdata : u16 , } let proxy = Rdatar { rdata : self . rdata () , } ; defmt :: write ! (f , "{}" , proxy) } } }
...
struct Bcr { pbo : u32 , pbba : u16 , } let proxy = Bcr { pbo : self . pbo () , pbba : self . pbba () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU cache control register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccr { ff : bool , fi : bool , } let proxy = Ccr { ff : self . ff () , fi : self . fi () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU configuration register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("boie" , & [self . boie (0usize) , self . boie (1usize) , self . boie (2usize) , self . boie (3usize) ,]) . field ("ameie" , & self . ameie ()) . field ("bm" , & [self . bm (0usize) ,]) . field ("ce" , & self . ce ()) . field ("cl" , & self . cl ()) . field ("clb" , & self . clb ()) . field ("fc" , & self . fc ()) . field ("pd" , & self . pd ()) . field ("oc" , & self . oc ()) . field ("ob" , & self . ob ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr { boie : [bool ; 4usize]
, ameie : bool , bm : [super :: vals :: Bm192 ; 1usize]
, ce : bool , cl : bool , clb : super :: vals :: Clb , fc : bool , pd : bool , oc : bool , ob : bool , } let proxy = Cr { boie : [self . boie (0usize) , self . boie (1usize) , self . boie (2usize) , self . boie (3usize) ,]
, ameie : self . ameie () , bm : [self . bm (0usize) ,]
, ce : self . ce () , cl : self . cl () , clb : self . clb () , fc : self . fc () , pd : self . pd () , oc : self . oc () , ob : self . ob () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU default value register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dvr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dvr { dv : u32 , } let proxy = Dvr { dv : self . dv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU flag clear register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Fcr { Fcr (0) } } impl core :: fmt :: Debug for Fcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Fcr") . field ("cbof" , & [self . cbof (0usize) , self . cbof (1usize) , self . cbof (2usize) , self . cbof (3usize) ,]) . field ("camef" , & self . camef ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Fcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Fcr { cbof : [bool ; 4usize]
, camef : bool , } let proxy = Fcr { cbof : [self . cbof (0usize) , self . cbof (1usize) , self . cbof (2usize) , self . cbof (3usize) ,]
, camef : self . camef () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU LUT entry high."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Luth { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Luth { lo : u32 , } let proxy = Luth { lo : self . lo () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU LUT entry low."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Lutl { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Lutl { en : bool , fvb : u8 , lvb : u8 , } let proxy = Lutl { en : self . en () , fvb : self . fvb () , lvb : self . lvb () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GFXMMU status register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("bof" , & [self . bof (0usize) , self . bof (1usize) , self . bof (2usize) , self . bof (3usize) ,]) . field ("amef" , & self . amef ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr { bof : [bool ; 4usize]
, amef : bool , } let proxy = Sr { bof : [self . bof (0usize) , self . bof (1usize) , self . bof (2usize) , self . bof (3usize) ,]
, amef : self . amef () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Amtcr { en : bool , dt : u8 , } let proxy = Amtcr { en : self . en () , dt : self . dt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "BGCLUT"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Bgclut { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Bgclut { blue : u8 , green : u8 , red : u8 , aplha : u8 , } let proxy = Bgclut { blue : self . blue () , green : self . green () , red : self . red () , aplha : self . aplha () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "background CLUT memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bgcmar { ma : u32 , } let proxy = Bgcmar { ma : self . ma () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "background color register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bgcolr { blue : u8 , green : u8 , red : u8 , } let proxy = Bgcolr { blue : self . blue () , green : self . green () , red : self . red () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "background memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bgmar { ma : u32 , } let proxy = Bgmar { ma : self . ma () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "background offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bgor { lo : u16 , } let proxy = Bgor { lo : self . lo () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "background PFC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bgpfccr { cm : super :: vals :: BgpfccrCm , ccm : super :: vals :: BgpfccrCcm , start : super :: vals :: BgpfccrStart , cs : u8 , am : super :: vals :: BgpfccrAm , alpha : u8 , } let proxy = Bgpfccr { cm : self . cm () , ccm : self . ccm () , start : self . start () , cs : self . cs () , am : self . am () , alpha : self . alpha () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fgclut { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Fgclut { blue : u8 , green : u8 , red : u8 , aplha : u8 , } let proxy = Fgclut { blue : self . blue () , green : self . green () , red : self . red () , aplha : self . aplha () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "foreground CLUT memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fgcmar { ma : u32 , } let proxy = Fgcmar { ma : self . ma () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "foreground color register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fgcolr { blue : u8 , green : u8 , red : u8 , } let proxy = Fgcolr { blue : self . blue () , green : self . green () , red : self . red () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "foreground memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fgmar { ma : u32 , } let proxy = Fgmar { ma : self . ma () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "foreground offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fgor { lo : u16 , } let proxy = Fgor { lo : self . lo () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "foreground PFC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fgpfccr { cm : super :: vals :: FgpfccrCm , ccm : super :: vals :: FgpfccrCcm , start : super :: vals :: FgpfccrStart , cs : u8 , am : super :: vals :: FgpfccrAm , alpha : u8 , } let proxy = Fgpfccr { cm : self . cm () , ccm : self . ccm () , start : self . start () , cs : self . cs () , am : self . am () , alpha : self . alpha () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt flag clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ifcr { cteif : super :: vals :: Cteif , ctcif : super :: vals :: Ctcif , ctwif : super :: vals :: Ctwif , caecif : super :: vals :: Caecif , cctcif : super :: vals :: Cctcif , cceif : super :: vals :: Cceif , } let proxy = Ifcr { cteif : self . cteif () , ctcif : self . ctcif () , ctwif : self . ctwif () , caecif : self . caecif () , cctcif : self . cctcif () , cceif : self . cceif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Isr { teif : bool , tcif : bool , twif : bool , caeif : bool , ctcif : bool , ceif : bool , } let proxy = Isr { teif : self . teif () , tcif : self . tcif () , twif : self . twif () , caeif : self . caeif () , ctcif : self . ctcif () , ceif : self . ceif () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "line watermark register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Lwr { lw : u16 , } let proxy = Lwr { lw : self . lw () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "number of line register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Nlr { nl : u16 , pl : u16 , } let proxy = Nlr { nl : self . nl () , pl : self . pl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "output color register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ocolr { blue : u8 , green : u8 , red : u8 , aplha : u8 , } let proxy = Ocolr { blue : self . blue () , green : self . green () , red : self . red () , aplha : self . aplha () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "output memory address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Omar { ma : u32 , } let proxy = Omar { ma : self . ma () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "output offset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Oor { lo : u16 , } let proxy = Oor { lo : self . lo () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "output PFC control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Opfccr { cm : super :: vals :: OpfccrCm , } let proxy = Opfccr { cm : self . cm () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
fn default () -> Af11chCmp { Af11chCmp (0) } } impl core :: fmt :: Debug for Af11chCmp { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af11chCmp") . field ("bkine" , & self . bkine ()) . field ("bkcmpe" , & [self . bkcmpe (0usize) , self . bkcmpe (1usize) ,]) . field ("bkdf1bke" , & self . bkdf1bke ()) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp" , & [self . bkcmpp (0usize) , self . bkcmpp (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af11chCmp { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af11chCmp { bkine : bool , bkcmpe : [bool ; 2usize]
, bkdf1bke : bool , bkinp : super :: vals :: Bkinp , bkcmpp : [super :: vals :: Bkinp ; 2usize]
, } let proxy = Af11chCmp { bkine : self . bkine () , bkcmpe : [self . bkcmpe (0usize) , self . bkcmpe (1usize) ,]
, bkdf1bke : self . bkdf1bke () , bkinp : self . bkinp () , bkcmpp : [self . bkcmpp (0usize) , self . bkcmpp (1usize) ,]
...
fn default () -> Af1Adv { Af1Adv (0) } } impl core :: fmt :: Debug for Af1Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af1Adv") . field ("bkine" , & self . bkine ()) . field ("bkcmpe" , & [self . bkcmpe (0usize) , self . bkcmpe (1usize) ,]) . field ("bkdf1bke" , & self . bkdf1bke ()) . field ("bkinp" , & self . bkinp ()) . field ("bkcmpp" , & [self . bkcmpp (0usize) , self . bkcmpp (1usize) ,]) . field ("etrsel" , & self . etrsel ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af1Adv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af1Adv { bkine : bool , bkcmpe : [bool ; 2usize]
, bkdf1bke : bool , bkinp : super :: vals :: Bkinp , bkcmpp : [super :: vals :: Bkinp ; 2usize]
, etrsel : u8 , } let proxy = Af1Adv { bkine : self . bkine () , bkcmpe : [self . bkcmpe (0usize) , self . bkcmpe (1usize) ,]
, bkdf1bke : self . bkdf1bke () , bkinp : self . bkinp () , bkcmpp : [self . bkcmpp (0usize) , self . bkcmpp (1usize) ,]
...
fn default () -> Af2Adv { Af2Adv (0) } } impl core :: fmt :: Debug for Af2Adv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Af2Adv") . field ("bk2ine" , & self . bk2ine ()) . field ("bk2cmpe" , & [self . bk2cmpe (0usize) ,]) . field ("bk2df1bk1e" , & self . bk2df1bk1e ()) . field ("bk2inp" , & self . bk2inp ()) . field ("bk2cmpp" , & [self . bk2cmpp (0usize) , self . bk2cmpp (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Af2Adv { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Af2Adv { bk2ine : bool , bk2cmpe : [bool ; 1usize]
, bk2df1bk1e : bool , bk2inp : super :: vals :: Bkinp , bk2cmpp : [super :: vals :: Bkinp ; 2usize]
, } let proxy = Af2Adv { bk2ine : self . bk2ine () , bk2cmpe : [self . bk2cmpe (0usize) ,]
, bk2df1bk1e : self . bk2df1bk1e () , bk2inp : self . bk2inp () , bk2cmpp : [self . bk2cmpp (0usize) , self . bk2cmpp (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "auto-reload register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct ArrCore { arr : u16 , } let proxy = ArrCore { arr : self . arr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "break and dead-time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> CcerAdv { CcerAdv (0) } } impl core :: fmt :: Debug for CcerAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("CcerAdv") . field ("cce" , & [self . cce (0usize) , self . cce (1usize) , self . cce (2usize) , self . cce (3usize) , self . cce (4usize) , self . cce (5usize) ,]) . field ("ccp" , & [self . ccp (0usize) , self . ccp (1usize) , self . ccp (2usize) , self . ccp (3usize) , self . ccp (4usize) , self . ccp (5usize) ,]) . field ("ccne" , & [self . ccne (0usize) , self . ccne (1usize) , self . ccne (2usize) ,]) . field ("ccnp" , & [self . ccnp (0usize) , self . ccnp (1usize) , self . ccnp (2usize) , self . ccnp (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
...
, ocm : [self . ocm (0usize) , self . ocm (1usize) ,]
, occe : [self . occe (0usize) , self . occe (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare register x (x=1-4,6)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccr1ch { ccr : u16 , } let proxy = Ccr1ch { ccr : self . ccr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "capture/compare register 5"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "counter"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct CntCore { cnt : u16 , uifcpy : bool , } let proxy = CntCore { cnt : self . cnt () , uifcpy : self . uifcpy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr11ch { cen : bool , udis : bool , urs : super :: vals :: Urs , opm : bool , arpe : bool , ckd : super :: vals :: Ckd , uifremap : bool , } let proxy = Cr11ch { cen : self . cen () , udis : self . udis () , urs : self . urs () , opm : self . opm () , arpe : self . arpe () , ckd : self . ckd () , uifremap : self . uifremap () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr1Core { cen : bool , udis : bool , urs : super :: vals :: Urs , opm : bool , arpe : bool , uifremap : bool , } let proxy = Cr1Core { cen : self . cen () , udis : self . udis () , urs : self . urs () , opm : self . opm () , arpe : self . arpe () , uifremap : self . uifremap () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr1Gp16 { cen : bool , udis : bool , urs : super :: vals :: Urs , opm : bool , dir : super :: vals :: Dir , cms : super :: vals :: Cms , arpe : bool , ckd : super :: vals :: Ckd , uifremap : bool , } let proxy = Cr1Gp16 { cen : self . cen () , udis : self . udis () , urs : self . urs () , opm : self . opm () , dir : self . dir () , cms : self . cms () , arpe : self . arpe () , ckd : self . ckd () , uifremap : self . uifremap () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dcr1chCmp { dba : u8 , dbl : u8 , } let proxy = Dcr1chCmp { dba : self . dba () , dbl : self . dbl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA/Interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> DierAdv { DierAdv (0) } } impl core :: fmt :: Debug for DierAdv { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("DierAdv") . field ("uie" , & self . uie ()) . field ("ccie" , & [self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) ,]) . field ("comie" , & self . comie ()) . field ("tie" , & self . tie ()) . field ("bie" , & self . bie ()) . field ("ude" , & self . ude ()) . field ("ccde" , & [self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) ,]) . field ("comde" , & self . comde ()) . field ("tde" , & self . tde ()) . finish () } } # [cfg (feature = "defmt")]
...
, comde : bool , tde : bool , } let proxy = DierAdv { uie : self . uie () , ccie : [self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) ,]
...
, tde : bool , } let proxy = DierGp16 { uie : self . uie () , ccie : [self . ccie (0usize) , self . ccie (1usize) , self . ccie (2usize) , self . ccie (3usize) ,]
, tie : self . tie () , ude : self . ude () , ccde : [self . ccde (0usize) , self . ccde (1usize) , self . ccde (2usize) , self . ccde (3usize) ,]
, tde : self . tde () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DMA address for full transfer"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for DmarGp16 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct DmarGp16 { dmab : u16 , } let proxy = DmarGp16 { dmab : self . dmab () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "event generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct SmcrGp16 { sms : super :: vals :: Sms , ts : super :: vals :: Ts , msm : super :: vals :: Msm , etf : super :: vals :: FilterValue , etps : super :: vals :: Etps , ece : bool , etp : super :: vals :: Etp , } let proxy = SmcrGp16 { sms : self . sms () , ts : self . ts () , msm : self . msm () , etf : self . etf () , etps : self . etps () , ece : self . ece () , etp : self . etp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, ccof : [bool ; 4usize]
, sbif : bool , ccif5 : bool , ccif6 : bool , } let proxy = SrAdv { uif : self . uif () , ccif : [self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) ,]
...
, sbif : self . sbif () , ccif5 : self . ccif5 () , ccif6 : self . ccif6 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> SrGp16 { SrGp16 (0) } } impl core :: fmt :: Debug for SrGp16 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SrGp16") . field ("uif" , & self . uif ()) . field ("ccif" , & [self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) ,]) . field ("tif" , & self . tif ()) . field ("ccof" , & [self . ccof (0usize) , self . ccof (1usize) , self . ccof (2usize) , self . ccof (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
...
, } let proxy = SrGp16 { uif : self . uif () , ccif : [self . ccif (0usize) , self . ccif (1usize) , self . ccif (2usize) , self . ccif (3usize) ,]

...
struct Ahb1lpenr { gpioalpen : bool , gpioblpen : bool , gpioclpen : bool , gpiodlpen : bool , gpioelpen : bool , gpioflpen : bool , gpioglpen : bool , gpiohlpen : bool , gpioilpen : bool , crclpen : bool , flashlpen : bool , sram1lpen : bool , sram2lpen : bool , bkpsramlpen : bool , dma1lpen : bool , dma2lpen : bool , ethlpen : bool , ethtxlpen : bool , ethrxlpen : bool , ethptplpen : bool , usb_otg_hslpen : bool , usb_otg_hsulpilpen : bool , } let proxy = Ahb1lpenr { gpioalpen : self . gpioalpen () , gpioblpen : self . gpioblpen () , gpioclpen : self . gpioclpen () , gpiodlpen : self . gpiodlpen () , gpioelpen : self . gpioelpen () , gpioflpen : self . gpioflpen () , gpioglpen : self . gpioglpen () , gpiohlpen : self . gpiohlpen () , gpioilpen : self . gpioilpen () , crclpen : self . crclpen () , flashlpen : self . flashlpen () , sram1lpen : self . sram1lpen () , sram2lpen : self . sram2lpen () , bkpsramlpen : self . bkpsramlpen () , dma1lpen : self . dma1lpen () , dma2lpen : self . dma2lpen () , ethlpen : self . ethlpen () , ethtxlpen : self . ethtxlpen () , ethrxlpen : self . ethrxlpen () , ethptplpen : self . ethptplpen () , usb_otg_hslpen : self . usb_otg_hslpen () , usb_otg_hsulpilpen : self . usb_otg_hsulpilpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2lpenr { dcmilpen : bool , cryplpen : bool , hashlpen : bool , rnglpen : bool , usb_otg_fslpen : bool , } let proxy = Ahb2lpenr { dcmilpen : self . dcmilpen () , cryplpen : self . cryplpen () , hashlpen : self . hashlpen () , rnglpen : self . rnglpen () , usb_otg_fslpen : self . usb_otg_fslpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3enr { fsmcen : bool , } let proxy = Ahb3enr { fsmcen : self . fsmcen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3lpenr { fsmclpen : bool , } let proxy = Ahb3lpenr { fsmclpen : self . fsmclpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3rstr { fsmcrst : bool , } let proxy = Ahb3rstr { fsmcrst : self . fsmcrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , tim12en : bool , tim13en : bool , tim14en : bool , wwdgen : bool , spi2en : bool , spi3en : bool , usart2en : bool , usart3en : bool , uart4en : bool , uart5en : bool , i2c1en : bool , i2c2en : bool , i2c3en : bool , can1en : bool , can2en : bool , pwren : bool , dacen : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , tim12en : self . tim12en () , tim13en : self . tim13en () , tim14en : self . tim14en () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , spi3en : self . spi3en () , usart2en : self . usart2en () , usart3en : self . usart3en () , uart4en : self . uart4en () , uart5en : self . uart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , i2c3en : self . i2c3en () , can1en : self . can1en () , can2en : self . can2en () , pwren : self . pwren () , dacen : self . dacen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1lpenr { tim2lpen : bool , tim3lpen : bool , tim4lpen : bool , tim5lpen : bool , tim6lpen : bool , tim7lpen : bool , tim12lpen : bool , tim13lpen : bool , tim14lpen : bool , wwdglpen : bool , spi2lpen : bool , spi3lpen : bool , usart2lpen : bool , usart3lpen : bool , uart4lpen : bool , uart5lpen : bool , i2c1lpen : bool , i2c2lpen : bool , i2c3lpen : bool , can1lpen : bool , can2lpen : bool , pwrlpen : bool , daclpen : bool , } let proxy = Apb1lpenr { tim2lpen : self . tim2lpen () , tim3lpen : self . tim3lpen () , tim4lpen : self . tim4lpen () , tim5lpen : self . tim5lpen () , tim6lpen : self . tim6lpen () , tim7lpen : self . tim7lpen () , tim12lpen : self . tim12lpen () , tim13lpen : self . tim13lpen () , tim14lpen : self . tim14lpen () , wwdglpen : self . wwdglpen () , spi2lpen : self . spi2lpen () , spi3lpen : self . spi3lpen () , usart2lpen : self . usart2lpen () , usart3lpen : self . usart3lpen () , uart4lpen : self . uart4lpen () , uart5lpen : self . uart5lpen () , i2c1lpen : self . i2c1lpen () , i2c2lpen : self . i2c2lpen () , i2c3lpen : self . i2c3lpen () , can1lpen : self . can1lpen () , can2lpen : self . can2lpen () , pwrlpen : self . pwrlpen () , daclpen : self . daclpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , tim12rst : bool , tim13rst : bool , tim14rst : bool , wwdgrst : bool , spi2rst : bool , spi3rst : bool , uart2rst : bool , uart3rst : bool , uart4rst : bool , uart5rst : bool , i2c1rst : bool , i2c2rst : bool , i2c3rst : bool , can1rst : bool , can2rst : bool , pwrrst : bool , dacrst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , tim12rst : self . tim12rst () , tim13rst : self . tim13rst () , tim14rst : self . tim14rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , spi3rst : self . spi3rst () , uart2rst : self . uart2rst () , uart3rst : self . uart3rst () , uart4rst : self . uart4rst () , uart5rst : self . uart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , i2c3rst : self . i2c3rst () , can1rst : self . can1rst () , can2rst : self . can2rst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { tim1en : bool , tim8en : bool , usart1en : bool , usart6en : bool , adc1en : bool , adc2en : bool , adc3en : bool , sdioen : bool , spi1en : bool , syscfgen : bool , tim9en : bool , tim10en : bool , tim11en : bool , } let proxy = Apb2enr { tim1en : self . tim1en () , tim8en : self . tim8en () , usart1en : self . usart1en () , usart6en : self . usart6en () , adc1en : self . adc1en () , adc2en : self . adc2en () , adc3en : self . adc3en () , sdioen : self . sdioen () , spi1en : self . spi1en () , syscfgen : self . syscfgen () , tim9en : self . tim9en () , tim10en : self . tim10en () , tim11en : self . tim11en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enabled in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2lpenr { tim1lpen : bool , tim8lpen : bool , usart1lpen : bool , usart6lpen : bool , adc1lpen : bool , adc2lpen : bool , adc3lpen : bool , sdiolpen : bool , spi1lpen : bool , syscfglpen : bool , tim9lpen : bool , tim10lpen : bool , tim11lpen : bool , } let proxy = Apb2lpenr { tim1lpen : self . tim1lpen () , tim8lpen : self . tim8lpen () , usart1lpen : self . usart1lpen () , usart6lpen : self . usart6lpen () , adc1lpen : self . adc1lpen () , adc2lpen : self . adc2lpen () , adc3lpen : self . adc3lpen () , sdiolpen : self . sdiolpen () , spi1lpen : self . spi1lpen () , syscfglpen : self . syscfglpen () , tim9lpen : self . tim9lpen () , tim10lpen : self . tim10lpen () , tim11lpen : self . tim11lpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { tim1rst : bool , tim8rst : bool , usart1rst : bool , usart6rst : bool , adcrst : bool , sdiorst : bool , spi1rst : bool , syscfgrst : bool , tim9rst : bool , tim10rst : bool , tim11rst : bool , } let proxy = Apb2rstr { tim1rst : self . tim1rst () , tim8rst : self . tim8rst () , usart1rst : self . usart1rst () , usart6rst : self . usart6rst () , adcrst : self . adcrst () , sdiorst : self . sdiorst () , spi1rst : self . spi1rst () , syscfgrst : self . syscfgrst () , tim9rst : self . tim9rst () , tim10rst : self . tim10rst () , tim11rst : self . tim11rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { hsion : bool , hsirdy : bool , hsitrim : u8 , hsical : u8 , hseon : bool , hserdy : bool , hsebyp : bool , csson : bool , pllon : bool , pllrdy : bool , plli2son : bool , plli2srdy : bool , } let proxy = Cr { hsion : self . hsion () , hsirdy : self . hsirdy () , hsitrim : self . hsitrim () , hsical : self . hsical () , hseon : self . hseon () , hserdy : self . hserdy () , hsebyp : self . hsebyp () , csson : self . csson () , pllon : self . pllon () , pllrdy : self . pllrdy () , plli2son : self . plli2son () , plli2srdy : self . plli2srdy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock control & status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pllcfgr { pllm : super :: vals :: Pllm , plln : super :: vals :: Plln , pllp : super :: vals :: Pllp , pllsrc : super :: vals :: Pllsrc , pllq : super :: vals :: Pllq , } let proxy = Pllcfgr { pllm : self . pllm () , plln : self . plln () , pllp : self . pllp () , pllsrc : self . pllsrc () , pllq : self . pllq () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PLLI2S configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Plli2scfgr { plln : super :: vals :: Plln , pllr : super :: vals :: Pllr , } let proxy = Plli2scfgr { plln : self . plln () , pllr : self . pllr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "spread spectrum clock generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

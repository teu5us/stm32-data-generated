...
fn default () -> Awdcr { Awdcr (0) } } impl core :: fmt :: Debug for Awdcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Awdcr") . field ("awd2ch0" , & [self . awd2ch0 (0usize) , self . awd2ch0 (1usize) , self . awd2ch0 (2usize) , self . awd2ch0 (3usize) , self . awd2ch0 (4usize) , self . awd2ch0 (5usize) , self . awd2ch0 (6usize) , self . awd2ch0 (7usize) , self . awd2ch0 (8usize) , self . awd2ch0 (9usize) , self . awd2ch0 (10usize) , self . awd2ch0 (11usize) , self . awd2ch0 (12usize) , self . awd2ch0 (13usize) , self . awd2ch0 (14usize) , self . awd2ch0 (15usize) , self . awd2ch0 (16usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Awdcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Awdcr { awd2ch0 : [bool ; 17usize]
, } let proxy = Awdcr { awd2ch0 : [self . awd2ch0 (0usize) , self . awd2ch0 (1usize) , self . awd2ch0 (2usize) , self . awd2ch0 (3usize) , self . awd2ch0 (4usize) , self . awd2ch0 (5usize) , self . awd2ch0 (6usize) , self . awd2ch0 (7usize) , self . awd2ch0 (8usize) , self . awd2ch0 (9usize) , self . awd2ch0 (10usize) , self . awd2ch0 (11usize) , self . awd2ch0 (12usize) , self . awd2ch0 (13usize) , self . awd2ch0 (14usize) , self . awd2ch0 (15usize) , self . awd2ch0 (16usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Calibration Factors"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr { dmaen : bool , dmacfg : super :: vals :: Dmacfg , res : super :: vals :: Res , align : super :: vals :: Align , extsel : u8 , exten : super :: vals :: Exten , ovrmod : bool , cont : bool , autdly : bool , discen : bool , discnum : u8 , jdiscen : bool , jqm : super :: vals :: Jqm , awd1sgl : super :: vals :: Awd1sgl , awd1en : bool , jawd1en : bool , jauto : bool , awd1ch : u8 , } let proxy = Cfgr { dmaen : self . dmaen () , dmacfg : self . dmacfg () , res : self . res () , align : self . align () , extsel : self . extsel () , exten : self . exten () , ovrmod : self . ovrmod () , cont : self . cont () , autdly : self . autdly () , discen : self . discen () , discnum : self . discnum () , jdiscen : self . jdiscen () , jqm : self . jqm () , awd1sgl : self . awd1sgl () , awd1en : self . awd1en () , jawd1en : self . jawd1en () , jauto : self . jauto () , awd1ch : self . awd1ch () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { aden : bool , addis : bool , adstart : bool , jadstart : bool , adstp : bool , jadstp : bool , advregen : super :: vals :: Advregen , adcaldif : bool , adcal : bool , } let proxy = Cr { aden : self . aden () , addis : self . addis () , adstart : self . adstart () , jadstart : self . jadstart () , adstp : self . adstp () , jadstp : self . jadstp () , advregen : self . advregen () , adcaldif : self . adcaldif () , adcal : self . adcal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Differential Mode Selection Register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Difsel { difsel_10 : super :: vals :: Difsel10 , difsel_11 : super :: vals :: Difsel10 , difsel_12 : super :: vals :: Difsel10 , difsel_13 : super :: vals :: Difsel10 , difsel_14 : super :: vals :: Difsel10 , difsel_15 : super :: vals :: Difsel10 , difsel_16 : super :: vals :: Difsel10 , difsel_17 : super :: vals :: Difsel10 , difsel_18 : super :: vals :: Difsel10 , difsel_19 : super :: vals :: Difsel10 , difsel_110 : super :: vals :: Difsel10 , difsel_111 : super :: vals :: Difsel10 , difsel_112 : super :: vals :: Difsel10 , difsel_113 : super :: vals :: Difsel10 , difsel_114 : super :: vals :: Difsel10 , difsel_115 : super :: vals :: Difsel10 , difsel_116 : super :: vals :: Difsel10 , difsel_117 : super :: vals :: Difsel10 , } let proxy = Difsel { difsel_10 : self . difsel_10 () , difsel_11 : self . difsel_11 () , difsel_12 : self . difsel_12 () , difsel_13 : self . difsel_13 () , difsel_14 : self . difsel_14 () , difsel_15 : self . difsel_15 () , difsel_16 : self . difsel_16 () , difsel_17 : self . difsel_17 () , difsel_18 : self . difsel_18 () , difsel_19 : self . difsel_19 () , difsel_110 : self . difsel_110 () , difsel_111 : self . difsel_111 () , difsel_112 : self . difsel_112 () , difsel_113 : self . difsel_113 () , difsel_114 : self . difsel_114 () , difsel_115 : self . difsel_115 () , difsel_116 : self . difsel_116 () , difsel_117 : self . difsel_117 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, jqovf : self . jqovf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected data register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "offset register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ofr { offset : u16 , ch : u8 , en : bool , } let proxy = Ofr { offset : self . offset () , ch : self . ch () , en : self . en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample time register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Smpr1 { smp : [super :: vals :: SampleTime ; 9usize]
, } let proxy = Smpr1 { smp : [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) ,]
...
struct Tr1 { lt1 : u16 , ht1 : u16 , } let proxy = Tr1 { lt1 : self . lt1 () , ht1 : self . ht1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

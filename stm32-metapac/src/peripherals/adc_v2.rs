...
struct Cr1 { awdch : u8 , eocie : bool , awdie : bool , jeocie : bool , scan : bool , awdsgl : super :: vals :: Awdsgl , jauto : bool , discen : bool , jdiscen : bool , discnum : u8 , jawden : bool , awden : bool , res : super :: vals :: Res , ovrie : bool , } let proxy = Cr1 { awdch : self . awdch () , eocie : self . eocie () , awdie : self . awdie () , jeocie : self . jeocie () , scan : self . scan () , awdsgl : self . awdsgl () , jauto : self . jauto () , discen : self . discen () , jdiscen : self . jdiscen () , discnum : self . discnum () , jawden : self . jawden () , awden : self . awden () , res : self . res () , ovrie : self . ovrie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { adon : bool , cont : bool , dma : bool , dds : super :: vals :: Dds , eocs : super :: vals :: Eocs , align : super :: vals :: Align , jextsel : u8 , jexten : super :: vals :: Exten , jswstart : bool , extsel : u8 , exten : super :: vals :: Exten , swstart : bool , } let proxy = Cr2 { adon : self . adon () , cont : self . cont () , dma : self . dma () , dds : self . dds () , eocs : self . eocs () , align : self . align () , jextsel : self . jextsel () , jexten : self . jexten () , jswstart : self . jswstart () , extsel : self . extsel () , exten : self . exten () , swstart : self . swstart () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Jdr { jdata : u16 , } let proxy = Jdr { jdata : self . jdata () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected channel data offset register x"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Jofr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Jofr { joffset : u16 , } let proxy = Jofr { joffset : self . joffset () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "injected sequence register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, smpx_x : super :: vals :: SmprSmpxX , } let proxy = Smpr1 { smp : [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) ,]
, smpx_x : self . smpx_x () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample time register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, smpx_x : super :: vals :: SmprSmpxX , } let proxy = Smpr2 { smp : [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) , self . smp (8usize) , self . smp (9usize) ,]
, smpx_x : self . smpx_x () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "regular sequence register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

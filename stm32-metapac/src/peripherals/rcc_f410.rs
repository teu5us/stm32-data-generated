...
struct Ahb1enr { gpioaen : bool , gpioben : bool , gpiocen : bool , gpiohen : bool , crcen : bool , dma1en : bool , dma2en : bool , rngen : bool , } let proxy = Ahb1enr { gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpiohen : self . gpiohen () , crcen : self . crcen () , dma1en : self . dma1en () , dma2en : self . dma2en () , rngen : self . rngen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb1lpenr { gpioalpen : bool , gpioblpen : bool , gpioclpen : bool , gpiohlpen : bool , crclpen : bool , flashlpen : bool , sram1lpen : bool , dma1lpen : bool , dma2lpen : bool , rnglpen : bool , } let proxy = Ahb1lpenr { gpioalpen : self . gpioalpen () , gpioblpen : self . gpioblpen () , gpioclpen : self . gpioclpen () , gpiohlpen : self . gpiohlpen () , crclpen : self . crclpen () , flashlpen : self . flashlpen () , sram1lpen : self . sram1lpen () , dma1lpen : self . dma1lpen () , dma2lpen : self . dma2lpen () , rnglpen : self . rnglpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb1rstr { gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiohrst : bool , crcrst : bool , dma1rst : bool , dma2rst : bool , rngrst : bool , } let proxy = Ahb1rstr { gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiohrst : self . gpiohrst () , crcrst : self . crcrst () , dma1rst : self . dma1rst () , dma2rst : self . dma2rst () , rngrst : self . rngrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim5en : bool , tim6en : bool , lptim1en : bool , rtcapben : bool , wwdgen : bool , spi2en : bool , usart2en : bool , i2c1en : bool , i2c2en : bool , fmpi2c1en : bool , pwren : bool , dacen : bool , } let proxy = Apb1enr { tim5en : self . tim5en () , tim6en : self . tim6en () , lptim1en : self . lptim1en () , rtcapben : self . rtcapben () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , usart2en : self . usart2en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , fmpi2c1en : self . fmpi2c1en () , pwren : self . pwren () , dacen : self . dacen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1lpenr { tim5lpen : bool , tim6lpen : bool , lptim1lpen : bool , rtcapblpen : bool , wwdglpen : bool , spi2lpen : bool , usart2lpen : bool , i2c1lpen : bool , i2c2lpen : bool , fmpi2c1lpen : bool , pwrlpen : bool , daclpen : bool , } let proxy = Apb1lpenr { tim5lpen : self . tim5lpen () , tim6lpen : self . tim6lpen () , lptim1lpen : self . lptim1lpen () , rtcapblpen : self . rtcapblpen () , wwdglpen : self . wwdglpen () , spi2lpen : self . spi2lpen () , usart2lpen : self . usart2lpen () , i2c1lpen : self . i2c1lpen () , i2c2lpen : self . i2c2lpen () , fmpi2c1lpen : self . fmpi2c1lpen () , pwrlpen : self . pwrlpen () , daclpen : self . daclpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim5rst : bool , tim6rst : bool , lptim1rst : bool , wwdgrst : bool , spi2rst : bool , usart2rst : bool , i2c1rst : bool , i2c2rst : bool , fmpi2c1rst : bool , pwrrst : bool , dacrst : bool , } let proxy = Apb1rstr { tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , lptim1rst : self . lptim1rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , usart2rst : self . usart2rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , fmpi2c1rst : self . fmpi2c1rst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { tim1en : bool , usart1en : bool , usart6en : bool , adc1en : bool , spi1en : bool , syscfgen : bool , extiten : bool , tim9en : bool , tim11en : bool , spi5en : bool , } let proxy = Apb2enr { tim1en : self . tim1en () , usart1en : self . usart1en () , usart6en : self . usart6en () , adc1en : self . adc1en () , spi1en : self . spi1en () , syscfgen : self . syscfgen () , extiten : self . extiten () , tim9en : self . tim9en () , tim11en : self . tim11en () , spi5en : self . spi5en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enabled in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2lpenr { tim1lpen : bool , usart1lpen : bool , usart6lpen : bool , adc1lpen : bool , sdiolpen : bool , spi1lpen : bool , syscfglpen : bool , extitlpen : bool , tim9lpen : bool , tim11lpen : bool , spi5lpen : bool , } let proxy = Apb2lpenr { tim1lpen : self . tim1lpen () , usart1lpen : self . usart1lpen () , usart6lpen : self . usart6lpen () , adc1lpen : self . adc1lpen () , sdiolpen : self . sdiolpen () , spi1lpen : self . spi1lpen () , syscfglpen : self . syscfglpen () , extitlpen : self . extitlpen () , tim9lpen : self . tim9lpen () , tim11lpen : self . tim11lpen () , spi5lpen : self . spi5lpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { tim1rst : bool , usart1rst : bool , usart6rst : bool , adcrst : bool , spi1rst : bool , syscfgrst : bool , tim9rst : bool , tim11rst : bool , spi5rst : bool , } let proxy = Apb2rstr { tim1rst : self . tim1rst () , usart1rst : self . usart1rst () , usart6rst : self . usart6rst () , adcrst : self . adcrst () , spi1rst : self . spi1rst () , syscfgrst : self . syscfgrst () , tim9rst : self . tim9rst () , tim11rst : self . tim11rst () , spi5rst : self . spi5rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bdcr { lseon : bool , lserdy : bool , lsebyp : bool , rtcsel : super :: vals :: Rtcsel , rtcen : bool , bdrst : bool , } let proxy = Bdcr { lseon : self . lseon () , lserdy : self . lserdy () , lsebyp : self . lsebyp () , rtcsel : self . rtcsel () , rtcen : self . rtcen () , bdrst : self . bdrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr { sw : super :: vals :: Sw , sws : super :: vals :: Sw , hpre : super :: vals :: Hpre , mco1en : bool , mco2en : bool , ppre1 : super :: vals :: Ppre , ppre2 : super :: vals :: Ppre , rtcpre : u8 , mco1sel : super :: vals :: Mco1sel , mco1pre : super :: vals :: Mcopre , mco2pre : super :: vals :: Mcopre , mco2sel : super :: vals :: Mco2sel , } let proxy = Cfgr { sw : self . sw () , sws : self . sws () , hpre : self . hpre () , mco1en : self . mco1en () , mco2en : self . mco2en () , ppre1 : self . ppre1 () , ppre2 : self . ppre2 () , rtcpre : self . rtcpre () , mco1sel : self . mco1sel () , mco1pre : self . mco1pre () , mco2pre : self . mco2pre () , mco2sel : self . mco2sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { hsion : bool , hsirdy : bool , hsitrim : u8 , hsical : u8 , hseon : bool , hserdy : bool , hsebyp : bool , csson : bool , pllon : bool , pllrdy : bool , } let proxy = Cr { hsion : self . hsion () , hsirdy : self . hsirdy () , hsitrim : self . hsitrim () , hsical : self . hsical () , hseon : self . hseon () , hserdy : self . hserdy () , hsebyp : self . hsebyp () , csson : self . csson () , pllon : self . pllon () , pllrdy : self . pllrdy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock control & status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dckcfgr { timpre : super :: vals :: Timpre , i2ssrc : super :: vals :: Issrc , } let proxy = Dckcfgr { timpre : self . timpre () , i2ssrc : self . i2ssrc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "DCKCFGR2 register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dckcfgr2 { fmpi2c1sel : super :: vals :: Fmpi2csel , lptim1sel : super :: vals :: Lptimsel , } let proxy = Dckcfgr2 { fmpi2c1sel : self . fmpi2c1sel () , lptim1sel : self . lptim1sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

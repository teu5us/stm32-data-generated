...
impl defmt :: Format for Alrbinr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Alrbinr { ss : u32 , } let proxy = Alrbinr { ss : self . ss () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Alarm register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Alrmr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Alrmr { su : u8 , st : u8 , msk1 : super :: vals :: AlrmrMsk , mnu : u8 , mnt : u8 , msk2 : super :: vals :: AlrmrMsk , hu : u8 , ht : u8 , pm : super :: vals :: AlrmrPm , msk3 : super :: vals :: AlrmrMsk , du : u8 , dt : u8 , wdsel : super :: vals :: AlrmrWdsel , msk4 : super :: vals :: AlrmrMsk , } let proxy = Alrmr { su : self . su () , st : self . st () , msk1 : self . msk1 () , mnu : self . mnu () , mnt : self . mnt () , msk2 : self . msk2 () , hu : self . hu () , ht : self . ht () , pm : self . pm () , msk3 : self . msk3 () , du : self . du () , dt : self . dt () , wdsel : self . wdsel () , msk4 : self . msk4 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Alarm sub second register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Alrmssr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Alrmssr { ss : u16 , maskss : u8 , ssclr : super :: vals :: AlrmssrSsclr , } let proxy = Alrmssr { ss : self . ss () , maskss : self . maskss () , ssclr : self . ssclr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Calr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Calr { calm : u16 , lpcal : super :: vals :: Lpcal , calw16 : super :: vals :: Calw16 , calw8 : super :: vals :: Calw8 , calp : super :: vals :: Calp , } let proxy = Calr { calm : self . calm () , lpcal : self . lpcal () , calw16 : self . calw16 () , calw8 : self . calw8 () , calp : self . calp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("wucksel" , & self . wucksel ()) . field ("tsedge" , & self . tsedge ()) . field ("refckon" , & self . refckon ()) . field ("bypshad" , & self . bypshad ()) . field ("fmt" , & self . fmt ()) . field ("ssruie" , & self . ssruie ()) . field ("alre" , & [self . alre (0usize) , self . alre (1usize) ,]) . field ("wute" , & self . wute ()) . field ("tse" , & self . tse ()) . field ("alrie" , & [self . alrie (0usize) , self . alrie (1usize) ,]) . field ("wutie" , & self . wutie ()) . field ("tsie" , & self . tsie ()) . field ("add1h" , & self . add1h ()) . field ("sub1h" , & self . sub1h ()) . field ("bkp" , & self . bkp ()) . field ("cosel" , & self . cosel ()) . field ("pol" , & self . pol ()) . field ("osel" , & self . osel ()) . field ("coe" , & self . coe ()) . field ("itse" , & self . itse ()) . field ("tampts" , & self . tampts ()) . field ("tampoe" , & self . tampoe ()) . field ("alrfclr" , & [self . alrfclr (0usize) , self . alrfclr (1usize) ,]) . field ("tampalrm_pu" , & self . tampalrm_pu ()) . field ("tampalrm_type" , & self . tampalrm_type ()) . field ("out2en" , & self . out2en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr { wucksel : super :: vals :: Wucksel , tsedge : super :: vals :: Tsedge , refckon : bool , bypshad : bool , fmt : super :: vals :: Fmt , ssruie : bool , alre : [bool ; 2usize]
, wute : bool , tse : bool , alrie : [bool ; 2usize]
, wutie : bool , tsie : bool , add1h : bool , sub1h : bool , bkp : bool , cosel : super :: vals :: Cosel , pol : super :: vals :: Pol , osel : super :: vals :: Osel , coe : bool , itse : bool , tampts : bool , tampoe : bool , alrfclr : [bool ; 2usize]
, tampalrm_pu : bool , tampalrm_type : super :: vals :: TampalrmType , out2en : bool , } let proxy = Cr { wucksel : self . wucksel () , tsedge : self . tsedge () , refckon : self . refckon () , bypshad : self . bypshad () , fmt : self . fmt () , ssruie : self . ssruie () , alre : [self . alre (0usize) , self . alre (1usize) ,]
, wute : self . wute () , tse : self . tse () , alrie : [self . alrie (0usize) , self . alrie (1usize) ,]
, wutie : self . wutie () , tsie : self . tsie () , add1h : self . add1h () , sub1h : self . sub1h () , bkp : self . bkp () , cosel : self . cosel () , pol : self . pol () , osel : self . osel () , coe : self . coe () , itse : self . itse () , tampts : self . tampts () , tampoe : self . tampoe () , alrfclr : [self . alrfclr (0usize) , self . alrfclr (1usize) ,]
, tampalrm_pu : self . tampalrm_pu () , tampalrm_type : self . tampalrm_type () , out2en : self . out2en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Date register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { du : u8 , dt : u8 , mu : u8 , mt : bool , wdu : u8 , yu : u8 , yt : u8 , } let proxy = Dr { du : self . du () , dt : self . dt () , mu : self . mu () , mt : self . mt () , wdu : self . wdu () , yu : self . yu () , yt : self . yt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Initialization control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icsr { Icsr (0) } } impl core :: fmt :: Debug for Icsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icsr") . field ("wutwf" , & self . wutwf ()) . field ("shpf" , & self . shpf ()) . field ("inits" , & self . inits ()) . field ("rsf" , & self . rsf ()) . field ("initf" , & self . initf ()) . field ("init" , & self . init ()) . field ("bin" , & self . bin ()) . field ("bcdu" , & self . bcdu ()) . field ("recalpf" , & self . recalpf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icsr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Icsr { wutwf : bool , shpf : bool , inits : bool , rsf : bool , initf : bool , init : bool , bin : super :: vals :: Bin , bcdu : super :: vals :: Bcdu , recalpf : super :: vals :: Recalpf , } let proxy = Icsr { wutwf : self . wutwf () , shpf : self . shpf () , inits : self . inits () , rsf : self . rsf () , initf : self . initf () , init : self . init () , bin : self . bin () , bcdu : self . bcdu () , recalpf : self . recalpf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Masked interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Misr { Misr (0) } } impl core :: fmt :: Debug for Misr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Misr") . field ("alrmf" , & [self . alrmf (0usize) , self . alrmf (1usize) ,]) . field ("wutmf" , & self . wutmf ()) . field ("tsmf" , & self . tsmf ()) . field ("tsovmf" , & self . tsovmf ()) . field ("itsmf" , & self . itsmf ()) . field ("ssrumf" , & self . ssrumf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Misr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Misr { alrmf : [super :: vals :: Alrmf ; 2usize]
, wutmf : super :: vals :: Wutmf , tsmf : super :: vals :: Tsmf , tsovmf : super :: vals :: Tsovmf , itsmf : super :: vals :: Itsmf , ssrumf : super :: vals :: Ssrumf , } let proxy = Misr { alrmf : [self . alrmf (0usize) , self . alrmf (1usize) ,]
, wutmf : self . wutmf () , tsmf : self . tsmf () , tsovmf : self . tsovmf () , itsmf : self . itsmf () , ssrumf : self . ssrumf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Prescaler register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Prer { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Prer { prediv_s : u16 , prediv_a : u8 , } let proxy = Prer { prediv_s : self . prediv_s () , prediv_a : self . prediv_a () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Privilege mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Privcr { Privcr (0) } } impl core :: fmt :: Debug for Privcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Privcr") . field ("alrpriv" , & [self . alrpriv (0usize) , self . alrpriv (1usize) ,]) . field ("wutpriv" , & self . wutpriv ()) . field ("tspriv" , & self . tspriv ()) . field ("calpriv" , & self . calpriv ()) . field ("initpriv" , & self . initpriv ()) . field ("priv_" , & self . priv_ ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Privcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Privcr { alrpriv : [bool ; 2usize]
, wutpriv : bool , tspriv : bool , calpriv : bool , initpriv : bool , priv_ : bool , } let proxy = Privcr { alrpriv : [self . alrpriv (0usize) , self . alrpriv (1usize) ,]
, wutpriv : self . wutpriv () , tspriv : self . tspriv () , calpriv : self . calpriv () , initpriv : self . initpriv () , priv_ : self . priv_ () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Scr { Scr (0) } } impl core :: fmt :: Debug for Scr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Scr") . field ("calrf" , & [self . calrf (0usize) , self . calrf (1usize) ,]) . field ("cwutf" , & self . cwutf ()) . field ("ctsf" , & self . ctsf ()) . field ("ctsovf" , & self . ctsovf ()) . field ("citsf" , & self . citsf ()) . field ("cssruf" , & self . cssruf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Scr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Scr { calrf : [super :: vals :: Calrf ; 2usize]
, cwutf : super :: vals :: Calrf , ctsf : super :: vals :: Calrf , ctsovf : super :: vals :: Calrf , citsf : super :: vals :: Calrf , cssruf : super :: vals :: Calrf , } let proxy = Scr { calrf : [self . calrf (0usize) , self . calrf (1usize) ,]
, cwutf : self . cwutf () , ctsf : self . ctsf () , ctsovf : self . ctsovf () , citsf : self . citsf () , cssruf : self . cssruf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Secure mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Seccfgr { alrasec : bool , alrbsec : bool , wutsec : bool , tssec : bool , calsec : bool , initsec : bool , sec : bool , } let proxy = Seccfgr { alrasec : self . alrasec () , alrbsec : self . alrbsec () , wutsec : self . wutsec () , tssec : self . tssec () , calsec : self . calsec () , initsec : self . initsec () , sec : self . sec () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Shift control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Shiftr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Shiftr { subfs : u16 , add1s : bool , } let proxy = Shiftr { subfs : self . subfs () , add1s : self . add1s () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Secure masked interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smisr { Smisr (0) } } impl core :: fmt :: Debug for Smisr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smisr") . field ("alrmf" , & [self . alrmf (0usize) , self . alrmf (1usize) ,]) . field ("wutmf" , & self . wutmf ()) . field ("tsmf" , & self . tsmf ()) . field ("tsovmf" , & self . tsovmf ()) . field ("itsmf" , & self . itsmf ()) . field ("ssrumf" , & self . ssrumf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smisr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smisr { alrmf : [bool ; 2usize]
, wutmf : bool , tsmf : bool , tsovmf : bool , itsmf : bool , ssrumf : bool , } let proxy = Smisr { alrmf : [self . alrmf (0usize) , self . alrmf (1usize) ,]
, wutmf : self . wutmf () , tsmf : self . tsmf () , tsovmf : self . tsovmf () , itsmf : self . itsmf () , ssrumf : self . ssrumf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("alrf" , & [self . alrf (0usize) , self . alrf (1usize) ,]) . field ("wutf" , & self . wutf ()) . field ("tsf" , & self . tsf ()) . field ("tsovf" , & self . tsovf ()) . field ("itsf" , & self . itsf ()) . field ("ssruf" , & self . ssruf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr { alrf : [super :: vals :: Alrf ; 2usize]
, wutf : super :: vals :: Wutf , tsf : super :: vals :: Tsf , tsovf : super :: vals :: Tsovf , itsf : super :: vals :: Itsf , ssruf : super :: vals :: Ssruf , } let proxy = Sr { alrf : [self . alrf (0usize) , self . alrf (1usize) ,]
, wutf : self . wutf () , tsf : self . tsf () , tsovf : self . tsovf () , itsf : self . itsf () , ssruf : self . ssruf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Sub second register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ssr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ssr { ss : u32 , } let proxy = Ssr { ss : self . ss () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Tr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tr { su : u8 , st : u8 , mnu : u8 , mnt : u8 , hu : u8 , ht : u8 , pm : super :: vals :: Ampm , } let proxy = Tr { su : self . su () , st : self . st () , mnu : self . mnu () , mnt : self . mnt () , hu : self . hu () , ht : self . ht () , pm : self . pm () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Timestamp date register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Tsdr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tsdr { du : u8 , dt : u8 , mu : u8 , mt : bool , wdu : u8 , } let proxy = Tsdr { du : self . du () , dt : self . dt () , mu : self . mu () , mt : self . mt () , wdu : self . wdu () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Timestamp sub second register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Tsssr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tsssr { ss : u32 , } let proxy = Tsssr { ss : self . ss () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Timestamp time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Tstr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Tstr { su : u8 , st : u8 , mnu : u8 , mnt : u8 , hu : u8 , ht : u8 , pm : bool , } let proxy = Tstr { su : self . su () , st : self . st () , mnu : self . mnu () , mnt : self . mnt () , hu : self . hu () , ht : self . ht () , pm : self . pm () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Write protection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Wpr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Wpr { key : super :: vals :: Key , } let proxy = Wpr { key : self . key () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Wakeup timer register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Wutr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Wutr { wut : u16 , wutoclr : u16 , } let proxy = Wutr { wut : self . wut () , wutoclr : self . wutoclr () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

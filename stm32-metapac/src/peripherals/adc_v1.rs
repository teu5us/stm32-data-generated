...
struct Ccr { vrefen : bool , tsen : bool , vbaten : bool , } let proxy = Ccr { vrefen : self . vrefen () , tsen : self . tsen () , vbaten : self . vbaten () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { ckmode : super :: vals :: Ckmode , } let proxy = Cfgr2 { ckmode : self . ckmode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "channel selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { aden : bool , addis : bool , adstart : bool , adstp : bool , adcal : bool , } let proxy = Cr { aden : self . aden () , addis : self . addis () , adstart : self . adstart () , adstp : self . adstp () , adcal : self . adcal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ier { adrdyie : bool , eosmpie : bool , eocie : bool , eoseqie : bool , ovrie : bool , awdie : bool , } let proxy = Ier { adrdyie : self . adrdyie () , eosmpie : self . eosmpie () , eocie : self . eocie () , eoseqie : self . eoseqie () , ovrie : self . ovrie () , awdie : self . awdie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Isr { adrdy : bool , eosmp : bool , eoc : bool , eoseq : bool , ovr : bool , awd : bool , } let proxy = Isr { adrdy : self . adrdy () , eosmp : self . eosmp () , eoc : self . eoc () , eoseq : self . eoseq () , ovr : self . ovr () , awd : self . awd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sampling time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

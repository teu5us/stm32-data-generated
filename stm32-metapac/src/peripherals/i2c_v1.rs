...
struct Ccr { ccr : u16 , duty : super :: vals :: Duty , f_s : super :: vals :: FS , } let proxy = Ccr { ccr : self . ccr () , duty : self . duty () , f_s : self . f_s () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr1 { pe : bool , smbus : super :: vals :: Smbus , smbtype : super :: vals :: Smbtype , enarp : bool , enpec : bool , engc : bool , nostretch : bool , start : bool , stop : bool , ack : bool , pos : super :: vals :: Pos , pec : bool , alert : bool , swrst : bool , } let proxy = Cr1 { pe : self . pe () , smbus : self . smbus () , smbtype : self . smbtype () , enarp : self . enarp () , enpec : self . enpec () , engc : self . engc () , nostretch : self . nostretch () , start : self . start () , stop : self . stop () , ack : self . ack () , pos : self . pos () , pec : self . pec () , alert : self . alert () , swrst : self . swrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { freq : u8 , iterren : bool , itevten : bool , itbufen : bool , dmaen : bool , last : bool , } let proxy = Cr2 { freq : self . freq () , iterren : self . iterren () , itevten : self . itevten () , itbufen : self . itbufen () , dmaen : self . dmaen () , last : self . last () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { dr : u8 , } let proxy = Dr { dr : self . dr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLTR register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Fltr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Fltr { dnf : super :: vals :: Dnf , anoff : bool , } let proxy = Fltr { dnf : self . dnf () , anoff : self . anoff () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Own address register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Oar1 { add : u16 , addmode : super :: vals :: Addmode , } let proxy = Oar1 { add : self . add () , addmode : self . addmode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Own address register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Oar2 { endual : super :: vals :: Endual , add2 : u8 , } let proxy = Oar2 { endual : self . endual () , add2 : self . add2 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr1 { start : bool , addr : bool , btf : bool , add10 : bool , stopf : bool , rxne : bool , txe : bool , berr : bool , arlo : bool , af : bool , ovr : bool , pecerr : bool , timeout : bool , alert : bool , } let proxy = Sr1 { start : self . start () , addr : self . addr () , btf : self . btf () , add10 : self . add10 () , stopf : self . stopf () , rxne : self . rxne () , txe : self . txe () , berr : self . berr () , arlo : self . arlo () , af : self . af () , ovr : self . ovr () , pecerr : self . pecerr () , timeout : self . timeout () , alert : self . alert () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr2 { msl : bool , busy : bool , tra : bool , gencall : bool , smbdefault : bool , smbhost : bool , dualf : bool , pec : u8 , } let proxy = Sr2 { msl : self . msl () , busy : self . busy () , tra : self . tra () , gencall : self . gencall () , smbdefault : self . smbdefault () , smbhost : self . smbhost () , dualf : self . dualf () , pec : self . pec () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "TRISE register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Trise { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Trise { trise : u8 , } let proxy = Trise { trise : self . trise () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

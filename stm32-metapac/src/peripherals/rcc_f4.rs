...
struct Ahb1enr { gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , gpiofen : bool , gpiogen : bool , gpiohen : bool , gpioien : bool , gpiojen : bool , gpioken : bool , crcen : bool , bkpsramen : bool , ccmdataramen : bool , dma1en : bool , dma2en : bool , dma2den : bool , ethen : bool , ethtxen : bool , ethrxen : bool , ethptpen : bool , usb_otg_hsen : bool , usb_otg_hsulpien : bool , } let proxy = Ahb1enr { gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , gpiofen : self . gpiofen () , gpiogen : self . gpiogen () , gpiohen : self . gpiohen () , gpioien : self . gpioien () , gpiojen : self . gpiojen () , gpioken : self . gpioken () , crcen : self . crcen () , bkpsramen : self . bkpsramen () , ccmdataramen : self . ccmdataramen () , dma1en : self . dma1en () , dma2en : self . dma2en () , dma2den : self . dma2den () , ethen : self . ethen () , ethtxen : self . ethtxen () , ethrxen : self . ethrxen () , ethptpen : self . ethptpen () , usb_otg_hsen : self . usb_otg_hsen () , usb_otg_hsulpien : self . usb_otg_hsulpien () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb1lpenr { gpioalpen : bool , gpioblpen : bool , gpioclpen : bool , gpiodlpen : bool , gpioelpen : bool , gpioflpen : bool , gpioglpen : bool , gpiohlpen : bool , gpioilpen : bool , gpiojlpen : bool , gpioklpen : bool , crclpen : bool , flashlpen : bool , sram1lpen : bool , sram2lpen : bool , bkpsramlpen : bool , sram3lpen : bool , dma1lpen : bool , dma2lpen : bool , dma2dlpen : bool , ethlpen : bool , ethtxlpen : bool , ethrxlpen : bool , ethptplpen : bool , usb_otg_hslpen : bool , usb_otg_hsulpilpen : bool , rnglpen : bool , } let proxy = Ahb1lpenr { gpioalpen : self . gpioalpen () , gpioblpen : self . gpioblpen () , gpioclpen : self . gpioclpen () , gpiodlpen : self . gpiodlpen () , gpioelpen : self . gpioelpen () , gpioflpen : self . gpioflpen () , gpioglpen : self . gpioglpen () , gpiohlpen : self . gpiohlpen () , gpioilpen : self . gpioilpen () , gpiojlpen : self . gpiojlpen () , gpioklpen : self . gpioklpen () , crclpen : self . crclpen () , flashlpen : self . flashlpen () , sram1lpen : self . sram1lpen () , sram2lpen : self . sram2lpen () , bkpsramlpen : self . bkpsramlpen () , sram3lpen : self . sram3lpen () , dma1lpen : self . dma1lpen () , dma2lpen : self . dma2lpen () , dma2dlpen : self . dma2dlpen () , ethlpen : self . ethlpen () , ethtxlpen : self . ethtxlpen () , ethrxlpen : self . ethrxlpen () , ethptplpen : self . ethptplpen () , usb_otg_hslpen : self . usb_otg_hslpen () , usb_otg_hsulpilpen : self . usb_otg_hsulpilpen () , rnglpen : self . rnglpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2enr { dcmien : bool , crypen : bool , hashen : bool , rngen : bool , usb_otg_fsen : bool , } let proxy = Ahb2enr { dcmien : self . dcmien () , crypen : self . crypen () , hashen : self . hashen () , rngen : self . rngen () , usb_otg_fsen : self . usb_otg_fsen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2lpenr { dcmilpen : bool , fsmclpen : bool , quadspilpen : bool , cryplpen : bool , hashlpen : bool , rnglpen : bool , usb_otg_fslpen : bool , } let proxy = Ahb2lpenr { dcmilpen : self . dcmilpen () , fsmclpen : self . fsmclpen () , quadspilpen : self . quadspilpen () , cryplpen : self . cryplpen () , hashlpen : self . hashlpen () , rnglpen : self . rnglpen () , usb_otg_fslpen : self . usb_otg_fslpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2rstr { dcmirst : bool , cryprst : bool , hsahrst : bool , rngrst : bool , usb_otg_fsrst : bool , } let proxy = Ahb2rstr { dcmirst : self . dcmirst () , cryprst : self . cryprst () , hsahrst : self . hsahrst () , rngrst : self . rngrst () , usb_otg_fsrst : self . usb_otg_fsrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3enr { fmcen : bool , fsmcen : bool , quadspien : bool , } let proxy = Ahb3enr { fmcen : self . fmcen () , fsmcen : self . fsmcen () , quadspien : self . quadspien () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3lpenr { fmclpen : bool , fsmclpen : bool , quadspilpen : bool , } let proxy = Ahb3lpenr { fmclpen : self . fmclpen () , fsmclpen : self . fsmclpen () , quadspilpen : self . quadspilpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3rstr { fmcrst : bool , fsmcrst : bool , quadspirst : bool , } let proxy = Ahb3rstr { fmcrst : self . fmcrst () , fsmcrst : self . fsmcrst () , quadspirst : self . quadspirst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1enr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1enr { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , tim12en : bool , tim13en : bool , tim14en : bool , lptim1en : bool , rtcapben : bool , wwdgen : bool , spi2en : bool , spi3en : bool , spdifrxen : bool , usart2en : bool , usart3en : bool , uart4en : bool , uart5en : bool , i2c1en : bool , i2c2en : bool , i2c3en : bool , fmpi2c1en : bool , can1en : bool , can2en : bool , can3en : bool , cecen : bool , pwren : bool , dacen : bool , uart7en : bool , uart8en : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , tim12en : self . tim12en () , tim13en : self . tim13en () , tim14en : self . tim14en () , lptim1en : self . lptim1en () , rtcapben : self . rtcapben () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , spi3en : self . spi3en () , spdifrxen : self . spdifrxen () , usart2en : self . usart2en () , usart3en : self . usart3en () , uart4en : self . uart4en () , uart5en : self . uart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , i2c3en : self . i2c3en () , fmpi2c1en : self . fmpi2c1en () , can1en : self . can1en () , can2en : self . can2en () , can3en : self . can3en () , cecen : self . cecen () , pwren : self . pwren () , dacen : self . dacen () , uart7en : self . uart7en () , uart8en : self . uart8en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1lpenr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1lpenr { tim2lpen : bool , tim3lpen : bool , tim4lpen : bool , tim5lpen : bool , tim6lpen : bool , tim7lpen : bool , tim12lpen : bool , tim13lpen : bool , tim14lpen : bool , lptim1lpen : bool , rtcapblpen : bool , wwdglpen : bool , spi2lpen : bool , spi3lpen : bool , spdiflpen : bool , usart2lpen : bool , usart3lpen : bool , uart4lpen : bool , uart5lpen : bool , i2c1lpen : bool , i2c2lpen : bool , i2c3lpen : bool , fmpi2c1lpen : bool , can1lpen : bool , can2lpen : bool , can3lpen : bool , ceclpen : bool , pwrlpen : bool , daclpen : bool , uart7lpen : bool , uart8lpen : bool , } let proxy = Apb1lpenr { tim2lpen : self . tim2lpen () , tim3lpen : self . tim3lpen () , tim4lpen : self . tim4lpen () , tim5lpen : self . tim5lpen () , tim6lpen : self . tim6lpen () , tim7lpen : self . tim7lpen () , tim12lpen : self . tim12lpen () , tim13lpen : self . tim13lpen () , tim14lpen : self . tim14lpen () , lptim1lpen : self . lptim1lpen () , rtcapblpen : self . rtcapblpen () , wwdglpen : self . wwdglpen () , spi2lpen : self . spi2lpen () , spi3lpen : self . spi3lpen () , spdiflpen : self . spdiflpen () , usart2lpen : self . usart2lpen () , usart3lpen : self . usart3lpen () , uart4lpen : self . uart4lpen () , uart5lpen : self . uart5lpen () , i2c1lpen : self . i2c1lpen () , i2c2lpen : self . i2c2lpen () , i2c3lpen : self . i2c3lpen () , fmpi2c1lpen : self . fmpi2c1lpen () , can1lpen : self . can1lpen () , can2lpen : self . can2lpen () , can3lpen : self . can3lpen () , ceclpen : self . ceclpen () , pwrlpen : self . pwrlpen () , daclpen : self . daclpen () , uart7lpen : self . uart7lpen () , uart8lpen : self . uart8lpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1rstr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , tim12rst : bool , tim13rst : bool , tim14rst : bool , lptim1rst : bool , wwdgrst : bool , spi2rst : bool , spi3rst : bool , spdifrxrst : bool , usart2rst : bool , usart3rst : bool , uart4rst : bool , uart5rst : bool , i2c1rst : bool , i2c2rst : bool , i2c3rst : bool , fmpi2c1rst : bool , can1rst : bool , can2rst : bool , can3rst : bool , pwrrst : bool , dacrst : bool , uart7rst : bool , uart8rst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , tim12rst : self . tim12rst () , tim13rst : self . tim13rst () , tim14rst : self . tim14rst () , lptim1rst : self . lptim1rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , spi3rst : self . spi3rst () , spdifrxrst : self . spdifrxrst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , uart4rst : self . uart4rst () , uart5rst : self . uart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , i2c3rst : self . i2c3rst () , fmpi2c1rst : self . fmpi2c1rst () , can1rst : self . can1rst () , can2rst : self . can2rst () , can3rst : self . can3rst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , uart7rst : self . uart7rst () , uart8rst : self . uart8rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { tim1en : bool , tim8en : bool , usart1en : bool , usart6en : bool , uart9en : bool , uart10en : bool , adc1en : bool , adc2en : bool , adc3en : bool , sdioen : bool , spi1en : bool , spi4en : bool , syscfgen : bool , extiten : bool , tim9en : bool , tim10en : bool , tim11en : bool , spi5en : bool , spi6en : bool , sai1en : bool , sai2en : bool , dfsdmen : bool , dfsdm2en : bool , ltdcen : bool , dsien : bool , } let proxy = Apb2enr { tim1en : self . tim1en () , tim8en : self . tim8en () , usart1en : self . usart1en () , usart6en : self . usart6en () , uart9en : self . uart9en () , uart10en : self . uart10en () , adc1en : self . adc1en () , adc2en : self . adc2en () , adc3en : self . adc3en () , sdioen : self . sdioen () , spi1en : self . spi1en () , spi4en : self . spi4en () , syscfgen : self . syscfgen () , extiten : self . extiten () , tim9en : self . tim9en () , tim10en : self . tim10en () , tim11en : self . tim11en () , spi5en : self . spi5en () , spi6en : self . spi6en () , sai1en : self . sai1en () , sai2en : self . sai2en () , dfsdmen : self . dfsdmen () , dfsdm2en : self . dfsdm2en () , ltdcen : self . ltdcen () , dsien : self . dsien () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enabled in low power mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2lpenr { tim1lpen : bool , tim8lpen : bool , usart1lpen : bool , usart6lpen : bool , uart9lpen : bool , uart10lpen : bool , adc1lpen : bool , adc2lpen : bool , adc3lpen : bool , sdiolpen : bool , spi1lpen : bool , spi4lpen : bool , syscfglpen : bool , extitlpen : bool , tim9lpen : bool , tim10lpen : bool , tim11lpen : bool , spi5lpen : bool , spi6lpen : bool , sai1lpen : bool , sai2lpen : bool , dfsdmlpen : bool , dfsdm2lpen : bool , ltdclpen : bool , dsilpen : bool , } let proxy = Apb2lpenr { tim1lpen : self . tim1lpen () , tim8lpen : self . tim8lpen () , usart1lpen : self . usart1lpen () , usart6lpen : self . usart6lpen () , uart9lpen : self . uart9lpen () , uart10lpen : self . uart10lpen () , adc1lpen : self . adc1lpen () , adc2lpen : self . adc2lpen () , adc3lpen : self . adc3lpen () , sdiolpen : self . sdiolpen () , spi1lpen : self . spi1lpen () , spi4lpen : self . spi4lpen () , syscfglpen : self . syscfglpen () , extitlpen : self . extitlpen () , tim9lpen : self . tim9lpen () , tim10lpen : self . tim10lpen () , tim11lpen : self . tim11lpen () , spi5lpen : self . spi5lpen () , spi6lpen : self . spi6lpen () , sai1lpen : self . sai1lpen () , sai2lpen : self . sai2lpen () , dfsdmlpen : self . dfsdmlpen () , dfsdm2lpen : self . dfsdm2lpen () , ltdclpen : self . ltdclpen () , dsilpen : self . dsilpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { tim1rst : bool , tim8rst : bool , usart1rst : bool , usart6rst : bool , uart9rst : bool , uart10rst : bool , adcrst : bool , sdiorst : bool , spi1rst : bool , spi4rst : bool , syscfgrst : bool , tim9rst : bool , tim10rst : bool , tim11rst : bool , spi5rst : bool , spi6rst : bool , sai1rst : bool , sai2rst : bool , dfsdmrst : bool , dfsdm2rst : bool , ltdcrst : bool , dsirst : bool , } let proxy = Apb2rstr { tim1rst : self . tim1rst () , tim8rst : self . tim8rst () , usart1rst : self . usart1rst () , usart6rst : self . usart6rst () , uart9rst : self . uart9rst () , uart10rst : self . uart10rst () , adcrst : self . adcrst () , sdiorst : self . sdiorst () , spi1rst : self . spi1rst () , spi4rst : self . spi4rst () , syscfgrst : self . syscfgrst () , tim9rst : self . tim9rst () , tim10rst : self . tim10rst () , tim11rst : self . tim11rst () , spi5rst : self . spi5rst () , spi6rst : self . spi6rst () , sai1rst : self . sai1rst () , sai2rst : self . sai2rst () , dfsdmrst : self . dfsdmrst () , dfsdm2rst : self . dfsdm2rst () , ltdcrst : self . ltdcrst () , dsirst : self . dsirst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Bdcr { lseon : bool , lserdy : bool , lsebyp : bool , lsemod : super :: vals :: Lsemod , rtcsel : super :: vals :: Rtcsel , rtcen : bool , bdrst : bool , } let proxy = Bdcr { lseon : self . lseon () , lserdy : self . lserdy () , lsebyp : self . lsebyp () , lsemod : self . lsemod () , rtcsel : self . rtcsel () , rtcen : self . rtcen () , bdrst : self . bdrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr { sw : super :: vals :: Sw , sws : super :: vals :: Sw , hpre : super :: vals :: Hpre , mco1en : bool , mco2en : bool , ppre1 : super :: vals :: Ppre , ppre2 : super :: vals :: Ppre , rtcpre : u8 , mco1sel : super :: vals :: Mco1sel , i2ssrc : super :: vals :: I2ssrcCfgr , mco1pre : super :: vals :: Mcopre , mco2pre : super :: vals :: Mcopre , mco2sel : super :: vals :: Mco2sel , } let proxy = Cfgr { sw : self . sw () , sws : self . sws () , hpre : self . hpre () , mco1en : self . mco1en () , mco2en : self . mco2en () , ppre1 : self . ppre1 () , ppre2 : self . ppre2 () , rtcpre : self . rtcpre () , mco1sel : self . mco1sel () , i2ssrc : self . i2ssrc () , mco1pre : self . mco1pre () , mco2pre : self . mco2pre () , mco2sel : self . mco2sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cir { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cir { lsirdyf : bool , lserdyf : bool , hsirdyf : bool , hserdyf : bool , pllrdyf : bool , plli2srdyf : bool , pllsairdyf : bool , cssf : bool , lsirdyie : bool , lserdyie : bool , hsirdyie : bool , hserdyie : bool , pllrdyie : bool , plli2srdyie : bool , pllsairdyie : bool , lsirdyc : bool , lserdyc : bool , hsirdyc : bool , hserdyc : bool , pllrdyc : bool , plli2srdyc : bool , pllsairdyc : bool , cssc : bool , } let proxy = Cir { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , pllrdyf : self . pllrdyf () , plli2srdyf : self . plli2srdyf () , pllsairdyf : self . pllsairdyf () , cssf : self . cssf () , lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , pllrdyie : self . pllrdyie () , plli2srdyie : self . plli2srdyie () , pllsairdyie : self . pllsairdyie () , lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , pllrdyc : self . pllrdyc () , plli2srdyc : self . plli2srdyc () , pllsairdyc : self . pllsairdyc () , cssc : self . cssc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clocks gated enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Ckgatenr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ckgatenr { ahb2apb1_cken : bool , ahb2apb2_cken : bool , cm4dbg_cken : bool , spare_cken : bool , sram_cken : bool , flash_cken : bool , rcc_cken : bool , evtcl_cken : bool , } let proxy = Ckgatenr { ahb2apb1_cken : self . ahb2apb1_cken () , ahb2apb2_cken : self . ahb2apb2_cken () , cm4dbg_cken : self . cm4dbg_cken () , spare_cken : self . spare_cken () , sram_cken : self . sram_cken () , flash_cken : self . flash_cken () , rcc_cken : self . rcc_cken () , evtcl_cken : self . evtcl_cken () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { hsion : bool , hsirdy : bool , hsitrim : u8 , hsical : u8 , hseon : bool , hserdy : bool , hsebyp : bool , csson : bool , pllon : bool , pllrdy : bool , plli2son : bool , plli2srdy : bool , pllsaion : bool , pllsairdy : bool , } let proxy = Cr { hsion : self . hsion () , hsirdy : self . hsirdy () , hsitrim : self . hsitrim () , hsical : self . hsical () , hseon : self . hseon () , hserdy : self . hserdy () , hsebyp : self . hsebyp () , csson : self . csson () , pllon : self . pllon () , pllrdy : self . pllrdy () , plli2son : self . plli2son () , plli2srdy : self . plli2srdy () , pllsaion : self . pllsaion () , pllsairdy : self . pllsairdy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "clock control & status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { lsion : bool , lsirdy : bool , rmvf : bool , borrstf : bool , padrstf : bool , porrstf : bool , sftrstf : bool , wdgrstf : bool , wwdgrstf : bool , lpwrrstf : bool , } let proxy = Csr { lsion : self . lsion () , lsirdy : self . lsirdy () , rmvf : self . rmvf () , borrstf : self . borrstf () , padrstf : self . padrstf () , porrstf : self . porrstf () , sftrstf : self . sftrstf () , wdgrstf : self . wdgrstf () , wwdgrstf : self . wwdgrstf () , lpwrrstf : self . lpwrrstf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Dedicated Clock Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dckcfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dckcfgr { plli2sdivq : super :: vals :: Plli2sdivq , plli2sdivr : super :: vals :: Plli2sdivr , plldivr : super :: vals :: Plldivr , pllsaidivq : super :: vals :: Pllsaidivq , ckdfsdm2asel : super :: vals :: Ckdfsdmasel , ckdfsdm1asel : super :: vals :: Ckdfsdmasel , pllsaidivr : super :: vals :: Pllsaidivr , sai1asrc : super :: vals :: Saiasrc , sai1src : super :: vals :: Sai1src , sai1bsrc : super :: vals :: Saibsrc , sai2src : super :: vals :: Sai2src , timpre : super :: vals :: Timpre , i2s1src : super :: vals :: I2s1src , i2ssrc : super :: vals :: I2ssrcDckcfgr , clk48sel : super :: vals :: Clk48sel , i2s2src : super :: vals :: I2s1src , sdiosel : super :: vals :: Sdiosel , dsisel : super :: vals :: Dsisel , ckdfsdm1sel : super :: vals :: Ckdfsdmsel , } let proxy = Dckcfgr { plli2sdivq : self . plli2sdivq () , plli2sdivr : self . plli2sdivr () , plldivr : self . plldivr () , pllsaidivq : self . pllsaidivq () , ckdfsdm2asel : self . ckdfsdm2asel () , ckdfsdm1asel : self . ckdfsdm1asel () , pllsaidivr : self . pllsaidivr () , sai1asrc : self . sai1asrc () , sai1src : self . sai1src () , sai1bsrc : self . sai1bsrc () , sai2src : self . sai2src () , timpre : self . timpre () , i2s1src : self . i2s1src () , i2ssrc : self . i2ssrc () , clk48sel : self . clk48sel () , i2s2src : self . i2s2src () , sdiosel : self . sdiosel () , dsisel : self . dsisel () , ckdfsdm1sel : self . ckdfsdm1sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "dedicated clocks configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Dckcfgr2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Dckcfgr2 { fmpi2c1sel : super :: vals :: Fmpi2csel , cecsel : super :: vals :: Cecsel , clk48sel : super :: vals :: Clk48sel , sdiosel : super :: vals :: Sdiosel , spdifrxsel : super :: vals :: Spdifrxsel , lptim1sel : super :: vals :: Lptimsel , } let proxy = Dckcfgr2 { fmpi2c1sel : self . fmpi2c1sel () , cecsel : self . cecsel () , clk48sel : self . clk48sel () , sdiosel : self . sdiosel () , spdifrxsel : self . spdifrxsel () , lptim1sel : self . lptim1sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Pllcfgr { pllm : super :: vals :: Pllm , plln : super :: vals :: Plln , pllp : super :: vals :: Pllp , pllsrc : super :: vals :: Pllsrc , pllq : super :: vals :: Pllq , pllr : super :: vals :: Pllr , } let proxy = Pllcfgr { pllm : self . pllm () , plln : self . plln () , pllp : self . pllp () , pllsrc : self . pllsrc () , pllq : self . pllq () , pllr : self . pllr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PLLI2S configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Plli2scfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Plli2scfgr { pllm : super :: vals :: Pllm , plln : super :: vals :: Plln , pllp : super :: vals :: Pllp , plli2ssrc : super :: vals :: Plli2ssrc , pllsrc : super :: vals :: Pllsrc , pllq : super :: vals :: Pllq , pllr : super :: vals :: Pllr , } let proxy = Plli2scfgr { pllm : self . pllm () , plln : self . plln () , pllp : self . pllp () , plli2ssrc : self . plli2ssrc () , pllsrc : self . pllsrc () , pllq : self . pllq () , pllr : self . pllr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PLL configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pllsaicfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Pllsaicfgr { pllm : super :: vals :: Pllm , plln : super :: vals :: Plln , pllp : super :: vals :: Pllp , pllsrc : super :: vals :: Pllsrc , pllq : super :: vals :: Pllq , pllr : super :: vals :: Pllr , } let proxy = Pllsaicfgr { pllm : self . pllm () , plln : self . plln () , pllp : self . pllp () , pllsrc : self . pllsrc () , pllq : self . pllq () , pllr : self . pllr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "spread spectrum clock generation register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Sscgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sscgr { modper : u16 , incstep : u16 , spreadsel : super :: vals :: Spreadsel , sscgen : bool , } let proxy = Sscgr { modper : self . modper () , incstep : self . incstep () , spreadsel : self . spreadsel () , sscgen : self . sscgen () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

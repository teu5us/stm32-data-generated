...
struct Cr1 { cpha : super :: vals :: Cpha , cpol : super :: vals :: Cpol , mstr : super :: vals :: Mstr , br : super :: vals :: Br , spe : bool , lsbfirst : super :: vals :: Lsbfirst , ssi : bool , ssm : bool , rxonly : super :: vals :: Rxonly , dff : super :: vals :: Dff , crcnext : super :: vals :: Crcnext , crcen : bool , bidioe : super :: vals :: Bidioe , bidimode : super :: vals :: Bidimode , } let proxy = Cr1 { cpha : self . cpha () , cpol : self . cpol () , mstr : self . mstr () , br : self . br () , spe : self . spe () , lsbfirst : self . lsbfirst () , ssi : self . ssi () , ssm : self . ssm () , rxonly : self . rxonly () , dff : self . dff () , crcnext : self . crcnext () , crcen : self . crcen () , bidioe : self . bidioe () , bidimode : self . bidimode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { rxdmaen : bool , txdmaen : bool , ssoe : bool , frf : super :: vals :: Frf , errie : bool , rxneie : bool , txeie : bool , } let proxy = Cr2 { rxdmaen : self . rxdmaen () , txdmaen : self . txdmaen () , ssoe : self . ssoe () , frf : self . frf () , errie : self . errie () , rxneie : self . rxneie () , txeie : self . txeie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CRC polynomial register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Crcpr { crcpoly : u16 , } let proxy = Crcpr { crcpoly : self . crcpoly () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { dr : u16 , } let proxy = Dr { dr : self . dr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "I2S configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct I2scfgr { chlen : super :: vals :: Chlen , datlen : super :: vals :: Datlen , ckpol : super :: vals :: Ckpol , i2sstd : super :: vals :: I2sstd , pcmsync : super :: vals :: Pcmsync , i2scfg : super :: vals :: I2scfg , i2se : bool , i2smod : bool , } let proxy = I2scfgr { chlen : self . chlen () , datlen : self . datlen () , ckpol : self . ckpol () , i2sstd : self . i2sstd () , pcmsync : self . pcmsync () , i2scfg : self . i2scfg () , i2se : self . i2se () , i2smod : self . i2smod () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "I2S prescaler register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { rxne : bool , txe : bool , chside : super :: vals :: Chside , udr : bool , crcerr : bool , modf : bool , ovr : bool , bsy : bool , fre : bool , } let proxy = Sr { rxne : self . rxne () , txe : self . txe () , chside : self . chside () , udr : self . udr () , crcerr : self . crcerr () , modf : self . modf () , ovr : self . ovr () , bsy : self . bsy () , fre : self . fre () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "TX CRC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
struct Acr { latency : u8 , wrhighfreq : u8 , } let proxy = Acr { latency : self . latency () , wrhighfreq : self . wrhighfreq () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH register with boot address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for BootCurr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct BootCurr { boot_add0 : u16 , boot_add1 : u16 , } let proxy = BootCurr { boot_add0 : self . boot_add0 () , boot_add1 : self . boot_add1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH register with boot address"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for BootPrgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct BootPrgr { boot_add0 : u16 , boot_add1 : u16 , } let proxy = BootPrgr { boot_add0 : self . boot_add0 () , boot_add1 : self . boot_add1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH clear control register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccr { clr_eop : bool , clr_wrperr : bool , clr_pgserr : bool , clr_strberr : bool , clr_incerr : bool , clr_operr : bool , clr_rdperr : bool , clr_rdserr : bool , clr_sneccerr : bool , clr_dbeccerr : bool , clr_crcend : bool , clr_crcrderr : bool , } let proxy = Ccr { clr_eop : self . clr_eop () , clr_wrperr : self . clr_wrperr () , clr_pgserr : self . clr_pgserr () , clr_strberr : self . clr_strberr () , clr_incerr : self . clr_incerr () , clr_operr : self . clr_operr () , clr_rdperr : self . clr_rdperr () , clr_rdserr : self . clr_rdserr () , clr_sneccerr : self . clr_sneccerr () , clr_dbeccerr : self . clr_dbeccerr () , clr_crcend : self . clr_crcend () , clr_crcrderr : self . clr_crcrderr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH control register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { lock : bool , pg : bool , ser : bool , ber : bool , fw : bool , start : bool , ssn : u8 , crc_en : bool , eopie : bool , wrperrie : bool , pgserrie : bool , strberrie : bool , incerrie : bool , operrie : bool , rdperrie : bool , rdserrie : bool , sneccerrie : bool , dbeccerrie : bool , crcendie : bool , crcrderrie : bool , } let proxy = Cr { lock : self . lock () , pg : self . pg () , ser : self . ser () , ber : self . ber () , fw : self . fw () , start : self . start () , ssn : self . ssn () , crc_en : self . crc_en () , eopie : self . eopie () , wrperrie : self . wrperrie () , pgserrie : self . pgserrie () , strberrie : self . strberrie () , incerrie : self . incerrie () , operrie : self . operrie () , rdperrie : self . rdperrie () , rdserrie : self . rdserrie () , sneccerrie : self . sneccerrie () , dbeccerrie : self . dbeccerrie () , crcendie : self . crcendie () , crcrderrie : self . crcrderrie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH CRC control register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Crccr { crc_sect : u8 , all_bank : bool , crc_by_sect : bool , add_sect : bool , clean_sect : bool , start_crc : bool , clean_crc : bool , crc_burst : u8 , } let proxy = Crccr { crc_sect : self . crc_sect () , all_bank : self . all_bank () , crc_by_sect : self . crc_by_sect () , add_sect : self . add_sect () , clean_sect : self . clean_sect () , start_crc : self . start_crc () , clean_crc : self . clean_crc () , crc_burst : self . crc_burst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH CRC data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Crcdatar { crc_data : u32 , } let proxy = Crcdatar { crc_data : self . crc_data () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH CRC end address register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Crceaddr { crc_end_addr : u32 , } let proxy = Crceaddr { crc_end_addr : self . crc_end_addr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH CRC start address register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Crcsaddr { crc_start_addr : u32 , } let proxy = Crcsaddr { crc_start_addr : self . crc_start_addr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH ECC fail address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Far { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Far { fail_ecc_addr : u16 , } let proxy = Far { fail_ecc_addr : self . fail_ecc_addr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH option clear control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Optccr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Optccr { clr_optchangeerr : bool , } let proxy = Optccr { clr_optchangeerr : self . clr_optchangeerr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH option control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Optcr { optlock : bool , optstart : bool , mer : bool , pg_otp : bool , optchangeerrie : bool , swap_bank : bool , } let proxy = Optcr { optlock : self . optlock () , optstart : self . optstart () , mer : self . mer () , pg_otp : self . pg_otp () , optchangeerrie : self . optchangeerrie () , swap_bank : self . swap_bank () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH option status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for OptsrCur { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct OptsrCur { opt_busy : bool , bor_lev : u8 , iwdg1_hw : bool , n_rst_stop_d1 : bool , n_rst_stby_d1 : bool , rdp : u8 , fz_iwdg_stop : bool , fz_iwdg_sdby : bool , st_ram_size : u8 , security : bool , rss1 : bool , perso_ok : bool , io_hslv : bool , optchangeerr : bool , swap_bank_opt : bool , } let proxy = OptsrCur { opt_busy : self . opt_busy () , bor_lev : self . bor_lev () , iwdg1_hw : self . iwdg1_hw () , n_rst_stop_d1 : self . n_rst_stop_d1 () , n_rst_stby_d1 : self . n_rst_stby_d1 () , rdp : self . rdp () , fz_iwdg_stop : self . fz_iwdg_stop () , fz_iwdg_sdby : self . fz_iwdg_sdby () , st_ram_size : self . st_ram_size () , security : self . security () , rss1 : self . rss1 () , perso_ok : self . perso_ok () , io_hslv : self . io_hslv () , optchangeerr : self . optchangeerr () , swap_bank_opt : self . swap_bank_opt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH option status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for OptsrPrg { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct OptsrPrg { bor_lev : u8 , iwdg1_hw : bool , n_rst_stop_d1 : bool , n_rst_stby_d1 : bool , rdp : u8 , fz_iwdg_stop : bool , fz_iwdg_sdby : bool , st_ram_size : u8 , security : bool , rss1 : bool , rss2 : bool , io_hslv : bool , swap_bank_opt : bool , } let proxy = OptsrPrg { bor_lev : self . bor_lev () , iwdg1_hw : self . iwdg1_hw () , n_rst_stop_d1 : self . n_rst_stop_d1 () , n_rst_stby_d1 : self . n_rst_stby_d1 () , rdp : self . rdp () , fz_iwdg_stop : self . fz_iwdg_stop () , fz_iwdg_sdby : self . fz_iwdg_sdby () , st_ram_size : self . st_ram_size () , security : self . security () , rss1 : self . rss1 () , rss2 : self . rss2 () , io_hslv : self . io_hslv () , swap_bank_opt : self . swap_bank_opt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH protection address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for PrarCur { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct PrarCur { prot_area_start : u16 , prot_area_end : u16 , dmep : bool , } let proxy = PrarCur { prot_area_start : self . prot_area_start () , prot_area_end : self . prot_area_end () , dmep : self . dmep () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH protection address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for PrarPrg { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct PrarPrg { prot_area_start : u16 , prot_area_end : u16 , dmep : bool , } let proxy = PrarPrg { prot_area_start : self . prot_area_start () , prot_area_end : self . prot_area_end () , dmep : self . dmep () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH secure address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for ScarCur { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct ScarCur { sec_area_start : u16 , sec_area_end : u16 , dmes : bool , } let proxy = ScarCur { sec_area_start : self . sec_area_start () , sec_area_end : self . sec_area_end () , dmes : self . dmes () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH secure address for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for ScarPrg { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct ScarPrg { sec_area_start : u16 , sec_area_end : u16 , dmes : bool , } let proxy = ScarPrg { sec_area_start : self . sec_area_start () , sec_area_end : self . sec_area_end () , dmes : self . dmes () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH status register for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { bsy : bool , wbne : bool , qw : bool , crc_busy : bool , eop : bool , wrperr : bool , pgserr : bool , strberr : bool , incerr : bool , operr : bool , rdperr : bool , rdserr : bool , sneccerr1 : bool , dbeccerr : bool , crcend : bool , crcrderr : bool , } let proxy = Sr { bsy : self . bsy () , wbne : self . wbne () , qw : self . qw () , crc_busy : self . crc_busy () , eop : self . eop () , wrperr : self . wrperr () , pgserr : self . pgserr () , strberr : self . strberr () , incerr : self . incerr () , operr : self . operr () , rdperr : self . rdperr () , rdserr : self . rdserr () , sneccerr1 : self . sneccerr1 () , dbeccerr : self . dbeccerr () , crcend : self . crcend () , crcrderr : self . crcrderr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH write sector protection for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for WpsnCurr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct WpsnCurr { wrpsn : u8 , } let proxy = WpsnCurr { wrpsn : self . wrpsn () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "FLASH write sector protection for bank 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for WpsnPrgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct WpsnPrgr { wrpsn : u8 , } let proxy = WpsnPrgr { wrpsn : self . wrpsn () , } ; defmt :: write ! (f , "{}" , proxy) } } }
...
struct Ahbenr { dmaen : bool , dma2en : bool , sramen : bool , flashen : bool , crcen : bool , gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , gpiofen : bool , tscen : bool , } let proxy = Ahbenr { dmaen : self . dmaen () , dma2en : self . dma2en () , sramen : self . sramen () , flashen : self . flashen () , crcen : self . crcen () , gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , gpiofen : self . gpiofen () , tscen : self . tscen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim2en : bool , tim3en : bool , tim6en : bool , tim7en : bool , tim14en : bool , wwdgen : bool , spi2en : bool , usart2en : bool , usart3en : bool , usart4en : bool , usart5en : bool , i2c1en : bool , i2c2en : bool , usben : bool , canen : bool , crsen : bool , pwren : bool , dacen : bool , cecen : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim6en : self . tim6en () , tim7en : self . tim7en () , tim14en : self . tim14en () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , usart2en : self . usart2en () , usart3en : self . usart3en () , usart4en : self . usart4en () , usart5en : self . usart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , usben : self . usben () , canen : self . canen () , crsen : self . crsen () , pwren : self . pwren () , dacen : self . dacen () , cecen : self . cecen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register (RCC_APB1RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim6rst : bool , tim7rst : bool , tim14rst : bool , wwdgrst : bool , spi2rst : bool , usart2rst : bool , usart3rst : bool , usart4rst : bool , usart5rst : bool , i2c1rst : bool , i2c2rst : bool , usbrst : bool , canrst : bool , crsrst : bool , pwrrst : bool , dacrst : bool , cecrst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , tim14rst : self . tim14rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , usart4rst : self . usart4rst () , usart5rst : self . usart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , usbrst : self . usbrst () , canrst : self . canrst () , crsrst : self . crsrst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , cecrst : self . cecrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register (RCC_APB2ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { syscfgen : bool , usart6en : bool , usart7en : bool , usart8en : bool , adcen : bool , tim1en : bool , spi1en : bool , usart1en : bool , tim15en : bool , tim16en : bool , tim17en : bool , dbgmcuen : bool , } let proxy = Apb2enr { syscfgen : self . syscfgen () , usart6en : self . usart6en () , usart7en : self . usart7en () , usart8en : self . usart8en () , adcen : self . adcen () , tim1en : self . tim1en () , spi1en : self . spi1en () , usart1en : self . usart1en () , tim15en : self . tim15en () , tim16en : self . tim16en () , tim17en : self . tim17en () , dbgmcuen : self . dbgmcuen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register (RCC_APB2RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { syscfgrst : bool , usart6rst : bool , usart7rst : bool , usart8rst : bool , adcrst : bool , tim1rst : bool , spi1rst : bool , usart1rst : bool , tim15rst : bool , tim16rst : bool , tim17rst : bool , dbgmcurst : bool , } let proxy = Apb2rstr { syscfgrst : self . syscfgrst () , usart6rst : self . usart6rst () , usart7rst : self . usart7rst () , usart8rst : self . usart8rst () , adcrst : self . adcrst () , tim1rst : self . tim1rst () , spi1rst : self . spi1rst () , usart1rst : self . usart1rst () , tim15rst : self . tim15rst () , tim16rst : self . tim16rst () , tim17rst : self . tim17rst () , dbgmcurst : self . dbgmcurst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register (RCC_BDCR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr { sw : super :: vals :: Sw , sws : super :: vals :: Sw , hpre : super :: vals :: Hpre , ppre : super :: vals :: Ppre , adcpre : bool , pllsrc : super :: vals :: Pllsrc , pllxtpre : super :: vals :: Pllxtpre , pllmul : super :: vals :: Pllmul , mcosel : super :: vals :: Mcosel , mcopre : super :: vals :: Mcopre , pllmcodiv : super :: vals :: Pllmcodiv , } let proxy = Cfgr { sw : self . sw () , sws : self . sws () , hpre : self . hpre () , ppre : self . ppre () , adcpre : self . adcpre () , pllsrc : self . pllsrc () , pllxtpre : self . pllxtpre () , pllmul : self . pllmul () , mcosel : self . mcosel () , mcopre : self . mcopre () , pllmcodiv : self . pllmcodiv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { prediv : super :: vals :: Prediv , } let proxy = Cfgr2 { prediv : self . prediv () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr3 { usart1sw : super :: vals :: Usart1sw , i2c1sw : super :: vals :: Icsw , cecsw : super :: vals :: Cecsw , usbsw : super :: vals :: Usbsw , adcsw : bool , usart2sw : super :: vals :: Usartsw , usart3sw : super :: vals :: Usartsw , } let proxy = Cfgr3 { usart1sw : self . usart1sw () , i2c1sw : self . i2c1sw () , cecsw : self . cecsw () , usbsw : self . usbsw () , adcsw : self . adcsw () , usart2sw : self . usart2sw () , usart3sw : self . usart3sw () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt register (RCC_CIR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cir { lsirdyf : bool , lserdyf : bool , hsirdyf : bool , hserdyf : bool , pllrdyf : bool , hsi14rdyf : bool , hsi48rdyf : bool , cssf : bool , lsirdyie : bool , lserdyie : bool , hsirdyie : bool , hserdyie : bool , pllrdyie : bool , hsi14rdyie : bool , hsi48rdyie : bool , lsirdyc : bool , lserdyc : bool , hsirdyc : bool , hserdyc : bool , pllrdyc : bool , hsi14rdyc : bool , hsi48rdyc : bool , cssc : bool , } let proxy = Cir { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , pllrdyf : self . pllrdyf () , hsi14rdyf : self . hsi14rdyf () , hsi48rdyf : self . hsi48rdyf () , cssf : self . cssf () , lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , pllrdyie : self . pllrdyie () , hsi14rdyie : self . hsi14rdyie () , hsi48rdyie : self . hsi48rdyie () , lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , pllrdyc : self . pllrdyc () , hsi14rdyc : self . hsi14rdyc () , hsi48rdyc : self . hsi48rdyc () , cssc : self . cssc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { hsi14on : bool , hsi14rdy : bool , hsi14dis : bool , hsi14trim : u8 , hsi14cal : u8 , hsi48on : bool , hsi48rdy : bool , hsi48cal : u8 , } let proxy = Cr2 { hsi14on : self . hsi14on () , hsi14rdy : self . hsi14rdy () , hsi14dis : self . hsi14dis () , hsi14trim : self . hsi14trim () , hsi14cal : self . hsi14cal () , hsi48on : self . hsi48on () , hsi48rdy : self . hsi48rdy () , hsi48cal : self . hsi48cal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control/status register (RCC_CSR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
struct Cr { en : bool , datatype : super :: vals :: Datatype , mode : super :: vals :: Mode , chmod10 : u8 , ccfc : bool , errc : bool , ccfie : bool , errie : bool , dmainen : bool , dmaouten : bool , gcmph : super :: vals :: Gcmph , chmod2 : bool , keysize : bool , } let proxy = Cr { en : self . en () , datatype : self . datatype () , mode : self . mode () , chmod10 : self . chmod10 () , ccfc : self . ccfc () , errc : self . errc () , ccfie : self . ccfie () , errie : self . errie () , dmainen : self . dmainen () , dmaouten : self . dmaouten () , gcmph : self . gcmph () , chmod2 : self . chmod2 () , keysize : self . keysize () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

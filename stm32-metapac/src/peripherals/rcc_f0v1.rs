...
struct Cfgr { sw : super :: vals :: Sw , sws : super :: vals :: Sw , hpre : super :: vals :: Hpre , ppre : super :: vals :: Ppre , adcpre : bool , pllsrc : super :: vals :: Pllsrc , pllxtpre : super :: vals :: Pllxtpre , pllmul : super :: vals :: Pllmul , mcosel : super :: vals :: Mcosel , } let proxy = Cfgr { sw : self . sw () , sws : self . sws () , hpre : self . hpre () , ppre : self . ppre () , adcpre : self . adcpre () , pllsrc : self . pllsrc () , pllxtpre : self . pllxtpre () , pllmul : self . pllmul () , mcosel : self . mcosel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

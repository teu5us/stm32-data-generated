...
struct Cr1 { pe : bool , txie : bool , rxie : bool , addrie : bool , nackie : bool , stopie : bool , tcie : bool , errie : bool , dnf : super :: vals :: Dnf , anfoff : bool , txdmaen : bool , rxdmaen : bool , sbc : bool , nostretch : bool , gcen : bool , smbhen : bool , smbden : bool , alerten : bool , pecen : bool , } let proxy = Cr1 { pe : self . pe () , txie : self . txie () , rxie : self . rxie () , addrie : self . addrie () , nackie : self . nackie () , stopie : self . stopie () , tcie : self . tcie () , errie : self . errie () , dnf : self . dnf () , anfoff : self . anfoff () , txdmaen : self . txdmaen () , rxdmaen : self . rxdmaen () , sbc : self . sbc () , nostretch : self . nostretch () , gcen : self . gcen () , smbhen : self . smbhen () , smbden : self . smbden () , alerten : self . alerten () , pecen : self . pecen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
impl defmt :: Format for Cfg1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfg1 { dsize : u8 , fthlv : super :: vals :: Fthlv , udrcfg : super :: vals :: Udrcfg , udrdet : super :: vals :: Udrdet , rxdmaen : bool , txdmaen : bool , crcsize : u8 , crcen : bool , mbr : super :: vals :: Mbr , } let proxy = Cfg1 { dsize : self . dsize () , fthlv : self . fthlv () , udrcfg : self . udrcfg () , udrdet : self . udrdet () , rxdmaen : self . rxdmaen () , txdmaen : self . txdmaen () , crcsize : self . crcsize () , crcen : self . crcen () , mbr : self . mbr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Cfg2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cfg2 { mssi : u8 , midi : u8 , ioswp : bool , comm : super :: vals :: Comm , sp : super :: vals :: Sp , master : super :: vals :: Master , lsbfirst : super :: vals :: Lsbfirst , cpha : super :: vals :: Cpha , cpol : super :: vals :: Cpol , ssm : bool , ssiop : super :: vals :: Ssiop , ssoe : bool , ssom : super :: vals :: Ssom , afcntr : bool , } let proxy = Cfg2 { mssi : self . mssi () , midi : self . midi () , ioswp : self . ioswp () , comm : self . comm () , sp : self . sp () , master : self . master () , lsbfirst : self . lsbfirst () , cpha : self . cpha () , cpol : self . cpol () , ssm : self . ssm () , ssiop : self . ssiop () , ssoe : self . ssoe () , ssom : self . ssom () , afcntr : self . afcntr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr1 { spe : bool , masrx : bool , cstart : bool , csusp : bool , hddir : super :: vals :: Hddir , ssi : bool , crc33_17 : bool , rcrcini : super :: vals :: Rcrcini , tcrcini : super :: vals :: Tcrcini , iolock : bool , } let proxy = Cr1 { spe : self . spe () , masrx : self . masrx () , cstart : self . cstart () , csusp : self . csusp () , hddir : self . hddir () , ssi : self . ssi () , crc33_17 : self . crc33_17 () , rcrcini : self . rcrcini () , tcrcini : self . tcrcini () , iolock : self . iolock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { tsize : u16 , tser : u16 , } let proxy = Cr2 { tsize : self . tsize () , tser : self . tser () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Polynomial Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Crcpoly { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Crcpoly { crcpoly : u32 , } let proxy = Crcpoly { crcpoly : self . crcpoly () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "I2S Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for I2scfgr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct I2scfgr { i2smod : bool , i2scfg : super :: vals :: I2scfg , i2sstd : super :: vals :: I2sstd , pcmsync : super :: vals :: Pcmsync , datlen : super :: vals :: Datlen , chlen : super :: vals :: Chlen , ckpol : super :: vals :: Ckpol , fixch : super :: vals :: Fixch , wsinv : bool , datfmt : super :: vals :: Datfmt , i2sdiv : u8 , odd : super :: vals :: Odd , mckoe : bool , } let proxy = I2scfgr { i2smod : self . i2smod () , i2scfg : self . i2scfg () , i2sstd : self . i2sstd () , pcmsync : self . pcmsync () , datlen : self . datlen () , chlen : self . chlen () , ckpol : self . ckpol () , fixch : self . fixch () , wsinv : self . wsinv () , datfmt : self . datfmt () , i2sdiv : self . i2sdiv () , odd : self . odd () , mckoe : self . mckoe () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt Enable Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ier { rxpie : bool , txpie : bool , dxpie : bool , eotie : bool , txtfie : bool , udrie : bool , ovrie : bool , crceie : bool , tifreie : bool , modfie : bool , tserfie : bool , } let proxy = Ier { rxpie : self . rxpie () , txpie : self . txpie () , dxpie : self . dxpie () , eotie : self . eotie () , txtfie : self . txtfie () , udrie : self . udrie () , ovrie : self . ovrie () , crceie : self . crceie () , tifreie : self . tifreie () , modfie : self . modfie () , tserfie : self . tserfie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt/Status Flags Clear Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ifcr { eotc : bool , txtfc : bool , udrc : bool , ovrc : bool , crcec : bool , tifrec : bool , modfc : bool , tserfc : bool , suspc : bool , } let proxy = Ifcr { eotc : self . eotc () , txtfc : self . txtfc () , udrc : self . udrc () , ovrc : self . ovrc () , crcec : self . crcec () , tifrec : self . tifrec () , modfc : self . modfc () , tserfc : self . tserfc () , suspc : self . suspc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Receiver CRC Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Rxcrc { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Rxcrc { rxcrc : u32 , } let proxy = Rxcrc { rxcrc : self . rxcrc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { rxp : bool , txp : bool , dxp : bool , eot : bool , txtf : bool , udr : bool , ovr : bool , crce : bool , tifre : bool , modf : bool , tserf : bool , susp : bool , txc : bool , rxplvl : super :: vals :: Rxplvl , rxwne : super :: vals :: Rxwne , ctsize : u16 , } let proxy = Sr { rxp : self . rxp () , txp : self . txp () , dxp : self . dxp () , eot : self . eot () , txtf : self . txtf () , udr : self . udr () , ovr : self . ovr () , crce : self . crce () , tifre : self . tifre () , modf : self . modf () , tserf : self . tserf () , susp : self . susp () , txc : self . txc () , rxplvl : self . rxplvl () , rxwne : self . rxwne () , ctsize : self . ctsize () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Transmitter CRC Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Txcrc { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Txcrc { txcrc : u32 , } let proxy = Txcrc { txcrc : self . txcrc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Underrun Data Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Udrdr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Udrdr { udrdr : u32 , } let proxy = Udrdr { udrdr : self . udrdr () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

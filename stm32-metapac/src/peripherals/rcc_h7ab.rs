...
struct Ahb2enr { dcmien : bool , crypen : bool , hashen : bool , rngen : bool , sdmmc2en : bool , bdma1en : bool , fmacen : bool , cordicen : bool , sram1en : bool , sram2en : bool , sram3en : bool , } let proxy = Ahb2enr { dcmien : self . dcmien () , crypen : self . crypen () , hashen : self . hashen () , rngen : self . rngen () , sdmmc2en : self . sdmmc2en () , bdma1en : self . bdma1en () , fmacen : self . fmacen () , cordicen : self . cordicen () , sram1en : self . sram1en () , sram2en : self . sram2en () , sram3en : self . sram3en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 Sleep Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2lpenr { dcmilpen : bool , cryplpen : bool , hashlpen : bool , rnglpen : bool , sdmmc2lpen : bool , bdma1lpen : bool , fmaclpen : bool , cordiclpen : bool , sram1lpen : bool , sram2lpen : bool , sram3lpen : bool , } let proxy = Ahb2lpenr { dcmilpen : self . dcmilpen () , cryplpen : self . cryplpen () , hashlpen : self . hashlpen () , rnglpen : self . rnglpen () , sdmmc2lpen : self . sdmmc2lpen () , bdma1lpen : self . bdma1lpen () , fmaclpen : self . fmaclpen () , cordiclpen : self . cordiclpen () , sram1lpen : self . sram1lpen () , sram2lpen : self . sram2lpen () , sram3lpen : self . sram3lpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB2 Peripheral Reset Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb2rstr { dcmirst : bool , cryprst : bool , hashrst : bool , rngrst : bool , sdmmc2rst : bool , bdma1rst : bool , fmacrst : bool , cordicrst : bool , } let proxy = Ahb2rstr { dcmirst : self . dcmirst () , cryprst : self . cryprst () , hashrst : self . hashrst () , rngrst : self . rngrst () , sdmmc2rst : self . sdmmc2rst () , bdma1rst : self . bdma1rst () , fmacrst : self . fmacrst () , cordicrst : self . cordicrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB3 Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3lpenr { mdmalpen : bool , dma2dlpen : bool , jpgdeclpen : bool , flashlpen : bool , fmclpen : bool , octospi1lpen : bool , sdmmc1lpen : bool , octospi2lpen : bool , iomngrlpen : bool , otfd1lpen : bool , otfd2lpen : bool , d1dtcm1lpen : bool , dtcm2lpen : bool , itcmlpen : bool , axisramlpen : bool , } let proxy = Ahb3lpenr { mdmalpen : self . mdmalpen () , dma2dlpen : self . dma2dlpen () , jpgdeclpen : self . jpgdeclpen () , flashlpen : self . flashlpen () , fmclpen : self . fmclpen () , octospi1lpen : self . octospi1lpen () , sdmmc1lpen : self . sdmmc1lpen () , octospi2lpen : self . octospi2lpen () , iomngrlpen : self . iomngrlpen () , otfd1lpen : self . otfd1lpen () , otfd2lpen : self . otfd2lpen () , d1dtcm1lpen : self . d1dtcm1lpen () , dtcm2lpen : self . dtcm2lpen () , itcmlpen : self . itcmlpen () , axisramlpen : self . axisramlpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB3 Reset Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3rstr { mdmarst : bool , dma2drst : bool , jpgdecrst : bool , fmcrst : bool , octospi1rst : bool , sdmmc1rst : bool , octospi2rst : bool , iomngrrst : bool , otfd1rst : bool , otfd2rst : bool , cpurst : bool , } let proxy = Ahb3rstr { mdmarst : self . mdmarst () , dma2drst : self . dma2drst () , jpgdecrst : self . jpgdecrst () , fmcrst : self . fmcrst () , octospi1rst : self . octospi1rst () , sdmmc1rst : self . sdmmc1rst () , octospi2rst : self . octospi2rst () , iomngrrst : self . iomngrrst () , otfd1rst : self . otfd1rst () , otfd2rst : self . otfd2rst () , cpurst : self . cpurst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB4 Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb4enr { gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , gpiofen : bool , gpiogen : bool , gpiohen : bool , gpioien : bool , gpiojen : bool , gpioken : bool , crcen : bool , bdma2en : bool , bdmaen : bool , adc3en : bool , hsemen : bool , bkpsramen : bool , } let proxy = Ahb4enr { gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , gpiofen : self . gpiofen () , gpiogen : self . gpiogen () , gpiohen : self . gpiohen () , gpioien : self . gpioien () , gpiojen : self . gpiojen () , gpioken : self . gpioken () , crcen : self . crcen () , bdma2en : self . bdma2en () , bdmaen : self . bdmaen () , adc3en : self . adc3en () , hsemen : self . hsemen () , bkpsramen : self . bkpsramen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC AHB4 Sleep Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb4rstr { gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiodrst : bool , gpioerst : bool , gpiofrst : bool , gpiogrst : bool , gpiohrst : bool , gpioirst : bool , gpiojrst : bool , gpiokrst : bool , crcrst : bool , bdma2rst : bool , bdmarst : bool , adc3rst : bool , hsemrst : bool , } let proxy = Ahb4rstr { gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiodrst : self . gpiodrst () , gpioerst : self . gpioerst () , gpiofrst : self . gpiofrst () , gpiogrst : self . gpiogrst () , gpiohrst : self . gpiohrst () , gpioirst : self . gpioirst () , gpiojrst : self . gpiojrst () , gpiokrst : self . gpiokrst () , crcrst : self . crcrst () , bdma2rst : self . bdma2rst () , bdmarst : self . bdmarst () , adc3rst : self . adc3rst () , hsemrst : self . hsemrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1lenr { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , tim12en : bool , tim13en : bool , tim14en : bool , lptim1en : bool , wwdg2en : bool , spi2en : bool , spi3en : bool , spdifrxen : bool , usart2en : bool , usart3en : bool , uart4en : bool , uart5en : bool , i2c1en : bool , i2c2en : bool , i2c3en : bool , i2c5en : bool , cecen : bool , dac1en : bool , uart7en : bool , uart8en : bool , } let proxy = Apb1lenr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , tim12en : self . tim12en () , tim13en : self . tim13en () , tim14en : self . tim14en () , lptim1en : self . lptim1en () , wwdg2en : self . wwdg2en () , spi2en : self . spi2en () , spi3en : self . spi3en () , spdifrxen : self . spdifrxen () , usart2en : self . usart2en () , usart3en : self . usart3en () , uart4en : self . uart4en () , uart5en : self . uart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , i2c3en : self . i2c3en () , i2c5en : self . i2c5en () , cecen : self . cecen () , dac1en : self . dac1en () , uart7en : self . uart7en () , uart8en : self . uart8en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 Low Sleep Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1llpenr { tim2lpen : bool , tim3lpen : bool , tim4lpen : bool , tim5lpen : bool , tim6lpen : bool , tim7lpen : bool , tim12lpen : bool , tim13lpen : bool , tim14lpen : bool , lptim1lpen : bool , wwdg2lpen : bool , spi2lpen : bool , spi3lpen : bool , spdifrxlpen : bool , usart2lpen : bool , usart3lpen : bool , uart4lpen : bool , uart5lpen : bool , i2c1lpen : bool , i2c2lpen : bool , i2c3lpen : bool , i2c5lpen : bool , ceclpen : bool , dac1lpen : bool , uart7lpen : bool , uart8lpen : bool , } let proxy = Apb1llpenr { tim2lpen : self . tim2lpen () , tim3lpen : self . tim3lpen () , tim4lpen : self . tim4lpen () , tim5lpen : self . tim5lpen () , tim6lpen : self . tim6lpen () , tim7lpen : self . tim7lpen () , tim12lpen : self . tim12lpen () , tim13lpen : self . tim13lpen () , tim14lpen : self . tim14lpen () , lptim1lpen : self . lptim1lpen () , wwdg2lpen : self . wwdg2lpen () , spi2lpen : self . spi2lpen () , spi3lpen : self . spi3lpen () , spdifrxlpen : self . spdifrxlpen () , usart2lpen : self . usart2lpen () , usart3lpen : self . usart3lpen () , uart4lpen : self . uart4lpen () , uart5lpen : self . uart5lpen () , i2c1lpen : self . i2c1lpen () , i2c2lpen : self . i2c2lpen () , i2c3lpen : self . i2c3lpen () , i2c5lpen : self . i2c5lpen () , ceclpen : self . ceclpen () , dac1lpen : self . dac1lpen () , uart7lpen : self . uart7lpen () , uart8lpen : self . uart8lpen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB1 Peripheral Reset Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1lrstr { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , tim12rst : bool , tim13rst : bool , tim14rst : bool , lptim1rst : bool , spi2rst : bool , spi3rst : bool , spdifrxrst : bool , usart2rst : bool , usart3rst : bool , uart4rst : bool , uart5rst : bool , i2c1rst : bool , i2c2rst : bool , i2c3rst : bool , i2c5rst : bool , cecrst : bool , dac1rst : bool , uart7rst : bool , uart8rst : bool , } let proxy = Apb1lrstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , tim12rst : self . tim12rst () , tim13rst : self . tim13rst () , tim14rst : self . tim14rst () , lptim1rst : self . lptim1rst () , spi2rst : self . spi2rst () , spi3rst : self . spi3rst () , spdifrxrst : self . spdifrxrst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , uart4rst : self . uart4rst () , uart5rst : self . uart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , i2c3rst : self . i2c3rst () , i2c5rst : self . i2c5rst () , cecrst : self . cecrst () , dac1rst : self . dac1rst () , uart7rst : self . uart7rst () , uart8rst : self . uart8rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC APB2 Clock Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cifr { Cifr (0) } } impl core :: fmt :: Debug for Cifr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cifr") . field ("lsirdyf" , & self . lsirdyf ()) . field ("lserdyf" , & self . lserdyf ()) . field ("hsirdyf" , & self . hsirdyf ()) . field ("hserdyf" , & self . hserdyf ()) . field ("csirdyf" , & self . csirdyf ()) . field ("hsi48rdyf" , & self . hsi48rdyf ()) . field ("pllrdyf" , & [self . pllrdyf (0usize) , self . pllrdyf (1usize) , self . pllrdyf (2usize) ,]) . field ("lsecssf" , & self . lsecssf ()) . field ("hsecssf" , & self . hsecssf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cifr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cifr { lsirdyf : bool , lserdyf : bool , hsirdyf : bool , hserdyf : bool , csirdyf : bool , hsi48rdyf : bool , pllrdyf : [bool ; 3usize]
, lsecssf : bool , hsecssf : bool , } let proxy = Cifr { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , csirdyf : self . csirdyf () , hsi48rdyf : self . hsi48rdyf () , pllrdyf : [self . pllrdyf (0usize) , self . pllrdyf (1usize) , self . pllrdyf (2usize) ,]
...
struct D1ccipr { fmcsel : super :: vals :: Fmcsel , octospisel : super :: vals :: Fmcsel , sdmmcsel : super :: vals :: Sdmmcsel , persel : super :: vals :: Persel , } let proxy = D1ccipr { fmcsel : self . fmcsel () , octospisel : self . octospisel () , sdmmcsel : self . sdmmcsel () , persel : self . persel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC Domain 1 Clock Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct D2ccip1r { sai1sel : super :: vals :: Saisel , sai2asel : super :: vals :: Saiasel , sai2bsel : super :: vals :: Saiasel , spi123sel : super :: vals :: Saisel , spi45sel : super :: vals :: Spi45sel , spdifrxsel : super :: vals :: Spdifrxsel , dfsdm1sel : super :: vals :: Dfsdmsel , fdcansel : super :: vals :: Fdcansel , swpmisel : super :: vals :: Swpmisel , } let proxy = D2ccip1r { sai1sel : self . sai1sel () , sai2asel : self . sai2asel () , sai2bsel : self . sai2bsel () , spi123sel : self . spi123sel () , spi45sel : self . spi45sel () , spdifrxsel : self . spdifrxsel () , dfsdm1sel : self . dfsdm1sel () , fdcansel : self . fdcansel () , swpmisel : self . swpmisel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC Domain 2 Kernel Clock Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct D3ccipr { lpuart1sel : super :: vals :: Lpuartsel , i2c4sel : super :: vals :: I2c4sel , lptim2sel : super :: vals :: Lptim2sel , lptim345sel : super :: vals :: Lptim2sel , adcsel : super :: vals :: Adcsel , dfsdm2sel : bool , spi6sel : super :: vals :: Spi6sel , } let proxy = D3ccipr { lpuart1sel : self . lpuart1sel () , i2c4sel : self . i2c4sel () , lptim2sel : self . lptim2sel () , lptim345sel : self . lptim345sel () , adcsel : self . adcsel () , dfsdm2sel : self . dfsdm2sel () , spi6sel : self . spi6sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC Domain 3 Clock Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Gcr { ww1rsc : bool , } let proxy = Gcr { ww1rsc : self . ww1rsc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC HSI configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Hsicfgr { hsical : u16 , hsitrim : u8 , } let proxy = Hsicfgr { hsical : self . hsical () , hsitrim : self . hsitrim () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RCC PLLs Configuration Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

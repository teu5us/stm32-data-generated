...
, cen : [bool ; 2usize]
, hfsel : bool , } let proxy = Cr { en : [self . en (0usize) , self . en (1usize) ,]
...
, hfsel : self . hfsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "channel 12-bit left-aligned data holding register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dhr12l { dhr : u16 , } let proxy = Dhr12l { dhr : self . dhr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "dual 12-bit left aligned data holding register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dhr12r { dhr : u16 , } let proxy = Dhr12r { dhr : self . dhr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "dual 12-bit right-aligned data holding register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dhr8r { dhr : u8 , } let proxy = Dhr8r { dhr : self . dhr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "dual 8-bit right aligned data holding register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dor { dor : u16 , } let proxy = Dor { dor : self . dor () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Mcr { Mcr (0) } } impl core :: fmt :: Debug for Mcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Mcr") . field ("mode" , & [self . mode (0usize) , self . mode (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Mcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mcr { mode : [super :: vals :: Mode ; 2usize]
, } let proxy = Mcr { mode : [self . mode (0usize) , self . mode (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sample and hold hold time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("dmaudr" , & [self . dmaudr (0usize) , self . dmaudr (1usize) ,]) . field ("cal_flag" , & [self . cal_flag (0usize) , self . cal_flag (1usize) ,]) . field ("bwst" , & [self . bwst (0usize) , self . bwst (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr { dmaudr : [bool ; 2usize]
, cal_flag : [bool ; 2usize]
, bwst : [bool ; 2usize]
, } let proxy = Sr { dmaudr : [self . dmaudr (0usize) , self . dmaudr (1usize) ,]
...
fn default () -> Swtrigr { Swtrigr (0) } } impl core :: fmt :: Debug for Swtrigr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Swtrigr") . field ("swtrig" , & [self . swtrig (0usize) , self . swtrig (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]

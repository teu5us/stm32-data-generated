...
struct Cir { lsirdyf : bool , lserdyf : bool , hsirdyf : bool , hserdyf : bool , pllrdyf : bool , hsi14rdyf : bool , cssf : bool , lsirdyie : bool , lserdyie : bool , hsirdyie : bool , hserdyie : bool , pllrdyie : bool , hsi14rdyie : bool , lsirdyc : bool , lserdyc : bool , hsirdyc : bool , hserdyc : bool , pllrdyc : bool , hsi14rdyc : bool , cssc : bool , } let proxy = Cir { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , pllrdyf : self . pllrdyf () , hsi14rdyf : self . hsi14rdyf () , cssf : self . cssf () , lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , pllrdyie : self . pllrdyie () , hsi14rdyie : self . hsi14rdyie () , lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , pllrdyc : self . pllrdyc () , hsi14rdyc : self . hsi14rdyc () , cssc : self . cssc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { hsi14on : bool , hsi14rdy : bool , hsi14dis : bool , hsi14trim : u8 , hsi14cal : u8 , } let proxy = Cr2 { hsi14on : self . hsi14on () , hsi14rdy : self . hsi14rdy () , hsi14dis : self . hsi14dis () , hsi14trim : self . hsi14trim () , hsi14cal : self . hsi14cal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control/status register (RCC_CSR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

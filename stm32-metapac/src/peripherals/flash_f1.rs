...
struct Ar { far : u32 , } let proxy = Ar { far : self . far () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { pg : bool , per : bool , mer : bool , optpg : bool , opter : bool , strt : bool , lock : bool , optwre : bool , errie : bool , eopie : bool , } let proxy = Cr { pg : self . pg () , per : self . per () , mer : self . mer () , optpg : self . optpg () , opter : self . opter () , strt : self . strt () , lock : self . lock () , optwre : self . optwre () , errie : self . errie () , eopie : self . eopie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Option byte register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Obr { opterr : bool , rdprt : bool , wdg_sw : bool , n_rst_stop : bool , n_rst_stdby : bool , data0 : u8 , data1 : u8 , } let proxy = Obr { opterr : self . opterr () , rdprt : self . rdprt () , wdg_sw : self . wdg_sw () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , data0 : self . data0 () , data1 : self . data1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

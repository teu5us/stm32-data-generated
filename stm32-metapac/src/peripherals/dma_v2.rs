...
struct Cr { en : bool , dmeie : bool , teie : bool , htie : bool , tcie : bool , pfctrl : super :: vals :: Pfctrl , dir : super :: vals :: Dir , circ : bool , pinc : bool , minc : bool , psize : super :: vals :: Size , msize : super :: vals :: Size , pincos : super :: vals :: Pincos , pl : super :: vals :: Pl , dbm : bool , ct : super :: vals :: Ct , pburst : super :: vals :: Burst , mburst : super :: vals :: Burst , chsel : u8 , } let proxy = Cr { en : self . en () , dmeie : self . dmeie () , teie : self . teie () , htie : self . htie () , tcie : self . tcie () , pfctrl : self . pfctrl () , dir : self . dir () , circ : self . circ () , pinc : self . pinc () , minc : self . minc () , psize : self . psize () , msize : self . msize () , pincos : self . pincos () , pl : self . pl () , dbm : self . dbm () , ct : self . ct () , pburst : self . pburst () , mburst : self . mburst () , chsel : self . chsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "stream x FIFO control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

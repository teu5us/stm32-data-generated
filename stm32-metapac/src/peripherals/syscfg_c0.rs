...
struct Cfgr1 { mem_mode : super :: vals :: MemMode , pa11_rmp : bool , pa12_rmp : bool , ir_pol : bool , ir_mod : super :: vals :: IrMod , i2c_pb6_fmp : bool , i2c_pb7_fmp : bool , i2c_pb8_fmp : bool , i2c_pb9_fmp : bool , i2c1_fmp : bool , i2c_pa9_fmp : bool , i2c_pa10_fmp : bool , i2c_pc14_fmp : bool , } let proxy = Cfgr1 { mem_mode : self . mem_mode () , pa11_rmp : self . pa11_rmp () , pa12_rmp : self . pa12_rmp () , ir_pol : self . ir_pol () , ir_mod : self . ir_mod () , i2c_pb6_fmp : self . i2c_pb6_fmp () , i2c_pb7_fmp : self . i2c_pb7_fmp () , i2c_pb8_fmp : self . i2c_pb8_fmp () , i2c_pb9_fmp : self . i2c_pb9_fmp () , i2c1_fmp : self . i2c1_fmp () , i2c_pa9_fmp : self . i2c_pa9_fmp () , i2c_pa10_fmp : self . i2c_pa10_fmp () , i2c_pc14_fmp : self . i2c_pc14_fmp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { lockup_lock : bool , } let proxy = Cfgr2 { lockup_lock : self . lockup_lock () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 3"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr3 { pinmux0 : super :: vals :: Pinmux0 , pinmux1 : super :: vals :: Pinmux1 , pinmux2 : super :: vals :: Pinmux2 , pinmux3 : super :: vals :: Pinmux3 , pinmux4 : super :: vals :: Pinmux4 , pinmux5 : super :: vals :: Pinmux5 , } let proxy = Cfgr3 { pinmux0 : self . pinmux0 () , pinmux1 : self . pinmux1 () , pinmux2 : self . pinmux2 () , pinmux3 : self . pinmux3 () , pinmux4 : self . pinmux4 () , pinmux5 : self . pinmux5 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 0 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline0 { wwdg : bool , } let proxy = Itline0 { wwdg : self . wwdg () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 10 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline11 { dmamux : bool , } let proxy = Itline11 { dmamux : self . dmamux () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 12 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline12 { adc : bool , } let proxy = Itline12 { adc : self . adc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 13 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline14 { tim1_cc : bool , } let proxy = Itline14 { tim1_cc : self . tim1_cc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 16 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline16 { tim3 : bool , } let proxy = Itline16 { tim3 : self . tim3 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 19 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline2 { rtc : bool , } let proxy = Itline2 { rtc : self . rtc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 21 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline23 { i2c1 : bool , } let proxy = Itline23 { i2c1 : self . i2c1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 25 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline25 { spi1 : bool , } let proxy = Itline25 { spi1 : self . spi1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 27 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline28 { usart2 : bool , } let proxy = Itline28 { usart2 : self . usart2 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 3 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline3 { flash_itf : bool , } let proxy = Itline3 { flash_itf : self . flash_itf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 4 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline5 { Itline5 (0) } } impl core :: fmt :: Debug for Itline5 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline5") . field ("exti" , & [self . exti (0usize) , self . exti (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline5 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Itline5 { exti : [bool ; 2usize]
, } let proxy = Itline5 { exti : [self . exti (0usize) , self . exti (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 6 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline6 { Itline6 (0) } } impl core :: fmt :: Debug for Itline6 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline6") . field ("exti" , & [self . exti (0usize) , self . exti (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline6 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Itline6 { exti : [bool ; 2usize]
, } let proxy = Itline6 { exti : [self . exti (0usize) , self . exti (1usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 7 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Itline7 { Itline7 (0) } } impl core :: fmt :: Debug for Itline7 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Itline7") . field ("exti" , & [self . exti (0usize) , self . exti (1usize) , self . exti (2usize) , self . exti (3usize) , self . exti (4usize) , self . exti (5usize) , self . exti (6usize) , self . exti (7usize) , self . exti (8usize) , self . exti (9usize) , self . exti (10usize) , self . exti (11usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Itline7 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Itline7 { exti : [bool ; 12usize]
, } let proxy = Itline7 { exti : [self . exti (0usize) , self . exti (1usize) , self . exti (2usize) , self . exti (3usize) , self . exti (4usize) , self . exti (5usize) , self . exti (6usize) , self . exti (7usize) , self . exti (8usize) , self . exti (9usize) , self . exti (10usize) , self . exti (11usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt line 9 status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Itline9 { dma1_ch1 : bool , } let proxy = Itline9 { dma1_ch1 : self . dma1_ch1 () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

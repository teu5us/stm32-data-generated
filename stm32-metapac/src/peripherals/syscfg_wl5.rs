...
struct C2imr1 { rtcstamptamplsecssim : bool , rtcalarmim : bool , rtcssruim : bool , rtcwkupim : bool , rccim : bool , flashim : bool , pkaim : bool , aesim : bool , compim : bool , adcim : bool , dacim : bool , exti0im : bool , exti1im : bool , exti2im : bool , exti3im : bool , exti4im : bool , exti5im : bool , exti6im : bool , exti7im : bool , exti8im : bool , exti9im : bool , exti10im : bool , exti11im : bool , exti12im : bool , exti13im : bool , exti14im : bool , exti15im : bool , } let proxy = C2imr1 { rtcstamptamplsecssim : self . rtcstamptamplsecssim () , rtcalarmim : self . rtcalarmim () , rtcssruim : self . rtcssruim () , rtcwkupim : self . rtcwkupim () , rccim : self . rccim () , flashim : self . flashim () , pkaim : self . pkaim () , aesim : self . aesim () , compim : self . compim () , adcim : self . adcim () , dacim : self . dacim () , exti0im : self . exti0im () , exti1im : self . exti1im () , exti2im : self . exti2im () , exti3im : self . exti3im () , exti4im : self . exti4im () , exti5im : self . exti5im () , exti6im : self . exti6im () , exti7im : self . exti7im () , exti8im : self . exti8im () , exti9im : self . exti9im () , exti10im : self . exti10im () , exti11im : self . exti11im () , exti12im : self . exti12im () , exti13im : self . exti13im () , exti14im : self . exti14im () , exti15im : self . exti15im () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SYSCFG CPU2 interrupt mask register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct C2imr2 { dma1ch1im : bool , dma1ch2im : bool , dma1ch3im : bool , dma1ch4im : bool , dma1ch5im : bool , dma1ch6im : bool , dma1ch7im : bool , dma2ch1im : bool , dma2ch2im : bool , dma2ch3im : bool , dma2ch4im : bool , dma2ch5im : bool , dma2ch6im : bool , dma2ch7im : bool , dmamux1im : bool , pvm3im : bool , pvdim : bool , } let proxy = C2imr2 { dma1ch1im : self . dma1ch1im () , dma1ch2im : self . dma1ch2im () , dma1ch3im : self . dma1ch3im () , dma1ch4im : self . dma1ch4im () , dma1ch5im : self . dma1ch5im () , dma1ch6im : self . dma1ch6im () , dma1ch7im : self . dma1ch7im () , dma2ch1im : self . dma2ch1im () , dma2ch2im : self . dma2ch2im () , dma2ch3im : self . dma2ch3im () , dma2ch4im : self . dma2ch4im () , dma2ch5im : self . dma2ch5im () , dma2ch6im : self . dma2ch6im () , dma2ch7im : self . dma2ch7im () , dmamux1im : self . dmamux1im () , pvm3im : self . pvm3im () , pvdim : self . pvdim () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr1 { boosten : bool , i2c_pb6_fmp : bool , i2c_pb7_fmp : bool , i2c_pb8_fmp : bool , i2c_pb9_fmp : bool , i2c1_fmp : bool , i2c2_fmp : bool , i2c3_fmp : bool , } let proxy = Cfgr1 { boosten : self . boosten () , i2c_pb6_fmp : self . i2c_pb6_fmp () , i2c_pb7_fmp : self . i2c_pb7_fmp () , i2c_pb8_fmp : self . i2c_pb8_fmp () , i2c_pb9_fmp : self . i2c_pb9_fmp () , i2c1_fmp : self . i2c1_fmp () , i2c2_fmp : self . i2c2_fmp () , i2c3_fmp : self . i2c3_fmp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CFGR2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { cll : bool , spl : bool , pvdl : bool , eccl : bool , spf : bool , } let proxy = Cfgr2 { cll : self . cll () , spl : self . spl () , pvdl : self . pvdl () , eccl : self . eccl () , spf : self . spf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "external interrupt configuration register 4"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SYSCFG CPU1 interrupt mask register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Imr1 { rtcstamptamplsecssim : bool , rtcssruim : bool , exti5im : bool , exti6im : bool , exti7im : bool , exti8im : bool , exti9im : bool , exti10im : bool , exti11im : bool , exti12im : bool , exti13im : bool , exti14im : bool , exti15im : bool , } let proxy = Imr1 { rtcstamptamplsecssim : self . rtcstamptamplsecssim () , rtcssruim : self . rtcssruim () , exti5im : self . exti5im () , exti6im : self . exti6im () , exti7im : self . exti7im () , exti8im : self . exti8im () , exti9im : self . exti9im () , exti10im : self . exti10im () , exti11im : self . exti11im () , exti12im : self . exti12im () , exti13im : self . exti13im () , exti14im : self . exti14im () , exti15im : self . exti15im () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SYSCFG CPU1 interrupt mask register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Imr2 { pvm3im : bool , pvdim : bool , } let proxy = Imr2 { pvm3im : self . pvm3im () , pvdim : self . pvdim () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "memory remap register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Memrmp { mem_mode : u8 , } let proxy = Memrmp { mem_mode : self . mem_mode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "radio debug control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Rfdcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Rfdcr { rftbsel : bool , } let proxy = Rfdcr { rftbsel : self . rftbsel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SCSR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Scsr { sram2er : bool , srambsy : bool , pkasrambsy : bool , } let proxy = Scsr { sram2er : self . sram2er () , srambsy : self . srambsy () , pkasrambsy : self . pkasrambsy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SKR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Skr { key : u8 , } let proxy = Skr { key : self . key () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SWPR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

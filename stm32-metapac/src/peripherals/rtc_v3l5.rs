...
struct Alrmssr { ss : u16 , maskss : u8 , } let proxy = Alrmssr { ss : self . ss () , maskss : self . maskss () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("wucksel" , & self . wucksel ()) . field ("tsedge" , & self . tsedge ()) . field ("refckon" , & self . refckon ()) . field ("bypshad" , & self . bypshad ()) . field ("fmt" , & self . fmt ()) . field ("alre" , & [self . alre (0usize) , self . alre (1usize) ,]) . field ("wute" , & self . wute ()) . field ("tse" , & self . tse ()) . field ("alrie" , & [self . alrie (0usize) , self . alrie (1usize) ,]) . field ("wutie" , & self . wutie ()) . field ("tsie" , & self . tsie ()) . field ("add1h" , & self . add1h ()) . field ("sub1h" , & self . sub1h ()) . field ("bkp" , & self . bkp ()) . field ("cosel" , & self . cosel ()) . field ("pol" , & self . pol ()) . field ("osel" , & self . osel ()) . field ("coe" , & self . coe ()) . field ("itse" , & self . itse ()) . field ("tampts" , & self . tampts ()) . field ("tampoe" , & self . tampoe ()) . field ("tampalrm_pu" , & self . tampalrm_pu ()) . field ("tampalrm_type" , & self . tampalrm_type ()) . field ("out2en" , & self . out2en ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr { wucksel : super :: vals :: Wucksel , tsedge : super :: vals :: Tsedge , refckon : bool , bypshad : bool , fmt : super :: vals :: Fmt , alre : [bool ; 2usize]
, wute : bool , tse : bool , alrie : [bool ; 2usize]
, wutie : bool , tsie : bool , add1h : bool , sub1h : bool , bkp : bool , cosel : super :: vals :: Cosel , pol : super :: vals :: Pol , osel : super :: vals :: Osel , coe : bool , itse : bool , tampts : bool , tampoe : bool , tampalrm_pu : bool , tampalrm_type : super :: vals :: TampalrmType , out2en : bool , } let proxy = Cr { wucksel : self . wucksel () , tsedge : self . tsedge () , refckon : self . refckon () , bypshad : self . bypshad () , fmt : self . fmt () , alre : [self . alre (0usize) , self . alre (1usize) ,]
, wute : self . wute () , tse : self . tse () , alrie : [self . alrie (0usize) , self . alrie (1usize) ,]
, wutie : self . wutie () , tsie : self . tsie () , add1h : self . add1h () , sub1h : self . sub1h () , bkp : self . bkp () , cosel : self . cosel () , pol : self . pol () , osel : self . osel () , coe : self . coe () , itse : self . itse () , tampts : self . tampts () , tampoe : self . tampoe () , tampalrm_pu : self . tampalrm_pu () , tampalrm_type : self . tampalrm_type () , out2en : self . out2en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Date register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Icsr { Icsr (0) } } impl core :: fmt :: Debug for Icsr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Icsr") . field ("wutwf" , & self . wutwf ()) . field ("shpf" , & self . shpf ()) . field ("inits" , & self . inits ()) . field ("rsf" , & self . rsf ()) . field ("initf" , & self . initf ()) . field ("init" , & self . init ()) . field ("recalpf" , & self . recalpf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Icsr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Icsr { wutwf : bool , shpf : bool , inits : bool , rsf : bool , initf : bool , init : bool , recalpf : super :: vals :: Recalpf , } let proxy = Icsr { wutwf : self . wutwf () , shpf : self . shpf () , inits : self . inits () , rsf : self . rsf () , initf : self . initf () , init : self . init () , recalpf : self . recalpf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Masked interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Misr { Misr (0) } } impl core :: fmt :: Debug for Misr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Misr") . field ("alrmf" , & [self . alrmf (0usize) , self . alrmf (1usize) ,]) . field ("wutmf" , & self . wutmf ()) . field ("tsmf" , & self . tsmf ()) . field ("tsovmf" , & self . tsovmf ()) . field ("itsmf" , & self . itsmf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Misr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Misr { alrmf : [super :: vals :: Alrmf ; 2usize]
, wutmf : super :: vals :: Wutmf , tsmf : super :: vals :: Tsmf , tsovmf : super :: vals :: Tsovmf , itsmf : super :: vals :: Itsmf , } let proxy = Misr { alrmf : [self . alrmf (0usize) , self . alrmf (1usize) ,]
, wutmf : self . wutmf () , tsmf : self . tsmf () , tsovmf : self . tsovmf () , itsmf : self . itsmf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Prescaler register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Scr { Scr (0) } } impl core :: fmt :: Debug for Scr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Scr") . field ("calrf" , & [self . calrf (0usize) , self . calrf (1usize) ,]) . field ("cwutf" , & self . cwutf ()) . field ("ctsf" , & self . ctsf ()) . field ("ctsovf" , & self . ctsovf ()) . field ("citsf" , & self . citsf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Scr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Scr { calrf : [super :: vals :: Calrf ; 2usize]
, cwutf : super :: vals :: Calrf , ctsf : super :: vals :: Calrf , ctsovf : super :: vals :: Calrf , citsf : super :: vals :: Calrf , } let proxy = Scr { calrf : [self . calrf (0usize) , self . calrf (1usize) ,]
, cwutf : self . cwutf () , ctsf : self . ctsf () , ctsovf : self . ctsovf () , citsf : self . citsf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Shift control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Shiftr { subfs : u16 , add1s : bool , } let proxy = Shiftr { subfs : self . subfs () , add1s : self . add1s () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RTC secure mode control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smcr { Smcr (0) } } impl core :: fmt :: Debug for Smcr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smcr") . field ("alrdprot" , & [self . alrdprot (0usize) , self . alrdprot (1usize) ,]) . field ("wutdprot" , & self . wutdprot ()) . field ("tsdprot" , & self . tsdprot ()) . field ("caldprot" , & self . caldprot ()) . field ("initdprot" , & self . initdprot ()) . field ("decprot" , & self . decprot ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smcr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smcr { alrdprot : [bool ; 2usize]
, wutdprot : bool , tsdprot : bool , caldprot : bool , initdprot : bool , decprot : bool , } let proxy = Smcr { alrdprot : [self . alrdprot (0usize) , self . alrdprot (1usize) ,]
, wutdprot : self . wutdprot () , tsdprot : self . tsdprot () , caldprot : self . caldprot () , initdprot : self . initdprot () , decprot : self . decprot () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Secure masked interrupt status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smisr { Smisr (0) } } impl core :: fmt :: Debug for Smisr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smisr") . field ("alrmf" , & [self . alrmf (0usize) , self . alrmf (1usize) ,]) . field ("wutmf" , & self . wutmf ()) . field ("tsmf" , & self . tsmf ()) . field ("tsovmf" , & self . tsovmf ()) . field ("itsmf" , & self . itsmf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smisr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smisr { alrmf : [bool ; 2usize]
, wutmf : bool , tsmf : bool , tsovmf : bool , itsmf : bool , } let proxy = Smisr { alrmf : [self . alrmf (0usize) , self . alrmf (1usize) ,]
, wutmf : self . wutmf () , tsmf : self . tsmf () , tsovmf : self . tsovmf () , itsmf : self . itsmf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Sr { Sr (0) } } impl core :: fmt :: Debug for Sr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Sr") . field ("alrf" , & [self . alrf (0usize) , self . alrf (1usize) ,]) . field ("wutf" , & self . wutf ()) . field ("tsf" , & self . tsf ()) . field ("tsovf" , & self . tsovf ()) . field ("itsf" , & self . itsf ()) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Sr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Sr { alrf : [super :: vals :: Alrf ; 2usize]
, wutf : super :: vals :: Wutf , tsf : super :: vals :: Tsf , tsovf : super :: vals :: Tsovf , itsf : super :: vals :: Itsf , } let proxy = Sr { alrf : [self . alrf (0usize) , self . alrf (1usize) ,]
, wutf : self . wutf () , tsf : self . tsf () , tsovf : self . tsovf () , itsf : self . itsf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Sub second register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ssr { ss : u16 , } let proxy = Ssr { ss : self . ss () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Tsssr { ss : u16 , } let proxy = Tsssr { ss : self . ss () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Timestamp time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

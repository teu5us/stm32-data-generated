...
struct Cr { reset : bool , polysize : super :: vals :: Polysize , rev_in : super :: vals :: RevIn , rev_out : super :: vals :: RevOut , } let proxy = Cr { reset : self . reset () , polysize : self . polysize () , rev_in : self . rev_in () , rev_out : self . rev_out () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

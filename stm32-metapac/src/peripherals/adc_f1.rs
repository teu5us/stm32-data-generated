...
struct Cr1 { awdch : u8 , eocie : bool , awdie : bool , jeocie : bool , scan : bool , awdsgl : bool , jauto : bool , discen : bool , jdiscen : bool , discnum : u8 , dualmod : super :: vals :: Dualmod , jawden : bool , awden : bool , } let proxy = Cr1 { awdch : self . awdch () , eocie : self . eocie () , awdie : self . awdie () , jeocie : self . jeocie () , scan : self . scan () , awdsgl : self . awdsgl () , jauto : self . jauto () , discen : self . discen () , jdiscen : self . jdiscen () , discnum : self . discnum () , dualmod : self . dualmod () , jawden : self . jawden () , awden : self . awden () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { data : u16 , adc2data : u16 , } let proxy = Dr { data : self . data () , adc2data : self . adc2data () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog higher threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Smpr1 { Smpr1 (0) } } impl core :: fmt :: Debug for Smpr1 { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Smpr1") . field ("smp" , & [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Smpr1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Smpr1 { smp : [super :: vals :: SampleTime ; 8usize]
, } let proxy = Smpr1 { smp : [self . smp (0usize) , self . smp (1usize) , self . smp (2usize) , self . smp (3usize) , self . smp (4usize) , self . smp (5usize) , self . smp (6usize) , self . smp (7usize) ,]
...
struct Sr { awd : bool , eoc : bool , jeoc : bool , jstrt : bool , strt : bool , } let proxy = Sr { awd : self . awd () , eoc : self . eoc () , jeoc : self . jeoc () , jstrt : self . jstrt () , strt : self . strt () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Cr { en : bool , dmeie : bool , teie : bool , htie : bool , tcie : bool , pfctrl : super :: vals :: Pfctrl , dir : super :: vals :: Dir , circ : bool , pinc : bool , minc : bool , psize : super :: vals :: Size , msize : super :: vals :: Size , pincos : super :: vals :: Pincos , pl : super :: vals :: Pl , dbm : bool , ct : super :: vals :: Ct , trbuff : bool , pburst : super :: vals :: Burst , mburst : super :: vals :: Burst , } let proxy = Cr { en : self . en () , dmeie : self . dmeie () , teie : self . teie () , htie : self . htie () , tcie : self . tcie () , pfctrl : self . pfctrl () , dir : self . dir () , circ : self . circ () , pinc : self . pinc () , minc : self . minc () , psize : self . psize () , msize : self . msize () , pincos : self . pincos () , pl : self . pl () , dbm : self . dbm () , ct : self . ct () , trbuff : self . trbuff () , pburst : self . pburst () , mburst : self . mburst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "stream x FIFO control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fcr { fth : super :: vals :: Fth , dmdis : super :: vals :: Dmdis , fs : super :: vals :: Fs , feie : bool , } let proxy = Fcr { fth : self . fth () , dmdis : self . dmdis () , fs : self . fs () , feie : self . feie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Ixr { Ixr (0) } } impl core :: fmt :: Debug for Ixr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Ixr") . field ("feif" , & [self . feif (0usize) , self . feif (1usize) , self . feif (2usize) , self . feif (3usize) ,]) . field ("dmeif" , & [self . dmeif (0usize) , self . dmeif (1usize) , self . dmeif (2usize) , self . dmeif (3usize) ,]) . field ("teif" , & [self . teif (0usize) , self . teif (1usize) , self . teif (2usize) , self . teif (3usize) ,]) . field ("htif" , & [self . htif (0usize) , self . htif (1usize) , self . htif (2usize) , self . htif (3usize) ,]) . field ("tcif" , & [self . tcif (0usize) , self . tcif (1usize) , self . tcif (2usize) , self . tcif (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Ixr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Ixr { feif : [bool ; 4usize]
, dmeif : [bool ; 4usize]
, teif : [bool ; 4usize]
, htif : [bool ; 4usize]
, tcif : [bool ; 4usize]
, } let proxy = Ixr { feif : [self . feif (0usize) , self . feif (1usize) , self . feif (2usize) , self . feif (3usize) ,]
, dmeif : [self . dmeif (0usize) , self . dmeif (1usize) , self . dmeif (2usize) , self . dmeif (3usize) ,]
, teif : [self . teif (0usize) , self . teif (1usize) , self . teif (2usize) , self . teif (3usize) ,]
, htif : [self . htif (0usize) , self . htif (1usize) , self . htif (2usize) , self . htif (3usize) ,]
, tcif : [self . tcif (0usize) , self . tcif (1usize) , self . tcif (2usize) , self . tcif (3usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "stream x number of data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

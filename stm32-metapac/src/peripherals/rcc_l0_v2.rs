...
struct Ahbenr { dma1en : bool , mifen : bool , crcen : bool , tscen : bool , rngen : bool , crypen : bool , } let proxy = Ahbenr { dma1en : self . dma1en () , mifen : self . mifen () , crcen : self . crcen () , tscen : self . tscen () , rngen : self . rngen () , crypen : self . crypen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahbrstr { dma1rst : bool , mifrst : bool , crcrst : bool , tscrst : bool , rngrst : bool , cryprst : bool , } let proxy = Ahbrstr { dma1rst : self . dma1rst () , mifrst : self . mifrst () , crcrst : self . crcrst () , tscrst : self . tscrst () , rngrst : self . rngrst () , cryprst : self . cryprst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB peripheral clock enable in sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahbsmenr { dma1smen : bool , mifsmen : bool , sramsmen : bool , crcsmen : bool , tscsmen : bool , rngsmen : bool , crypsmen : bool , } let proxy = Ahbsmenr { dma1smen : self . dma1smen () , mifsmen : self . mifsmen () , sramsmen : self . sramsmen () , crcsmen : self . crcsmen () , tscsmen : self . tscsmen () , rngsmen : self . rngsmen () , crypsmen : self . crypsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim2en : bool , tim3en : bool , tim6en : bool , tim7en : bool , wwdgen : bool , spi2en : bool , usart2en : bool , lpuart1en : bool , usart4en : bool , usart5en : bool , i2c1en : bool , i2c2en : bool , usben : bool , crsen : bool , pwren : bool , dacen : bool , i2c3en : bool , lptim1en : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim6en : self . tim6en () , tim7en : self . tim7en () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , usart2en : self . usart2en () , lpuart1en : self . lpuart1en () , usart4en : self . usart4en () , usart5en : self . usart5en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , usben : self . usben () , crsen : self . crsen () , pwren : self . pwren () , dacen : self . dacen () , i2c3en : self . i2c3en () , lptim1en : self . lptim1en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim6rst : bool , tim7rst : bool , wwdgrst : bool , spi2rst : bool , usart2rst : bool , lpuart1rst : bool , usart4rst : bool , usart5rst : bool , i2c1rst : bool , i2c2rst : bool , usbrst : bool , crsrst : bool , pwrrst : bool , dacrst : bool , i2c3rst : bool , lptim1rst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , usart2rst : self . usart2rst () , lpuart1rst : self . lpuart1rst () , usart4rst : self . usart4rst () , usart5rst : self . usart5rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , usbrst : self . usbrst () , crsrst : self . crsrst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , i2c3rst : self . i2c3rst () , lptim1rst : self . lptim1rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable in sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Apb1smenr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Apb1smenr { tim2smen : bool , tim3smen : bool , tim6smen : bool , tim7smen : bool , wwdgsmen : bool , spi2smen : bool , usart2smen : bool , lpuart1smen : bool , usart4smen : bool , usart5smen : bool , i2c1smen : bool , i2c2smen : bool , usbsmen : bool , crssmen : bool , pwrsmen : bool , dacsmen : bool , i2c3smen : bool , lptim1smen : bool , } let proxy = Apb1smenr { tim2smen : self . tim2smen () , tim3smen : self . tim3smen () , tim6smen : self . tim6smen () , tim7smen : self . tim7smen () , wwdgsmen : self . wwdgsmen () , spi2smen : self . spi2smen () , usart2smen : self . usart2smen () , lpuart1smen : self . lpuart1smen () , usart4smen : self . usart4smen () , usart5smen : self . usart5smen () , i2c1smen : self . i2c1smen () , i2c2smen : self . i2c2smen () , usbsmen : self . usbsmen () , crssmen : self . crssmen () , pwrsmen : self . pwrsmen () , dacsmen : self . dacsmen () , i2c3smen : self . i2c3smen () , lptim1smen : self . lptim1smen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { syscfgen : bool , tim21en : bool , tim22en : bool , fwen : bool , adcen : bool , spi1en : bool , usart1en : bool , dbgen : bool , } let proxy = Apb2enr { syscfgen : self . syscfgen () , tim21en : self . tim21en () , tim22en : self . tim22en () , fwen : self . fwen () , adcen : self . adcen () , spi1en : self . spi1en () , usart1en : self . usart1en () , dbgen : self . dbgen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { syscfgrst : bool , tim21rst : bool , tim22rst : bool , adcrst : bool , spi1rst : bool , usart1rst : bool , dbgrst : bool , } let proxy = Apb2rstr { syscfgrst : self . syscfgrst () , tim21rst : self . tim21rst () , tim22rst : self . tim22rst () , adcrst : self . adcrst () , spi1rst : self . spi1rst () , usart1rst : self . usart1rst () , dbgrst : self . dbgrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable in sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2smenr { syscfgsmen : bool , tim21smen : bool , tim22smen : bool , adcsmen : bool , spi1smen : bool , usart1smen : bool , dbgsmen : bool , } let proxy = Apb2smenr { syscfgsmen : self . syscfgsmen () , tim21smen : self . tim21smen () , tim22smen : self . tim22smen () , adcsmen : self . adcsmen () , spi1smen : self . spi1smen () , usart1smen : self . usart1smen () , dbgsmen : self . dbgsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccipr { usart1sel : super :: vals :: Usart1sel , usart2sel : super :: vals :: Uartsel , lpuart1sel : super :: vals :: Uartsel , i2c1sel : super :: vals :: I2csel , i2c3sel : super :: vals :: I2csel , lptim1sel : super :: vals :: Lptimsel , clk48sel : super :: vals :: Clk48sel , } let proxy = Ccipr { usart1sel : self . usart1sel () , usart2sel : self . usart2sel () , lpuart1sel : self . lpuart1sel () , i2c1sel : self . i2c1sel () , i2c3sel : self . i2c3sel () , lptim1sel : self . lptim1sel () , clk48sel : self . clk48sel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cicr { lsirdyc : bool , lserdyc : bool , hsirdyc : bool , hserdyc : bool , pllrdyc : bool , msirdyc : bool , hsi48rdyc : bool , csslsec : bool , csshsec : bool , } let proxy = Cicr { lsirdyc : self . lsirdyc () , lserdyc : self . lserdyc () , hsirdyc : self . hsirdyc () , hserdyc : self . hserdyc () , pllrdyc : self . pllrdyc () , msirdyc : self . msirdyc () , hsi48rdyc : self . hsi48rdyc () , csslsec : self . csslsec () , csshsec : self . csshsec () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cier { lsirdyie : bool , lserdyie : bool , hsirdyie : bool , hserdyie : bool , pllrdyie : bool , msirdyie : bool , hsi48rdyie : bool , csslse : bool , } let proxy = Cier { lsirdyie : self . lsirdyie () , lserdyie : self . lserdyie () , hsirdyie : self . hsirdyie () , hserdyie : self . hserdyie () , pllrdyie : self . pllrdyie () , msirdyie : self . msirdyie () , hsi48rdyie : self . hsi48rdyie () , csslse : self . csslse () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock interrupt flag register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cifr { lsirdyf : bool , lserdyf : bool , hsirdyf : bool , hserdyf : bool , pllrdyf : bool , msirdyf : bool , hsi48rdyf : bool , csslsef : bool , csshsef : bool , } let proxy = Cifr { lsirdyf : self . lsirdyf () , lserdyf : self . lserdyf () , hsirdyf : self . hsirdyf () , hserdyf : self . hserdyf () , pllrdyf : self . pllrdyf () , msirdyf : self . msirdyf () , hsi48rdyf : self . hsi48rdyf () , csslsef : self . csslsef () , csshsef : self . csshsef () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { hsion : bool , hsikeron : bool , hsirdy : bool , hsidiven : bool , hsidivf : bool , hsiouten : bool , msion : bool , msirdy : bool , hseon : bool , hserdy : bool , hsebyp : bool , csshseon : bool , rtcpre : super :: vals :: Rtcpre , pllon : bool , pllrdy : bool , } let proxy = Cr { hsion : self . hsion () , hsikeron : self . hsikeron () , hsirdy : self . hsirdy () , hsidiven : self . hsidiven () , hsidivf : self . hsidivf () , hsiouten : self . hsiouten () , msion : self . msion () , msirdy : self . msirdy () , hseon : self . hseon () , hserdy : self . hserdy () , hsebyp : self . hsebyp () , csshseon : self . csshseon () , rtcpre : self . rtcpre () , pllon : self . pllon () , pllrdy : self . pllrdy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Clock recovery RC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Crrcr { hsi48on : bool , hsi48rdy : bool , hsi48div6en : bool , hsi48cal : u8 , } let proxy = Crrcr { hsi48on : self . hsi48on () , hsi48rdy : self . hsi48rdy () , hsi48div6en : self . hsi48div6en () , hsi48cal : self . hsi48cal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Csr { lsion : bool , lsirdy : bool , lseon : bool , lserdy : bool , lsebyp : bool , lsedrv : super :: vals :: Lsedrv , csslseon : bool , csslsed : bool , rtcsel : super :: vals :: Rtcsel , rtcen : bool , rtcrst : bool , rmvf : bool , fwrstf : bool , oblrstf : bool , pinrstf : bool , porrstf : bool , sftrstf : bool , iwdgrstf : bool , wwdgrstf : bool , lpwrrstf : bool , } let proxy = Csr { lsion : self . lsion () , lsirdy : self . lsirdy () , lseon : self . lseon () , lserdy : self . lserdy () , lsebyp : self . lsebyp () , lsedrv : self . lsedrv () , csslseon : self . csslseon () , csslsed : self . csslsed () , rtcsel : self . rtcsel () , rtcen : self . rtcen () , rtcrst : self . rtcrst () , rmvf : self . rmvf () , fwrstf : self . fwrstf () , oblrstf : self . oblrstf () , pinrstf : self . pinrstf () , porrstf : self . porrstf () , sftrstf : self . sftrstf () , iwdgrstf : self . iwdgrstf () , wwdgrstf : self . wwdgrstf () , lpwrrstf : self . lpwrrstf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GPIO clock enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Gpioenr { gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , gpiohen : bool , } let proxy = Gpioenr { gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , gpiohen : self . gpiohen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GPIO reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Gpiorstr { gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiodrst : bool , gpioerst : bool , gpiohrst : bool , } let proxy = Gpiorstr { gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiodrst : self . gpiodrst () , gpioerst : self . gpioerst () , gpiohrst : self . gpiohrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "GPIO clock enable in sleep mode register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Gpiosmen { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Gpiosmen { gpioasmen : bool , gpiobsmen : bool , gpiocsmen : bool , gpiodsmen : bool , gpioesmen : bool , gpiohsmen : bool , } let proxy = Gpiosmen { gpioasmen : self . gpioasmen () , gpiobsmen : self . gpiobsmen () , gpiocsmen : self . gpiocsmen () , gpiodsmen : self . gpiodsmen () , gpioesmen : self . gpioesmen () , gpiohsmen : self . gpiohsmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Internal clock sources calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Icscr { hsical : u8 , hsitrim : u8 , msirange : super :: vals :: Msirange , msical : u8 , msitrim : u8 , } let proxy = Icscr { hsical : self . hsical () , hsitrim : self . hsitrim () , msirange : self . msirange () , msical : self . msical () , msitrim : self . msitrim () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

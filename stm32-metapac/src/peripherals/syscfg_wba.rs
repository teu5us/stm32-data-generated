...
struct Cccr { ncc1 : u8 , pcc1 : u8 , } let proxy = Cccr { ncc1 : self . ncc1 () , pcc1 : self . pcc1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "compensation cell control/status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cccsr { en1 : bool , cs1 : bool , rdy1 : bool , } let proxy = Cccsr { en1 : self . en1 () , cs1 : self . cs1 () , rdy1 : self . rdy1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "compensation cell value register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccvr { ncv1 : u8 , pcv1 : u8 , } let proxy = Ccvr { ncv1 : self . ncv1 () , pcv1 : self . pcv1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr1 { boosten : bool , anaswvdd : bool , pa6_fmp : bool , pa7_fmp : bool , pa15_fmp : bool , pb3_fmp : bool , } let proxy = Cfgr1 { boosten : self . boosten () , anaswvdd : self . anaswvdd () , pa6_fmp : self . pa6_fmp () , pa7_fmp : self . pa7_fmp () , pa15_fmp : self . pa15_fmp () , pb3_fmp : self . pb3_fmp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { cll : bool , spl : bool , pvdl : bool , eccl : bool , } let proxy = Cfgr2 { cll : self . cll () , spl : self . spl () , pvdl : self . pvdl () , eccl : self . eccl () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU non-secure lock register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cnslckr { locknsvtor : bool , locknsmpu : bool , } let proxy = Cnslckr { locknsvtor : self . locknsvtor () , locknsmpu : self . locknsmpu () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CPU secure lock register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Mesr { mclr : bool , ipmee : bool , } let proxy = Mesr { mclr : self . mclr () , ipmee : self . ipmee () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "RSS command register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Rsscmdr { rsscmd : u16 , } let proxy = Rsscmdr { rsscmd : self . rsscmd () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "secure configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Seccfgr { syscfgsec : bool , classbsec : bool , fpusec : bool , } let proxy = Seccfgr { syscfgsec : self . syscfgsec () , classbsec : self . classbsec () , fpusec : self . fpusec () , } ; defmt :: write ! (f , "{}" , proxy) } } }
...
fn default () -> HrtimAdc1r { HrtimAdc1r (0) } } impl core :: fmt :: Debug for HrtimAdc1r { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("HrtimAdc1r") . field ("adcmc" , & [self . adcmc (0usize) , self . adcmc (1usize) , self . adcmc (2usize) , self . adcmc (3usize) ,]) . field ("adcmper" , & self . adcmper ()) . field ("adceev" , & [self . adceev (0usize) , self . adceev (1usize) , self . adceev (2usize) , self . adceev (3usize) , self . adceev (4usize) ,]) . field ("adctc2" , & [self . adctc2 (0usize) , self . adctc2 (1usize) , self . adctc2 (2usize) , self . adctc2 (3usize) , self . adctc2 (4usize) ,]) . field ("adctc3" , & [self . adctc3 (0usize) , self . adctc3 (1usize) , self . adctc3 (2usize) , self . adctc3 (3usize) , self . adctc3 (4usize) ,]) . field ("adctc4" , & [self . adctc4 (0usize) , self . adctc4 (1usize) , self . adctc4 (2usize) , self . adctc4 (3usize) , self . adctc4 (4usize) ,]) . field ("adctper" , & [self . adctper (0usize) , self . adctper (1usize) , self . adctper (2usize) , self . adctper (3usize) , self . adctper (4usize) ,]) . field ("adctrst" , & [self . adctrst (0usize) , self . adctrst (1usize) ,]) . finish () } } # [cfg (feature = "defmt")]
...
, adctc2 : [self . adctc2 (0usize) , self . adctc2 (1usize) , self . adctc2 (2usize) , self . adctc2 (3usize) , self . adctc2 (4usize) ,]
...
, adctc3 : [self . adctc3 (0usize) , self . adctc3 (1usize) , self . adctc3 (2usize) , self . adctc3 (3usize) , self . adctc3 (4usize) ,]
, adctc4 : [self . adctc4 (0usize) , self . adctc4 (1usize) , self . adctc4 (2usize) , self . adctc4 (3usize) , self . adctc4 (4usize) ,]
, adctper : [self . adctper (0usize) , self . adctper (1usize) , self . adctper (2usize) , self . adctper (3usize) ,]
...
fn default () -> Timxrst { Timxrst (0) } } impl core :: fmt :: Debug for Timxrst { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Timxrst") . field ("updt" , & self . updt ()) . field ("cmp" , & [self . cmp (0usize) , self . cmp (1usize) ,]) . field ("mstper" , & self . mstper ()) . field ("mstcmp" , & [self . mstcmp (0usize) , self . mstcmp (1usize) , self . mstcmp (2usize) , self . mstcmp (3usize) ,]) . field ("extevnt" , & [self . extevnt (0usize) , self . extevnt (1usize) , self . extevnt (2usize) , self . extevnt (3usize) , self . extevnt (4usize) , self . extevnt (5usize) , self . extevnt (6usize) , self . extevnt (7usize) , self . extevnt (8usize) , self . extevnt (9usize) ,]) . field ("tcmp1" , & [self . tcmp1 (0usize) , self . tcmp1 (1usize) , self . tcmp1 (2usize) , self . tcmp1 (3usize) ,]) . field ("tcmp2" , & [self . tcmp2 (0usize) , self . tcmp2 (1usize) , self . tcmp2 (2usize) , self . tcmp2 (3usize) ,]) . field ("tcmp4" , & [self . tcmp4 (0usize) , self . tcmp4 (1usize) , self . tcmp4 (2usize) , self . tcmp4 (3usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Timxrst { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Timxrst { updt : bool , cmp : [bool ; 2usize]
, mstper : bool , mstcmp : [bool ; 4usize]
, extevnt : [bool ; 10usize]
, tcmp1 : [bool ; 4usize]
, tcmp2 : [bool ; 4usize]
, tcmp4 : [bool ; 4usize]
, } let proxy = Timxrst { updt : self . updt () , cmp : [self . cmp (0usize) , self . cmp (1usize) ,]
...
, tcmp1 : [self . tcmp1 (0usize) , self . tcmp1 (1usize) , self . tcmp1 (2usize) , self . tcmp1 (3usize) ,]
, tcmp2 : [self . tcmp2 (0usize) , self . tcmp2 (1usize) , self . tcmp2 (2usize) , self . tcmp2 (3usize) ,]

...
struct Ahbenr { dma1en : bool , dma2en : bool , sramen : bool , flashen : bool , crcen : bool , gpioaen : bool , gpioben : bool , gpiocen : bool , gpioden : bool , gpioeen : bool , gpiofen : bool , tscen : bool , } let proxy = Ahbenr { dma1en : self . dma1en () , dma2en : self . dma2en () , sramen : self . sramen () , flashen : self . flashen () , crcen : self . crcen () , gpioaen : self . gpioaen () , gpioben : self . gpioben () , gpiocen : self . gpiocen () , gpioden : self . gpioden () , gpioeen : self . gpioeen () , gpiofen : self . gpiofen () , tscen : self . tscen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahbrstr { gpioarst : bool , gpiobrst : bool , gpiocrst : bool , gpiodrst : bool , gpioerst : bool , gpiofrst : bool , tscrst : bool , } let proxy = Ahbrstr { gpioarst : self . gpioarst () , gpiobrst : self . gpiobrst () , gpiocrst : self . gpiocrst () , gpiodrst : self . gpiodrst () , gpioerst : self . gpioerst () , gpiofrst : self . gpiofrst () , tscrst : self . tscrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral clock enable register (RCC_APB1ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1enr { tim2en : bool , tim3en : bool , tim4en : bool , tim5en : bool , tim6en : bool , tim7en : bool , tim12en : bool , tim13en : bool , tim14en : bool , tim18en : bool , wwdgen : bool , spi2en : bool , spi3en : bool , usart2en : bool , usart3en : bool , i2c1en : bool , i2c2en : bool , usben : bool , canen : bool , dac2en : bool , pwren : bool , dacen : bool , cecen : bool , } let proxy = Apb1enr { tim2en : self . tim2en () , tim3en : self . tim3en () , tim4en : self . tim4en () , tim5en : self . tim5en () , tim6en : self . tim6en () , tim7en : self . tim7en () , tim12en : self . tim12en () , tim13en : self . tim13en () , tim14en : self . tim14en () , tim18en : self . tim18en () , wwdgen : self . wwdgen () , spi2en : self . spi2en () , spi3en : self . spi3en () , usart2en : self . usart2en () , usart3en : self . usart3en () , i2c1en : self . i2c1en () , i2c2en : self . i2c2en () , usben : self . usben () , canen : self . canen () , dac2en : self . dac2en () , pwren : self . pwren () , dacen : self . dacen () , cecen : self . cecen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB1 peripheral reset register (RCC_APB1RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb1rstr { tim2rst : bool , tim3rst : bool , tim4rst : bool , tim5rst : bool , tim6rst : bool , tim7rst : bool , tim12rst : bool , tim13rst : bool , tim14rst : bool , tim18rst : bool , wwdgrst : bool , spi2rst : bool , spi3rst : bool , usart2rst : bool , usart3rst : bool , i2c1rst : bool , i2c2rst : bool , usbrst : bool , canrst : bool , dac2rst : bool , pwrrst : bool , dacrst : bool , cecrst : bool , } let proxy = Apb1rstr { tim2rst : self . tim2rst () , tim3rst : self . tim3rst () , tim4rst : self . tim4rst () , tim5rst : self . tim5rst () , tim6rst : self . tim6rst () , tim7rst : self . tim7rst () , tim12rst : self . tim12rst () , tim13rst : self . tim13rst () , tim14rst : self . tim14rst () , tim18rst : self . tim18rst () , wwdgrst : self . wwdgrst () , spi2rst : self . spi2rst () , spi3rst : self . spi3rst () , usart2rst : self . usart2rst () , usart3rst : self . usart3rst () , i2c1rst : self . i2c1rst () , i2c2rst : self . i2c2rst () , usbrst : self . usbrst () , canrst : self . canrst () , dac2rst : self . dac2rst () , pwrrst : self . pwrrst () , dacrst : self . dacrst () , cecrst : self . cecrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral clock enable register (RCC_APB2ENR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2enr { syscfgen : bool , adcen : bool , spi1en : bool , usart1en : bool , tim15en : bool , tim16en : bool , tim17en : bool , tim19en : bool , dbgmcuen : bool , sdadc1en : bool , sdadc2en : bool , sdadc3en : bool , } let proxy = Apb2enr { syscfgen : self . syscfgen () , adcen : self . adcen () , spi1en : self . spi1en () , usart1en : self . usart1en () , tim15en : self . tim15en () , tim16en : self . tim16en () , tim17en : self . tim17en () , tim19en : self . tim19en () , dbgmcuen : self . dbgmcuen () , sdadc1en : self . sdadc1en () , sdadc2en : self . sdadc2en () , sdadc3en : self . sdadc3en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "APB2 peripheral reset register (RCC_APB2RSTR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Apb2rstr { syscfgrst : bool , adcrst : bool , spi1rst : bool , usart1rst : bool , tim15rst : bool , tim16rst : bool , tim17rst : bool , tim19rst : bool , dbgmcurst : bool , sdadc1rst : bool , sdadc2rst : bool , sdadc3rst : bool , } let proxy = Apb2rstr { syscfgrst : self . syscfgrst () , adcrst : self . adcrst () , spi1rst : self . spi1rst () , usart1rst : self . usart1rst () , tim15rst : self . tim15rst () , tim16rst : self . tim16rst () , tim17rst : self . tim17rst () , tim19rst : self . tim19rst () , dbgmcurst : self . dbgmcurst () , sdadc1rst : self . sdadc1rst () , sdadc2rst : self . sdadc2rst () , sdadc3rst : self . sdadc3rst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Backup domain control register (RCC_BDCR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

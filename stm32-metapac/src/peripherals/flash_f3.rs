...
struct Acr { latency : super :: vals :: Latency , hlfcya : bool , prftbe : bool , prftbs : bool , } let proxy = Acr { latency : self . latency () , hlfcya : self . hlfcya () , prftbe : self . prftbe () , prftbs : self . prftbs () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { pg : bool , per : bool , mer : bool , optpg : bool , opter : bool , strt : bool , lock : bool , optwre : bool , errie : bool , eopie : bool , obl_launch : bool , } let proxy = Cr { pg : self . pg () , per : self . per () , mer : self . mer () , optpg : self . optpg () , opter : self . opter () , strt : self . strt () , lock : self . lock () , optwre : self . optwre () , errie : self . errie () , eopie : self . eopie () , obl_launch : self . obl_launch () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Option byte register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Obr { opterr : bool , rdprt : super :: vals :: Rdprt , wdg_sw : super :: vals :: WdgSw , n_rst_stop : super :: vals :: NRstStop , n_rst_stdby : super :: vals :: NRstStdby , n_boot1 : bool , vdda_monitor : bool , sram_parity_check : bool , sdadc12_vdd_monitor : bool , data0 : u8 , data1 : u8 , } let proxy = Obr { opterr : self . opterr () , rdprt : self . rdprt () , wdg_sw : self . wdg_sw () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , n_boot1 : self . n_boot1 () , vdda_monitor : self . vdda_monitor () , sram_parity_check : self . sram_parity_check () , sdadc12_vdd_monitor : self . sdadc12_vdd_monitor () , data0 : self . data0 () , data1 : self . data1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { bsy : bool , pgerr : bool , wrprterr : bool , eop : bool , } let proxy = Sr { bsy : self . bsy () , pgerr : self . pgerr () , wrprterr : self . wrprterr () , eop : self . eop () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Write protection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

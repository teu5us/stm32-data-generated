...
struct Acr { latency : super :: vals :: Latency , prftbe : bool , prftbs : bool , } let proxy = Acr { latency : self . latency () , prftbe : self . prftbe () , prftbs : self . prftbs () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash address register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ar { far : u32 , } let proxy = Ar { far : self . far () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash control register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr { pg : bool , per : bool , mer : bool , optpg : bool , opter : bool , strt : bool , lock : bool , optwre : bool , errie : bool , eopie : bool , force_optload : bool , } let proxy = Cr { pg : self . pg () , per : self . per () , mer : self . mer () , optpg : self . optpg () , opter : self . opter () , strt : self . strt () , lock : self . lock () , optwre : self . optwre () , errie : self . errie () , eopie : self . eopie () , force_optload : self . force_optload () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Option byte register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Obr { opterr : bool , rdprt : super :: vals :: Rdprt , wdg_sw : super :: vals :: WdgSw , n_rst_stop : super :: vals :: NRstStop , n_rst_stdby : super :: vals :: NRstStdby , n_boot0 : bool , n_boot1 : bool , vdda_monitor : bool , ram_parity_check : super :: vals :: RamParityCheck , boot_sel : super :: vals :: BootSel , data0 : u8 , data1 : u8 , } let proxy = Obr { opterr : self . opterr () , rdprt : self . rdprt () , wdg_sw : self . wdg_sw () , n_rst_stop : self . n_rst_stop () , n_rst_stdby : self . n_rst_stdby () , n_boot0 : self . n_boot0 () , n_boot1 : self . n_boot1 () , vdda_monitor : self . vdda_monitor () , ram_parity_check : self . ram_parity_check () , boot_sel : self . boot_sel () , data0 : self . data0 () , data1 : self . data1 () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Flash status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { bsy : bool , pgerr : bool , wrprt : bool , eop : bool , } let proxy = Sr { bsy : self . bsy () , pgerr : self . pgerr () , wrprt : self . wrprt () , eop : self . eop () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Write protection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Wrpr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Wrpr { wrp : u32 , } let proxy = Wrpr { wrp : self . wrp () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

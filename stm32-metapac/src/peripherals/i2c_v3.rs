...
struct Cr1 { pe : bool , txie : bool , rxie : bool , addrie : bool , nackie : bool , stopie : bool , tcie : bool , errie : bool , dnf : super :: vals :: Dnf , anfoff : bool , txdmaen : bool , rxdmaen : bool , sbc : bool , nostretch : bool , gcen : bool , smbhen : bool , smbden : bool , alerten : bool , pecen : bool , fmp : bool , addraclr : bool , stopfaclr : bool , } let proxy = Cr1 { pe : self . pe () , txie : self . txie () , rxie : self . rxie () , addrie : self . addrie () , nackie : self . nackie () , stopie : self . stopie () , tcie : self . tcie () , errie : self . errie () , dnf : self . dnf () , anfoff : self . anfoff () , txdmaen : self . txdmaen () , rxdmaen : self . rxdmaen () , sbc : self . sbc () , nostretch : self . nostretch () , gcen : self . gcen () , smbhen : self . smbhen () , smbden : self . smbden () , alerten : self . alerten () , pecen : self . pecen () , fmp : self . fmp () , addraclr : self . addraclr () , stopfaclr : self . stopfaclr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Control register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { sadd : u16 , dir : super :: vals :: Dir , add10 : super :: vals :: Addmode , head10r : super :: vals :: Headr , start : bool , stop : bool , nack : bool , nbytes : u8 , reload : super :: vals :: Reload , autoend : super :: vals :: Autoend , pecbyte : bool , } let proxy = Cr2 { sadd : self . sadd () , dir : self . dir () , add10 : self . add10 () , head10r : self . head10r () , start : self . start () , stop : self . stop () , nack : self . nack () , nbytes : self . nbytes () , reload : self . reload () , autoend : self . autoend () , pecbyte : self . pecbyte () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Icr { addrcf : bool , nackcf : bool , stopcf : bool , berrcf : bool , arlocf : bool , ovrcf : bool , peccf : bool , timoutcf : bool , alertcf : bool , } let proxy = Icr { addrcf : self . addrcf () , nackcf : self . nackcf () , stopcf : self . stopcf () , berrcf : self . berrcf () , arlocf : self . arlocf () , ovrcf : self . ovrcf () , peccf : self . peccf () , timoutcf : self . timoutcf () , alertcf : self . alertcf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt and Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Isr { txe : bool , txis : bool , rxne : bool , addr : bool , nackf : bool , stopf : bool , tc : bool , tcr : bool , berr : bool , arlo : bool , ovr : bool , pecerr : bool , timeout : bool , alert : bool , busy : bool , dir : super :: vals :: Dir , addcode : u8 , } let proxy = Isr { txe : self . txe () , txis : self . txis () , rxne : self . rxne () , addr : self . addr () , nackf : self . nackf () , stopf : self . stopf () , tc : self . tc () , tcr : self . tcr () , berr : self . berr () , arlo : self . arlo () , ovr : self . ovr () , pecerr : self . pecerr () , timeout : self . timeout () , alert : self . alert () , busy : self . busy () , dir : self . dir () , addcode : self . addcode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Own address register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Oar1 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Oar1 { oa1 : u16 , oa1mode : super :: vals :: Addmode , oa1en : bool , } let proxy = Oar1 { oa1 : self . oa1 () , oa1mode : self . oa1mode () , oa1en : self . oa1en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Own address register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Oar2 { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Oar2 { oa2 : u8 , oa2msk : super :: vals :: Oamsk , oa2en : bool , } let proxy = Oar2 { oa2 : self . oa2 () , oa2msk : self . oa2msk () , oa2en : self . oa2en () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "PEC register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Pecr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Pecr { pec : u8 , } let proxy = Pecr { pec : self . pec () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Receive data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Rxdr { rxdata : u8 , } let proxy = Rxdr { rxdata : self . rxdata () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Timeout register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Timeoutr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Timeoutr { timeouta : u16 , tidle : bool , timouten : bool , timeoutb : u16 , texten : bool , } let proxy = Timeoutr { timeouta : self . timeouta () , tidle : self . tidle () , timouten : self . timouten () , timeoutb : self . timeoutb () , texten : self . texten () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Timing register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Timingr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Timingr { scll : u8 , sclh : u8 , sdadel : u8 , scldel : u8 , presc : u8 , } let proxy = Timingr { scll : self . scll () , sclh : self . sclh () , sdadel : self . sdadel () , scldel : self . scldel () , presc : self . presc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Transmit data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

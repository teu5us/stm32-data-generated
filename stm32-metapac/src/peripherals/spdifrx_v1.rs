...
struct Cr { spdifen : u8 , rxdmaen : bool , rxsteo : bool , drfmt : u8 , pmsk : bool , vmsk : bool , cumsk : bool , ptmsk : bool , cbdmaen : bool , chsel : bool , nbtr : u8 , wfa : bool , insel : u8 , } let proxy = Cr { spdifen : self . spdifen () , rxdmaen : self . rxdmaen () , rxsteo : self . rxsteo () , drfmt : self . drfmt () , pmsk : self . pmsk () , vmsk : self . vmsk () , cumsk : self . cumsk () , ptmsk : self . ptmsk () , cbdmaen : self . cbdmaen () , chsel : self . chsel () , nbtr : self . nbtr () , wfa : self . wfa () , insel : self . insel () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Channel Status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dir { thi : u16 , tlo : u16 , } let proxy = Dir { thi : self . thi () , tlo : self . tlo () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Data input register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { dr : u32 , pe : bool , v : bool , u : bool , c : bool , pt : u8 , } let proxy = Dr { dr : self . dr () , pe : self . pe () , v : self . v () , u : self . u () , c : self . c () , pt : self . pt () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt Flag Clear register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

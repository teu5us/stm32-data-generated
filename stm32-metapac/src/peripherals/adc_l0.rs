...
struct Calfact { calfact : u8 , } let proxy = Calfact { calfact : self . calfact () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "common configuration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ccr { presc : super :: vals :: Presc , vrefen : bool , tsen : bool , lfmen : bool , } let proxy = Ccr { presc : self . presc () , vrefen : self . vrefen () , tsen : self . tsen () , lfmen : self . lfmen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr1 { dmaen : bool , dmacfg : super :: vals :: Dmacfg , scandir : super :: vals :: Scandir , res : super :: vals :: Res , align : super :: vals :: Align , extsel : u8 , exten : super :: vals :: Exten , ovrmod : super :: vals :: Ovrmod , cont : bool , wait : bool , autoff : bool , discen : bool , awdsgl : super :: vals :: Awdsgl , awden : bool , awdch : u8 , } let proxy = Cfgr1 { dmaen : self . dmaen () , dmacfg : self . dmacfg () , scandir : self . scandir () , res : self . res () , align : self . align () , extsel : self . extsel () , exten : self . exten () , ovrmod : self . ovrmod () , cont : self . cont () , wait : self . wait () , autoff : self . autoff () , discen : self . discen () , awdsgl : self . awdsgl () , awden : self . awden () , awdch : self . awdch () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfgr2 { ovse : bool , ovsr : u8 , ovss : u8 , tovs : bool , ckmode : super :: vals :: Ckmode , } let proxy = Cfgr2 { ovse : self . ovse () , ovsr : self . ovsr () , ovss : self . ovss () , tovs : self . tovs () , ckmode : self . ckmode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "channel selection register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Chselr { Chselr (0) } } impl core :: fmt :: Debug for Chselr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Chselr") . field ("chsel_x" , & [self . chsel_x (0usize) , self . chsel_x (1usize) , self . chsel_x (2usize) , self . chsel_x (3usize) , self . chsel_x (4usize) , self . chsel_x (5usize) , self . chsel_x (6usize) , self . chsel_x (7usize) , self . chsel_x (8usize) , self . chsel_x (9usize) , self . chsel_x (10usize) , self . chsel_x (11usize) , self . chsel_x (12usize) , self . chsel_x (13usize) , self . chsel_x (14usize) , self . chsel_x (15usize) , self . chsel_x (16usize) , self . chsel_x (17usize) , self . chsel_x (18usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Chselr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Chselr { chsel_x : [bool ; 19usize]
, } let proxy = Chselr { chsel_x : [self . chsel_x (0usize) , self . chsel_x (1usize) , self . chsel_x (2usize) , self . chsel_x (3usize) , self . chsel_x (4usize) , self . chsel_x (5usize) , self . chsel_x (6usize) , self . chsel_x (7usize) , self . chsel_x (8usize) , self . chsel_x (9usize) , self . chsel_x (10usize) , self . chsel_x (11usize) , self . chsel_x (12usize) , self . chsel_x (13usize) , self . chsel_x (14usize) , self . chsel_x (15usize) , self . chsel_x (16usize) , self . chsel_x (17usize) , self . chsel_x (18usize) ,]
...
struct Cr { aden : bool , addis : bool , adstart : bool , adstp : bool , advregen : bool , adcal : bool , } let proxy = Cr { aden : self . aden () , addis : self . addis () , adstart : self . adstart () , adstp : self . adstp () , advregen : self . advregen () , adcal : self . adcal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "data register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Dr { data : u16 , } let proxy = Dr { data : self . data () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt enable register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ier { adrdyie : bool , eosmpie : bool , eocie : bool , eosie : bool , ovrie : bool , awdie : bool , eocalie : bool , } let proxy = Ier { adrdyie : self . adrdyie () , eosmpie : self . eosmpie () , eocie : self . eocie () , eosie : self . eosie () , ovrie : self . ovrie () , awdie : self . awdie () , eocalie : self . eocalie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "interrupt and status register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Isr { adrdy : bool , eosmp : bool , eoc : bool , eos : bool , ovr : bool , awd : bool , eocal : bool , } let proxy = Isr { adrdy : self . adrdy () , eosmp : self . eosmp () , eoc : self . eoc () , eos : self . eos () , ovr : self . ovr () , awd : self . awd () , eocal : self . eocal () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "sampling time register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Smpr { smp : super :: vals :: SampleTime , } let proxy = Smpr { smp : self . smp () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "watchdog threshold register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

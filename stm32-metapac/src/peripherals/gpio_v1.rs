...
fn default () -> Brr { Brr (0) } } impl core :: fmt :: Debug for Brr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Brr") . field ("br" , & [self . br (0usize) , self . br (1usize) , self . br (2usize) , self . br (3usize) , self . br (4usize) , self . br (5usize) , self . br (6usize) , self . br (7usize) , self . br (8usize) , self . br (9usize) , self . br (10usize) , self . br (11usize) , self . br (12usize) , self . br (13usize) , self . br (14usize) , self . br (15usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Brr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Brr { br : [bool ; 16usize]
, } let proxy = Brr { br : [self . br (0usize) , self . br (1usize) , self . br (2usize) , self . br (3usize) , self . br (4usize) , self . br (5usize) , self . br (6usize) , self . br (7usize) , self . br (8usize) , self . br (9usize) , self . br (10usize) , self . br (11usize) , self . br (12usize) , self . br (13usize) , self . br (14usize) , self . br (15usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Port bit set/reset register (GPIOn_BSRR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Port configuration register (GPIOn_CRx)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
fn default () -> Cr { Cr (0) } } impl core :: fmt :: Debug for Cr { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("Cr") . field ("mode" , & [self . mode (0usize) , self . mode (1usize) , self . mode (2usize) , self . mode (3usize) , self . mode (4usize) , self . mode (5usize) , self . mode (6usize) , self . mode (7usize) ,]) . field ("cnf_in" , & [self . cnf_in (0usize) , self . cnf_in (1usize) , self . cnf_in (2usize) , self . cnf_in (3usize) , self . cnf_in (4usize) , self . cnf_in (5usize) , self . cnf_in (6usize) , self . cnf_in (7usize) ,]) . field ("cnf_out" , & [self . cnf_out (0usize) , self . cnf_out (1usize) , self . cnf_out (2usize) , self . cnf_out (3usize) , self . cnf_out (4usize) , self . cnf_out (5usize) , self . cnf_out (6usize) , self . cnf_out (7usize) ,]) . finish () } } # [cfg (feature = "defmt")]
impl defmt :: Format for Cr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Cr { mode : [super :: vals :: Mode ; 8usize]
, cnf_in : [super :: vals :: CnfIn ; 8usize]
, cnf_out : [super :: vals :: CnfOut ; 8usize]
, } let proxy = Cr { mode : [self . mode (0usize) , self . mode (1usize) , self . mode (2usize) , self . mode (3usize) , self . mode (4usize) , self . mode (5usize) , self . mode (6usize) , self . mode (7usize) ,]
, cnf_in : [self . cnf_in (0usize) , self . cnf_in (1usize) , self . cnf_in (2usize) , self . cnf_in (3usize) , self . cnf_in (4usize) , self . cnf_in (5usize) , self . cnf_in (6usize) , self . cnf_in (7usize) ,]
, cnf_out : [self . cnf_out (0usize) , self . cnf_out (1usize) , self . cnf_out (2usize) , self . cnf_out (3usize) , self . cnf_out (4usize) , self . cnf_out (5usize) , self . cnf_out (6usize) , self . cnf_out (7usize) ,]
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Port input data register (GPIOn_IDR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Port configuration lock register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
, lckk : self . lckk () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Port output data register (GPIOn_ODR)"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

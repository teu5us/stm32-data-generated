...
struct Cr { en : bool , cacheinv : bool , waysel : super :: vals :: Waysel , hitmen : bool , missmen : bool , hitmrst : bool , missmrst : bool , } let proxy = Cr { en : self . en () , cacheinv : self . cacheinv () , waysel : self . waysel () , hitmen : self . hitmen () , missmen : self . missmen () , hitmrst : self . hitmrst () , missmrst : self . missmrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ICACHE region configuration register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Crr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Crr { baseaddr : u8 , rsize : super :: vals :: Rsize , ren : bool , remapaddr : u16 , mstsel : super :: vals :: Mstsel , hburst : super :: vals :: Hburst , } let proxy = Crr { baseaddr : self . baseaddr () , rsize : self . rsize () , ren : self . ren () , remapaddr : self . remapaddr () , mstsel : self . mstsel () , hburst : self . hburst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ICACHE flag clear register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Fcr { cbsyendf : bool , cerrf : bool , } let proxy = Fcr { cbsyendf : self . cbsyendf () , cerrf : self . cerrf () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ICACHE interrupt enable register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ier { bsyendie : bool , errie : bool , } let proxy = Ier { bsyendie : self . bsyendie () , errie : self . errie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ICACHE miss monitor register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
impl defmt :: Format for Mmonr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Mmonr { missmon : u16 , } let proxy = Mmonr { missmon : self . missmon () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "ICACHE status register."]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { busyf : bool , bsyendf : bool , errf : bool , } let proxy = Sr { busyf : self . busyf () , bsyendf : self . bsyendf () , errf : self . errf () , } ; defmt :: write ! (f , "{}" , proxy) } } } pub mod vals { # [repr (u8)]

...
struct Cfgr1 { fwdis : bool , boosten : bool , i2c_pb6_fmp : bool , i2c_pb7_fmp : bool , i2c_pb8_fmp : bool , i2c_pb9_fmp : bool , i2c1_fmp : bool , i2c2_fmp : bool , i2c3_fmp : bool , fpu_ie : u8 , } let proxy = Cfgr1 { fwdis : self . fwdis () , boosten : self . boosten () , i2c_pb6_fmp : self . i2c_pb6_fmp () , i2c_pb7_fmp : self . i2c_pb7_fmp () , i2c_pb8_fmp : self . i2c_pb8_fmp () , i2c_pb9_fmp : self . i2c_pb9_fmp () , i2c1_fmp : self . i2c1_fmp () , i2c2_fmp : self . i2c2_fmp () , i2c3_fmp : self . i2c3_fmp () , fpu_ie : self . fpu_ie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "CFGR2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Memrmp { mem_mode : u8 , qfs : bool , fb_mode : bool , } let proxy = Memrmp { mem_mode : self . mem_mode () , qfs : self . qfs () , fb_mode : self . fb_mode () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SCSR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Scsr { sram2er : bool , sram2bsy : bool , } let proxy = Scsr { sram2er : self . sram2er () , sram2bsy : self . sram2bsy () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "SKR"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

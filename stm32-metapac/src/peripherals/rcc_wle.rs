...
struct Ahb3enr { pkaen : bool , aesen : bool , rngen : bool , hsemen : bool , flashen : bool , } let proxy = Ahb3enr { pkaen : self . pkaen () , aesen : self . aesen () , rngen : self . rngen () , hsemen : self . hsemen () , flashen : self . flashen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral reset register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ahb3rstr { pkarst : bool , aesrst : bool , rngrst : bool , hsemrst : bool , flashrst : bool , } let proxy = Ahb3rstr { pkarst : self . pkarst () , aesrst : self . aesrst () , rngrst : self . rngrst () , hsemrst : self . hsemrst () , flashrst : self . flashrst () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "AHB3 peripheral clocks enable in Sleep and Stop modes register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Extcfgr { shdhpre : super :: vals :: Hpre , shdhpref : bool , } let proxy = Extcfgr { shdhpre : self . shdhpre () , shdhpref : self . shdhpref () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Internal clock sources calibration register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]

...
impl defmt :: Format for Autocr { fn format (& self , f : defmt :: Formatter) { # [derive (defmt :: Format)]
struct Autocr { trigsel : u8 , trigpol : super :: vals :: Trigpol , trigen : bool , } let proxy = Autocr { trigsel : self . trigsel () , trigpol : self . trigpol () , trigen : self . trigen () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfg1 { dsize : u8 , fthlv : super :: vals :: Fthlv , udrcfg : super :: vals :: Udrcfg , rxdmaen : bool , txdmaen : bool , crcsize : u8 , crcen : bool , mbr : super :: vals :: Mbr , bpass : bool , } let proxy = Cfg1 { dsize : self . dsize () , fthlv : self . fthlv () , udrcfg : self . udrcfg () , rxdmaen : self . rxdmaen () , txdmaen : self . txdmaen () , crcsize : self . crcsize () , crcen : self . crcen () , mbr : self . mbr () , bpass : self . bpass () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "configuration register 2"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cfg2 { mssi : u8 , midi : u8 , rdiom : super :: vals :: Rdiom , rdiop : super :: vals :: Rdiop , ioswp : bool , comm : super :: vals :: Comm , sp : super :: vals :: Sp , master : super :: vals :: Master , lsbfirst : super :: vals :: Lsbfirst , cpha : super :: vals :: Cpha , cpol : super :: vals :: Cpol , ssm : bool , ssiop : super :: vals :: Ssiop , ssoe : bool , ssom : super :: vals :: Ssom , afcntr : bool , } let proxy = Cfg2 { mssi : self . mssi () , midi : self . midi () , rdiom : self . rdiom () , rdiop : self . rdiop () , ioswp : self . ioswp () , comm : self . comm () , sp : self . sp () , master : self . master () , lsbfirst : self . lsbfirst () , cpha : self . cpha () , cpol : self . cpol () , ssm : self . ssm () , ssiop : self . ssiop () , ssoe : self . ssoe () , ssom : self . ssom () , afcntr : self . afcntr () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "control register 1"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Cr2 { tsize : u16 , } let proxy = Cr2 { tsize : self . tsize () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Polynomial Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Crcpoly { crcpoly : u32 , } let proxy = Crcpoly { crcpoly : self . crcpoly () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt Enable Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ier { rxpie : bool , txpie : bool , dxpie : bool , eotie : bool , txtfie : bool , udrie : bool , ovrie : bool , crceie : bool , tifreie : bool , modfie : bool , } let proxy = Ier { rxpie : self . rxpie () , txpie : self . txpie () , dxpie : self . dxpie () , eotie : self . eotie () , txtfie : self . txtfie () , udrie : self . udrie () , ovrie : self . ovrie () , crceie : self . crceie () , tifreie : self . tifreie () , modfie : self . modfie () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Interrupt/Status Flags Clear Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Ifcr { eotc : bool , txtfc : bool , udrc : bool , ovrc : bool , crcec : bool , tifrec : bool , modfc : bool , suspc : bool , } let proxy = Ifcr { eotc : self . eotc () , txtfc : self . txtfc () , udrc : self . udrc () , ovrc : self . ovrc () , crcec : self . crcec () , tifrec : self . tifrec () , modfc : self . modfc () , suspc : self . suspc () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Receiver CRC Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
...
struct Sr { rxp : bool , txp : bool , dxp : bool , eot : bool , txtf : bool , udr : bool , ovr : bool , crce : bool , tifre : bool , modf : bool , susp : bool , txc : bool , rxplvl : super :: vals :: Rxplvl , rxwne : super :: vals :: Rxwne , ctsize : u16 , } let proxy = Sr { rxp : self . rxp () , txp : self . txp () , dxp : self . dxp () , eot : self . eot () , txtf : self . txtf () , udr : self . udr () , ovr : self . ovr () , crce : self . crce () , tifre : self . tifre () , modf : self . modf () , susp : self . susp () , txc : self . txc () , rxplvl : self . rxplvl () , rxwne : self . rxwne () , ctsize : self . ctsize () , } ; defmt :: write ! (f , "{}" , proxy) } } # [doc = "Transmitter CRC Register"]
# [repr (transparent)]
# [derive (Copy , Clone , Eq , PartialEq)]
